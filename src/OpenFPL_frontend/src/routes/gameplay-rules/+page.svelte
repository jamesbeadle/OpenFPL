        ...
        <table class="w-full border-collapse striped mb-8 mt-4">
          ...
          <tr>
            <td class="text-left px-4 py-2"
              >Every 3 saves a goalkeeper makes.</td
            >
            <td>5</td>
          </tr>
          <tr>
            <td class="text-left px-4 py-2"
              >Goalkeeper or defender cleansheet.</td
            >
            <td>10</td>
          </tr>
          <tr>
        ...
        <table class="w-full border-collapse striped mb-8 mt-4">
          ...
          <tr>
            ...
            <td
              ...
              score a goal in a match.</td
            >
          </tr>
          <tr>
            <td class="text-left px-4 py-2">Countrymen</td>
            <td
              >Receive a X2 multiplier for players of a selected nationality.</td
            >
          </tr>
          <tr>
