<script lang="ts">
  ...
  import type { FantasyTeam, ManagerDTO, SystemState, Team } from "../../../../declarations/OpenFPL_backend/OpenFPL_backend.did";
        ...
        <div class="flex justify-start items-center text-white space-x-4 flex-grow m-4 bg-panel p-4 rounded-md">
          <div class="flex-grow">
            ...
            <p class="text-2xl sm:text-3xl md:text-4xl mt-2 mb-2 font-bold">
              ...
              <span class="text-xs">({manager.weeklyPoints.toLocaleString()})</span>
            </p>
          ...
          <div class="flex-grow">
            ...
            <p class="text-2xl sm:text-3xl md:text-4xl mt-2 mb-2 font-bold">
              ...
              <span class="text-xs">({manager.seasonPoints.toLocaleString()})</span>
            </p>
