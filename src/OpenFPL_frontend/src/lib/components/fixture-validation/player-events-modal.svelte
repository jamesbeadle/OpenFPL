<script lang="ts">
    ...
    function handleAddEvent() {
      if (eventType && eventStartTime !== null && eventEndTime !== null) {
        ...
        let updatedEvents: PlayerEventData[] = [...get(playerEventData), newEvent];
          ...
          <div class="mt-4 p-4 border-t border-gray-200">
            ...
            <div class="flex flex-col gap-3">
              ...
              <div>
                  ...
                  <input type="number" id="startMinute" bind:value={eventStartTime} class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md" placeholder="Enter start minute">
              </div>
              <div>
                  <label for="endMinute" class="block text-sm font-medium text-gray-700">End Minute</label>
                  <input type="number" id="endMinute" bind:value={eventEndTime} class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md" placeholder="Enter end minute">
              </div>
