<script lang="ts">
    ...
    $: groupedFixtures = filteredFixtures.reduce((acc: { [key: string]: FixtureWithTeams[] }, fixtureWithTeams) => {
                        ...
                        <div class="flex items-center justify-between py-2 border-b border-gray-700">
                            ...
                            <div class="flex items-center space-x-10 w-1/2 md:justify-center">
                                <div class={`flex flex-col min-w-[120px] md:min-w-[200px] text-xs 3xl:text-base ${
                                    ...
                                    <a class="my-1" href={`/club/${fixture.homeTeamId}`}>{homeTeam ? homeTeam.friendlyName : ''}</a>
                                    <a class="my-1" href={`/club/${fixture.awayTeamId}`}>{awayTeam ? awayTeam.friendlyName : ''}</a>
                                </div>
