...
<div class="container-fluid">
  <div class="flex flex-col space-y-4">
    <div>
      ...
      <div class="flex border-b border-gray-700 bg-light-gray text-xs xs:text-sm p-2 px-4">
        ...
        <div class="flex w-6/12 sm:w-4/12">Player Name</div>
      ...
      {#each filteredPlayers as player}
        <div class="flex items-center p-2 px-4 border-b border-gray-700 text-white cursor-pointer text-xs xs:text-sm">
          <a
          ...
          >
            ...
            <div class="flex items-center w-6/12 sm:w-4/12">
              <svelte:component
