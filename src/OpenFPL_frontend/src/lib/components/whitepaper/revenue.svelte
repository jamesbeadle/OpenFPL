<div class="m-4">
  ...
  <p class="my-2">
    ...
    Advertising, and Merchandise. These channels provide a balanced mix of $FPL and
  ...
  <p class="my-2">
    OpenFPL provides many instances to implement non-intrusive advertising to increase the value of the DAO. 
    This includes on the board behind the goal on the pick team view along within the content subscription video reel and podcasting infrastructure.
  </p>
