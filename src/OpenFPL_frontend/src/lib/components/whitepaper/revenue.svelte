<div class="m-4">
  ...
  <p class="my-2">
    ...
    Podcasts, and Merchandise. These channels provide a balanced mix of $FPL and
    $ICP revenue, enhancing the DAO's financial resilience.
  </p>
  ...
  <p class="my-2">
    ...
    club-specific satellite podcasts. Initially hosted off-chain, our long-term
    goal is to transition these to on-chain hosting as services become
    available.
  </p>
  <p class="my-2">
  ...
  <p class="my-2">
    Revenue will be generated from sponsorships and advertising. As our listener
    base grows, these podcasts are expected to become increasingly lucrative.
    All profits, after production costs, will be deposited into the DAO's
    treasury. Beyond revenue, these podcasts are a strategic move to bolster
    community engagement and enhance the OpenFPL brand, providing valuable
