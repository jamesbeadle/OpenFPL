...
const BadgeIcon = ({ onClick, width=814, height=814, marginRight=0 }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={width}
    height={height}
  ...
  >
    ...
    <path d="M407.237 135.667C464.862 135.667 527.811 150.42 576.583 174.467V493.012C576.583 547.347 562.542 558.539 407 654.422L407.237 135.667Z" fill="white"/>
  </svg>
);
...
export { LogoIcon, BadgeIcon, ClockIcon, ArrowLeft, ArrowRight, CopyIcon, ExitIcon, LogoutIcon, ProfileIcon, EditIcon, StarIcon, GovernanceIcon, TableIcon, FixtureIcon, TeamIcon, PlayerIcon, TransferIcon, StarOutlineIcon, 
