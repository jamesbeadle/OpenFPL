              ...
              <Card.Body>
                ...
                <Accordion>
                  <Accordion.Item eventKey="0">
                    ...
                    <Accordion.Body>
                      <p>
                        OpenFPL is a decentralised fantasy football app for the Premier League running on the Internet Computer blockchain. 
                      </p>
                      <p>
                        With millions of users playing fantasy football around the world, OpenFPL aims to introduce a large number of users the platform and therefore the Internet Computer blockchain. 
                        It operates as decentralised autonomous organisation (DAO) 
                        with the purpose to reward users for playing fantasy football with revenue generated by the DAO in the form of FPL tokens.
                      </p>
                      <p>
                        Then OpenFPL fantasy football game is an <a target='_blank' href="https://www.github.com">open source</a> progessive web application (PWA). It has been designed to work 
                        with any device as it were a native app. It has been designed with scaling in mind, 
                        automatically creating the required canister infrastructure to potentially serve the billions of Premier League football fans around the world.
                      </p>
                  ...
                  <Accordion.Item eventKey="1">
                    ...
                    <Accordion.Body>
                      <p>OpenFPL is fully decentralised, with its governance using an on-chain, decentralised autonomous organisation (DAO). 
                        The DAO aims to operate under the Internet Computer's Service Nervous System (SNS).</p>
                      <p>To maintain no reliance on third parties, the DAO manages its own Premier League event dataset used within the fantasy football game. 
                        This is curated by the DAOs neuron holders in return for FPL token rewards.</p>
                      <p>Neuron holders can also receive FPL rewards by valuing players. A neuron can value a player once during the season to receive FPL tokens rewards. 
                        After each valuation a players value changes.</p>
                      <p>The DAO can make a proposal to burn or otherwise utilise FPL tokens within the DAO's treasury FPL ledger account.</p>
                      <p>The DAO can make a proposal to utilise ICP tokens within the DAO's treasury ICP ledger account.</p>
                  ...
                  <Accordion.Item eventKey="3">
                    ...
                    <Accordion.Body>
                      ...
                      <p>The FPL utility token can be used to pay for OpenFPL products and services:</p>
                      <p>- Creating a private league.</p>
                      <p>- Placing bets with other users or groups of users.</p>
                      <p>- Purchasing an advertising space for a season.</p>
                      ...
                      <Container fluid>
                        ...
                        <Row className="mb-3">
                          <Col>
                            ...
                            <br />
                            <br />- The first neuron will have a zero dissolve delay and so be immediately disbursable to liquid FPL tokens.
                            <br />- The other neurons will have dissolve delays of 1 & 2 years respectively. 
                            <br />
                            <br />
                            Each Community Fund participant will also receive their share of tokens as a 
                            basket of 3 neurons with the same configuration.</p>
                          </Col>
                        </Row>
                        ...
                        <Row className="mb-3">
                          <Col>
                            ...
                            <p>Each funded.app NFT purchaser will receive their FPL as a basket of 3 equal value neurons:
                              <br />
                              <br />- The first neuron will have a zero dissolve delay and so be immediately disbursable to liquid FPL tokens.
                              <br />- The other neurons will have dissolve delays of 1 & 2 years respectively.  
                            </p>
                        ...
                        <Row className="mb-3">
                          <Col>
                            <h3>Treasury (51%)</h3>
                            <p>After the decentralization sale the SNS will be left with a treasury of the remaining 51% of FPL tokens. 
                              ...
                              To list FPL on a DEX implementing an AMM it is necessary to provide a liquidity pool of FPL backed by another token, in our case ICP raised from the decentralization sale. 
                        ...
                        <Row className="mb-3">
                          <Col>
                            <h3>SNS Decentralization Sale Configuration</h3>
                            <Table striped bordered hover className="table-fixed">
                              <colgroup>
                                <col style={{width: '70%'}} />
                                <col style={{width: '30%'}} />
                  ...
                  <Accordion.Item eventKey="5">
                    ...
                    <Accordion.Body>
                      ...
                      <p>Soon after the decentralization sale, as and when DEXes are available, proposals will be made to transfer FPL and the corresponding value of ICP from 
                  ...
                  <Accordion.Item eventKey="6">
                    ...
                    <Accordion.Body>
                      ...
                      <p>At genesis the SNS will have a treasury of ICP from the decentralization sale and 51M FPL tokens.</p>
                      ...
                      <p>
                        As the OpenChat DAO sees fit it can choose to burn FPL tokens to reduce the total supply. 
                        The expectation is that over several years the SNS will be able to afford to burn CHAT at an increasing rate until the burn rate exceeds 
                      ...
                      <p>After the decentralization sale, participants and funded.app NFT holders will receive a basket of neurons of varying dissolve delays with only 1/3 being immediately liquid. 
                        The voting reward rate, initialized to 2.5%, is expected to encourage token holders to lock up a certain proportion of tokens thus, at least temporarily, 
