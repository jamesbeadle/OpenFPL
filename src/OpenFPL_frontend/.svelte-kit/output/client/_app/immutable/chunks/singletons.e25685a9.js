import { n as d, s as v } from "./scheduler.e108d1fd.js";
const u = [];
function p(e, t = d) {
  let n;
  const o = new Set();
...
var g;
const m = ((g = globalThis.__sveltekit_zia9yy) == null ? void 0 : g.base) ?? "";
var k;
const E =
    ((k = globalThis.__sveltekit_zia9yy) == null ? void 0 : k.assets) ?? m,
  w = "1699438606236",
...
function A() {
  ...
  async function o() {
    clearTimeout(n);
    try {
      const a = await fetch(`${E}/_app/version.json`, {
        headers: { pragma: "no-cache", "cache-control": "no-cache" },
      });
      if (!a.ok) return !1;
      const r = (await a.json()).version !== w;
...
const V = { url: h({}), page: h({}), navigating: p(null), updated: A() };
export {
  x as I,
  _ as P,
  I as S,
