  ...
  actor Self {
    ...
    private func postUpgradeCallback() : async (){
      ...
      //populate all canister ids
    };
    /*
    public shared func getDefaultCanisterInfo() : async [DTOs.CanisterInfoDTO] {

    };

    public shared func getAutoGeneratedCanisterInfo() :async [DTOs.CanisterInfoDTO] {
