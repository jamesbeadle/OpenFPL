...
export interface BuyerState { 'icp' : [] | [TransferableAmount] }
...
export interface GetLifecycleResponse { 'lifecycle' : [] | [number] }
...
export type Possibility = { 'Ok' : Response } |
  { 'Err' : CanisterCallError };
export type Possibility_1 = { 'Ok' : SetDappControllersResponse } |
  { 'Err' : CanisterCallError };
...
export interface SetModeCallResult { 'possibility' : [] | [Possibility_2] }
