...
export interface GetManagerByUsername { 'username' : string }
...
export type Result_1 = { 'ok' : ManagerDTO } |
  { 'err' : Error };
export type Result_10 = { 'ok' : Array<DataHashDTO> } |
  { 'err' : Error };
export type Result_11 = { 'ok' : TeamSelectionDTO } |
  { 'err' : Error };
export type Result_12 = { 'ok' : Array<CanisterDTO> } |
  { 'err' : Error };
export type Result_13 = { 'ok' : RewardRatesDTO } |
  { 'err' : Error };
...
export type Result_5 = { 'ok' : bigint } |
  { 'err' : Error };
export type Result_6 = { 'ok' : AppStatusDTO } |
  { 'err' : Error };
export type Result_7 = { 'ok' : ProfileDTO } |
  { 'err' : Error };
export type Result_8 = { 'ok' : Array<CanisterId> } |
  { 'err' : Error };
export type Result_9 = { 'ok' : ManagerGameweekDTO } |
  { 'err' : Error };
...
export interface _SERVICE {
  ...
  'getManagerCanisterIds' : ActorMethod<[], Result_8>,
