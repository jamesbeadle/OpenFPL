export const idlFactory = ({ IDL }) => {
  ...
  const Result_23 = IDL.Variant({ 'ok' : AdminDashboardDTO, 'err' : Error });
  ...
  const Result_10 = IDL.Variant({ 'ok' : IDL.Vec(PlayerDTO), 'err' : Error });
  ...
  return IDL.Service({
    ...
    'getAdminDashboard' : IDL.Func([], [Result_23], []),
