...
import { f as tl } from "../chunks/fixture-store.880a736f.js";
import {
  A as Pe,
  a as v,
  b as Me,
...
import { p as na } from "../chunks/player-store.f12f3662.js";
import { S as Ha } from "../chunks/ShirtIcon.3da312bd.js";
import { p as ka } from "../chunks/stores.42c5f1dc.js";
import { s as ia, t as el } from "../chunks/team-store.583260fe.js";
function ma(s, n, f) {
  const t = s.slice();
  return (t[5] = n[f]), t;
}
    ...
    ie && (V = ra(ie, fe())),
    {
      ...
      p(h, H) {
        if (
          ...
          (!z || H & 2) &&
            G !== (G = fa(Number(h[5].dateOfBirth)) + "") &&
            ue(M, G),
          H & 2 && ie !== (ie = ca(h[5].nationality)))
        ) {
          if (V) {
            Ht();
            const u = V;
...
function ba(s) {
  let n,
    ...
    se,
    G,
    M = ua(Number(s[10].kickOff)) + "",
    ne,
    R,
    V,
    re = da(Number(s[10].kickOff)) + "",
    X,
    ae,
    Z,
    P,
    ...
    })),
    {
      ...
      h() {
        l(f, "class", "w-1/6 ml-4"),
          ...
          l(P, "class", "flex flex-col text-xs md:text-base"),
          l(Z, "class", "w-1/3"),
          l(H, "class", "flex flex-col text-xs md:text-base"),
      ...
      p(D, I) {
        ...
        I & 2 && (B.primaryColour = D[12] ? D[12].primaryColourHex : ""),
          ...
          (!K || (I & 2 && J !== (J = `/club?id=${D[10].awayTeamId}`))) &&
            l(Y, "href", J),
          (!K || I & 2) &&
            M !== (M = ua(Number(D[10].kickOff)) + "") &&
            ue(ne, M),
          (!K || I & 2) &&
            re !== (re = da(Number(D[10].kickOff)) + "") &&
            ue(X, re),
          (!K || I & 2) &&
