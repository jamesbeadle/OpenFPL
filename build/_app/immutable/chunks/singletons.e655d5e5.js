import { H as d, s as m } from "./index.a8c54947.js";
const u = [];
function p(e, t = d) {
  let n;
  const o = new Set();
...
const v = globalThis.__sveltekit_7hy25a?.base ?? "",
  w = globalThis.__sveltekit_7hy25a?.assets ?? v,
  y = "1701552390062",
...
function L(e, t) {
  ...
  const o = e instanceof SVGAElement ? e.target.baseVal : e.target,
    ...
    c = n?.origin === location.origin && e.hasAttribute("download");
...
function E() {
  ...
  async function o() {
    ...
    try {
      ...
      if (!r.ok) return !1;
      const a = (await r.json()).version !== y;
...
const Y = { url: h({}), page: h({}), navigating: p(null), updated: E() };
export {
  I,
  _ as P,
  T as S,
