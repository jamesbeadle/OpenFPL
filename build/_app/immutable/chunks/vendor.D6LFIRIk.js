import { c as Lr, g as Cu, _ as Mu, a as Vu } from "./index.BD1-Avof.js";
const rp = !1;
var to = {},
  _n = {};
_n.byteLength = Gu;
...
for (var Ar = 0, qu = Li.length; Ar < qu; ++Ar)
  (kt[Ar] = Li[Ar]), (ht[Li.charCodeAt(Ar)] = Ar);
ht[45] = 62;
ht[95] = 63;
function ro(e) {
  var t = e.length;
...
function Lu(e) {
  ...
  for (g = 0; g < o; g += 4)
    (t =
      (ht[e.charCodeAt(g)] << 18) |
      (ht[e.charCodeAt(g + 1)] << 12) |
      (ht[e.charCodeAt(g + 2)] << 6) |
      ht[e.charCodeAt(g + 3)]),
      (a[l++] = (t >> 16) & 255),
      (a[l++] = (t >> 8) & 255),
      (a[l++] = t & 255);
  return (
    i === 2 &&
      ((t = (ht[e.charCodeAt(g)] << 2) | (ht[e.charCodeAt(g + 1)] >> 4)),
      (a[l++] = t & 255)),
    i === 1 &&
      ((t =
        (ht[e.charCodeAt(g)] << 10) |
        (ht[e.charCodeAt(g + 1)] << 4) |
        (ht[e.charCodeAt(g + 2)] >> 2)),
      (a[l++] = (t >> 8) & 255),
      (a[l++] = t & 255)),
    a
  );
...
function Hu(e) {
  return (
    kt[(e >> 18) & 63] + kt[(e >> 12) & 63] + kt[(e >> 6) & 63] + kt[e & 63]
  );
}
function Du(e, t, r) {
...
function Ku(e) {
  for (
    var t, r = e.length, n = r % 3, i = [], a = 16383, l = 0, o = r - n;
    l < o;
    l += a
  )
    i.push(Du(e, l, l + a > o ? o : l + a));
  return (
    n === 1
      ? ((t = e[r - 1]), i.push(kt[t >> 2] + kt[(t << 4) & 63] + "=="))
      : n === 2 &&
        ((t = (e[r - 2] << 8) + e[r - 1]),
        i.push(kt[t >> 10] + kt[(t >> 4) & 63] + kt[(t << 2) & 63] + "=")),
    i.join("")
  );
}
var xn = {};
/*! ieee754. BSD-3-Clause License. Feross Aboukhadijeh <https://feross.org/opensource> */ xn.read =
  function (e, t, r, n, i) {
    var a,
      l,
      o = i * 8 - n - 1,
    ...
    for (
      l = a & ((1 << -B) - 1), a >>= -B, B += n;
      B > 0;
      l = l * 256 + e[t + N], N += I, B -= 8
    );
    if (a === 0) a = 1 - _;
    else {
      if (a === g) return l ? NaN : (S ? -1 : 1) * (1 / 0);
      (l = l + Math.pow(2, n)), (a = a - _);
    }
    return (S ? -1 : 1) * l * Math.pow(2, a - n);
  };
xn.write = function (e, t, r, n, i, a) {
  var l,
    o,
    g,
    _ = a * 8 - i - 1,
    ...
    t = Math.abs(t),
      isNaN(t) || t === 1 / 0
        ...
        : ((l = Math.floor(Math.log(t) / Math.LN2)),
          t * (g = Math.pow(2, -l)) < 1 && (l--, (g *= 2)),
          l + N >= 1 ? (t += I / g) : (t += I * Math.pow(2, 1 - N)),
          t * g >= 2 && (l++, (g /= 2)),
          l + N >= B
            ? ((o = 0), (l = B))
            : l + N >= 1
              ? ((o = (t * g - 1) * Math.pow(2, i)), (l = l + N))
              : ((o = t * Math.pow(2, N - 1) * Math.pow(2, i)), (l = 0)));
    i >= 8;
    e[r + S] = o & 255, S += m, o /= 256, i -= 8
  );
  for (
    l = (l << i) | o, _ += i;
    _ > 0;
    e[r + S] = l & 255, S += m, l /= 256, _ -= 8
  );
  e[r + S - m] |= $ * 128;
};
/*!
 ...
 */ (function (e) {
  ...
  function g(y, f, d) {
    ...
    if (
      L(y, ArrayBuffer) ||
      (y && L(y.buffer, ArrayBuffer)) ||
      (typeof SharedArrayBuffer < "u" &&
        (L(y, SharedArrayBuffer) || (y && L(y.buffer, SharedArrayBuffer))))
    )
      return $(y, f, d);
    if (typeof y == "number")
      throw new TypeError(
    ...
    if (A != null && A !== y) return o.from(A, f, d);
    const k = V(y);
    if (k) return k;
    if (
      typeof Symbol < "u" &&
      ...
      return o.from(y[Symbol.toPrimitive]("string"), f, d);
    throw new TypeError(
      "The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type " +
        typeof y,
    );
  ...
  function I(y, f) {
    ...
    let A = l(d);
    const k = A.write(y, f);
    return k !== d && (A = A.slice(0, k)), A;
  }
  function S(y) {
    const f = y.length < 0 ? 0 : W(y.length) | 0,
      d = l(f);
    for (let A = 0; A < f; A += 1) d[A] = y[A] & 255;
    return d;
  }
  function m(y) {
    if (L(y, Uint8Array)) {
  ...
  function V(y) {
    if (o.isBuffer(y)) {
      const f = W(y.length) | 0,
        d = l(f);
      return d.length === 0 || y.copy(d, 0, 0, f), d;
    }
    if (y.length !== void 0)
      return typeof y.length != "number" || Y(y.length) ? l(0) : S(y);
  ...
  (o.isBuffer = function (f) {
    ...
    (o.compare = function (f, d) {
      if (
        (L(f, Uint8Array) && (f = o.from(f, f.offset, f.byteLength)),
        L(d, Uint8Array) && (d = o.from(d, d.offset, d.byteLength)),
        !o.isBuffer(f) || !o.isBuffer(d))
      )
        throw new TypeError(
    ...
    (o.concat = function (f, d) {
      ...
      if (f.length === 0) return o.alloc(0);
      let A;
      if (d === void 0) for (d = 0, A = 0; A < f.length; ++A) d += f[A].length;
      const k = o.allocUnsafe(d);
      let D = 0;
      for (A = 0; A < f.length; ++A) {
        let H = f[A];
        if (L(H, Uint8Array))
          D + H.length > k.length
            ? (o.isBuffer(H) || (H = o.from(H)), H.copy(k, D))
            : Uint8Array.prototype.set.call(k, H, D);
        else if (o.isBuffer(H)) H.copy(k, D);
  ...
  function q(y, f) {
    ...
    if (ArrayBuffer.isView(y) || L(y, ArrayBuffer)) return y.byteLength;
    if (typeof y != "string")
      throw new TypeError(
  ...
  (o.prototype.swap16 = function () {
    ...
    for (let d = 0; d < f; d += 2) C(this, d, d + 1);
    return this;
  }),
    (o.prototype.swap32 = function () {
      ...
      for (let d = 0; d < f; d += 4) C(this, d, d + 3), C(this, d + 1, d + 2);
      return this;
    }),
    ...
    (o.prototype.compare = function (f, d, A, k, D) {
      if (
        (L(f, Uint8Array) && (f = o.from(f, f.offset, f.byteLength)),
        !o.isBuffer(f))
      )
      ...
      if (
        ...
        d < 0 || A > f.length || k < 0 || D > this.length)
      )
        throw new RangeError("out of range index");
      if (k >= D && d >= A) return 0;
      if (k >= D) return -1;
      if (d >= A) return 1;
      if (((d >>>= 0), (A >>>= 0), (k >>>= 0), (D >>>= 0), this === f))
        return 0;
      let H = D - k,
        _e = A - d;
      const ve = Math.min(H, _e),
        Ee = this.slice(k, D),
        xe = f.slice(d, A);
  ...
  function Z(y, f, d, A, k) {
    ...
    if ((typeof f == "string" && (f = o.from(f, A)), o.isBuffer(f)))
      return f.length === 0 ? -1 : G(y, f, d, A, k);
    if (typeof f == "number")
      return (
        (f = f & 255),
        typeof Uint8Array.prototype.indexOf == "function"
          ? k
            ? Uint8Array.prototype.indexOf.call(y, f, d)
            : Uint8Array.prototype.lastIndexOf.call(y, f, d)
          : G(y, [f], d, A, k)
      );
    throw new TypeError("val must be string, number or Buffer");
  }
  function G(y, f, d, A, k) {
    let D = 1,
      H = y.length,
      _e = f.length;
    if (
  ...
  (o.prototype.includes = function (f, d, A) {
    return this.indexOf(f, d, A) !== -1;
  }),
    (o.prototype.indexOf = function (f, d, A) {
      return Z(this, f, d, A, !0);
    }),
    (o.prototype.lastIndexOf = function (f, d, A) {
      return Z(this, f, d, A, !1);
    });
  function Q(y, f, d, A) {
    d = Number(d) || 0;
    const k = y.length - d;
  ...
  function fe(y, f, d, A) {
    return O(w(f, y.length - d), y, d, A);
  }
  (o.prototype.write = function (f, d, A, k) {
    if (d === void 0) (k = "utf8"), (A = this.length), (d = 0);
    else if (A === void 0 && typeof d == "string")
      (k = d), (A = this.length), (d = 0);
    else if (isFinite(d))
      (d = d >>> 0),
        isFinite(A)
    ...
    if (
      ((A === void 0 || A > D) && (A = D),
      (f.length > 0 && (A < 0 || d < 0)) || d > this.length)
    )
    ...
    for (;;)
      switch (k) {
        ...
        case "utf8":
        case "utf-8":
          return re(this, f, d, A);
        case "ascii":
        case "latin1":
        case "binary":
          return X(this, f, d, A);
        case "base64":
          return de(this, f, d, A);
        case "ucs2":
        case "ucs-2":
        case "utf16le":
        case "utf-16le":
          return fe(this, f, d, A);
        default:
  ...
  function R(y, f, d) {
    return f === 0 && d === y.length
      ? t.fromByteArray(y)
      : t.fromByteArray(y.slice(f, d));
  }
  function P(y, f, d) {
  ...
  function M(y) {
    ...
    let d = "",
      A = 0;
    for (; A < f; )
      d += String.fromCharCode.apply(String, y.slice(A, (A += z)));
    return d;
  }
  function j(y, f, d) {
    let A = "";
    d = Math.min(y.length, d);
    for (let k = f; k < d; ++k) A += String.fromCharCode(y[k] & 127);
    return A;
  }
  function J(y, f, d) {
    let A = "";
    d = Math.min(y.length, d);
    for (let k = f; k < d; ++k) A += String.fromCharCode(y[k]);
    return A;
  }
  function ee(y, f, d) {
    const A = y.length;
  ...
  (o.prototype.readUintLE = o.prototype.readUIntLE =
    function (f, d, A) {
      (f = f >>> 0), (d = d >>> 0), A || ae(f, d, this.length);
      let k = this[f],
        D = 1,
        H = 0;
      for (; ++H < d && (D *= 256); ) k += this[f + H] * D;
      return k;
    }),
    ...
    (o.prototype.readBigUInt64LE = pe(function (f) {
      (f = f >>> 0), E(f, "offset");
      const d = this[f],
        A = this[f + 7];
      (d === void 0 || A === void 0) && T(f, this.length - 8);
      const k =
          d + this[++f] * 2 ** 8 + this[++f] * 2 ** 16 + this[++f] * 2 ** 24,
        D = this[++f] + this[++f] * 2 ** 8 + this[++f] * 2 ** 16 + A * 2 ** 24;
      return BigInt(k) + (BigInt(D) << BigInt(32));
    })),
    (o.prototype.readBigUInt64BE = pe(function (f) {
      (f = f >>> 0), E(f, "offset");
      const d = this[f],
        A = this[f + 7];
      (d === void 0 || A === void 0) && T(f, this.length - 8);
      const k =
          d * 2 ** 24 + this[++f] * 2 ** 16 + this[++f] * 2 ** 8 + this[++f],
        D = this[++f] * 2 ** 24 + this[++f] * 2 ** 16 + this[++f] * 2 ** 8 + A;
      return (BigInt(k) << BigInt(32)) + BigInt(D);
    })),
    (o.prototype.readIntLE = function (f, d, A) {
      (f = f >>> 0), (d = d >>> 0), A || ae(f, d, this.length);
      let k = this[f],
        D = 1,
        H = 0;
      for (; ++H < d && (D *= 256); ) k += this[f + H] * D;
      return (D *= 128), k >= D && (k -= Math.pow(2, 8 * d)), k;
    }),
    (o.prototype.readIntBE = function (f, d, A) {
      (f = f >>> 0), (d = d >>> 0), A || ae(f, d, this.length);
      let k = d,
        D = 1,
        H = this[f + --k];
      for (; k > 0 && (D *= 256); ) H += this[f + --k] * D;
      return (D *= 128), H >= D && (H -= Math.pow(2, 8 * d)), H;
    }),
    (o.prototype.readInt8 = function (f, d) {
      return (
        (f = f >>> 0),
        d || ae(f, 1, this.length),
        this[f] & 128 ? (255 - this[f] + 1) * -1 : this[f]
      );
    }),
    (o.prototype.readInt16LE = function (f, d) {
      (f = f >>> 0), d || ae(f, 2, this.length);
    ...
    (o.prototype.readBigInt64LE = pe(function (f) {
      (f = f >>> 0), E(f, "offset");
      const d = this[f],
        A = this[f + 7];
      (d === void 0 || A === void 0) && T(f, this.length - 8);
    ...
    (o.prototype.readBigInt64BE = pe(function (f) {
      (f = f >>> 0), E(f, "offset");
      const d = this[f],
        A = this[f + 7];
      (d === void 0 || A === void 0) && T(f, this.length - 8);
      const k =
        (d << 24) + this[++f] * 2 ** 16 + this[++f] * 2 ** 8 + this[++f];
      return (
        (BigInt(k) << BigInt(32)) +
        BigInt(
    ...
    (o.prototype.readFloatLE = function (f, d) {
      return (
        (f = f >>> 0), d || ae(f, 4, this.length), r.read(this, f, !0, 23, 4)
      );
    }),
    (o.prototype.readFloatBE = function (f, d) {
      return (
        (f = f >>> 0), d || ae(f, 4, this.length), r.read(this, f, !1, 23, 4)
      );
    }),
    (o.prototype.readDoubleLE = function (f, d) {
      return (
        (f = f >>> 0), d || ae(f, 8, this.length), r.read(this, f, !0, 52, 8)
      );
    }),
    (o.prototype.readDoubleBE = function (f, d) {
      return (
        (f = f >>> 0), d || ae(f, 8, this.length), r.read(this, f, !1, 52, 8)
      );
    });
  function le(y, f, d, A, k, D) {
    if (!o.isBuffer(y))
  ...
  (o.prototype.writeUintLE = o.prototype.writeUIntLE =
    function (f, d, A, k) {
      if (((f = +f), (d = d >>> 0), (A = A >>> 0), !k)) {
        const _e = Math.pow(2, 8 * A) - 1;
        le(this, f, d, A, _e, 0);
      }
      let D = 1,
        H = 0;
      for (this[d] = f & 255; ++H < A && (D *= 256); )
        this[d + H] = (f / D) & 255;
      return d + A;
    }),
  ...
  (o.prototype.writeBigUInt64LE = pe(function (f, d = 0) {
    return te(this, f, d, BigInt(0), BigInt("0xffffffffffffffff"));
  })),
    (o.prototype.writeBigUInt64BE = pe(function (f, d = 0) {
      return x(this, f, d, BigInt(0), BigInt("0xffffffffffffffff"));
    })),
    (o.prototype.writeIntLE = function (f, d, A, k) {
      if (((f = +f), (d = d >>> 0), !k)) {
        const ve = Math.pow(2, 8 * A - 1);
        le(this, f, d, A, ve - 1, -ve);
      }
      let D = 0,
        H = 1,
        _e = 0;
      for (this[d] = f & 255; ++D < A && (H *= 256); )
        f < 0 && _e === 0 && this[d + D - 1] !== 0 && (_e = 1),
          (this[d + D] = (((f / H) >> 0) - _e) & 255);
      return d + A;
    }),
    (o.prototype.writeIntBE = function (f, d, A, k) {
      if (((f = +f), (d = d >>> 0), !k)) {
        const ve = Math.pow(2, 8 * A - 1);
        le(this, f, d, A, ve - 1, -ve);
      }
    ...
    (o.prototype.writeInt8 = function (f, d, A) {
      return (
        (f = +f),
        (d = d >>> 0),
        A || le(this, f, d, 1, 127, -128),
        f < 0 && (f = 255 + f + 1),
        (this[d] = f & 255),
        d + 1
      );
    }),
    (o.prototype.writeInt16LE = function (f, d, A) {
      return (
        (f = +f),
        (d = d >>> 0),
        A || le(this, f, d, 2, 32767, -32768),
        (this[d] = f & 255),
        (this[d + 1] = f >>> 8),
        d + 2
      );
    }),
    (o.prototype.writeInt16BE = function (f, d, A) {
      return (
        (f = +f),
        (d = d >>> 0),
        A || le(this, f, d, 2, 32767, -32768),
    ...
    (o.prototype.writeInt32LE = function (f, d, A) {
      return (
        (f = +f),
        (d = d >>> 0),
        A || le(this, f, d, 4, 2147483647, -2147483648),
        (this[d] = f & 255),
        (this[d + 1] = f >>> 8),
        (this[d + 2] = f >>> 16),
        (this[d + 3] = f >>> 24),
    ...
    (o.prototype.writeInt32BE = function (f, d, A) {
      return (
        (f = +f),
        (d = d >>> 0),
        A || le(this, f, d, 4, 2147483647, -2147483648),
    ...
    (o.prototype.writeBigInt64LE = pe(function (f, d = 0) {
      return te(
        this,
        f,
        d,
    ...
    (o.prototype.writeBigInt64BE = pe(function (f, d = 0) {
      return x(
        this,
        f,
        d,
  ...
  function se(y, f, d, A, k, D) {
    if (d + A > y.length) throw new RangeError("Index out of range");
    if (d < 0) throw new RangeError("Index out of range");
  }
  function ue(y, f, d, A, k) {
    return (
      (f = +f),
      (d = d >>> 0),
      k || se(y, f, d, 4),
      r.write(y, f, d, A, 23, 4),
      d + 4
    );
  }
  (o.prototype.writeFloatLE = function (f, d, A) {
    return ue(this, f, d, !0, A);
  }),
    (o.prototype.writeFloatBE = function (f, d, A) {
      return ue(this, f, d, !1, A);
    });
  function he(y, f, d, A, k) {
    return (
      (f = +f),
      (d = d >>> 0),
      k || se(y, f, d, 8),
      r.write(y, f, d, A, 52, 8),
      d + 8
    );
  }
  (o.prototype.writeDoubleLE = function (f, d, A) {
    return he(this, f, d, !0, A);
  }),
    (o.prototype.writeDoubleBE = function (f, d, A) {
      return he(this, f, d, !1, A);
    }),
    (o.prototype.copy = function (f, d, A, k) {
      ...
      k > this.length && (k = this.length),
        f.length - d < k - A && (k = f.length - d + A);
      const D = k - A;
      return (
        this === f && typeof Uint8Array.prototype.copyWithin == "function"
          ? this.copyWithin(d, A, k)
          : Uint8Array.prototype.set.call(f, this.subarray(A, k), d),
        D
      );
    }),
    (o.prototype.fill = function (f, d, A, k) {
      if (typeof f == "string") {
        if (
          (typeof d == "string"
            ? ((k = d), (d = 0), (A = this.length))
      ...
      let D;
      if (typeof f == "number") for (D = d; D < A; ++D) this[D] = f;
      else {
        const H = o.isBuffer(f) ? f : o.from(f, k),
          _e = H.length;
        if (_e === 0)
          throw new TypeError(
            'The value "' + f + '" is invalid for argument "value"',
          );
        for (D = 0; D < A - d; ++D) this[D + d] = H[D % _e];
      }
      return this;
    });
  const ne = {};
  function ce(y, f, d) {
    ne[y] = class extends d {
      constructor() {
        super(),
  ...
  function b(y) {
    let f = "",
      d = y.length;
    const A = y[0] === "-" ? 1 : 0;
    for (; d >= A + 4; d -= 3) f = `_${y.slice(d - 3, d)}${f}`;
    return `${y.slice(0, d)}${f}`;
  }
  function s(y, f, d) {
    E(f, "offset"),
      (y[f] === void 0 || y[f + d] === void 0) && T(f, y.length - (d + 1));
  }
  function h(y, f, d, A, k, D) {
    if (y > d || y < f) {
      ...
      throw (
        ...
        new ne.ERR_OUT_OF_RANGE("value", _e, y))
      );
    }
    s(A, k, D);
  }
  function E(y, f) {
    if (typeof y != "number") throw new ne.ERR_INVALID_ARG_TYPE(f, "number", y);
  }
  function T(y, f, d) {
    throw Math.floor(y) !== y
      ? (E(y, d), new ne.ERR_OUT_OF_RANGE("offset", "an integer", y))
      : f < 0
        ? new ne.ERR_BUFFER_OUT_OF_BOUNDS()
        : new ne.ERR_OUT_OF_RANGE("offset", `>= 0 and <= ${f}`, y);
  }
  ...
  function c(y, f) {
    ...
    const D = [];
    for (let H = 0; H < A; ++H) {
      if (((d = y.charCodeAt(H)), d > 55295 && d < 57344)) {
        if (!k) {
          if (d > 56319) {
  ...
  function u(y) {
    const f = [];
    for (let d = 0; d < y.length; ++d) f.push(y.charCodeAt(d) & 255);
    return f;
  }
  function w(y, f) {
    let d, A, k;
    ...
    for (let H = 0; H < y.length && !((f -= 2) < 0); ++H)
      (d = y.charCodeAt(H)), (A = d >> 8), (k = d % 256), D.push(k), D.push(A);
    return D;
  }
  function v(y) {
  ...
  function O(y, f, d, A) {
    let k;
    for (k = 0; k < A && !(k + d >= f.length || k >= y.length); ++k)
      f[k + d] = y[k];
    return k;
  }
  function L(y, f) {
  ...
  const oe = (function () {
    ...
    for (let d = 0; d < 16; ++d) {
      const A = d * 16;
      for (let k = 0; k < 16; ++k) f[A + k] = y[d] + y[k];
    }
    return f;
  })();
  function pe(y) {
...
function ip(e, t) {
  ...
  function i(a, l = !1) {
    ...
    const o = r[a];
    if (!o || typeof o != "object") n[a] = o;
    else if (Array.isArray(o))
      if (typeof o[0] == "string") {
        const g = o[0],
          _ = t?.[g];
        if (_) return (n[a] = _(i(o[1])));
        switch (g) {
          case "Date":
            n[a] = new Date(o[1]);
            break;
          case "Set":
            const B = new Set();
            n[a] = B;
            for (let S = 1; S < o.length; S += 1) B.add(i(o[S]));
            break;
          case "Map":
            const N = new Map();
            n[a] = N;
            for (let S = 1; S < o.length; S += 2) N.set(i(o[S]), i(o[S + 1]));
            break;
          case "RegExp":
            n[a] = new RegExp(o[1], o[2]);
            break;
          case "Object":
            n[a] = Object(o[1]);
            break;
...
const fi = "abcdefghijklmnopqrstuvwxyz234567",
  Hr = Object.create(null);
for (let e = 0; e < fi.length; e++) Hr[fi[e]] = e;
Hr[0] = Hr.o;
Hr[1] = Hr.i;
function tf(e) {
  let t = 0,
...
function rf(e) {
  ...
  function a(l) {
    ...
    (o <<= 3),
      ...
      (t += 5),
      t >= 8 &&
        ((n[i++] = r), (t -= 8), t > 0 ? (r = (o << (5 - t)) & 255) : (r = 0));
  }
  for (const l of e) a(l);
  return n.slice(0, i);
}
...
function no(e, ...t) {
  if (!af(e)) throw new Error("Uint8Array expected");
...
/*! noble-hashes - MIT License (c) 2022 Paul Miller (paulmillr.com) */ const Hi =
...
function io(e) {
  return typeof e == "string" && (e = cf(e)), no(e), e;
}
let uf = class {
  clone() {
...
function so(e) {
  const t = (n) => e().update(io(n)).digest(),
    r = e();
  return (
...
function ff(e, t, r, n) {
  ...
  const i = BigInt(32),
    ...
    g = n ? 4 : 0,
    _ = n ? 0 : 4;
  e.setUint32(t + g, l, n), e.setUint32(t + _, o, n);
}
const lf = (e, t, r) => (e & t) ^ (~e & r),
  df = (e, t, r) => (e & t) ^ (e & r) ^ (t & r);
let hf = class extends uf {
  ...
  update(t) {
    ...
    const a = t.length;
    for (let l = 0; l < a; ) {
      const o = Math.min(i - this.pos, a - l);
      if (o === i) {
        const g = Hi(t);
        for (; i <= a - l; l += i) this.process(g, l);
        continue;
      }
      n.set(t.subarray(l, l + o), this.pos),
        (this.pos += o),
        (l += o),
  ...
  digestInto(t) {
    ia(this), of(t, this), (this.finished = !0);
    const { buffer: r, view: n, blockLen: i, isLE: a } = this;
    let { pos: l } = this;
    (r[l++] = 128),
      this.buffer.subarray(l).fill(0),
      this.padOffset > i - l && (this.process(n, 0), (l = 0));
    for (let N = l; N < i; N++) r[N] = 0;
    ff(n, i - 8, BigInt(this.length * 8), a), this.process(n, 0);
    const o = Hi(t),
      g = this.outputLen;
    if (g % 4) throw new Error("_sha2: outputLen should be aligned to 32bit");
    const _ = g / 4,
      B = this.get();
    if (_ > B.length) throw new Error("_sha2: outputLen bigger than state");
    for (let N = 0; N < _; N++) o.setUint32(4 * N, B[N], a);
  }
  digest() {
...
let ao = class extends hf {
  ...
  get() {
    const { A: t, B: r, C: n, D: i, E: a, F: l, G: o, H: g } = this;
    return [t, r, n, i, a, l, o, g];
  }
  set(t, r, n, i, a, l, o, g) {
    (this.A = t | 0),
      (this.B = r | 0),
  ...
  process(t, r) {
    for (let N = 0; N < 16; N++, r += 4) zt[N] = t.getUint32(r, !1);
    for (let N = 16; N < 64; N++) {
      const I = zt[N - 15],
        S = zt[N - 2],
        m = Nt(I, 7) ^ Nt(I, 18) ^ (I >>> 3),
        $ = Nt(S, 17) ^ Nt(S, 19) ^ (S >>> 10);
      zt[N] = ($ + zt[N - 7] + m + zt[N - 16]) | 0;
    }
    let { A: n, B: i, C: a, D: l, E: o, F: g, G: _, H: B } = this;
    for (let N = 0; N < 64; N++) {
      const I = Nt(o, 6) ^ Nt(o, 11) ^ Nt(o, 25),
        S = (B + I + lf(o, g, _) + pf[N] + zt[N]) | 0,
        $ = ((Nt(n, 2) ^ Nt(n, 13) ^ Nt(n, 22)) + df(n, i, a)) | 0;
      (B = _),
        (_ = g),
        (g = o),
        (o = (l + S) | 0),
...
const gf = so(() => new ao()),
  wf = so(() => new yf());
function mf(e) {
  return wf.create().update(new Uint8Array(e)).digest();
}
const Qr = "__principal__",
  bf = 2,
  sa = 4,
  _f = "aaaaa-aa",
  xf = (e) => {
  ...
  Ef = (e) => e.reduce((t, r) => t + r.toString(16).padStart(2, "0"), "");
let Te = class $n {
  constructor(t) {
    (this._arr = t), (this._isPrincipal = !0);
  }
  static anonymous() {
    return new this(new Uint8Array([sa]));
  }
  static managementCanister() {
    return this.fromHex(_f);
  }
  static selfAuthenticating(t) {
    const r = mf(t);
    return new this(new Uint8Array([...r, bf]));
  }
  static from(t) {
    if (typeof t == "string") return $n.fromText(t);
    if (Object.getPrototypeOf(t) === Uint8Array.prototype) return new $n(t);
    if (typeof t == "object" && t !== null && t._isPrincipal === !0)
      return new $n(t._arr);
    throw new Error(`Impossible to convert ${JSON.stringify(t)} to Principal.`);
  }
  static fromHex(t) {
    return new this(xf(t));
  }
  static fromText(t) {
    let r = t;
    if (t.includes(Qr)) {
  ...
  isAnonymous() {
    return this._arr.byteLength === 1 && this._arr[0] === sa;
  }
  toUint8Array() {
    return this._arr;
  }
  toHex() {
    return Ef(this._arr).toUpperCase();
  }
  toText() {
    const t = new ArrayBuffer(4);
    new DataView(t).setUint32(0, sf(this._arr));
...
const vf = Object.freeze(
  Object.defineProperty(
    { __proto__: null, JSON_KEY_PRINCIPAL: Qr, Principal: Te },
    Symbol.toStringTag,
    { value: "Module" },
  ),
);
...
const Tf = new RegExp(/^[0-9a-fA-F]+$/);
function Ht(e) {
  if (!Tf.test(e)) throw new Error("Invalid hexadecimal string.");
  const t = [...e]
...
let Wr = class {
  constructor(t, r = t?.byteLength || 0) {
    (this._buffer = li(t || new ArrayBuffer(0))),
      (this._view = new Uint8Array(this._buffer, 0, r));
  }
  get buffer() {
    return li(this._view.slice());
  }
  get byteLength() {
...
function xr(e, t) {
  return e.byteLength < t && co(), e.read(t);
}
function Er(e) {
  const t = e.readUint8();
...
function Ye(e) {
  let t = BigInt(1),
    r = BigInt(0),
    n;
  do (n = Er(e)), (r += BigInt(n & 127).valueOf() * t), (t *= BigInt(128));
  while (n >= 128);
  return r;
}
function Ke(e) {
  ...
  function i(a) {
    const l = a % BigInt(128);
    return Number(t ? BigInt(128) - l - BigInt(1) : l);
  }
  return n.buffer;
}
function Qt(e) {
  ...
  const n = new Uint8Array(xr(e, r + 1));
  let i = BigInt(0);
...
function uo(e, t) {
  e = BigInt(e);
  const r = new Wr(new ArrayBuffer(Math.min(1, t)), 0);
  let n = 0,
    i = BigInt(256),
    a = BigInt(0),
    l = Number(e % i);
  for (r.write(new Uint8Array([l])); ++n < t; )
    e < 0 && a === BigInt(0) && l !== 0 && (a = BigInt(1)),
      (l = Number((e / i - a) % BigInt(256))),
...
class ho extends Si {
  ...
  decodeValue(t, r) {
    ...
    let i;
    return (
      r instanceof pr ? (i = () => r.getType()) : (i = () => r),
...
class vr extends wt {
  ...
  covariant(t) {
    const r = gs(this._bits - 1) * BigInt(-1),
      n = gs(this._bits - 1) - BigInt(1);
    let i = !1;
...
class Ii extends hr {
  constructor(t) {
    super(),
      ...
      t instanceof fr && t._bits === 8 && (this._blobOptimization = !0);
  }
  accept(t, r) {
...
index ${i} -> ${a.message}`);
  ...
  encodeValue(t) {
    ...
    const n = new Wr(new ArrayBuffer(r.byteLength + t.length), 0);
    n.write(r);
    for (const i of t) {
  ...
  decodeValue(t, r) {
    ...
    if (!(n instanceof Ii)) throw new Error("Not a vector type");
    const i = Number(Ye(t));
    if (this._type instanceof fr) {
    ...
    const a = [];
    for (let l = 0; l < i; l++) a.push(this._type.decodeValue(t, n._type));
    return a;
  }
  get name() {
...
-> ${r.message}`);
  ...
  decodeValue(t, r) {
    const n = this.checkType(r);
    if (!(n instanceof Dr)) throw new Error("Not an option type");
    switch (Er(t)) {
      case 0:
        return [];
      case 1:
...
class En extends hr {
  constructor(t = {}) {
    super(),
      (this._fields = Object.entries(t).sort((r, n) => Ct(r[0]) - Ct(n[0])));
  }
  accept(t, r) {
...
field ${r} -> ${i.message}`);
  ...
  _buildTypeTableImpl(t) {
    this._fields.forEach(([a, l]) => l.buildTypeTable(t));
    const r = Ke(-20),
      n = $e(this._fields.length),
      i = this._fields.map(([a, l]) => Re($e(Ct(a)), l.encodeType(t)));
    t.add(this, Re(r, n, Re(...i)));
  }
  decodeValue(t, r) {
    const n = this.checkType(r);
    if (!(n instanceof En)) throw new Error("Not a record type");
    const i = {};
    let a = 0,
      l = 0;
    for (; l < n._fields.length; ) {
      const [o, g] = n._fields[l];
      if (a >= this._fields.length) {
        g.decodeValue(t, g), l++;
        continue;
      }
      const [_, B] = this._fields[a],
        N = Ct(this._fields[a][0]),
        I = Ct(o);
      if (N === I) (i[_] = B.decodeValue(t, g)), a++, l++;
      else if (I > N)
        if (B instanceof Dr || B instanceof di) (i[_] = []), a++;
        else throw new Error("Cannot find required field " + _);
      else g.decodeValue(t, g), l++;
    }
    for (const [o, g] of this._fields.slice(a))
      if (g instanceof Dr || g instanceof di) i[o] = [];
  ...
  valueToString(t) {
    const r = this._fields.map(([i]) => t[i]);
    return `record {${hn(this._fields, r, ([i, a], l) => i + "=" + a.valueToString(l)).join("; ")}}`;
  }
}
class Oi extends En {
  constructor(t) {
...
index ${n} -> ${i.message}`);
  ...
  encodeValue(t) {
    const r = hn(this._components, t, (n, i) => n.encodeValue(i));
    return Re(...r);
  }
  decodeValue(t, r) {
    const n = this.checkType(r);
    if (!(n instanceof Oi)) throw new Error("not a tuple type");
    if (n._components.length < this._components.length)
      throw new Error("tuple mismatch");
    const i = [];
    for (const [a, l] of n._components.entries())
      a >= this._components.length
        ? l.decodeValue(t, l)
        : i.push(this._components[a].decodeValue(t, l));
    return i;
  }
  display() {
  ...
  valueToString(t) {
    return `record {${hn(this._components, t, (n, i) => n.valueToString(i)).join("; ")}}`;
  }
}
class Ri extends hr {
  constructor(t = {}) {
...
variant ${r} -> ${i.message}`);
  ...
  decodeValue(t, r) {
    const n = this.checkType(r);
    if (!(n instanceof Ri)) throw new Error("Not a variant type");
    const i = Number(Ye(t));
    if (i >= n._fields.length) throw Error("Invalid variant index: " + i);
    const [a, l] = n._fields[i];
    for (const [o, g] of this._fields)
      if (Ct(a) === Ct(o)) {
        const _ = g.decodeValue(t, l);
        return { [o]: _ };
      }
...
class pr extends hr {
  constructor() {
    super(...arguments), (this._id = pr._counter++), (this._type = void 0);
  }
  accept(t, r) {
...
pr._counter = 0;
function $s(e) {
  if (Er(e) !== 1) throw new Error("Cannot decode principal");
  const r = Number(Ye(e));
  return Te.fromUint8Array(new Uint8Array(xr(e, r)));
}
class bo extends wt {
  accept(t, r) {
...
class qs extends hr {
  ...
  encodeValue([t, r]) {
    const n = t.toUint8Array(),
      ...
      o = $e(l.byteLength);
    return Re(new Uint8Array([1]), a, o, l);
  }
  _buildTypeTableImpl(t) {
    this.argTypes.forEach((_) => _.buildTypeTable(t)),
      this.retTypes.forEach((_) => _.buildTypeTable(t));
    const r = Ke(-22),
      n = $e(this.argTypes.length),
      i = Re(...this.argTypes.map((_) => _.encodeType(t))),
      a = $e(this.retTypes.length),
      l = Re(...this.retTypes.map((_) => _.encodeType(t))),
      o = $e(this.annotations.length),
      g = Re(...this.annotations.map((_) => this.encodeAnnotation(_)));
    t.add(this, Re(r, n, i, a, l, o, g));
  }
  decodeValue(t) {
    if (Er(t) !== 1) throw new Error("Cannot decode function reference");
    const n = $s(t),
      i = Number(Ye(t)),
      a = xr(t, i),
      o = new TextDecoder("utf8", { fatal: !0 }).decode(a);
    return [n, o];
  }
  get name() {
...
class _o extends hr {
  ...
  _buildTypeTableImpl(t) {
    ...
    const r = Ke(-23),
      n = $e(this._fields.length),
      i = this._fields.map(([a, l]) => {
        const o = new TextEncoder().encode(a),
          g = $e(o.length);
        return Re(g, o, l.encodeType(t));
      });
    t.add(this, Re(r, n, ...i));
  }
  decodeValue(t) {
...
function Ge(e) {
  ...
  return t && t.length > aa ? t.substring(0, aa - 3) + "..." : t;
}
function ws(e, t) {
  if (t.length < e.length) throw Error("Wrong number of message arguments");
  const r = new Sf();
  e.forEach((g) => g.buildTypeTable(r));
  const n = new TextEncoder().encode(qn),
    i = r.encode(),
    a = $e(t.length),
    l = Re(...e.map((g) => g.encodeType(r))),
    o = Re(
      ...hn(e, t, (g, _) => {
        try {
          g.covariant(_);
...
function xo(e, t) {
  const r = new Wr(t);
  if (t.byteLength < qn.length)
    throw new Error("Message length smaller than magic number");
  const n = xr(r, qn.length),
    i = new TextDecoder().decode(n);
  if (i !== qn) throw new Error("Wrong magic number: " + JSON.stringify(i));
  function a(S) {
    const m = [],
      $ = Number(Ye(S));
    for (let K = 0; K < $; K++) {
      ...
      switch (q) {
        ...
        case -22: {
          const ie = [];
          let C = Number(Ye(S));
          for (; C--; ) ie.push(Number(Qt(S)));
          const Z = [];
          let G = Number(Ye(S));
          for (; G--; ) Z.push(Number(Qt(S)));
          const Q = [];
          let re = Number(Ye(S));
          for (; re--; )
            switch (Number(Ye(S))) {
        ...
        case -23: {
          ...
          for (; ie--; ) {
            const Z = Number(Ye(S)),
              G = new TextDecoder().decode(xr(S, Z)),
              Q = Qt(S);
            C.push([G, Q]);
          }
          m.push([q, C]);
    ...
    const V = [],
      W = Number(Ye(S));
    for (let K = 0; K < W; K++) V.push(Number(Qt(S)));
    return [m, V];
  }
  const [l, o] = a(r);
  if (o.length < e.length) throw new Error("Wrong number of return values");
  const g = l.map((S) => Do());
  function _(S) {
  ...
  function B(S) {
    switch (S[0]) {
      ...
      case -20: {
        const m = {};
        for (const [W, K] of S[1]) {
          const q = `_${W}_`;
          m[q] = _(K);
        }
        const $ = Lo(m),
          V = $.tryAsTuple();
        return Array.isArray(V) ? qo(...V) : $;
      }
      case -21: {
        const m = {};
        for (const [$, V] of S[1]) {
      ...
      case -23: {
        ...
        for (const [V, W] of $) {
          let K = _(W);
          if ((K instanceof pr && (K = K.getType()), !(K instanceof qs)))
            throw new Error(
  ...
  const N = o.map((S) => _(S)),
    I = e.map((S, m) => S.decodeValue(r, N[m]));
 ...
 */ (function (e) {
  ...
  function g(p, c, u) {
    ...
    var w = p.valueOf && p.valueOf();
    if (w != null && w !== p) return o.from(w, c, u);
    var v = V(p);
    if (v) return v;
    if (
      typeof Symbol < "u" &&
  ...
  function I(p, c) {
    ...
    var u = q(p, c) | 0,
      w = l(u),
      v = w.write(p, c);
    return v !== u && (w = w.slice(0, v)), w;
  }
  function S(p) {
    for (
      var c = p.length < 0 ? 0 : W(p.length) | 0, u = l(c), w = 0;
      w < c;
      w += 1
    )
      u[w] = p[w] & 255;
  ...
  function $(p, c, u) {
    ...
    return (
      c === void 0 && u === void 0
        ? (w = new Uint8Array(p))
        : u === void 0
          ? (w = new Uint8Array(p, c))
          : (w = new Uint8Array(p, c, u)),
  ...
  function V(p) {
    ...
    if (p.length !== void 0)
      return typeof p.length != "number" || T(p.length) ? l(0) : S(p);
  ...
  (o.isBuffer = function (c) {
    ...
    (o.compare = function (c, u) {
      if (
        (E(c, Uint8Array) && (c = o.from(c, c.offset, c.byteLength)),
        E(u, Uint8Array) && (u = o.from(u, u.offset, u.byteLength)),
      ...
      if (c === u) return 0;
      for (
        var w = c.length, v = u.length, O = 0, L = Math.min(w, v);
        O < L;
        ++O
      )
        if (c[O] !== u[O]) {
    ...
    (o.concat = function (c, u) {
      ...
      var w;
      if (u === void 0) for (u = 0, w = 0; w < c.length; ++w) u += c[w].length;
      var v = o.allocUnsafe(u),
        O = 0;
      for (w = 0; w < c.length; ++w) {
        ...
        if (E(L, Uint8Array))
          O + L.length > v.length
            ? o.from(L).copy(v, O)
            : Uint8Array.prototype.set.call(v, L, O);
        else if (o.isBuffer(L)) L.copy(v, O);
        else throw new TypeError('"list" argument must be an Array of Buffers');
        O += L.length;
      }
      return v;
  ...
  (o.prototype.swap16 = function () {
    ...
    if (c % 2 !== 0)
      throw new RangeError("Buffer size must be a multiple of 16-bits");
    for (var u = 0; u < c; u += 2) C(this, u, u + 1);
    return this;
  }),
    (o.prototype.swap32 = function () {
      var c = this.length;
      if (c % 4 !== 0)
        throw new RangeError("Buffer size must be a multiple of 32-bits");
      for (var u = 0; u < c; u += 4) C(this, u, u + 3), C(this, u + 1, u + 2);
      return this;
    }),
    (o.prototype.swap64 = function () {
      var c = this.length;
    ...
    n && (o.prototype[n] = o.prototype.inspect),
    (o.prototype.compare = function (c, u, w, v, O) {
      if (
        (E(c, Uint8Array) && (c = o.from(c, c.offset, c.byteLength)),
        !o.isBuffer(c))
      )
      ...
      if (
        ...
        u < 0 || w > c.length || v < 0 || O > this.length)
      )
        throw new RangeError("out of range index");
      if (v >= O && u >= w) return 0;
      if (v >= O) return -1;
      if (u >= w) return 1;
      if (((u >>>= 0), (w >>>= 0), (v >>>= 0), (O >>>= 0), this === c))
        return 0;
      for (
        var L = O - v,
          Y = w - u,
  ...
  function Z(p, c, u, w, v) {
    ...
    if ((typeof c == "string" && (c = o.from(c, w)), o.isBuffer(c)))
      return c.length === 0 ? -1 : G(p, c, u, w, v);
    if (typeof c == "number")
      return (
        (c = c & 255),
        typeof Uint8Array.prototype.indexOf == "function"
  ...
  function G(p, c, u, w, v) {
    ...
    function oe(d, A) {
      return O === 1 ? d[A] : d.readUInt16BE(A * O);
    }
    var pe;
    if (v) {
      var me = -1;
      for (pe = u; pe < L; pe++)
        if (oe(p, pe) === oe(c, me === -1 ? 0 : pe - me)) {
          if ((me === -1 && (me = pe), pe - me + 1 === Y)) return me * O;
        } else me !== -1 && (pe -= pe - me), (me = -1);
    } else
      for (u + Y > L && (u = L - Y), pe = u; pe >= 0; pe--) {
        for (var y = !0, f = 0; f < Y; f++)
          if (oe(p, pe + f) !== oe(c, f)) {
            y = !1;
            break;
          }
  ...
  (o.prototype.includes = function (c, u, w) {
    return this.indexOf(c, u, w) !== -1;
  }),
    (o.prototype.indexOf = function (c, u, w) {
      return Z(this, c, u, w, !0);
    }),
    (o.prototype.lastIndexOf = function (c, u, w) {
      return Z(this, c, u, w, !1);
    });
  function Q(p, c, u, w) {
    u = Number(u) || 0;
    var v = p.length - u;
    ...
    w > O / 2 && (w = O / 2);
    for (var L = 0; L < w; ++L) {
      var Y = parseInt(c.substr(L * 2, 2), 16);
      if (T(Y)) return L;
      p[u + L] = Y;
    }
    return L;
  ...
  function re(p, c, u, w) {
    return h(ne(c, p.length - u), p, u, w);
  }
  function X(p, c, u, w) {
    return h(ce(c), p, u, w);
  }
  ...
  function fe(p, c, u, w) {
    return h(b(c, p.length - u), p, u, w);
  }
  (o.prototype.write = function (c, u, w, v) {
    if (u === void 0) (v = "utf8"), (w = this.length), (u = 0);
    else if (w === void 0 && typeof u == "string")
      (v = u), (w = this.length), (u = 0);
    else if (isFinite(u))
      (u = u >>> 0),
        isFinite(w)
          ? ((w = w >>> 0), v === void 0 && (v = "utf8"))
          : ((v = w), (w = void 0));
    else
      throw new Error(
        "Buffer.write(string, encoding, offset[, length]) is no longer supported",
    ...
    if (
      ((w === void 0 || w > O) && (w = O),
      (c.length > 0 && (w < 0 || u < 0)) || u > this.length)
    )
      throw new RangeError("Attempt to write outside buffer bounds");
    v || (v = "utf8");
    for (var L = !1; ; )
      switch (v) {
        ...
        case "binary":
          return X(this, c, u, w);
        case "base64":
          return de(this, c, u, w);
        case "ucs2":
        case "ucs-2":
        case "utf16le":
        case "utf-16le":
          return fe(this, c, u, w);
        default:
        ...
        switch (Y) {
          ...
          case 3:
            (oe = p[v + 1]),
              ...
              (oe & 192) === 128 &&
                (pe & 192) === 128 &&
                ((y = ((O & 15) << 12) | ((oe & 63) << 6) | (pe & 63)),
                y > 2047 && (y < 55296 || y > 57343) && (L = y));
            break;
          case 4:
            (oe = p[v + 1]),
              (pe = p[v + 2]),
  ...
  function M(p) {
    var c = p.length;
    if (c <= z) return String.fromCharCode.apply(String, p);
    for (var u = "", w = 0; w < c; )
      u += String.fromCharCode.apply(String, p.slice(w, (w += z)));
    return u;
  }
  function j(p, c, u) {
    var w = "";
    u = Math.min(p.length, u);
    for (var v = c; v < u; ++v) w += String.fromCharCode(p[v] & 127);
    return w;
  }
  function J(p, c, u) {
    var w = "";
    u = Math.min(p.length, u);
    for (var v = c; v < u; ++v) w += String.fromCharCode(p[v]);
    return w;
  }
  function ee(p, c, u) {
    var w = p.length;
    (!c || c < 0) && (c = 0), (!u || u < 0 || u > w) && (u = w);
    for (var v = "", O = c; O < u; ++O) v += U[p[O]];
    return v;
  }
  function ge(p, c, u) {
    for (var w = p.slice(c, u), v = "", O = 0; O < w.length - 1; O += 2)
      v += String.fromCharCode(w[O] + w[O + 1] * 256);
    return v;
  }
  o.prototype.slice = function (c, u) {
    ...
    (c = ~~c),
      ...
      u < c && (u = c);
    var v = this.subarray(c, u);
    return Object.setPrototypeOf(v, o.prototype), v;
  };
  function ae(p, c, u) {
  ...
  (o.prototype.readUintLE = o.prototype.readUIntLE =
    function (c, u, w) {
      (c = c >>> 0), (u = u >>> 0), w || ae(c, u, this.length);
      for (var v = this[c], O = 1, L = 0; ++L < u && (O *= 256); )
        v += this[c + L] * O;
      return v;
    }),
    (o.prototype.readUintBE = o.prototype.readUIntBE =
      function (c, u, w) {
        (c = c >>> 0), (u = u >>> 0), w || ae(c, u, this.length);
        for (var v = this[c + --u], O = 1; u > 0 && (O *= 256); )
          v += this[c + --u] * O;
        return v;
      }),
    (o.prototype.readUint8 = o.prototype.readUInt8 =
      function (c, u) {
        return (c = c >>> 0), u || ae(c, 1, this.length), this[c];
      }),
    (o.prototype.readUint16LE = o.prototype.readUInt16LE =
      function (c, u) {
        return (
          (c = c >>> 0),
          u || ae(c, 2, this.length),
          this[c] | (this[c + 1] << 8)
        );
      }),
    (o.prototype.readUint16BE = o.prototype.readUInt16BE =
    ...
    (o.prototype.readIntLE = function (c, u, w) {
      (c = c >>> 0), (u = u >>> 0), w || ae(c, u, this.length);
      for (var v = this[c], O = 1, L = 0; ++L < u && (O *= 256); )
        v += this[c + L] * O;
      return (O *= 128), v >= O && (v -= Math.pow(2, 8 * u)), v;
    }),
    (o.prototype.readIntBE = function (c, u, w) {
      (c = c >>> 0), (u = u >>> 0), w || ae(c, u, this.length);
      for (var v = u, O = 1, L = this[c + --v]; v > 0 && (O *= 256); )
        L += this[c + --v] * O;
    ...
    (o.prototype.readFloatLE = function (c, u) {
      return (
        (c = c >>> 0), u || ae(c, 4, this.length), r.read(this, c, !0, 23, 4)
      );
    }),
    (o.prototype.readFloatBE = function (c, u) {
      return (
        (c = c >>> 0), u || ae(c, 4, this.length), r.read(this, c, !1, 23, 4)
      );
    }),
    (o.prototype.readDoubleLE = function (c, u) {
      return (
        (c = c >>> 0), u || ae(c, 8, this.length), r.read(this, c, !0, 52, 8)
      );
    }),
    (o.prototype.readDoubleBE = function (c, u) {
      return (
        (c = c >>> 0), u || ae(c, 8, this.length), r.read(this, c, !1, 52, 8)
      );
    });
  function le(p, c, u, w, v, O) {
    if (!o.isBuffer(p))
      throw new TypeError('"buffer" argument must be a Buffer instance');
    if (c > v || c < O)
      throw new RangeError('"value" argument is out of bounds');
    if (u + w > p.length) throw new RangeError("Index out of range");
  }
  (o.prototype.writeUintLE = o.prototype.writeUIntLE =
    function (c, u, w, v) {
      if (((c = +c), (u = u >>> 0), (w = w >>> 0), !v)) {
        var O = Math.pow(2, 8 * w) - 1;
        le(this, c, u, w, O, 0);
      }
      var L = 1,
        Y = 0;
      for (this[u] = c & 255; ++Y < w && (L *= 256); )
        this[u + Y] = (c / L) & 255;
      return u + w;
    }),
    (o.prototype.writeUintBE = o.prototype.writeUIntBE =
    ...
    (o.prototype.writeIntLE = function (c, u, w, v) {
      if (((c = +c), (u = u >>> 0), !v)) {
        var O = Math.pow(2, 8 * w - 1);
        le(this, c, u, w, O - 1, -O);
      }
      var L = 0,
        Y = 1,
        oe = 0;
      for (this[u] = c & 255; ++L < w && (Y *= 256); )
        c < 0 && oe === 0 && this[u + L - 1] !== 0 && (oe = 1),
          (this[u + L] = (((c / Y) >> 0) - oe) & 255);
      return u + w;
    }),
    (o.prototype.writeIntBE = function (c, u, w, v) {
      if (((c = +c), (u = u >>> 0), !v)) {
        var O = Math.pow(2, 8 * w - 1);
        le(this, c, u, w, O - 1, -O);
      }
    ...
    (o.prototype.writeInt8 = function (c, u, w) {
      return (
        (c = +c),
        (u = u >>> 0),
        w || le(this, c, u, 1, 127, -128),
        c < 0 && (c = 255 + c + 1),
        (this[u] = c & 255),
        u + 1
      );
    }),
    (o.prototype.writeInt16LE = function (c, u, w) {
      return (
        (c = +c),
        (u = u >>> 0),
        w || le(this, c, u, 2, 32767, -32768),
        (this[u] = c & 255),
        (this[u + 1] = c >>> 8),
        u + 2
      );
    }),
    (o.prototype.writeInt16BE = function (c, u, w) {
      return (
        (c = +c),
        (u = u >>> 0),
        w || le(this, c, u, 2, 32767, -32768),
    ...
    (o.prototype.writeInt32LE = function (c, u, w) {
      return (
        (c = +c),
        (u = u >>> 0),
        w || le(this, c, u, 4, 2147483647, -2147483648),
        (this[u] = c & 255),
        (this[u + 1] = c >>> 8),
        (this[u + 2] = c >>> 16),
        (this[u + 3] = c >>> 24),
    ...
    (o.prototype.writeInt32BE = function (c, u, w) {
      return (
        (c = +c),
        (u = u >>> 0),
        w || le(this, c, u, 4, 2147483647, -2147483648),
  ...
  function te(p, c, u, w, v, O) {
    if (u + w > p.length) throw new RangeError("Index out of range");
    if (u < 0) throw new RangeError("Index out of range");
  }
  function x(p, c, u, w, v) {
    return (
      (c = +c),
      (u = u >>> 0),
      v || te(p, c, u, 4),
      r.write(p, c, u, w, 23, 4),
      u + 4
    );
  }
  (o.prototype.writeFloatLE = function (c, u, w) {
    return x(this, c, u, !0, w);
  }),
    (o.prototype.writeFloatBE = function (c, u, w) {
      return x(this, c, u, !1, w);
    });
  function se(p, c, u, w, v) {
    return (
      (c = +c),
      (u = u >>> 0),
      v || te(p, c, u, 8),
      r.write(p, c, u, w, 52, 8),
      u + 8
    );
  }
  (o.prototype.writeDoubleLE = function (c, u, w) {
    return se(this, c, u, !0, w);
  }),
    (o.prototype.writeDoubleBE = function (c, u, w) {
      return se(this, c, u, !1, w);
    }),
    (o.prototype.copy = function (c, u, w, v) {
      ...
      v > this.length && (v = this.length),
        c.length - u < v - w && (v = c.length - u + w);
      var O = v - w;
      return (
        this === c && typeof Uint8Array.prototype.copyWithin == "function"
          ? this.copyWithin(u, w, v)
          : Uint8Array.prototype.set.call(c, this.subarray(w, v), u),
        O
      );
    }),
    (o.prototype.fill = function (c, u, w, v) {
      if (typeof c == "string") {
        if (
          (typeof u == "string"
            ? ((v = u), (u = 0), (w = this.length))
            : typeof w == "string" && ((v = w), (w = this.length)),
      ...
      var L;
      if (typeof c == "number") for (L = u; L < w; ++L) this[L] = c;
      else {
        var Y = o.isBuffer(c) ? c : o.from(c, v),
          oe = Y.length;
        if (oe === 0)
          throw new TypeError(
            'The value "' + c + '" is invalid for argument "value"',
          );
        for (L = 0; L < w - u; ++L) this[L + u] = Y[L % oe];
      }
      return this;
    });
  var ue = /[^+/0-9A-Za-z-_]/g;
  function he(p) {
    if (((p = p.split("=")[0]), (p = p.trim().replace(ue, "")), p.length < 2))
      return "";
  ...
  function ne(p, c) {
    c = c || 1 / 0;
    for (var u, w = p.length, v = null, O = [], L = 0; L < w; ++L) {
      if (((u = p.charCodeAt(L)), u > 55295 && u < 57344)) {
        ...
        if (u < 56320) {
          (c -= 3) > -1 && O.push(239, 191, 189), (v = u);
          continue;
        }
        u = (((v - 55296) << 10) | (u - 56320)) + 65536;
      } else v && (c -= 3) > -1 && O.push(239, 191, 189);
      if (((v = null), u < 128)) {
        if ((c -= 1) < 0) break;
        O.push(u);
      } else if (u < 2048) {
  ...
  function b(p, c) {
    for (var u, w, v, O = [], L = 0; L < p.length && !((c -= 2) < 0); ++L)
      (u = p.charCodeAt(L)), (w = u >> 8), (v = u % 256), O.push(v), O.push(w);
    return O;
  }
  function s(p) {
    return t.toByteArray(he(p));
  }
  function h(p, c, u, w) {
    for (var v = 0; v < w && !(v + u >= c.length || v >= p.length); ++v)
      c[v + u] = p[v];
    return v;
  }
  function E(p, c) {
  ...
  var U = (function () {
    for (var p = "0123456789abcdef", c = new Array(256), u = 0; u < 16; ++u)
      for (var w = u * 16, v = 0; v < 16; ++v) c[w + v] = p[u] + p[v];
    return c;
  })();
})(vn);
var Yo = { exports: {} };
(function (e) {
  (function (t) {
    var r,
      ...
      a = Math.floor,
      l = "[BigNumber Error] ",
      o = l + "Number primitive has more than 15 significant digits: ",
      g = 1e14,
      _ = 14,
      B = 9007199254740991,
      N = [
    ...
    function m(Z) {
      var G,
        Q,
        re,
        X = (x.prototype = { constructor: x, toString: null, valueOf: null }),
        de = new x(1),
        fe = 20,
        R = 4,
        P = -7,
      ...
      function x(b, s) {
        var h,
          ...
          w,
          v = this;
        if (!(v instanceof x)) return new x(b, s);
        if (s == null) {
          ...
          if ((c = typeof b == "number") && b * 0 == 0) {
            if (((v.s = 1 / b < 0 ? ((b = -b), -1) : 1), b === ~~b)) {
              for (U = 0, p = b; p >= 10; p /= 10, U++);
              U > j ? (v.c = v.e = null) : ((v.e = U), (v.c = [b]));
              return;
            }
            w = String(b);
          } else {
            if (!n.test((w = String(b)))) return re(v, w, c);
            v.s = w.charCodeAt(0) == 45 ? ((w = w.slice(1)), -1) : 1;
          }
          (U = w.indexOf(".")) > -1 && (w = w.replace(".", "")),
            (p = w.search(/e/i)) > 0
              ? (U < 0 && (U = p),
                (U += +w.slice(p + 1)),
                (w = w.substring(0, p)))
          ...
          if ((K(s, 2, le.length, "Base"), s == 10 && te))
            return (v = new x(b)), ne(v, fe + v.e + 1, R);
          if (((w = String(b)), (c = typeof b == "number"))) {
            if (b * 0 != 0) return re(v, w, c, s);
            if (
              ((v.s = 1 / b < 0 ? ((w = w.slice(1)), -1) : 1),
              x.DEBUG && w.replace(/^0\.0*|\./, "").length > 15)
            )
              throw Error(o + b);
          } else v.s = w.charCodeAt(0) === 45 ? ((w = w.slice(1)), -1) : 1;
          for (h = le.slice(0, s), U = p = 0, u = w.length; p < u; p++)
            if (h.indexOf((E = w.charAt(p))) < 0) {
              if (E == ".") {
                if (p > U) {
                  U = u;
                  continue;
        ...
        for (u = w.length; w.charCodeAt(--u) === 48; );
        if ((w = w.slice(p, ++u))) {
          if (((u -= p), c && x.DEBUG && u > 15 && (b > B || b !== a(b))))
            throw Error(o + v.s * b);
          if ((U = U - p - 1) > j) v.c = v.e = null;
            ...
            if (
              ...
              for (p && v.c.push(+w.slice(0, p)), u -= _; p < u; )
                v.c.push(+w.slice(p, (p += _)));
              p = _ - (w = w.slice(p)).length;
            } else p -= u;
            for (; p--; w += "0");
            v.c.push(+w);
          }
        ...
        (x.config = x.set =
          function (b) {
            ...
            if (b != null)
              if (typeof b == "object") {
                if (
                  (b.hasOwnProperty((s = "DECIMAL_PLACES")) &&
                    ((h = b[s]), K(h, 0, S, s), (fe = h)),
                  b.hasOwnProperty((s = "ROUNDING_MODE")) &&
                    ((h = b[s]), K(h, 0, 8, s), (R = h)),
                  b.hasOwnProperty((s = "EXPONENTIAL_AT")) &&
                    ((h = b[s]),
                    h && h.pop
                      ? (K(h[0], -S, 0, s),
                        K(h[1], 0, S, s),
                        (P = h[0]),
                        (z = h[1]))
                      : (K(h, -S, S, s), (P = -(z = h < 0 ? -h : h)))),
                  b.hasOwnProperty((s = "RANGE")))
                )
                  if (((h = b[s]), h && h.pop))
                    K(h[0], -S, -1, s),
                      K(h[1], 1, S, s),
                      (M = h[0]),
                      (j = h[1]);
                  else if ((K(h, -S, S, s), h)) M = -(j = h < 0 ? -h : h);
                  else throw Error(l + s + " cannot be zero: " + h);
                if (b.hasOwnProperty((s = "CRYPTO")))
                  if (((h = b[s]), h === !!h))
                    if (h)
                      if (
                        typeof crypto < "u" &&
                        ...
                        J = h;
                      else throw ((J = !h), Error(l + "crypto unavailable"));
                    else J = h;
                  else throw Error(l + s + " not true or false: " + h);
                if (
                  (b.hasOwnProperty((s = "MODULO_MODE")) &&
                    ((h = b[s]), K(h, 0, 9, s), (ee = h)),
                  b.hasOwnProperty((s = "POW_PRECISION")) &&
                    ((h = b[s]), K(h, 0, S, s), (ge = h)),
                  b.hasOwnProperty((s = "FORMAT")))
                )
                  if (((h = b[s]), typeof h == "object")) ae = h;
                  else throw Error(l + s + " not an object: " + h);
                if (b.hasOwnProperty((s = "ALPHABET")))
                  if (
                    ((h = b[s]),
                    typeof h == "string" && !/^.?$|[+\-.\s]|(.).*\1/.test(h))
                  )
                    (te = h.slice(0, 10) == "0123456789"), (le = h);
                  else throw Error(l + s + " invalid: " + h);
        ...
        (x.isBigNumber = function (b) {
          ...
          e: if ({}.toString.call(E) == "[object Array]") {
            if ((U === 1 || U === -1) && T >= -S && T <= S && T === a(T)) {
              ...
              if (
                ((s = (T + 1) % _), s < 1 && (s += _), String(E[0]).length == s)
              ) {
                for (s = 0; s < E.length; s++)
                  if (((h = E[s]), h < 0 || h >= g || h !== a(h))) break e;
                if (h !== 0) return !0;
              }
            }
          } else if (
        ...
        (x.random = (function () {
          ...
          return function (h) {
            var E,
              ...
              w = [],
              v = new x(de);
            if ((h == null ? (h = fe) : K(h, 0, S), (p = i(h / _)), J))
                ...
                for (E = crypto.randomBytes((p *= 7)); u < p; )
                  (c =
                    ...
                    c >= 9e15
                      ...
                      : (w.push(c % 1e14), (u += 7));
                u = p / 7;
              } else throw ((J = !1), Error(l + "crypto unavailable"));
            if (!J) for (; u < p; ) (c = s()), c < 9e15 && (w[u++] = c % 1e14);
            for (
              p = w[--u],
                h %= _,
                p && h && ((c = N[_ - h]), (w[u] = a(p / c) * c));
              w[u] === 0;
              w.pop(), u--
            );
            if (u < 0) w = [(U = 0)];
            else {
              for (U = -1; w[0] === 0; w.splice(0, 1), U -= _);
              for (u = 1, c = w[0]; c >= 10; c /= 10, u++);
              u < _ && (U -= _ - u);
            }
            return (v.e = U), (v.c = w), v;
          };
        })()),
        (x.sum = function () {
          for (var b = 1, s = arguments, h = new x(s[0]); b < s.length; )
            h = h.plus(s[b++]);
          return h;
        }),
        (Q = (function () {
          var b = "0123456789";
          function s(h, E, T, U) {
            for (var p, c = [0], u, w = 0, v = h.length; w < v; ) {
              for (u = c.length; u--; c[u] *= E);
              for (c[0] += U.indexOf(h.charAt(w++)), p = 0; p < c.length; p++)
                c[p] > T - 1 &&
                  (c[p + 1] == null && (c[p + 1] = 0),
                  (c[p + 1] += (c[p] / T) | 0),
                  (c[p] %= T));
          ...
          return function (h, E, T, U, p) {
            ...
            for (
              pe >= 0 &&
                ...
                (h = h.replace(".", "")),
                (oe = new x(E)),
                (L = oe.pow(h.length - pe)),
                (ge = v),
                (oe.c = s(C(V(L.c), L.e, "0"), 10, T, b)),
                (oe.e = oe.c.length)),
                Y = s(h, E, T, p ? ((c = le), b) : ((c = b), le)),
                w = v = Y.length;
              Y[--v] == 0;
              Y.pop()
            );
            ...
            if (
              ...
              h = O ? C(c.charAt(1), -me, c.charAt(0)) : c.charAt(0);
            else {
              if (((Y.length = u), O))
                for (--T; ++Y[--u] > T; )
                  (Y[u] = 0), u || (++w, (Y = [1].concat(Y)));
              for (v = Y.length; !Y[--v]; );
              for (pe = 0, h = ""; pe <= v; h += c.charAt(Y[pe++]));
              h = C(h, w, c.charAt(0));
            }
            return h;
          };
          ...
          return function (E, T, U, p, c) {
            ...
            for (
              pe = new x(ve),
                ...
                ve = U + w + 1,
                c ||
                  ((c = g), (w = $(E.e / _) - $(T.e / _)), (ve = (ve / _) | 0)),
                v = 0;
              xe[v] == (Ee[v] || 0);
              v++
            );
            if ((xe[v] > (Ee[v] || 0) && w--, ve < 0)) me.push(1), (O = !0);
            else {
              for (
                k = Ee.length,
                  H = xe.length,
                  ...
                  if (
                    ...
                    for (
                      ...
                      L--,
                        ...
                        (oe = Y.length),
                        (u = 1);
                  else L == 0 && (u = L = 1), (Y = xe.slice()), (oe = Y.length);
                  if (
                    (oe < f && (Y = [0].concat(Y)),
                    h(y, Y, f, c),
                    (f = y.length),
                    ...
                    for (; s(xe, y, H, f) < 1; )
                      L++, h(y, H < f ? _e : xe, f, c), (f = y.length);
                } else u === 0 && (L++, (y = [0]));
                (me[v++] = L),
                  y[0] ? (y[f++] = Ee[A] || 0) : ((y = [Ee[A]]), (f = 1));
              } while ((A++ < k || y[0] != null) && ve--);
              (O = y[0] != null), me[0] || me.splice(0, 1);
            }
            if (c == g) {
              for (v = 1, ve = me[0]; ve >= 10; ve /= 10, v++);
              ne(pe, U + (pe.e = v + w * _ - 1) + 1, p, O);
            } else (pe.e = w), (pe.r = +O);
            return pe;
          };
        })());
      function se(b, s, h, E) {
        var T, U, p, c, u;
        if ((h == null ? (h = R) : K(h, 0, 8), !b.c)) return b.toString();
        if (((T = b.c[0]), (p = b.e), s == null))
          (u = V(b.c)),
            (u =
              E == 1 || (E == 2 && (p <= P || p >= z))
                ? ie(u, p)
      ...
      function ue(b, s) {
        for (var h, E, T = 1, U = new x(b[0]); T < b.length; T++)
          (E = new x(b[T])),
            (!E.s || (h = W(U, E)) === s || (h === 0 && U.s === s)) && (U = E);
        return U;
      }
      function he(b, s, h) {
      ...
      re = (function () {
        ...
        return function (U, p, c, u) {
          ...
          if (E.test(v)) U.s = isNaN(v) ? null : v < 0 ? -1 : 1;
            ...
            if (
              !c &&
              ((v = v.replace(b, function (O, L, Y) {
                return (
                  (w = (Y = Y.toLowerCase()) == "x" ? 16 : Y == "b" ? 2 : 8),
                  !u || u == w ? L : O
                );
              })),
              u && ((w = u), (v = v.replace(s, "$1").replace(h, "0.$1"))),
              p != v)
            )
              return new x(v, w);
            if (x.DEBUG)
              throw Error(
                l + "Not a" + (u ? " base " + u : "") + " number: " + p,
              );
            U.s = null;
          }
          U.c = U.e = null;
      ...
      function ne(b, s, h, E) {
        ...
        if (O) {
          e: {
            for (T = 1, c = O[0]; c >= 10; c /= 10, T++);
            if (((U = s - T), U < 0))
              (U += _),
                (p = s),
                (u = O[(w = 0)]),
                (v = a((u / L[T - p - 1]) % 10));
            else if (((w = i((U + 1) / _)), w >= O.length))
              if (E) {
                for (; O.length <= w; O.push(0));
                (u = v = 0), (T = 1), (U %= _), (p = U - _ + 1);
              } else break e;
            else {
              for (u = c = O[w], T = 1; c >= 10; c /= 10, T++);
              (U %= _),
                (p = U - _ + T),
                (v = p < 0 ? 0 : a((u / L[T - p - 1]) % 10));
            }
            if (
              ((E =
                E ||
            ...
            if (
              (U == 0
                ...
                : ((O.length = w + 1),
                  (c = L[_ - U]),
                  (O[w] = p > 0 ? a((u / L[T - p]) % L[p]) * c : 0)),
              E)
            )
              for (;;)
                if (w == 0) {
                  for (U = 1, p = O[0]; p >= 10; p /= 10, U++);
                  for (p = O[0] += c, c = 1; p >= 10; p /= 10, c++);
                  U != c && (b.e++, O[0] == g && (O[0] = 1));
                  break;
                } else {
                  if (((O[w] += c), O[w] != g)) break;
                  (O[w--] = 0), (c = 1);
                }
            for (U = O.length; O[--U] === 0; O.pop());
          }
          b.e > j ? (b.c = b.e = null) : b.e < M && (b.c = [(b.e = 0)]);
        }
        return b;
      }
      function ce(b) {
      ...
      return (
        ...
        (X.comparedTo = function (b, s) {
          return W(this, new x(b, s));
        }),
          ...
          function (b, s) {
            ...
            if (b != null)
              return (
                K(b, 0, S),
                s == null ? (s = R) : K(s, 0, 8),
                ne(new x(U), b + U.e + 1, s)
              );
            if (!(h = U.c)) return null;
            if (((E = ((T = h.length - 1) - $(this.e / _)) * _), (T = h[T])))
              for (; T % 10 == 0; T /= 10, E--);
            return E < 0 && (E = 0), E;
          }),
        (X.dividedBy = X.div =
          function (b, s) {
            return G(this, new x(b, s), fe, R);
          }),
        (X.dividedToIntegerBy = X.idiv =
          function (b, s) {
            return G(this, new x(b, s), 0, 1);
          }),
        (X.exponentiatedBy = X.pow =
          function (b, s) {
            ...
            if (((b = new x(b)), b.c && !b.isInteger()))
              throw Error(l + "Exponent not an integer: " + ce(b));
            if (
              (s != null && (s = new x(s)),
              (c = b.e > 14),
              !O.c ||
              ...
              return (
                (v = new x(Math.pow(+ce(O), c ? b.s * (2 - q(b)) : +ce(b)))),
                s ? v.mod(s) : v
              );
            if (((u = b.s < 0), s)) {
              if (s.c ? !s.c[0] : !s.s) return new x(NaN);
              ...
              if (
                ...
                (O.e > 0 ||
                  O.e < -1 ||
                  (O.e == 0
                    ? O.c[0] > 1 || (c && O.c[1] >= 24e7)
                    : O.c[0] < 8e13 || (c && O.c[0] <= 9999975e7)))
              )
                return (
                  (U = O.s < 0 && q(b) ? -0 : 0),
                  O.e > -1 && (U = 1 / U),
            ...
            for (
              c
                ? ((h = new x(0.5)), u && (b.s = 1), (w = q(b)))
                : ((T = Math.abs(+ce(b))), (w = T % 2)),
                v = new x(de);
              ;
              ...
              if (T) {
                ...
                w = T % 2;
              } else if (((b = b.times(h)), ne(b, b.e + 1, 1), b.e > 14))
                w = q(b);
              else {
                if (((T = +ce(b)), T === 0)) break;
                w = T % 2;
            ...
            return E
              ? v
              : (u && (v = de.div(v)), s ? v.mod(s) : U ? ne(v, ge, R, p) : v);
          }),
        (X.integerValue = function (b) {
          var s = new x(this);
          return b == null ? (b = R) : K(b, 0, 8), ne(s, s.e + 1, b);
        }),
        (X.isEqualTo = X.eq =
          function (b, s) {
            return W(this, new x(b, s)) === 0;
          }),
        (X.isFinite = function () {
          return !!this.c;
        }),
        ...
        (X.isGreaterThanOrEqualTo = X.gte =
          function (b, s) {
            return (s = W(this, new x(b, s))) === 1 || s === 0;
          }),
        (X.isInteger = function () {
          return !!this.c && $(this.e / _) > this.c.length - 2;
        }),
        (X.isLessThan = X.lt =
          function (b, s) {
            return W(this, new x(b, s)) < 0;
        ...
        (X.minus = function (b, s) {
          var h,
            ...
            p = this,
            c = p.s;
          if (((b = new x(b, s)), (s = b.s), !c || !s)) return new x(NaN);
          if (c != s) return (b.s = -s), p.plus(b);
          var u = p.e / _,
            w = b.e / _,
            v = p.c,
            O = b.c;
          if (!u || !w) {
            if (!v || !O) return v ? ((b.s = -s), b) : new x(O ? p : NaN);
            if (!v[0] || !O[0])
              return O[0] ? ((b.s = -s), b) : new x(v[0] ? p : R == 3 ? -0 : 0);
          }
          if (((u = $(u)), (w = $(w)), (v = v.slice()), (c = u - w))) {
            for (
              (U = c < 0) ? ((c = -c), (T = v)) : ((w = u), (T = O)),
                T.reverse(),
                s = c;
              s--;
              T.push(0)
            ...
            for (
              E = (U = (c = v.length) < (s = O.length)) ? c : s, c = s = 0;
              s < E;
              s++
            )
              if (v[s] != O[s]) {
          ...
          for (; v[0] == 0; v.splice(0, 1), --w);
          return v[0]
            ? he(b, v, w)
            : ((b.s = R == 3 ? -1 : 1), (b.c = [(b.e = 0)]), b);
        }),
        (X.modulo = X.mod =
          function (b, s) {
            var h,
        ...
        (X.multipliedBy = X.times =
          function (b, s) {
            ...
            if (!f || !d || !f[0] || !d[0])
              return (
                !y.s || !b.s || (f && !f[0] && !d) || (d && !d[0] && !f)
                  ? (b.c = b.e = b.s = null)
                  : ((b.s *= y.s),
                    !f || !d ? (b.c = b.e = null) : ((b.c = [0]), (b.e = 0))),
                b
              );
            for (
              E = $(y.e / _) + $(b.e / _),
                ...
                O = d.length,
                u < O &&
                  ((oe = f), (f = d), (d = oe), (T = u), (u = O), (O = T)),
                T = u + O,
                oe = [];
              T--;
              oe.push(0)
            );
            for (pe = g, me = I, T = O; --T >= 0; ) {
              for (
                h = 0, L = d[T] % me, Y = (d[T] / me) | 0, p = u, U = T + p;
                U > T;
                ...
                (w = f[--p] % me),
                  (v = (f[p] / me) | 0),
                  (c = Y * w + v * L),
                  (w = L * w + (c % me) * me + oe[U] + h),
                  (h = ((w / pe) | 0) + ((c / me) | 0) + Y * v),
                  (oe[U--] = w % pe);
              oe[U] = h;
            }
            return h ? ++E : oe.splice(0, 1), he(b, oe, E);
          }),
        (X.negated = function () {
          var b = new x(this);
        ...
        (X.plus = function (b, s) {
          var h,
            E = this,
            T = E.s;
          if (((b = new x(b, s)), (s = b.s), !T || !s)) return new x(NaN);
          if (T != s) return (b.s = -s), E.minus(b);
          var U = E.e / _,
            p = b.e / _,
            c = E.c,
            u = b.c;
          if (!U || !p) {
            if (!c || !u) return new x(T / 0);
            if (!c[0] || !u[0]) return u[0] ? b : new x(c[0] ? E : T * 0);
          }
          if (((U = $(U)), (p = $(p)), (c = c.slice()), (T = U - p))) {
            for (
              T > 0 ? ((p = U), (h = u)) : ((T = -T), (h = c)), h.reverse();
              T--;
              h.push(0)
            );
            h.reverse();
          ...
          for (
            ...
            (T = ((c[--s] = c[s] + u[s] + T) / g) | 0),
              (c[s] = g === c[s] ? 0 : c[s] % g);
          return T && ((c = [T].concat(c)), ++p), he(b, c, p);
        }),
        (X.precision = X.sd =
          function (b, s) {
            var h,
            ...
            if (b != null && b !== !!b)
              return (
                K(b, 1, S), s == null ? (s = R) : K(s, 0, 8), ne(new x(U), b, s)
              );
            if (!(h = U.c)) return null;
            if (((T = h.length - 1), (E = T * _ + 1), (T = h[T]))) {
              for (; T % 10 == 0; T /= 10, E--);
              for (T = h[0]; T >= 10; T /= 10, E++);
            }
            return b && U.e + 1 > E && (E = U.e + 1), E;
          }),
        (X.shiftedBy = function (b) {
          return K(b, -B, B), this.times("1e" + b);
        }),
        (X.squareRoot = X.sqrt =
          function () {
            var b,
              ...
              v = new x("0.5");
            if (c !== 1 || !p || !p[0])
              return new x(!c || (c < 0 && (!p || p[0])) ? NaN : p ? U : 1 / 0);
            if (
              ((c = Math.sqrt(+ce(U))),
              c == 0 || c == 1 / 0
                ? ((s = V(p)),
              ...
              for (u = h.e, c = u + w, c < 3 && (c = 0); ; )
                if (
                  ((T = h),
                  (h = v.times(T.plus(G(U, T, w, 1)))),
                  V(T.c).slice(0, c) === (s = V(h.c)).slice(0, c))
                )
                  if (
                    (h.e < u && --c,
                    (s = s.slice(c - 3, c + 1)),
                    ...
                    if (!E && (ne(T, T.e + fe + 2, 0), T.times(T).eq(U))) {
                      h = T;
                      break;
                    }
                    (w += 4), (c += 4), (E = 1);
                    ...
                    (!+s || (!+s.slice(1) && s.charAt(0) == "5")) &&
                      (ne(h, h.e + fe + 2, 1), (b = !h.times(h).eq(U)));
                    break;
                  }
            }
            return ne(h, h.e + fe + 1, R, b);
          }),
        (X.toExponential = function (b, s) {
          return b != null && (K(b, 0, S), b++), se(this, b, s, 1);
        }),
        (X.toFixed = function (b, s) {
          return (
            b != null && (K(b, 0, S), (b = b + this.e + 1)), se(this, b, s)
          );
        }),
        (X.toFormat = function (b, s, h) {
          var E,
            T = this;
          if (h == null)
            b != null && s && typeof s == "object"
              ? ((h = s), (s = null))
              : b && typeof b == "object"
                ? ((h = b), (b = s = null))
                : (h = ae);
          else if (typeof h != "object")
            throw Error(l + "Argument not an object: " + h);
          if (((E = T.toFixed(b, s)), T.c)) {
            var U,
              p = E.split("."),
              c = +h.groupSize,
              ...
              oe = Y.length;
            if (
              (u && ((U = c), (c = u), (u = U), (oe -= U)), c > 0 && oe > 0)
            ) {
              for (U = oe % c || c, v = Y.substr(0, U); U < oe; U += c)
                v += w + Y.substr(U, c);
              u > 0 && (v += w + Y.slice(U)), L && (v = "-" + v);
            }
            E = O
              ? v +
                (h.decimalSeparator || "") +
        ...
        (X.toFraction = function (b) {
          ...
          if (
            b != null &&
            ((c = new x(b)), (!c.isInteger() && (c.c || c.s !== 1)) || c.lt(de))
          )
            throw Error(
              l +
                "Argument " +
          ...
          if (!oe) return new x(Y);
          for (
            s = new x(de),
              w = h = new x(de),
              E = u = new x(de),
              L = V(oe),
              U = s.e = L.length - Y.e - 1,
              s.c[0] = N[(p = U % _) < 0 ? _ + p : p],
              b = !b || c.comparedTo(s) > 0 ? (U > 0 ? s : w) : c,
              p = j,
              j = 1 / 0,
              c = new x(L),
              u.c[0] = 0;
            (v = G(c, s, 0, 1)), (T = h.plus(v.times(E))), T.comparedTo(b) != 1;

          )
            (h = E),
              (E = T),
              (w = u.plus(v.times((T = w)))),
              (u = T),
              (s = c.minus(v.times((T = s)))),
              (c = T);
          return (
            (T = G(b.minus(h), E, 0, 1)),
            (u = u.plus(T.times(w))),
            ...
            (O =
              G(w, E, U, R)
                .minus(Y)
                .abs()
                .comparedTo(G(u, h, U, R).minus(Y).abs()) < 1
                ? [w, E]
                : [u, h]),
            (j = p),
            O
        ...
        (X.toPrecision = function (b, s) {
          return b != null && K(b, 1, S), se(this, b, s, 2);
        }),
          ...
          return (
            T === null
              ? E
                ...
                : (s = "NaN")
              : (b == null
                  ? (s = T <= P || T >= z ? ie(V(h.c), T) : C(V(h.c), T, "0"))
                  : b === 10 && te
                    ? ((h = ne(new x(h), fe + T + 1, R)),
                      (s = C(V(h.c), h.e, "0")))
                    : (K(b, 2, le.length, "Base"),
                      (s = Q(C(V(h.c), T, "0"), 10, b, E, !0))),
                E < 0 && h.c[0] && (s = "-" + s)),
            s
          );
        }),
    ...
    function $(Z) {
      var G = Z | 0;
      return Z > 0 || Z === G ? G : G - 1;
    }
    function V(Z) {
      for (var G, Q, re = 1, X = Z.length, de = Z[0] + ""; re < X; ) {
        for (G = Z[re++] + "", Q = _ - G.length; Q--; G = "0" + G);
        de += G;
      }
      for (X = de.length; de.charCodeAt(--X) === 48; );
      return de.slice(0, X + 1 || 1);
    }
    function W(Z, G) {
      var Q,
        re,
        ...
        z = G.e;
      if (!fe || !R) return null;
      if (((Q = X && !X[0]), (re = de && !de[0]), Q || re))
        return Q ? (re ? 0 : -R) : fe;
      if (fe != R) return fe;
      if (((Q = fe < 0), (re = P == z), !X || !de))
        return re ? 0 : !X ^ Q ? 1 : -1;
      if (!re) return (P > z) ^ Q ? 1 : -1;
      for (R = (P = X.length) < (z = de.length) ? P : z, fe = 0; fe < R; fe++)
        if (X[fe] != de[fe]) return (X[fe] > de[fe]) ^ Q ? 1 : -1;
      return P == z ? 0 : (P > z) ^ Q ? 1 : -1;
    }
    function K(Z, G, Q, re) {
      if (Z < G || Z > Q || Z !== a(Z))
        throw Error(
    ...
    function C(Z, G, Q) {
      ...
      if (G < 0) {
        for (X = Q + "."; ++G; X += Q);
        Z = X + Z;
      } else if (((re = Z.length), ++G > re)) {
        for (X = Q, G -= re; --G; X += Q);
        Z += X;
      } else G < re && (Z = Z.slice(0, G) + "." + Z.slice(G));
      return Z;
    }
    (r = m()),
  ...
  Uf = function (t, r, n) {
    ...
    function he(F) {
      for (
        F = F | 0, x = 0, se = F;
        (x | 0) < (se | 0) &&
        ((ue = ku[i[x] & 255](i[x] | 0) | 0), !((ue | 0) > 0));

      );
      return ue | 0;
    }
    function ne(F) {
      return (F = F | 0), (((x | 0) + (F | 0)) | 0) < (se | 0) ? 0 : 1;
    }
    function ce(F) {
    ...
    function s(F) {
      return (F = F | 0), a(F | 0), (x = (x + 1) | 0), 0;
    }
    function h(F) {
      return (
        (F = F | 0),
        ne(1) | 0 ? 1 : (a(i[(x + 1) | 0] | 0), (x = (x + 2) | 0), 0)
      );
    }
    function E(F) {
      return (
        (F = F | 0),
        ne(2) | 0 ? 1 : (a(ce((x + 1) | 0) | 0), (x = (x + 3) | 0), 0)
      );
    }
    function T(F) {
      return (
        ...
        ne(4) | 0
          ? 1
          : (l(ce((x + 1) | 0) | 0, ce((x + 3) | 0) | 0), (x = (x + 5) | 0), 0)
      );
    }
    function U(F) {
      return (
    ...
    function p(F) {
      return (F = F | 0), a((-1 - ((F - 32) | 0)) | 0), (x = (x + 1) | 0), 0;
    }
    function c(F) {
      return (
        (F = F | 0),
    ...
    function w(F) {
      return (
        ...
        ne(4) | 0
          ? 1
          : (o(ce((x + 1) | 0) | 0, ce((x + 3) | 0) | 0), (x = (x + 5) | 0), 0)
      );
    }
    function v(F) {
      return (
    ...
    function D(F) {
      return (F = F | 0), M(), (x = (x + 1) | 0), 0;
    }
    function H(F) {
      return (F = F | 0), Z((F - 128) | 0), (x = (x + 1) | 0), 0;
    }
    function _e(F) {
      return (
        (F = F | 0),
        ne(1) | 0 ? 1 : (Z(i[(x + 1) | 0] | 0), (x = (x + 2) | 0), 0)
      );
    }
    function ve(F) {
      return (
        (F = F | 0),
        ne(2) | 0 ? 1 : (Z(ce((x + 1) | 0) | 0), (x = (x + 3) | 0), 0)
      );
    }
    function Ee(F) {
      return (
        ...
        ne(4) | 0
          ? 1
          : (G(ce((x + 1) | 0) | 0, ce((x + 3) | 0) | 0), (x = (x + 5) | 0), 0)
      );
    }
    function xe(F) {
      return (
    ...
    function ke(F) {
      ...
      return (
        (Se = (F - 160) | 0),
        ne(Se | 0) | 0 ? 1 : (X(Se | 0), (x = (x + 1) | 0), 0)
      );
    }
    function qi(F) {
      return (
        (F = F | 0),
        ne(1) | 0 ? 1 : (X(i[(x + 1) | 0] | 0), (x = (x + 2) | 0), 0)
      );
    }
    function Gi(F) {
      return (
        (F = F | 0),
        ne(2) | 0 ? 1 : (X(ce((x + 1) | 0) | 0), (x = (x + 3) | 0), 0)
      );
    }
    function ji(F) {
      return (
        ...
        ne(4) | 0
          ? 1
          : (de(ce((x + 1) | 0) | 0, ce((x + 3) | 0) | 0), (x = (x + 5) | 0), 0)
      );
    }
    function _u(F) {
      return (
    ...
    function xu(F) {
      return (F = F | 0), re(), (x = (x + 1) | 0), 0;
    }
    function Br(F) {
      return (F = F | 0), J((F - 192) | 0 | 0), (x = (x + 1) | 0), 0;
    }
    function zh(F) {
      return (F = F | 0), J(F | 0), (x = (x + 1) | 0), 0;
    }
    function Wh(F) {
      return (F = F | 0), J(F | 0), (x = (x + 1) | 0), 0;
    }
    ...
    function Eu(F) {
      return (
        (F = F | 0),
        ne(1) | 0 ? 1 : (J(i[(x + 1) | 0] | 0), (x = (x + 2) | 0), 0)
      );
    }
    function vu(F) {
      return (
        (F = F | 0),
        ne(2) | 0 ? 1 : (J(ce((x + 1) | 0) | 0), (x = (x + 3) | 0), 0)
      );
    }
    function Tu(F) {
      return (
        ...
        ne(4) | 0
          ? 1
          : (ee(ce((x + 1) | 0) | 0, ce((x + 3) | 0) | 0), (x = (x + 5) | 0), 0)
      );
    }
    function Bu(F) {
      return (
    ...
    function je(F) {
      return (F = F | 0), j(((F | 0) - 224) | 0), (x = (x + 1) | 0), 0;
    }
    function Au(F) {
      return (F = F | 0), m(), (x = (x + 1) | 0), 0;
    }
    function Nu(F) {
      return (F = F | 0), S(), (x = (x + 1) | 0), 0;
    }
    function Su(F) {
      return (F = F | 0), V(), (x = (x + 1) | 0), 0;
    }
    function Iu(F) {
      return (F = F | 0), $(), (x = (x + 1) | 0), 0;
    }
    function Ou(F) {
      return (
        (F = F | 0),
...
(function (e) {
  ...
  (e.arrayBufferToBignumber = function (g) {
    const _ = g.byteLength;
    let B = "";
    for (let N = 0; N < _; N++) B += o(g[N]);
    return new r(B, 16);
  }),
    (e.buildMap = (g) => {
      const _ = new Map(),
        B = Object.keys(g),
        N = B.length;
      for (let I = 0; I < N; I++) _.set(B[I], g[B[I]]);
      return _;
    }),
    (e.buildInt32 = (g, _) => g * a + _),
    (e.buildInt64 = (g, _, B, N) => {
      const I = e.buildInt32(g, _),
        S = e.buildInt32(B, N);
      return I > l ? new r(I).times(i).plus(S) : I * i + S;
    }),
    (e.writeHalf = function (_, B) {
      ...
      const m = (I >> 23) & 255,
        $ = I & 8388607;
      if (m >= 113 && m <= 142) S += ((m - 112) << 10) + ($ >> 13);
      else if (m >= 103 && m < 113) {
        if ($ & ((1 << (126 - m)) - 1)) return !1;
        S += ($ + 8388608) >> (126 - m);
      } else return !1;
      return _.writeUInt16BE(S, 0), !0;
    }),
    (e.keySorter = function (g, _) {
      var B = g[0].byteLength,
        N = _[0].byteLength;
      return B > N ? 1 : N > B ? -1 : g[0].compare(_[0]);
    }),
    (e.isNegativeZero = (g) => g === 0 && 1 / g < 0),
    (e.nextPowerOf2 = (g) => {
      let _ = 0;
      if (g && !(g & (g - 1))) return g;
      for (; g !== 0; ) (g >>= 1), (_ += 1);
...
let Pf = class ms {
  ...
  encodeCBOR(t) {
    return t._pushInt(this.value, Ff.SIMPLE_FLOAT);
  }
  static isSimple(t) {
  ...
  static decode(t, r) {
    switch ((r == null && (r = !0), t)) {
      ...
      case Sn.TRUE:
        return !0;
      case Sn.NULL:
        return r ? null : Ki.NULL;
      case Sn.UNDEFINED:
        return r ? void 0 : Ki.UNDEFINED;
      case -1:
...
let kf = class bs {
  ...
  convert(t) {
    ...
    if (
      ((n = t?.[this.tag]),
      typeof n != "function" &&
        ((n = bs["_tag" + this.tag]), typeof n != "function"))
    )
      return this;
    try {
      return n.call(bs, this.value);
    } catch (i) {
...
function Mf(e) {
  if (typeof e == "string") return new _s(e).toString();
  if (!(e instanceof _s)) {
...
const { URLWithLegacySupport: oa, format: Vf } = Qo;
var $f = (e, t = {}, r = {}, n) => {
  ...
  return new oa(e, Vf(l)).toString();
};
const {
    URLWithLegacySupport: qf,
    format: Gf,
    URLSearchParams: jf,
    defaultBase: Lf,
  } = Qo,
...
let xs = class Es {
  constructor(t) {
    (t = t || {}),
      ...
      (this._buffer = Nr.from(this._heap)),
      this._reset(),
  ...
  createByteStringFromHeap(t, r) {
    return t === r ? Nr.alloc(0) : Nr.from(this._heap.slice(t, r));
  }
  createInt(t) {
    return t;
  }
  ...
  createFloatSingle(t, r, n, i) {
    return ca.read([t, r, n, i], 0, !1, 23, 4);
  }
  createFloatDouble(t, r, n, i, a, l, o, g) {
    return ca.read([t, r, n, i, a, l, o, g], 0, !1, 52, 8);
  }
  createInt32Neg(t, r) {
  ...
  createInt64Neg(t, r, n, i) {
    ...
    return a > Ue.MAX_SAFE_HIGH
      ? Ue.NEG_ONE.minus(new Df(a).times(Ue.SHIFT32).plus(l))
      : -1 - (a * Ue.SHIFT32 + l);
  }
  createTrue() {
    return !0;
  ...
  pushFloatDouble(t, r, n, i, a, l, o, g) {
    this._push(this.createFloatDouble(t, r, n, i, a, l, o, g));
  }
  pushInt32Neg(t, r) {
  ...
  static decode(t, r) {
    return (
      typeof t == "string" && (t = Nr.from(t, r || "hex")),
      new Es({ size: t.length }).decodeFirst(t)
    );
  }
  static decodeAll(t, r) {
    return (
      typeof t == "string" && (t = Nr.from(t, r || "hex")),
      new Es({ size: t.length }).decodeAll(t)
    );
  }
};
xs.decodeFirst = xs.decode;
var tc = xs;
const { Buffer: zi } = vn,
  Zf = tc,
  Xf = Fi;
class Ls extends Zf {
  ...
  createFloat(t) {
    ...
    return Xf.isNegativeZero(t) ? "-0_1" : `${r}_1`;
  }
  createFloatSingle(t, r, n, i) {
    return `${super.createFloatSingle(t, r, n, i)}_2`;
  }
  createFloatDouble(t, r, n, i, a, l, o, g) {
    return `${super.createFloatDouble(t, r, n, i, a, l, o, g)}_3`;
  }
  createByteString(t, r) {
    const n = t.join(", ");
    return r === -1 ? `(_ ${n})` : `h'${n}`;
  ...
  createByteStringFromHeap(t, r) {
    return `h'${zi.from(super.createByteStringFromHeap(t, r)).toString("hex")}'`;
  }
  createInfinity() {
    return "Infinity_1";
  }
  ...
  createMap(t, r) {
    const n = super.createMap(t),
      i = Array.from(n.keys()).reduce(ua(n), "");
    return r === -1 ? `{_ ${i}}` : `{${i}}`;
  }
  createObject(t, r) {
    const n = super.createObject(t),
      i = Object.keys(n).reduce(ua(n), "");
    return r === -1 ? `{_ ${i}}` : `{${i}}`;
  }
  createUtf8String(t, r) {
    const n = t.join(", ");
  ...
  createUtf8StringFromHeap(t, r) {
    return `"${zi.from(super.createUtf8StringFromHeap(t, r)).toString("utf8")}"`;
  }
  static diagnose(t, r) {
    return (
      typeof t == "string" && (t = zi.from(t, r || "hex")),
      new Ls().decodeFirst(t)
    );
  }
}
var Jf = Ls;
...
const { Buffer: Ft } = vn,
  ...
  la = ze.SYMS,
  Sr = ze.TAG,
  el = (ze.MT.SIMPLE_FLOAT << 5) | ze.NUMBYTES.TWO,
  tl = (ze.MT.SIMPLE_FLOAT << 5) | ze.NUMBYTES.FOUR,
  rl = (ze.MT.SIMPLE_FLOAT << 5) | ze.NUMBYTES.EIGHT,
  nl = (ze.MT.SIMPLE_FLOAT << 5) | ze.SIMPLE.TRUE,
  il = (ze.MT.SIMPLE_FLOAT << 5) | ze.SIMPLE.FALSE,
  sl = (ze.MT.SIMPLE_FLOAT << 5) | ze.SIMPLE.UNDEFINED,
  da = (ze.MT.SIMPLE_FLOAT << 5) | ze.SIMPLE.NULL,
  al = new vs("0x20000000000000"),
  ol = Ft.from("f97e00", "hex"),
  cl = Ft.from("f9fc00", "hex"),
  ul = Ft.from("f97c00", "hex");
function fl(e) {
...
class hi {
  ...
  _pushFloat(t) {
    const r = Ft.allocUnsafe(2);
    if (Wi.writeHalf(r, t) && Wi.parseHalf(r) === t)
      return this._pushUInt8(el) && this.push(r);
    const n = Ft.allocUnsafe(4);
    return (
      n.writeFloatBE(t, 0),
      n.readFloatBE(0) === t
        ? this._pushUInt8(tl) && this.push(n)
  ...
  _pushInt(t, r, n) {
    ...
    return t < 24
      ? this._pushUInt8(i | t)
      : t <= 255
        ? this._pushUInt8(i | In.ONE) && this._pushUInt8(t)
        : t <= 65535
          ? this._pushUInt8(i | In.TWO) && this._pushUInt16BE(t)
          : t <= 4294967295
            ? this._pushUInt8(i | In.FOUR) && this._pushUInt32BE(t)
            : t <= Number.MAX_SAFE_INTEGER
              ? this._pushUInt8(i | In.EIGHT) &&
                this._pushUInt32BE(Math.floor(t / fa)) &&
                this._pushUInt32BE(t % fa)
              : r === mt.NEG_INT
                ? this._pushFloat(n)
                : this._pushFloat(t);
  }
  ...
  _pushDate(t, r) {
    return t._pushTag(Sr.DATE_EPOCH) && t.pushAny(Math.round(r / 1e3));
  }
  _pushBuffer(t, r) {
  ...
  _pushRegexp(t, r) {
    return t._pushTag(Sr.REGEXP) && t.pushAny(r.source);
  }
  _pushSet(t, r) {
  ...
  _pushUrl(t, r) {
    return t._pushTag(Sr.URI) && t.pushAny(r.format());
  }
  _pushBigint(t) {
    let r = Sr.POS_BIGINT;
    t.isNegative() && ((t = t.negated().minus(1)), (r = Sr.NEG_BIGINT));
    let n = t.toString(16);
    n.length % 2 && (n = "0" + n);
    const i = Ft.from(n, "hex");
  ...
  _pushBigNumber(t, r) {
    ...
    if (!(t._pushTag(Sr.DECIMAL_FRAC) && t._pushInt(2, mt.ARRAY))) return !1;
  ...
  _pushObject(t) {
    if (!t) return this._pushUInt8(da);
  ...
  pushAny(t) {
    ...
    switch (r) {
      ...
      case "Uint8Array":
        return this._pushBuffer(this, Ft.isBuffer(t) ? t : Ft.from(t));
      case "Null":
        return this._pushUInt8(da);
      case "Undefined":
    ...
    for (l = 0; l < i; l++) {
      switch (((_ = r[l]), n[l])) {
        case 0:
          ...
          break;
        case 1:
          o.writeUInt8(t[l], g, !0);
          break;
        case 2:
          o.writeUInt16BE(t[l], g, !0);
          break;
        case 3:
          o.writeUInt32BE(t[l], g, !0);
          break;
        case 4:
          o.writeDoubleBE(t[l], g, !0);
          break;
        case 5:
          o.write(t[l], g, _, "utf8");
          break;
        default:
...
const rc = Cu(Wo);
function Tt(e) {
  return cn(gf.create().update(new Uint8Array(e)).digest());
}
function Gn(e) {
  if (e instanceof rc.Tagged) return Gn(e.value);
  if (typeof e == "string") return nc(e);
  if (typeof e == "number") return Tt($e(e));
  ...
  if (Array.isArray(e)) {
    ...
    if (typeof e == "object" && e !== null && typeof e.toHash == "function")
      return Gn(e.toHash());
    if (typeof e == "object") return pi(e);
    if (typeof e == "bigint") return Tt($e(e));
  }
  throw Object.assign(
  ...
  async transformRequest(t) {
    ...
    return Object.assign(Object.assign({}, n), {
      body: {
        ...
        sender_sig: await this.sign(Bt(hl, i)),
      },
    });
  }
}
...
function ic(e) {
  ...
  return Dt(new Uint8Array(Pi(3, e.length)), new Uint8Array(t));
}
function yl(e, t) {
  if (e == 14277111) return Dt(new Uint8Array([217, 217, 247]), t);
  if (e < 24) return Dt(new Uint8Array([192 + e]), t);
  {
    const r = e <= 255 ? 24 : e <= 65535 ? 25 : e <= 4294967295 ? 26 : 27,
      ...
      i = e
        ...
        .slice(-n * 2)
        .padStart(n * 2, "0"),
      a = [192 + r].concat(i.match(/../g).map((l) => parseInt(l, 16)));
...
function Ks(e, t) {
  ...
  if (((e = parseInt("" + e, t)), isNaN(e)))
    throw new RangeError("Invalid number.");
  return (e = Math.min(Math.max(0, e), pl)), (e = e.toString(16)), At(0, 27, e);
}
Pe.u64 = Ks;
function cc(e) {
  if (isNaN(e)) throw new RangeError("Invalid number.");
  ...
  if (typeof e == "string" && t == 16) {
    ...
    let r = !1,
      n = e.split("").reduceRight((i, a) => {
        if (r) return a + i;
        let l = parseInt(a, 16) - 1;
        return l >= 0 ? ((r = !0), l.toString(16) + i) : "f" + i;
      }, "");
    return r ? At(1, 27, n) : Ks(0);
  }
  if (((e = parseInt("" + e, t)), isNaN(e)))
    throw new RangeError("Invalid number.");
  return (
...
function _l(e, t = !1) {
  ...
  return (
    ...
    Dt(Pi(5, e.size), ...r.map(([n, i]) => Dt(ic(n), i)))
  );
}
Pe.map = _l;
function xl(e) {
  const t = new Float32Array([e]);
  return Dt(new Uint8Array([250]), new Uint8Array(t.buffer));
}
Pe.singleFloat = xl;
function El(e) {
  const t = new Float64Array([e]);
  return Dt(new Uint8Array([251]), new Uint8Array(t.buffer));
}
Pe.doubleFloat = El;
function vl(e) {
  return e ? hc() : pc();
...
Pe.bool = vl;
function hc() {
  return Tn(new Uint8Array([245]));
}
Pe.true_ = hc;
function pc() {
  return Tn(new Uint8Array([244]));
}
Pe.false_ = pc;
function Tl() {
  return Tn(new Uint8Array([246]));
}
Pe.null_ = Tl;
function Bl() {
  return Tn(new Uint8Array([247]));
}
Pe.undefined_ = Bl;
var Al =
  (Lr && Lr.__importStar) ||
  ...
  encode(t) {
    switch (typeof t) {
      ...
      case "object":
        ...
        if (Nl.find((r) => t instanceof r)) return _t.bytes(t.buffer);
...
class wc {
  ...
  static withDefaultEncoders(t = !1) {
    const r = new this();
    return r.addEncoder(new yc(r, t)), r.addEncoder(new gc()), r;
  }
  removeEncoder(t) {
...
Yr.SelfDescribeCborSerializer = Sl;
(function (e) {
  function t(i) {
  ...
  var r =
    ...
    function (i) {
      ...
      var a = {};
      if (i != null)
        for (var l in i) Object.hasOwnProperty.call(i, l) && (a[l] = i[l]);
      return (a.default = i), a;
    };
  Object.defineProperty(e, "__esModule", { value: !0 }), t(Yr);
  const n = r(Pe);
  e.value = n;
})(lt);
class Il {
...
class Rl {
  ...
  encode(t) {
    return t > BigInt(0)
      ? lt.value.tagged(2, lt.value.bytes(Ht(t.toString(16))))
      : lt.value.tagged(3, lt.value.bytes(Ht((BigInt("-1") * t).toString(16))));
  }
}
const ki = lt.SelfDescribeCborSerializer.withDefaultEncoders(!0);
ki.addEncoder(new Il());
ki.addEncoder(new Ol());
ki.addEncoder(new Rl());
var Ts;
(function (e) {
...
function jt(e) {
  const t = new Uint8Array(e),
    r = new Ul({
      size: t.byteLength,
      tags: { 2: (n) => ha(n), 3: (n) => -ha(n), [Ts.Semantic]: (n) => n },
    });
  try {
...
class Ur {
  constructor(t) {
    if (t < 90 * 1e3) {
      const o = (BigInt(Date.now() + t) * pa) / BigInt(1e9);
      this._value = o * BigInt(1e9);
      return;
    }
    const a =
      ((BigInt(Math.floor(Date.now() + t - Fl)) * pa) /
        BigInt(1e9) /
        BigInt(60)) *
      BigInt(60) *
      BigInt(1e9);
...
function mc(e, ...t) {
  if (!Pl(e)) throw new Error("Uint8Array expected");
  if (t.length > 0 && !t.includes(e.length))
    throw new Error(
      "Uint8Array expected of length " + t + ", got length=" + e.length,
    );
...
function bc(e) {
  return typeof e == "string" && (e = Cl(e)), mc(e), e;
}
class Ml {
  clone() {
    return this._cloneInto();
...
function _c(e) {
  const t = (n) => e().update(bc(n)).digest(),
    r = e();
  return (
    (t.outputLen = r.outputLen),
    (t.blockLen = r.blockLen),
...
function xc(e = 32) {
  ...
  if (Ir && typeof Ir.randomBytes == "function") return Ir.randomBytes(e);
...
const $l = (e, t, r) => (e & t) ^ (~e & r),
  ql = (e, t, r) => (e & t) ^ (e & r) ^ (t & r);
class Ec extends Ml {
  constructor(t, r, n, i) {
    super(),
      (this.blockLen = t),
  ...
  digestInto(t) {
    ga(this), kl(t, this), (this.finished = !0);
    const { buffer: r, view: n, blockLen: i, isLE: a } = this;
    let { pos: l } = this;
    (r[l++] = 128),
      this.buffer.subarray(l).fill(0),
      this.padOffset > i - l && (this.process(n, 0), (l = 0));
    for (let N = l; N < i; N++) r[N] = 0;
    Vl(n, i - 8, BigInt(this.length * 8), a), this.process(n, 0);
    const o = Xi(t),
      g = this.outputLen;
    if (g % 4) throw new Error("_sha2: outputLen should be aligned to 32bit");
    const _ = g / 4,
...
class jl extends Ec {
  ...
  process(t, r) {
    for (let N = 0; N < 16; N++, r += 4) Yt[N] = t.getUint32(r, !1);
    for (let N = 16; N < 64; N++) {
      const I = Yt[N - 15],
        S = Yt[N - 2],
        m = St(I, 7) ^ St(I, 18) ^ (I >>> 3),
        $ = St(S, 17) ^ St(S, 19) ^ (S >>> 10);
      Yt[N] = ($ + Yt[N - 7] + m + Yt[N - 16]) | 0;
    }
    let { A: n, B: i, C: a, D: l, E: o, F: g, G: _, H: B } = this;
    for (let N = 0; N < 64; N++) {
      const I = St(o, 6) ^ St(o, 11) ^ St(o, 25),
        S = (B + I + $l(o, g, _) + Gl[N] + Yt[N]) | 0,
        $ = ((St(n, 2) ^ St(n, 13) ^ St(n, 22)) + ql(n, i, a)) | 0;
      (B = _),
        (_ = g),
        (g = o),
        (o = (l + S) | 0),
...
function dr(e) {
  if (!Ci(e)) throw new Error("Uint8Array expected");
}
function un(e, t) {
  if (typeof t != "boolean") throw new Error(e + " boolean expected, got " + t);
}
const Hl = Array.from({ length: 256 }, (e, t) =>
  t.toString(16).padStart(2, "0"),
);
function Tr(e) {
  dr(e);
  let t = "";
  for (let r = 0; r < e.length; r++) t += Hl[e[r]];
  return t;
}
function Tc(e) {
  if (typeof e != "string")
    throw new Error("hex string expected, got " + typeof e);
  return e === "" ? zs : BigInt("0x" + e);
}
const Vt = { _0: 48, _9: 57, A: 65, F: 70, a: 97, f: 102 };
function wa(e) {
  if (e >= Vt._0 && e <= Vt._9) return e - Vt._0;
  if (e >= Vt.A && e <= Vt.F) return e - (Vt.A - 10);
  if (e >= Vt.a && e <= Vt.f) return e - (Vt.a - 10);
}
function Bc(e) {
  if (typeof e != "string")
  ...
  for (let i = 0, a = 0; i < r; i++, a += 2) {
    const l = wa(e.charCodeAt(a)),
      o = wa(e.charCodeAt(a + 1));
    if (l === void 0 || o === void 0) {
      const g = e[a] + e[a + 1];
      throw new Error(
        'hex string expected, got non-hex character "' + g + '" at index ' + a,
      );
    }
    n[i] = l * 16 + o;
  }
...
function fn(e) {
  return dr(e), Tc(Tr(Uint8Array.from(e).reverse()));
}
function Qe(e, t) {
  return Bc(e.toString(16).padStart(t * 2, "0"));
}
function gi(e, t) {
...
const Ji = (e) => typeof e == "bigint" && zs <= e;
function Ac(e, t, r) {
...
function ln(e) {
  let t;
  for (t = 0; e > zs; e >>= Ws, t += 1);
  return t;
}
function Dl(e, t) {
  return (e >> BigInt(t)) & Ws;
}
const jn = (e) => (Ll << BigInt(e - 1)) - Ws,
  Kl = {
    bigint: (e) => typeof e == "bigint",
    function: (e) => typeof e == "function",
    boolean: (e) => typeof e == "boolean",
    string: (e) => typeof e == "string",
    stringOrUint8Array: (e) => typeof e == "string" || Ci(e),
...
function Bn(e, t, r = {}) {
  const n = (i, a, l) => {
    ...
    if (!(l && g === void 0) && !o(g, e))
      throw new Error(
        "param " + String(i) + " is invalid. Expected " + a + ", got " + g,
      );
  };
...
function Wl(e, t, r) {
  if (t < Je) throw new Error("invalid exponent, negatives unsupported");
  if (r <= Je) throw new Error("invalid modulus");
  if (r === Ce) return Je;
  let n = Ce;
...
function xa(e, t) {
  if (e === Je) throw new Error("invert: expected non-zero number");
  if (t <= Je) throw new Error("invert: expected positive modulus, got " + t);
  let r = Ve(e, t),
    n = t,
    i = Je,
    a = Ce;
...
function Yl(e) {
  const t = (e - Ce) / or;
  let r, n, i;
  for (r = e - Ce, n = 0; r % or === Je; r /= or, n++);
  for (i = or; i < e && Wl(i, t, e) !== e - Ce; i++)
    if (i > 1e3) throw new Error("Cannot find square root: likely non-prime P");
  if (n === 1) {
    const l = (e + Ce) / Ns;
    return function (g, _) {
      const B = g.pow(_, l);
      if (!g.eql(g.sqr(B), _)) throw new Error("Cannot find square root");
      return B;
    };
  }
  const a = (r + Ce) / or;
  return function (o, g) {
    if (o.pow(g, t) === o.neg(o.ONE))
      throw new Error("Cannot find square root");
    let _ = n,
      B = o.pow(o.mul(o.ONE, i), r),
      N = o.pow(g, a),
      I = o.pow(g, r);
    for (; !o.eql(I, o.ONE); ) {
      if (o.eql(I, o.ZERO)) return o.ZERO;
      let S = 1;
      for (let $ = o.sqr(I); S < _ && !o.eql($, o.ONE); S++) $ = o.sqr($);
      const m = o.pow(B, Ce << BigInt(_ - S - 1));
      (B = o.sqr(m)), (N = o.mul(N, m)), (I = o.mul(I, B)), (_ = S);
    }
    return N;
  };
}
  ...
  if (e % _a === ba) {
    ...
    return function (n, i) {
      const a = n.mul(i, or),
        l = n.pow(a, t),
        o = n.mul(i, l),
        g = n.mul(n.mul(o, or), l),
        _ = n.mul(o, n.sub(g, n.ONE));
      if (!n.eql(n.sqr(_), i)) throw new Error("Cannot find square root");
      return _;
    };
  }
  return Yl(e);
}
const Xl = (e, t) => (Ve(e, t) & Ce) === Ce,
  Jl = [
    "create",
    "isValid",
    "is0",
...
function Nc(e) {
  const t = {
    ...
    r = Jl.reduce((n, i) => ((n[i] = "function"), n), t);
  return Bn(e, r);
}
function Ln(e, t, r) {
  if (r < Je) throw new Error("invalid exponent, negatives unsupported");
...
function Hn(e, t) {
  const r = new Array(t.length),
    n = t.reduce(
      (a, l, o) => (e.is0(l) ? a : ((r[o] = a), e.mul(a, l))),
      e.ONE,
    ),
    i = e.inv(n);
  return (
    t.reduceRight(
      (a, l, o) => (e.is0(l) ? a : ((r[o] = e.mul(a, r[o])), e.mul(a, l))),
      i,
    ),
    r
  );
...
function An(e, t, r = !1, n = {}) {
  if (e <= Je) throw new Error("invalid field: expected ORDER > 0, got " + e);
  const { nBitLength: i, nByteLength: a } = Sc(e, t);
  if (a > 2048)
  ...
  const o = Object.freeze({
    ...
    isValid: (g) => {
      if (typeof g != "bigint")
        throw new Error(
          "invalid field element: expected bigint, got " + typeof g,
        );
      return Je <= g && g < e;
    },
    is0: (g) => g === Je,
    ...
    mul: (g, _) => Ve(g * _, e),
    pow: (g, _) => Ln(o, g, _),
    div: (g, _) => Ve(g * xa(_, e), e),
    sqrN: (g) => g * g,
    addN: (g, _) => g + _,
    subN: (g, _) => g - _,
    mulN: (g, _) => g * _,
    inv: (g) => xa(g, e),
    sqrt: n.sqrt || ((g) => (l || (l = Zl(e)), l(o, g))),
    invertBatch: (g) => Hn(o, g),
    cmov: (g, _, B) => (B ? _ : g),
    toBytes: (g) => (r ? gi(g, a) : Qe(g, a)),
    fromBytes: (g) => {
      if (g.length !== a)
        throw new Error(
          "Field.fromBytes: expected " + a + " bytes, got " + g.length,
        );
      return r ? fn(g) : vt(g);
    },
  });
...
function e0(e, t, r = !1) {
  ...
  const l = r ? vt(e) : fn(e),
    o = Ve(l, t - Ce) + Ce;
  return r ? gi(o, i) : Qe(o, i);
}
const t0 = vt;
function tr(e, t) {
  if ((gn(e), gn(t), e < 0 || e >= 1 << (8 * t)))
...
function n0(e, t, r, n) {
  dr(e),
    dr(t),
    gn(r),
    t.length > 255 && (t = n(Le(Ys("H2C-OVERSIZE-DST-"), t)));
  const { outputLen: i, blockLen: a } = n,
    l = Math.ceil(r / i);
  if (r > 65535 || l > 255)
    throw new Error("expand_message_xmd: invalid lenInBytes");
  const o = Le(t, tr(t.length, 1)),
    g = tr(0, a),
    _ = tr(r, 2),
    B = new Array(l),
    N = n(Le(g, e, _, tr(0, 1), o));
  B[0] = n(Le(N, tr(1, 1), o));
  for (let S = 1; S <= l; S++) {
    const m = [r0(N, B[S - 1]), tr(S + 1, 1), o];
    B[S] = n(Le(...m));
  }
  return Le(...B).slice(0, r);
}
function i0(e, t, r, n, i) {
  if ((dr(e), dr(t), gn(r), t.length > 255)) {
    const a = Math.ceil((2 * n) / 8);
    t = i
      .create({ dkLen: a })
      .update(Ys("H2C-OVERSIZE-DST-"))
      .update(t)
      .digest();
  }
...
function Ea(e, t, r) {
  ...
  const { p: n, k: i, m: a, hash: l, expand: o, DST: g } = r;
  dr(e), gn(t);
  const _ = typeof g == "string" ? Ys(g) : g,
    B = n.toString(2).length,
    N = Math.ceil((B + i) / 8),
    I = t * a * N;
  let S;
  if (o === "xmd") S = n0(e, _, I, l);
  else if (o === "xof") S = i0(e, _, I, i, l);
  else if (o === "_internal_pass") S = e;
...
function Rc(e, t) {
  ...
  return (n, i) => {
    const [a, l, o, g] = r.map((_) =>
      _.reduce((B, N) => e.add(e.mul(B, n), N)),
    );
    return (n = e.div(a, l)), (i = e.mul(i, e.div(o, g))), { x: n, y: i };
  };
}
function va(e, t, r) {
  ...
  return {
    hashToCurve(n, i) {
      const a = Ea(n, 2, { ...r, DST: r.DST, ...i }),
        l = e.fromAffine(t(a[0])),
        o = e.fromAffine(t(a[1])),
        g = l.add(o).clearCofactor();
      return g.assertValidity(), g;
    },
    encodeToCurve(n, i) {
      const a = Ea(n, 1, { ...r, DST: r.encodeDST, ...i }),
        l = e.fromAffine(t(a[0])).clearCofactor();
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ const Ta =
    BigInt(0),
  Rn = BigInt(1);
function Qi(e, t) {
  const r = t.negate();
...
function Pc(e, t) {
  return {
    ...
    unsafeLadder(r, n, i = e.ZERO) {
      let a = r;
      for (; n > Ta; ) n & Rn && (i = i.add(a)), (a = a.double()), (n >>= Rn);
      return i;
    },
    precomputeWindow(r, n) {
      const { windows: i, windowSize: a } = es(n, t),
        l = [];
      let o = r,
        g = o;
      for (let _ = 0; _ < i; _++) {
        (g = o), l.push(g);
        for (let B = 1; B < a; B++) (g = g.add(o)), l.push(g);
        o = g.double();
      }
      return l;
    },
    wNAF(r, n, i) {
      const { windows: a, windowSize: l } = es(r, t);
      let o = e.ZERO,
        g = e.BASE;
      const _ = BigInt(2 ** r - 1),
        B = 2 ** r,
        N = BigInt(r);
      for (let I = 0; I < a; I++) {
        const S = I * l;
        ...
        const $ = S,
          ...
          W = I % 2 !== 0,
          K = m < 0;
        m === 0 ? (g = g.add(Qi(W, n[$]))) : (o = o.add(Qi(K, n[V])));
      }
      return { p: o, f: g };
    },
    wNAFUnsafe(r, n, i, a = e.ZERO) {
      const { windows: l, windowSize: o } = es(r, t),
        g = BigInt(2 ** r - 1),
        _ = 2 ** r,
        B = BigInt(r);
      for (let N = 0; N < l; N++) {
        ...
        if (i === Ta) break;
        let S = Number(i & g);
        if (((i >>= B), S > o && ((S -= _), (i += Rn)), S === 0)) continue;
        let m = n[I + Math.abs(S) - 1];
        S < 0 && (m = m.negate()), (a = a.add(m));
      }
      return a;
    },
    getPrecomputes(r, n, i) {
      let a = ts.get(n);
      return (
        a || ((a = this.precomputeWindow(n, r)), r !== 1 && ts.set(n, i(a))), a
      );
    },
    wNAFCached(r, n, i) {
      const a = rs(r);
    ...
    wNAFCachedUnsafe(r, n, i, a) {
      ...
      return l === 1
        ...
        : this.wNAFUnsafe(l, this.getPrecomputes(l, r, i), n, a);
    },
    setWindowSize(r, n) {
      Uc(n, t), Fc.set(r, n), ts.delete(r);
    },
  };
}
function kc(e, t, r, n) {
  if ((s0(r, e), a0(n, t), r.length !== n.length))
    throw new Error("arrays of points and scalars must have equal length");
  const i = e.ZERO,
    a = ln(BigInt(r.length)),
    l = a > 12 ? a - 3 : a > 4 ? a - 2 : a ? 2 : 1,
    o = (1 << l) - 1,
    g = new Array(o + 1).fill(i),
    _ = Math.floor((t.BITS - 1) / l) * l;
  let B = i;
  for (let N = _; N >= 0; N -= l) {
    g.fill(i);
    for (let S = 0; S < n.length; S++) {
      const m = n[S],
        $ = Number((m >> BigInt(N)) & BigInt(o));
      g[$] = g[$].add(r[S]);
    }
    let I = i;
    for (let S = g.length - 1, m = i; S > 0; S--)
      (m = m.add(g[S])), (I = I.add(m));
    if (((B = B.add(I)), N !== 0)) for (let S = 0; S < l; S++) B = B.double();
  }
  return B;
}
function Cc(e) {
  return (
    ...
    Object.freeze({ ...Sc(e.n, e.nBitLength), ...e, p: e.Fp.ORDER })
  );
}
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ function o0(
  e,
) {
  const t = Cc(e);
  Bn(
...
function Aa(e) {
  const t = o0(e),
    { Fp: r } = t,
    n = An(t.n, t.nBitLength),
    i =
      t.toBytes ||
      (($, V, W) => {
        const K = V.toAffine();
        return Le(Uint8Array.from([4]), r.toBytes(K.x), r.toBytes(K.y));
      }),
    a =
      t.fromBytes ||
      (($) => {
        const V = $.subarray(1),
          W = r.fromBytes(V.subarray(0, r.BYTES)),
          K = r.fromBytes(V.subarray(r.BYTES, 2 * r.BYTES));
        return { x: W, y: K };
      });
  function l($) {
    const { a: V, b: W } = t,
      K = r.sqr($),
      q = r.mul(K, $);
    return r.add(r.add(q, r.mul($, V)), W);
  }
  ...
  function g($) {
    ...
    if (V && typeof $ != "bigint") {
      if ((Ci($) && ($ = Tr($)), typeof $ != "string" || !V.includes($.length)))
        throw new Error("invalid private key");
      $ = $.padStart(W * 2, "0");
    }
    let ie;
    try {
      ie = typeof $ == "bigint" ? $ : vt(ct("private key", $, W));
    } catch {
      throw new Error(
        "invalid private key, expected hex or " + W + " bytes, got " + typeof $,
      );
    }
    return K && (ie = Ve(ie, q)), ar("private key", ie, qe, q), ie;
  }
  function _($) {
    if (!($ instanceof I)) throw new Error("ProjectivePoint expected");
  }
  const B = yn(($, V) => {
      const { px: W, py: K, pz: q } = $;
      if (r.eql(q, r.ONE)) return { x: W, y: K };
      const ie = $.is0();
      V == null && (V = ie ? r.ONE : r.inv(q));
      const C = r.mul(W, V),
        Z = r.mul(K, V),
        G = r.mul(q, V);
      if (ie) return { x: r.ZERO, y: r.ZERO };
      if (!r.eql(G, r.ONE)) throw new Error("invZ was invalid");
      return { x: C, y: Z };
    }),
    N = yn(($) => {
      if ($.is0()) {
        if (t.allowInfinityPoint && !r.is0($.py)) return;
        throw new Error("bad point: ZERO");
      }
      const { x: V, y: W } = $.toAffine();
      if (!r.isValid(V) || !r.isValid(W))
        throw new Error("bad point: x or y not FE");
      const K = r.sqr(W),
        q = l(V);
      if (!r.eql(K, q)) throw new Error("bad point: equation left != right");
      if (!$.isTorsionFree())
  ...
  class I {
    constructor(V, W, K) {
      ...
      if (K == null || !r.isValid(K)) throw new Error("z required");
      Object.freeze(this);
    }
    static fromAffine(V) {
      const { x: W, y: K } = V || {};
      if (!V || !r.isValid(W) || !r.isValid(K))
        throw new Error("invalid affine point");
      if (V instanceof I) throw new Error("projective point not allowed");
      const q = (ie) => r.eql(ie, r.ZERO);
      return q(W) && q(K) ? I.ZERO : new I(W, K, r.ONE);
    }
    get x() {
    ...
    static normalizeZ(V) {
      const W = r.invertBatch(V.map((K) => K.pz));
      return V.map((K, q) => K.toAffine(W[q])).map(I.fromAffine);
    }
    static fromHex(V) {
      const W = I.fromAffine(a(ct("pointHex", V)));
      return W.assertValidity(), W;
    }
    static fromPrivateKey(V) {
      return I.BASE.multiply(g(V));
    }
    static msm(V, W) {
      return kc(I, n, V, W);
    }
    _setWindowSize(V) {
      m.setWindowSize(this, V);
    }
    assertValidity() {
      N(this);
    }
    ...
    equals(V) {
      _(V);
      const { px: W, py: K, pz: q } = this,
        { px: ie, py: C, pz: Z } = V,
        G = r.eql(r.mul(W, Z), r.mul(ie, q)),
        Q = r.eql(r.mul(K, Z), r.mul(C, q));
      return G && Q;
    }
    negate() {
    ...
    wNAF(V) {
      return m.wNAFCached(this, V, I.normalizeZ);
    }
    multiplyUnsafe(V) {
      const { endo: W, n: K } = t;
      ar("scalar", V, mr, K);
      const q = I.ZERO;
      if (V === mr) return q;
      if (this.is0() || V === qe) return this;
      if (!W || m.hasPrecomputes(this))
        return m.wNAFCachedUnsafe(this, V, I.normalizeZ);
      let { k1neg: ie, k1: C, k2neg: Z, k2: G } = W.splitScalar(V),
        Q = q,
        re = q,
        X = this;
      for (; C > mr || G > mr; )
      ...
      return (
        ie && (Q = Q.negate()),
        Z && (re = re.negate()),
        (re = new I(r.mul(re.px, W.beta), re.py, re.pz)),
        Q.add(re)
      );
    }
    multiply(V) {
      ...
      let q, ie;
      if (W) {
        const { k1neg: C, k1: Z, k2neg: G, k2: Q } = W.splitScalar(V);
        let { p: re, f: X } = this.wNAF(Z),
          { p: de, f: fe } = this.wNAF(Q);
        (re = m.constTimeNegate(C, re)),
          (de = m.constTimeNegate(G, de)),
          (de = new I(r.mul(de.px, W.beta), de.py, de.pz)),
          (q = re.add(de)),
          (ie = X.add(fe));
      } else {
        const { p: C, f: Z } = this.wNAF(V);
        (q = C), (ie = Z);
      }
      return I.normalizeZ([q, ie])[0];
    }
    multiplyAndAddUnsafe(V, W, K) {
      const q = I.BASE,
        ie = (Z, G) =>
          G === mr || G === qe || !Z.equals(q)
            ? Z.multiplyUnsafe(G)
            : Z.multiply(G),
        C = ie(this, W).add(ie(V, K));
    ...
    clearCofactor() {
      const { h: V, clearCofactor: W } = t;
      return V === qe ? this : W ? W(I, this) : this.multiplyUnsafe(t.h);
    }
    toRawBytes(V = !0) {
      return un("isCompressed", V), this.assertValidity(), i(I, this, V);
    }
    toHex(V = !0) {
      return un("isCompressed", V), Tr(this.toRawBytes(V));
    }
  }
  (I.BASE = new I(t.Gx, t.Gy, r.ONE)), (I.ZERO = new I(r.ZERO, r.ONE, r.ZERO));
  const S = t.nBitLength,
    m = Pc(I, t.endo ? Math.ceil(S / 2) : S);
  return {
    CURVE: t,
    ProjectivePoint: I,
...
function c0(e, t) {
  const r = e.ORDER;
  let n = mr;
  for (let m = r - qe; m % Zt === mr; m /= Zt) n += qe;
  const i = n,
    a = Zt << (i - qe - qe),
    l = a * Zt,
    o = (r - qe) / l,
  ...
  let S = (m, $) => {
    ...
    K = e.mul(K, $);
    let q = e.mul(m, K);
    (q = e.pow(q, g)), (q = e.mul(q, W)), (W = e.mul(q, $)), (K = e.mul(q, m));
    let ie = e.mul(K, W);
    q = e.pow(ie, B);
    let C = e.eql(q, e.ONE);
    (W = e.mul(K, I)),
    ...
    return { isValid: C, value: K };
  };
  if (e.ORDER % Ba === wi) {
    const m = (e.ORDER - wi) / Ba,
      $ = e.sqrt(e.neg(t));
    S = (V, W) => {
      let K = e.sqr(W);
      const q = e.mul(V, W);
      ...
      const C = e.mul(ie, $),
        ...
        G = e.eql(Z, V);
      let Q = e.cmov(C, ie, G);
      return { isValid: G, value: Q };
    };
  }
  return S;
}
function Mc(e, t) {
  if ((Nc(e), !e.isValid(t.A) || !e.isValid(t.B) || !e.isValid(t.Z)))
  ...
  return (n) => {
    ...
    (i = e.sqr(n)),
      ...
      (l = e.add(a, e.ONE)),
      (l = e.mul(l, t.B)),
      (o = e.cmov(t.Z, e.neg(a), !e.eql(a, e.ZERO))),
      (o = e.mul(o, t.A)),
      (a = e.sqr(l)),
      (_ = e.sqr(o)),
      (g = e.mul(_, t.A)),
      ...
      (a = e.add(a, g)),
      (B = e.mul(i, l));
    const { isValid: I, value: S } = r(a, _);
    (N = e.mul(i, n)),
      (N = e.mul(N, S)),
      (B = e.cmov(B, l, I)),
      (N = e.cmov(N, S, I));
    const m = e.isOdd(n) === e.isOdd(N);
    return (N = e.cmov(e.neg(N), N, m)), (B = e.div(B, o)), { x: B, y: N };
  };
}
...
function l0(e) {
  const { Fp: t, Fr: r, Fp2: n, Fp6: i, Fp12: a } = e.fields,
    l = e.params.xNegative,
    o = e.params.twistType,
    g = Aa({ n: r.ORDER, ...e.G1 }),
    _ = Object.assign(
      g,
      va(g.ProjectivePoint, e.G1.mapToCurve, {
        ...e.htfDefaults,
        ...e.G1.htfDefaults,
      }),
    ),
    ...
    N = Object.assign(
      B,
      va(B.ProjectivePoint, e.G2.mapToCurve, {
        ...e.htfDefaults,
        ...e.G2.htfDefaults,
      }),
    );
  ...
  if (o === "multiplicative")
    I = (te, x, se, ue, he, ne) =>
      a.mul014(ue, te, n.mul(x, he), n.mul(se, ne));
  else if (o === "divisive")
    I = (te, x, se, ue, he, ne) =>
      a.mul034(ue, n.mul(se, ne), n.mul(x, he), te);
  else throw new Error("bls: unknown twist type");
  const S = n.div(n.ONE, n.mul(n.ONE, Na));
  function m(te, x, se, ue) {
    const he = n.sqr(se),
      ne = n.sqr(ue),
      ce = n.mulByB(n.mul(ne, $r)),
      b = n.mul(ce, $r),
      s = n.sub(n.sub(n.sqr(n.add(se, ue)), ne), he),
      h = n.sub(ce, he),
      E = n.mul(n.sqr(x), $r),
      T = n.neg(s);
    return (
      te.push([h, E, T]),
      (x = n.mul(n.mul(n.mul(n.sub(he, b), x), se), S)),
      (se = n.sub(n.sqr(n.mul(n.add(he, b), S)), n.mul(n.sqr(ce), $r))),
      (ue = n.mul(he, s)),
      { Rx: x, Ry: se, Rz: ue }
    );
  }
  function $(te, x, se, ue, he, ne) {
    const ce = n.sub(se, n.mul(ne, ue)),
      b = n.sub(x, n.mul(he, ue)),
      s = n.sub(n.mul(ce, he), n.mul(b, ne)),
      h = n.neg(ce),
      E = b;
    te.push([s, h, E]);
    const T = n.sqr(b),
      U = n.mul(T, b),
      p = n.mul(T, x),
      c = n.add(n.sub(U, n.mul(p, Na)), n.mul(n.sqr(ce), ue));
    return (
      (x = n.mul(b, c)),
      (se = n.sub(n.mul(n.sub(p, c), ce), n.mul(U, se))),
      (ue = n.mul(ue, U)),
      { Rx: x, Ry: se, Rz: ue }
    );
  }
  const V = f0(e.params.ateLoopSize),
    W = yn((te) => {
      const x = te,
        { x: se, y: ue } = x.toAffine(),
        he = se,
        ne = ue,
        ce = n.neg(ue);
      let b = he,
      ...
      for (const T of V) {
        const U = [];
        ({ Rx: b, Ry: s, Rz: h } = m(U, b, s, h)),
          T &&
            ({ Rx: b, Ry: s, Rz: h } = $(U, b, s, h, he, T === -1 ? ce : ne)),
          E.push(U);
      }
      if (e.postPrecompute) {
        const T = E[E.length - 1];
        e.postPrecompute(b, s, h, he, ne, $.bind(null, T));
      }
      return E;
    });
  function K(te, x = !1) {
    let se = a.ONE;
    if (te.length) {
      const ue = te[0][0].length;
      for (let he = 0; he < ue; he++) {
        se = a.sqr(se);
        for (const [ne, ce, b] of te)
          for (const [s, h, E] of ne[he]) se = I(s, h, E, se, ce, b);
      }
    }
    return l && (se = a.conjugate(se)), x ? a.finalExponentiate(se) : se;
  }
  function q(te, x = !0) {
    const se = [];
    _.ProjectivePoint.normalizeZ(te.map(({ g1: ue }) => ue)),
      N.ProjectivePoint.normalizeZ(te.map(({ g2: ue }) => ue));
    for (const { g1: ue, g2: he } of te) {
      if (
        ue.equals(_.ProjectivePoint.ZERO) ||
        he.equals(N.ProjectivePoint.ZERO)
      )
        throw new Error("pairing is not available for ZERO point");
      ue.assertValidity(), he.assertValidity();
      const ne = ue.toAffine();
      se.push([W(he), ne.x, ne.y]);
    }
    return K(se, x);
  }
  function ie(te, x, se = !0) {
    return q([{ g1: te, g2: x }], se);
  }
  const C = {
      randomPrivateKey: () => {
        const te = Oc(r.ORDER);
        return e0(e.randomBytes(te), r.ORDER);
      },
      calcPairingPrecomputes: W,
    },
    { ShortSignature: Z } = e.G1,
    { Signature: G } = e.G2;
  function Q(te) {
    return te instanceof _.ProjectivePoint ? te : _.ProjectivePoint.fromHex(te);
  }
  function re(te, x) {
    return te instanceof _.ProjectivePoint
      ? te
      : _.hashToCurve(ct("point", te), x);
  }
  function X(te) {
    return te instanceof N.ProjectivePoint ? te : G.fromHex(te);
  }
  function de(te, x) {
    return te instanceof N.ProjectivePoint
      ? te
      : N.hashToCurve(ct("point", te), x);
  }
  function fe(te) {
    return _.ProjectivePoint.fromPrivateKey(te).toRawBytes(!0);
  }
  function R(te) {
    return N.ProjectivePoint.fromPrivateKey(te).toRawBytes(!0);
  }
  function P(te, x, se) {
    const ue = de(te, se);
    ue.assertValidity();
    const he = ue.multiply(_.normPrivateKeyToScalar(x));
    return te instanceof N.ProjectivePoint ? he : G.toRawBytes(he);
  }
  function z(te, x, se) {
    const ue = re(te, se);
    ue.assertValidity();
    const he = ue.multiply(_.normPrivateKeyToScalar(x));
    return te instanceof _.ProjectivePoint ? he : Z.toRawBytes(he);
  }
  function M(te, x, se, ue) {
    const he = Q(se),
      ne = de(x, ue),
      ce = _.ProjectivePoint.BASE,
      b = X(te),
      s = q([
        { g1: he.negate(), g2: ne },
        { g1: ce, g2: b },
  ...
  function j(te, x, se, ue) {
    const he = X(se),
      ne = re(x, ue),
      ce = N.ProjectivePoint.BASE,
      b = Q(te),
      s = q([
        { g1: ne, g2: he },
        { g1: b, g2: ce.negate() },
  ...
  function ee(te) {
    J(te);
    const se = te.map(Q).reduce((ue, he) => ue.add(he), _.ProjectivePoint.ZERO);
    return te[0] instanceof _.ProjectivePoint
      ? (se.assertValidity(), se)
      : se.toRawBytes(!0);
  }
  function ge(te) {
    J(te);
    const se = te.map(X).reduce((ue, he) => ue.add(he), N.ProjectivePoint.ZERO);
    return te[0] instanceof N.ProjectivePoint
      ? (se.assertValidity(), se)
      : G.toRawBytes(se);
  }
  function ae(te) {
  ...
  function le(te, x, se, ue) {
    if ((J(x), se.length !== x.length))
    ...
    for (let h = 0; h < ce.length; h++) {
      const E = ce[h],
        T = ne[h];
      let U = b.get(T);
      U === void 0 && ((U = []), b.set(T, U)), U.push(E);
    }
    const s = [];
    try {
      for (const [h, E] of b) {
        const T = E.reduce((U, p) => U.add(p));
        s.push({ g1: T, g2: h });
      }
      return (
        s.push({ g1: _.ProjectivePoint.BASE.negate(), g2: he }),
        a.eql(q(s), a.ONE)
      );
    } catch {
      return !1;
  ...
  return (
    _.ProjectivePoint.BASE._setWindowSize(4),
    {
      getPublicKey: fe,
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ const d0 =
  ...
  qt = BigInt(2),
  Sa = BigInt(3);
function ns(e, t, r, n, i = 1, a) {
  const l = BigInt(a === void 0 ? n : a),
    o = r ** BigInt(n),
    g = [];
  for (let _ = 0; _ < i; _++) {
    const B = BigInt(_ + 1),
      N = [];
    for (let I = 0, S = qr; I < n; I++) {
      const m = ((B * S - B) / l) % o;
      N.push(e.pow(t, m)), (S *= r);
    }
    g.push(N);
  }
  return g;
...
function h0(e, t, r) {
  const n = t.pow(r, (e.ORDER - qr) / Sa),
    i = t.pow(r, (e.ORDER - qr) / qt);
  function a(I, S) {
    const m = t.mul(t.frobeniusMap(I, 1), n),
      $ = t.mul(t.frobeniusMap(S, 1), i);
    return [m, $];
  }
  const l = t.pow(r, (e.ORDER ** qt - qr) / Sa),
    o = t.pow(r, (e.ORDER ** qt - qr) / qt);
  if (!t.eql(o, t.neg(t.ONE))) throw new Error("psiFrobenius: PSI2_Y!==-1");
  function g(I, S) {
    return [t.mul(I, l), t.neg(S)];
  }
  const _ = (I) => (S, m) => {
      const $ = m.toAffine(),
        V = I($.x, $.y);
...
function p0(e) {
  const { ORDER: t } = e,
    ...
    i = Ql(t),
    a = r.div(r.ONE, qt),
    l = ns(r, n, r.ORDER, 2)[0],
    o = ({ c0: R, c1: P }, { c0: z, c1: M }) => ({
      c0: r.add(R, z),
      c1: r.add(P, M),
    }),
    g = ({ c0: R, c1: P }, { c0: z, c1: M }) => ({
      c0: r.sub(R, z),
      c1: r.sub(P, M),
    }),
    _ = ({ c0: R, c1: P }, z) => {
      ...
      let J = r.mul(R, M),
        ee = r.mul(P, j);
      const ge = r.sub(J, ee),
        ae = r.sub(r.mul(r.add(R, P), r.add(M, j)), r.add(J, ee));
      return { c0: ge, c1: ae };
    },
    B = ({ c0: R, c1: P }) => {
      const z = r.add(R, P),
        M = r.sub(R, P),
        j = r.add(R, R);
      return { c0: r.mul(z, M), c1: r.mul(j, P) };
    },
    N = (R) => {
    ...
    m = {
      ...
      sqrN: B,
      div: (R, P) =>
        m.mul(R, typeof P == "bigint" ? r.inv(r.create(P)) : m.inv(P)),
      inv: ({ c0: R, c1: P }) => {
      ...
      sqrt: (R) => {
        ...
        if (r.is0(z))
          return r.eql(i(r, P), r.ONE)
            ? m.create({ c0: r.sqrt(P), c1: r.ZERO })
            : m.create({ c0: r.ZERO, c1: r.sqrt(r.div(P, n)) });
        const M = r.sqrt(r.sub(r.sqr(P), r.mul(r.sqr(z), n)));
        let j = r.mul(r.add(M, P), a);
        const J = i(r, j);
        !r.is0(J) && !r.eql(J, r.ONE) && (j = r.sub(j, M));
        const ee = r.sqrt(j),
          ge = m.create({ c0: ee, c1: r.div(r.mul(z, a), ee) });
        if (!m.eql(m.sqr(ge), R)) throw new Error("Cannot find square root");
        const ae = ge,
          le = m.neg(ae),
          { re: te, im: x } = m.reim(ae),
          { re: se, im: ue } = m.reim(le);
        return x > ue || (x === ue && te > se) ? ae : le;
      },
      isOdd: (R) => {
        const { re: P, im: z } = m.reim(R),
          M = P % qt,
          j = P === d0,
          J = z % qt;
        return BigInt(M || (j && J)) == qr;
      },
      fromBytes(R) {
        if (R.length !== m.BYTES)
          throw new Error("fromBytes invalid length=" + R.length);
        return {
      ...
      cmov: ({ c0: R, c1: P }, { c0: z, c1: M }, j) => ({
        c0: r.cmov(R, z, j),
        c1: r.cmov(P, M, j),
      }),
      reim: ({ c0: R, c1: P }) => ({ re: R, im: P }),
      mulByNonresidue: ({ c0: R, c1: P }) => m.mul({ c0: R, c1: P }, S),
      mulByB: e.Fp2mulByB,
      fromBigTuple: N,
    ...
    $ = ({ c0: R, c1: P, c2: z }, { c0: M, c1: j, c2: J }) => ({
      c0: m.add(R, M),
      c1: m.add(P, j),
      c2: m.add(z, J),
    }),
    V = ({ c0: R, c1: P, c2: z }, { c0: M, c1: j, c2: J }) => ({
      c0: m.sub(R, M),
      c1: m.sub(P, j),
      c2: m.sub(z, J),
    }),
    W = ({ c0: R, c1: P, c2: z }, M) => {
      if (typeof M == "bigint")
        return { c0: m.mul(R, M), c1: m.mul(P, M), c2: m.mul(z, M) };
      const { c0: j, c1: J, c2: ee } = M,
        ge = m.mul(R, j),
        ae = m.mul(P, J),
        le = m.mul(z, ee);
      return {
        c0: m.add(
          ge,
          m.mulByNonresidue(
            m.sub(m.mul(m.add(P, z), m.add(J, ee)), m.add(ae, le)),
          ),
        ),
        c1: m.add(
          m.sub(m.mul(m.add(R, P), m.add(j, J)), m.add(ge, ae)),
          m.mulByNonresidue(le),
        ),
        c2: m.sub(m.add(ae, m.mul(m.add(R, z), m.add(j, ee))), m.add(ge, le)),
      };
    },
    K = ({ c0: R, c1: P, c2: z }) => {
      let M = m.sqr(R),
        j = m.mul(m.mul(R, P), qt),
        J = m.mul(m.mul(P, z), qt),
        ee = m.sqr(z);
      return {
        c0: m.add(m.mulByNonresidue(J), M),
        c1: m.add(m.mulByNonresidue(ee), j),
        c2: m.sub(
          m.sub(m.add(m.add(j, m.sqr(m.add(m.sub(R, P), z))), J), M),
          ee,
        ),
      };
    },
    [q, ie] = ns(m, S, r.ORDER, 6, 2, 3),
    C = {
      ORDER: m.ORDER,
      BITS: 3 * m.BITS,
      BYTES: 3 * m.BYTES,
      ...
      isValid: ({ c0: R, c1: P, c2: z }) =>
        m.isValid(R) && m.isValid(P) && m.isValid(z),
      is0: ({ c0: R, c1: P, c2: z }) => m.is0(R) && m.is0(P) && m.is0(z),
      neg: ({ c0: R, c1: P, c2: z }) => ({
        c0: m.neg(R),
        c1: m.neg(P),
        c2: m.neg(z),
      }),
      eql: ({ c0: R, c1: P, c2: z }, { c0: M, c1: j, c2: J }) =>
        m.eql(R, M) && m.eql(P, j) && m.eql(z, J),
      sqrt: ma,
      div: (R, P) =>
        C.mul(R, typeof P == "bigint" ? r.inv(r.create(P)) : C.inv(P)),
      pow: (R, P) => Ln(C, R, P),
      invertBatch: (R) => Hn(C, R),
      add: $,
      sub: V,
      mul: W,
      sqr: K,
      ...
      sqrN: K,
      inv: ({ c0: R, c1: P, c2: z }) => {
        let M = m.sub(m.sqr(R), m.mulByNonresidue(m.mul(z, P))),
          j = m.sub(m.mulByNonresidue(m.sqr(z)), m.mul(R, P)),
          J = m.sub(m.sqr(P), m.mul(R, z)),
          ee = m.inv(
            m.add(
              m.mulByNonresidue(m.add(m.mul(z, j), m.mul(P, J))),
              m.mul(R, M),
            ),
          );
        return { c0: m.mul(ee, M), c1: m.mul(ee, j), c2: m.mul(ee, J) };
      },
      fromBytes: (R) => {
        if (R.length !== C.BYTES)
          throw new Error("fromBytes invalid length=" + R.length);
      ...
      toBytes: ({ c0: R, c1: P, c2: z }) =>
        Le(m.toBytes(R), m.toBytes(P), m.toBytes(z)),
      cmov: ({ c0: R, c1: P, c2: z }, { c0: M, c1: j, c2: J }, ee) => ({
        c0: m.cmov(R, M, ee),
        c1: m.cmov(P, j, ee),
        c2: m.cmov(z, J, ee),
      }),
      ...
      frobeniusMap: ({ c0: R, c1: P, c2: z }, M) => ({
        c0: m.frobeniusMap(R, M),
        c1: m.mul(m.frobeniusMap(P, M), q[M % 6]),
        c2: m.mul(m.frobeniusMap(z, M), ie[M % 6]),
      }),
      ...
      mulByNonresidue: ({ c0: R, c1: P, c2: z }) => ({
        c0: m.mulByNonresidue(z),
        c1: R,
        c2: P,
      }),
      mul1: ({ c0: R, c1: P, c2: z }, M) => ({
        c0: m.mulByNonresidue(m.mul(z, M)),
        c1: m.mul(R, M),
        c2: m.mul(P, M),
      }),
      mul01({ c0: R, c1: P, c2: z }, M, j) {
        let J = m.mul(R, M),
          ee = m.mul(P, j);
        return {
          c0: m.add(m.mulByNonresidue(m.sub(m.mul(m.add(P, z), j), ee)), J),
          c1: m.sub(m.sub(m.mul(m.add(M, j), m.add(R, P)), J), ee),
          c2: m.add(m.sub(m.mul(m.add(R, z), M), J), ee),
        };
      },
    },
    Z = ns(m, S, r.ORDER, 12, 1, 6)[0],
    G = ({ c0: R, c1: P }, { c0: z, c1: M }) => ({
      c0: C.add(R, z),
      c1: C.add(P, M),
    }),
    ...
    re = ({ c0: R, c1: P }, z) => {
      if (typeof z == "bigint") return { c0: C.mul(R, z), c1: C.mul(P, z) };
      let { c0: M, c1: j } = z,
        J = C.mul(R, M),
        ee = C.mul(P, j);
      return {
        c0: C.add(J, C.mulByNonresidue(ee)),
        c1: C.sub(C.mul(C.add(R, P), C.add(M, j)), C.add(J, ee)),
      };
    },
    X = ({ c0: R, c1: P }) => {
      let z = C.mul(R, P);
      return {
        c0: C.sub(
          C.sub(C.mul(C.add(C.mulByNonresidue(P), R), C.add(R, P)), z),
          C.mulByNonresidue(z),
        ),
        c1: C.add(z, z),
      };
  ...
  function de(R, P) {
    const z = m.sqr(R),
      M = m.sqr(P);
    return {
      first: m.add(m.mulByNonresidue(M), z),
      second: m.sub(m.sub(m.sqr(m.add(R, P)), z), M),
    };
  }
  const fe = {
    ORDER: m.ORDER,
    ...
    BYTES: 2 * m.BYTES,
    MASK: jn(2 * m.BITS),
    ZERO: { c0: C.ZERO, c1: C.ZERO },
    ONE: { c0: C.ONE, c1: C.ZERO },
    create: (R) => R,
    isValid: ({ c0: R, c1: P }) => C.isValid(R) && C.isValid(P),
    is0: ({ c0: R, c1: P }) => C.is0(R) && C.is0(P),
    neg: ({ c0: R, c1: P }) => ({ c0: C.neg(R), c1: C.neg(P) }),
    eql: ({ c0: R, c1: P }, { c0: z, c1: M }) => C.eql(R, z) && C.eql(P, M),
    sqrt: ma,
    inv: ({ c0: R, c1: P }) => {
      let z = C.inv(C.sub(C.sqr(R), C.mulByNonresidue(C.sqr(P))));
      return { c0: C.mul(R, z), c1: C.neg(C.mul(P, z)) };
    },
    div: (R, P) =>
      fe.mul(R, typeof P == "bigint" ? r.inv(r.create(P)) : fe.inv(P)),
    pow: (R, P) => Ln(fe, R, P),
    invertBatch: (R) => Hn(fe, R),
    add: G,
    sub: Q,
    mul: re,
    sqr: X,
    ...
    sqrN: X,
    fromBytes: (R) => {
      if (R.length !== fe.BYTES)
        throw new Error("fromBytes invalid length=" + R.length);
      return {
        c0: C.fromBytes(R.subarray(0, C.BYTES)),
        c1: C.fromBytes(R.subarray(C.BYTES)),
      };
    },
    toBytes: ({ c0: R, c1: P }) => Le(C.toBytes(R), C.toBytes(P)),
    cmov: ({ c0: R, c1: P }, { c0: z, c1: M }, j) => ({
      c0: C.cmov(R, z, j),
      c1: C.cmov(P, M, j),
    }),
    fromBigTwelve: (R) => ({
      c0: C.fromBigSix(R.slice(0, 6)),
      c1: C.fromBigSix(R.slice(6, 12)),
    }),
    frobeniusMap(R, P) {
      const { c0: z, c1: M, c2: j } = C.frobeniusMap(R.c1, P),
        J = Z[P % 12];
      return {
        c0: C.frobeniusMap(R.c0, P),
        c1: C.create({ c0: m.mul(z, J), c1: m.mul(M, J), c2: m.mul(j, J) }),
      };
    },
    ...
    conjugate: ({ c0: R, c1: P }) => ({ c0: R, c1: C.neg(P) }),
    mul014: ({ c0: R, c1: P }, z, M, j) => {
      let J = C.mul01(R, z, M),
        ee = C.mul1(P, j);
      return {
        c0: C.add(C.mulByNonresidue(ee), J),
        c1: C.sub(C.sub(C.mul01(C.add(P, R), z, m.add(M, j)), J), ee),
      };
    },
    mul034: ({ c0: R, c1: P }, z, M, j) => {
      const J = C.create({
          c0: m.mul(R.c0, z),
          c1: m.mul(R.c1, z),
          c2: m.mul(R.c2, z),
        ...
        ee = C.mul01(P, M, j),
        ge = C.mul01(C.add(R, P), m.add(z, M), j);
      return {
        c0: C.add(C.mulByNonresidue(ee), J),
        c1: C.sub(ge, C.add(J, ee)),
      };
    },
  ...
  return { Fp: r, Fp2: m, Fp6: C, Fp4Square: de, Fp12: fe };
}
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ const ot =
  ...
  y0 = ln(rr),
  {
    ...
    Fp12cyclotomicSquare: ({ c0: e, c1: t }) => {
      const { c0: r, c1: n, c2: i } = e,
        { c0: a, c1: l, c2: o } = t,
        { first: g, second: _ } = is(r, l),
        { first: B, second: N } = is(a, i),
        { first: I, second: S } = is(n, o),
        m = be.mulByNonresidue(S);
      return {
        c0: Ss.create({
          c0: be.add(be.mul(be.sub(g, r), Ze), g),
          c1: be.add(be.mul(be.sub(B, n), Ze), B),
          c2: be.add(be.mul(be.sub(I, i), Ze), I),
        }),
        c1: Ss.create({
          c0: be.add(be.mul(be.add(m, a), Ze), m),
          c1: be.add(be.mul(be.add(_, l), Ze), _),
          c2: be.add(be.mul(be.add(N, o), Ze), N),
        }),
      };
    },
    Fp12cyclotomicExp(e, t) {
      let r = Ne.ONE;
      for (let n = y0 - 1; n >= 0; n--)
        (r = Ne._cyclotomicSquare(r)), Dl(t, n) && (r = Ne.mul(r, e));
      return r;
    },
    Fp12finalExponentiate: (e) => {
      const t = rr,
        ...
        l = Ne.conjugate(Ne._cyclotomicExp(a, t)),
        o = Ne.conjugate(Ne._cyclotomicExp(l, t)),
        g = Ne.mul(
          Ne.conjugate(Ne._cyclotomicExp(o, t)),
          Ne._cyclotomicSquare(i),
        ),
        _ = Ne.conjugate(Ne._cyclotomicExp(g, t)),
        B = Ne.frobeniusMap(Ne.mul(i, o), 2),
        N = Ne.frobeniusMap(Ne.mul(l, n), 3),
        I = Ne.frobeniusMap(Ne.mul(g, Ne.conjugate(n)), 1),
        S = Ne.mul(Ne.mul(_, Ne.conjugate(a)), n);
  ...
  m0 = Mc(be, {
    A: be.create({ c0: we.create(ot), c1: we.create(BigInt(240)) }),
    B: be.create({ c0: we.create(BigInt(1012)), c1: we.create(BigInt(1012)) }),
    Z: be.create({ c0: we.create(BigInt(-2)), c1: we.create(BigInt(-1)) }),
  }),
  b0 = Mc(we, {
    A: we.create(
      BigInt(
  ...
  { G2psi: Oa, G2psi2: _0 } = h0(we, be, be.div(be.ONE, be.NONRESIDUE)),
  ss = Object.freeze({
  ...
  bi = wn(we.toBytes(ot), { infinity: !0, compressed: !0 });
function Pn(e) {
  e = e.slice();
  const t = e[0] & 224,
    r = !!((t >> 7) & 1),
...
function Ra(e) {
  ...
  const t = e.equals(pt.G1.ProjectivePoint.ZERO),
    { x: r, y: n } = e.toAffine();
  if (t) return bi.slice();
  const i = we.ORDER,
    a = !!((n * Ze) / i);
  return wn(Qe(r, we.BYTES), { compressed: !0, sort: a });
}
function Ua(e) {
  e.assertValidity();
  const t = we.BYTES;
  if (e.equals(pt.G2.ProjectivePoint.ZERO)) return Le(bi, Qe(ot, t));
  const { x: r, y: n } = e.toAffine(),
    { re: i, im: a } = be.reim(r),
    { re: l, im: o } = be.reim(n),
    _ = !!(((o > ot ? o * Ze : l * Ze) / we.ORDER) & mi),
    B = i;
  return Le(wn(Qe(a, t), { sort: _, compressed: !0 }), Qe(B, t));
}
const pt = l0({
  fields: { Fp: we, Fp2: be, Fp6: Ss, Fp12: Ne, Fr: Ia },
  G1: {
    Fp: we,
    ...
    isTorsionFree: (e, t) => {
      const r = BigInt(
        ...
        n = new e(we.mul(t.px, r), t.py, t.pz);
      return t.multiplyUnsafe(rr).negate().multiplyUnsafe(rr).equals(n);
    },
    clearCofactor: (e, t) => t.multiplyUnsafe(rr).add(t),
    mapToCurve: (e) => {
      const { x: t, y: r } = b0(we.create(e[0]));
      return w0(t, r);
    },
    fromBytes: (e) => {
      const { compressed: t, infinity: r, sort: n, value: i } = Pn(e);
      if (i.length === 48 && t) {
        const a = we.ORDER,
          l = vt(i),
          o = we.create(l & we.MASK);
        if (r) {
          if (o !== ot)
            throw new Error("G1: non-empty compressed point at infinity");
          return { x: ot, y: ot };
        }
        const g = we.add(we.pow(o, Fn), we.create(pt.params.G1b));
        let _ = we.sqrt(g);
        if (!_) throw new Error("invalid compressed G1 point");
        return (
          (_ * Ze) / a !== BigInt(n) && (_ = we.neg(_)),
          { x: we.create(o), y: we.create(_) }
        );
      } else if (i.length === 96 && !t) {
        const a = vt(i.subarray(0, we.BYTES)),
          l = vt(i.subarray(we.BYTES));
        if (r) {
          if (a !== ot || l !== ot)
            throw new Error("G1: non-empty point at infinity");
          return pt.G1.ProjectivePoint.ZERO.toAffine();
        }
        return { x: we.create(a), y: we.create(l) };
    ...
    toBytes: (e, t, r) => {
      ...
      if (r) {
        ...
        const l = we.ORDER,
          o = !!((a * Ze) / l);
        return wn(Qe(i, we.BYTES), { compressed: !0, sort: o });
      } else
        return n
          ? Le(new Uint8Array([64]), new Uint8Array(2 * we.BYTES - 1))
          : Le(Qe(i, we.BYTES), Qe(a, we.BYTES));
    },
    ShortSignature: {
      fromHex(e) {
        const {
            ...
            sort: r,
            value: n,
          } = Pn(ct("signatureHex", e, 48)),
          i = we.ORDER,
          a = vt(n);
        if (t) return pt.G1.ProjectivePoint.ZERO;
        const l = we.create(a & we.MASK),
          o = we.add(we.pow(l, Fn), we.create(pt.params.G1b));
        let g = we.sqrt(o);
        if (!g) throw new Error("invalid compressed G1 point");
        const _ = BigInt(r);
        (g * Ze) / i !== _ && (g = we.neg(g));
        const B = pt.G1.ProjectivePoint.fromAffine({ x: l, y: g });
  ...
  G2: {
    ...
    allowInfinityPoint: !0,
    mapToCurve: (e) => {
      const { x: t, y: r } = m0(be.fromBigTuple(e));
      return g0(t, r);
    },
    isTorsionFree: (e, t) => t.multiplyUnsafe(rr).negate().equals(Oa(e, t)),
    clearCofactor: (e, t) => {
      const r = rr;
    ...
    fromBytes: (e) => {
      ...
      const a = we.BYTES,
        l = (o, g, _) => vt(o.slice(g, _));
      if (i.length === 96 && t) {
        const o = pt.params.G2b,
          g = we.ORDER;
        if (r) {
          if (i.reduce(($, V) => ($ !== 0 ? V + 1 : V), 0) > 0)
            throw new Error("invalid compressed G2 point");
          return { x: be.ZERO, y: be.ZERO };
        }
        const _ = l(i, 0, a),
          B = l(i, a, 2 * a),
          N = be.create({ c0: we.create(B), c1: we.create(_) }),
          I = be.add(be.pow(N, Fn), o);
        let S = be.sqrt(I);
        const m = S.c1 === ot ? (S.c0 * Ze) / g : (S.c1 * Ze) / g ? mi : ot;
        return (S = n && m > 0 ? S : be.neg(S)), { x: N, y: S };
        ...
        const o = l(i, 0, a),
          ...
          _ = l(i, 2 * a, 3 * a),
          B = l(i, 3 * a, 4 * a);
        return { x: be.fromBigTuple([g, o]), y: be.fromBigTuple([B, _]) };
    ...
    toBytes: (e, t, r) => {
      const { BYTES: n, ORDER: i } = we,
        ...
        { x: l, y: o } = t.toAffine();
      if (r) {
        if (a) return Le(bi, Qe(ot, n));
        const g = !!(o.c1 === ot ? (o.c0 * Ze) / i : (o.c1 * Ze) / i);
        return Le(wn(Qe(l.c1, n), { compressed: !0, sort: g }), Qe(l.c0, n));
      } else {
        if (a) return Le(new Uint8Array([64]), new Uint8Array(4 * n - 1));
        const { re: g, im: _ } = be.reim(l),
          { re: B, im: N } = be.reim(o);
        return Le(Qe(_, n), Qe(g, n), Qe(N, n), Qe(B, n));
      }
    },
    Signature: {
      fromHex(e) {
        const { infinity: t, sort: r, value: n } = Pn(ct("signatureHex", e)),
          i = we.ORDER,
          a = n.length / 2;
        if (a !== 48 && a !== 96)
          throw new Error(
        ...
        const l = vt(n.slice(0, a)),
          o = vt(n.slice(a));
        if (t) return pt.G2.ProjectivePoint.ZERO;
        const g = we.create(l & we.MASK),
          _ = we.create(o),
          B = be.create({ c0: _, c1: g }),
          N = be.add(be.pow(B, Fn), pt.params.G2b);
        let I = be.sqrt(N);
        if (!I) throw new Error("Failed to find a square root");
        const { re: S, im: m } = be.reim(I),
          $ = BigInt(r),
          V = m > ot && (m * Ze) / i !== $,
          W = m === ot && (S * Ze) / i !== $;
        (V || W) && (I = be.neg(I));
        const K = pt.G2.ProjectivePoint.fromAffine({ x: B, y: I });
...
class _r {
  constructor(t, r, n, i, a = 5) {
    (this._rootKey = r),
      ...
      (this.cert = jt(new Uint8Array(t)));
  }
  static async create(t) {
    const r = _r.createUnverified(t);
  ...
  static createUnverified(t) {
    ...
    return (
      r || (r = x0),
      new _r(t.certificate, t.rootKey, t.canisterId, r, t.maxAgeInMinutes)
    );
  }
  lookup(t) {
    return Kr(t, this.cert.tree);
  }
  lookup_label(t) {
    return this.lookup([t]);
  }
  async verify() {
    const t = await Dn(this.cert.tree),
      r = await this._checkDelegationAndGetKey(this.cert.delegation),
      n = this.cert.signature,
      i = T0(r),
      a = Bt(tn("ic-state-root"), t);
    let l = !1;
    const o = gt(this.lookup(["time"]));
    if (!o) throw new Pt("Certificate does not contain a time");
    const g = 5 * 60 * 1e3,
      _ = this._maxAgeInMinutes * 60 * 1e3,
      B = Date.now(),
      N = B - _,
      I = B + g,
      S = Zs(o);
    ...
    if (!l) throw new Pt("Signature verification failed");
  }
  async _checkDelegationAndGetKey(t) {
    ...
    if (r.cert.delegation)
      throw new Pt("Delegation certificates cannot be nested");
    if (
      (await r.verify(),
      this._canisterId.toString() !== wd &&
        !$c({
          canisterId: this._canisterId,
...
const Xr = Ht(
  ...
  v0 = 96;
function T0(e) {
  const t = Xr.byteLength + v0;
  if (e.byteLength !== t)
    throw new TypeError(`BLS DER-encoded public key must be ${t} bytes long`);
  const r = e.slice(0, Xr.byteLength);
  if (!Ni(r, Xr))
    throw new TypeError(
      `BLS DER-encoded public key is invalid. Expect the following prefix: ${Xr}, but get ${r}`,
    );
  return e.slice(Xr.byteLength);
}
function gt(e) {
...
async function Dn(e) {
  switch (e[0]) {
    case dt.Empty:
      return Tt(tn("ic-hashtree-empty"));
    case dt.Pruned:
      return e[1];
    case dt.Leaf:
      return Tt(Bt(tn("ic-hashtree-leaf"), e[1]));
    case dt.Labeled:
      return Tt(Bt(tn("ic-hashtree-labeled"), e[1], await Dn(e[2])));
    case dt.Fork:
      return Tt(Bt(tn("ic-hashtree-fork"), await Dn(e[1]), await Dn(e[2])));
    default:
  ...
  switch (t[0]) {
    ...
    case dt.Fork:
      ...
      switch (r.status) {
        case Gt.Greater: {
          const n = Kn(e, t[2]);
          return n.status === Gt.Less ? { status: He.Absent } : n;
        }
        case He.Unknown: {
          let n = Kn(e, t[2]);
          return n.status === Gt.Less ? { status: He.Unknown } : n;
        }
        default:
          return r;
      }
...
function $c(e) {
  const { canisterId: t, subnetId: r, tree: n } = e,
    i = Kr(["subnet", r.toUint8Array(), "canister_ranges"], n);
  if (i.status !== He.Found || !(i.value instanceof ArrayBuffer))
    throw new Error(`Could not find canister ranges for subnet ${r}`);
  return jt(i.value)
    .map((g) => [Te.fromUint8Array(g[0]), Te.fromUint8Array(g[1])])
    .some((g) => g[0].ltEq(t) && g[1].gtEq(t));
}
class B0 {
  constructor(t, r, n) {
...
const qc = async (e) => {
    const { agent: t, paths: r } = e,
      ...
      o = i.map((g, _) =>
        (async () => {
          var B;
          try {
            const N = await t.readState(n, { paths: [a[_]] }),
              I = await _r.create({
              ...
              S = (V, W) => {
                if (W === "subnet") {
                  const K = Gc(N.certificate, n, t.rootKey);
                  return { path: W, data: K };
                } else return { path: W, data: gt(V.lookup(Os(W, n))) };
              },
              { path: m, data: $ } = S(I, i[_]);
            if (!$)
              console.warn(
                ...
                typeof m == "string" ? l.set(m, null) : l.set(m.key, null);
            else
              switch (m) {
                case "time": {
                  l.set(m, Zs($));
                ...
                case "candid": {
                  l.set(m, new TextDecoder().decode($));
                  break;
                }
                default:
            ...
            typeof g != "string" && "key" in g && "path" in g
              ? l.set(g.key, null)
              : l.set(g, null),
              console.group(),
              console.warn(
    ...
    return await Promise.all(o), l;
  },
  Gc = (e, t, r) => {
    if (!t._isPrincipal) throw new Error("Invalid canisterId");
    const n = jt(new Uint8Array(e)),
      i = n.tree;
    let a = n.delegation,
      l;
    if (
      (a && a.subnet_id
        ? (l = Te.fromUint8Array(new Uint8Array(a.subnet_id)))
        : !a && typeof r < "u"
          ? ((l = Te.selfAuthenticating(new Uint8Array(r))),
            (a = {
              subnet_id: l.toUint8Array(),
              certificate: new ArrayBuffer(0),
            }))
          : ((l = Te.selfAuthenticating(
              Te.fromText(
      ...
      !$c({ canisterId: t, subnetId: l, tree: i }))
    )
      throw new Error("Canister not in range");
    const g = Kr(["subnet", a.subnet_id, "node"], i);
    if (g.status !== He.Found) throw new Error("Node not found");
    if (g.value instanceof ArrayBuffer) throw new Error("Invalid node tree");
    const _ = Is(g.value),
      B = new Map();
    return (
      _.forEach((N) => {
  ...
  Fa = (e) => et(e),
  jc = (e) => jt(e),
  A0 = (e) => new TextDecoder().decode(e),
  N0 = (e) => jc(e).map((r) => Te.fromUint8Array(new Uint8Array(r))),
  S0 = Object.freeze(
    Object.defineProperty(
      {
        __proto__: null,
...
function Lc(e, t = !1) {
  return t
    ? { h: Number(e & kn), l: Number((e >> Rs) & kn) }
    : { h: Number((e >> Rs) & kn) | 0, l: Number(e & kn) | 0 };
}
function I0(e, t = !1) {
  let r = new Uint32Array(e.length),
    n = new Uint32Array(e.length);
  for (let i = 0; i < e.length; i++) {
    const { h: a, l } = Lc(e[i], t);
    [r[i], n[i]] = [a, l];
  }
  return [r, n];
}
const O0 = (e, t) => (BigInt(e >>> 0) << Rs) | BigInt(t >>> 0),
  R0 = (e, t, r) => e >>> r,
  U0 = (e, t, r) => (e << (32 - r)) | (t >>> r),
  F0 = (e, t, r) => (e >>> r) | (t << (32 - r)),
  P0 = (e, t, r) => (e << (32 - r)) | (t >>> r),
  k0 = (e, t, r) => (e << (64 - r)) | (t >>> (r - 32)),
  C0 = (e, t, r) => (e >>> (r - 32)) | (t << (64 - r)),
  M0 = (e, t) => t,
  V0 = (e, t) => e,
  $0 = (e, t, r) => (e << r) | (t >>> (32 - r)),
  q0 = (e, t, r) => (t << r) | (e >>> (32 - r)),
  G0 = (e, t, r) => (t << (r - 32)) | (e >>> (64 - r)),
  j0 = (e, t, r) => (e << (r - 32)) | (t >>> (64 - r));
function L0(e, t, r, n) {
  const i = (t >>> 0) + (n >>> 0);
  return { h: (e + r + ((i / 2 ** 32) | 0)) | 0, l: i | 0 };
}
const H0 = (e, t, r) => (e >>> 0) + (t >>> 0) + (r >>> 0),
  D0 = (e, t, r, n) => (t + r + n + ((e / 2 ** 32) | 0)) | 0,
  K0 = (e, t, r, n) => (e >>> 0) + (t >>> 0) + (r >>> 0) + (n >>> 0),
  z0 = (e, t, r, n, i) => (t + r + n + i + ((e / 2 ** 32) | 0)) | 0,
  W0 = (e, t, r, n, i) =>
    (e >>> 0) + (t >>> 0) + (r >>> 0) + (n >>> 0) + (i >>> 0),
  Y0 = (e, t, r, n, i, a) => (t + r + n + i + a + ((e / 2 ** 32) | 0)) | 0,
  Be = {
    fromBig: Lc,
    split: I0,
    toBig: O0,
...
class J0 extends Ec {
  ...
  get() {
    ...
    return [t, r, n, i, a, l, o, g, _, B, N, I, S, m, $, V];
  }
  set(t, r, n, i, a, l, o, g, _, B, N, I, S, m, $, V) {
    (this.Ah = t | 0),
      (this.Al = r | 0),
      (this.Bh = n | 0),
      (this.Bl = i | 0),
  ...
  process(t, r) {
    for (let q = 0; q < 16; q++, r += 4)
      (Xt[q] = t.getUint32(r)), (Jt[q] = t.getUint32((r += 4)));
    for (let q = 16; q < 80; q++) {
      const ie = Xt[q - 15] | 0,
        C = Jt[q - 15] | 0,
        Z = Be.rotrSH(ie, C, 1) ^ Be.rotrSH(ie, C, 8) ^ Be.shrSH(ie, C, 7),
        G = Be.rotrSL(ie, C, 1) ^ Be.rotrSL(ie, C, 8) ^ Be.shrSL(ie, C, 7),
        Q = Xt[q - 2] | 0,
        re = Jt[q - 2] | 0,
        X = Be.rotrSH(Q, re, 19) ^ Be.rotrBH(Q, re, 61) ^ Be.shrSH(Q, re, 6),
        de = Be.rotrSL(Q, re, 19) ^ Be.rotrBL(Q, re, 61) ^ Be.shrSL(Q, re, 6),
        fe = Be.add4L(G, de, Jt[q - 7], Jt[q - 16]),
        R = Be.add4H(fe, Z, X, Xt[q - 7], Xt[q - 16]);
      (Xt[q] = R | 0), (Jt[q] = fe | 0);
    }
    let {
      Ah: n,
    ...
    for (let q = 0; q < 80; q++) {
      const ie =
          Be.rotrSH(N, I, 14) ^ Be.rotrSH(N, I, 18) ^ Be.rotrBH(N, I, 41),
        C = Be.rotrSL(N, I, 14) ^ Be.rotrSL(N, I, 18) ^ Be.rotrBL(N, I, 41),
        Z = (N & S) ^ (~N & $),
        G = (I & m) ^ (~I & V),
        Q = Be.add5L(K, C, G, X0[q], Jt[q]),
        re = Be.add5H(Q, W, ie, Z, Z0[q], Xt[q]),
        X = Q | 0,
        de = Be.rotrSH(n, i, 28) ^ Be.rotrBH(n, i, 34) ^ Be.rotrBH(n, i, 39),
        fe = Be.rotrSL(n, i, 28) ^ Be.rotrBL(n, i, 34) ^ Be.rotrBL(n, i, 39),
        R = (n & a) ^ (n & o) ^ (a & o),
        P = (i & l) ^ (i & g) ^ (l & g);
      (W = $ | 0),
        (K = V | 0),
        ...
        (S = N | 0),
        (m = I | 0),
        ({ h: N, l: I } = Be.add(_ | 0, B | 0, re | 0, X | 0)),
        (_ = o | 0),
        (B = g | 0),
        (o = a | 0),
        (g = l | 0),
        (a = n | 0),
        (l = i | 0);
      const z = Be.add3L(X, fe, P);
      (n = Be.add3H(z, re, de, R)), (i = z | 0);
    }
    ({ h: n, l: i } = Be.add(this.Ah | 0, this.Al | 0, n | 0, i | 0)),
      ({ h: a, l } = Be.add(this.Bh | 0, this.Bl | 0, a | 0, l | 0)),
      ({ h: o, l: g } = Be.add(this.Ch | 0, this.Cl | 0, o | 0, g | 0)),
      ({ h: _, l: B } = Be.add(this.Dh | 0, this.Dl | 0, _ | 0, B | 0)),
      ({ h: N, l: I } = Be.add(this.Eh | 0, this.El | 0, N | 0, I | 0)),
      ({ h: S, l: m } = Be.add(this.Fh | 0, this.Fl | 0, S | 0, m | 0)),
      ({ h: $, l: V } = Be.add(this.Gh | 0, this.Gl | 0, $ | 0, V | 0)),
      ({ h: W, l: K } = Be.add(this.Hh | 0, this.Hl | 0, W | 0, K | 0)),
      this.set(n, i, a, l, o, g, _, B, N, I, S, m, $, V, W, K);
  }
  roundClean() {
    Xt.fill(0), Jt.fill(0);
  }
...
function nd(e) {
  const t = rd(e),
    { Fp: r, n, prehash: i, hash: a, randomBytes: l, nByteLength: o, h: g } = t,
    _ = Cn << (BigInt(o * 8) - ft),
    B = r.create,
    N = An(t.n, t.nBitLength),
    I =
      ...
      ((M, j) => {
        try {
          return { isValid: !0, value: r.sqrt(M * r.inv(j)) };
        } catch {
    ...
    m =
      t.domain ||
      ((M, j, J) => {
        if ((un("phflag", J), j.length || J))
          throw new Error("Contexts/pre-hash are not supported");
        return M;
      });
  function $(M, j) {
    ar("coordinate " + M, j, bt, _);
  }
  function V(M) {
    if (!(M instanceof q)) throw new Error("ExtendedPoint expected");
  }
  const W = yn((M, j) => {
      const { ex: J, ey: ee, ez: ge } = M,
        ae = M.is0();
      j == null && (j = ae ? ed : r.inv(ge));
      const le = B(J * j),
        te = B(ee * j),
        x = B(ge * j);
      if (ae) return { x: bt, y: ft };
      if (x !== ft) throw new Error("invZ was invalid");
      return { x: le, y: te };
    }),
    K = yn((M) => {
      const { a: j, d: J } = t;
      if (M.is0()) throw new Error("bad point: ZERO");
      const { ex: ee, ey: ge, ez: ae, et: le } = M,
        te = B(ee * ee),
        x = B(ge * ge),
        se = B(ae * ae),
        ue = B(se * se),
        ...
        ne = B(se * B(he + x)),
        ce = B(ue + B(J * B(te * x)));
      if (ne !== ce) throw new Error("bad point: equation left != right (1)");
      const b = B(ee * ge),
        s = B(ae * le);
      if (b !== s) throw new Error("bad point: equation left != right (2)");
      return !0;
    });
  class q {
    constructor(j, J, ee, ge) {
      (this.ex = j),
        (this.ey = J),
        (this.ez = ee),
        (this.et = ge),
    ...
    static fromAffine(j) {
      if (j instanceof q) throw new Error("extended point not allowed");
      const { x: J, y: ee } = j || {};
      return $("x", J), $("y", ee), new q(J, ee, ft, B(J * ee));
    }
    static normalizeZ(j) {
      const J = r.invertBatch(j.map((ee) => ee.ez));
      return j.map((ee, ge) => ee.toAffine(J[ge])).map(q.fromAffine);
    }
    static msm(j, J) {
      return kc(q, N, j, J);
    }
    _setWindowSize(j) {
      Z.setWindowSize(this, j);
    }
    assertValidity() {
      K(this);
    }
    ...
    double() {
      const { a: j } = t,
        ...
        h = B(ue * ce),
        E = B(ne * he);
      return new q(b, s, E, h);
    }
    add(j) {
      V(j);
      const { a: J, d: ee } = t,
        { ex: ge, ey: ae, ez: le, et: te } = this,
        { ex: x, ey: se, ez: ue, et: he } = j;
      if (J === BigInt(-1)) {
        const v = B((ae - ge) * (se + x)),
          O = B((ae + ge) * (se - x)),
          L = B(O - v);
        if (L === bt) return this.double();
        const Y = B(le * Cn * he),
          oe = B(te * Cn * ue),
          pe = oe + Y,
          me = O + v,
          ...
          A = B(pe * y),
          k = B(L * me);
        return new q(f, d, k, A);
      }
      const ne = B(ge * x),
        ce = B(ae * se),
        b = B(te * ee * he),
        s = B(le * ue),
        h = B((ge + ae) * (x + se) - ne - ce),
        E = s - b,
        T = s + b,
        U = B(ce - J * ne),
        p = B(h * E),
        ...
        u = B(h * U),
        w = B(E * T);
      return new q(p, c, w, u);
    }
    subtract(j) {
      return this.add(j.negate());
    }
    wNAF(j) {
      return Z.wNAFCached(this, j, q.normalizeZ);
    }
    multiply(j) {
      const J = j;
      ar("scalar", J, ft, n);
      const { p: ee, f: ge } = this.wNAF(J);
      return q.normalizeZ([ee, ge])[0];
    }
    multiplyUnsafe(j, J = q.ZERO) {
      const ee = j;
      return (
        ar("scalar", ee, bt, n),
        ee === bt
          ...
          : this.is0() || ee === ft
            ? this
            : Z.wNAFCachedUnsafe(this, ee, q.normalizeZ, J)
      );
    }
    isSmallOrder() {
    ...
    clearCofactor() {
      const { h: j } = t;
      return j === ft ? this : this.multiplyUnsafe(j);
    }
    static fromHex(j, J = !1) {
      const { d: ee, a: ge } = t,
        ae = r.BYTES;
      (j = ct("pointHex", j, ae)), un("zip215", J);
      const le = j.slice(),
        te = j[ae - 1];
      le[ae - 1] = te & -129;
      const x = fn(le),
        se = J ? _ : r.ORDER;
      ar("pointHex.y", x, bt, se);
      const ue = B(x * x),
        he = B(ue - ft),
        ne = B(ee * ue - ge);
      let { isValid: ce, value: b } = I(he, ne);
      if (!ce) throw new Error("Point.fromHex: invalid y coordinate");
      const s = (b & ft) === ft,
        h = (te & 128) !== 0;
      if (!J && b === bt && h) throw new Error("Point.fromHex: x=0 and x_0=1");
      return h !== s && (b = B(-b)), q.fromAffine({ x: b, y: x });
    }
    static fromPrivateKey(j) {
      return re(j).point;
    }
    toRawBytes() {
      const { x: j, y: J } = this.toAffine(),
        ee = gi(J, r.BYTES);
      return (ee[ee.length - 1] |= j & ft ? 128 : 0), ee;
    }
    toHex() {
      return Tr(this.toRawBytes());
    }
  }
  (q.BASE = new q(t.Gx, t.Gy, ft, B(t.Gx * t.Gy))),
    (q.ZERO = new q(bt, ft, ft, bt));
  const { BASE: ie, ZERO: C } = q,
    Z = Pc(q, o * 8);
  function G(M) {
    return Ve(M, n);
  }
  ...
  function re(M) {
    const j = r.BYTES;
    M = ct("private key", M, j);
    const J = ct("hashed private key", a(M), 2 * j),
      ee = S(J.slice(0, j)),
      ge = J.slice(j, 2 * j),
      ae = Q(ee),
      le = ie.multiply(ae),
      te = le.toRawBytes();
    return { head: ee, prefix: ge, scalar: ae, point: le, pointBytes: te };
  }
  function X(M) {
    return re(M).pointBytes;
  }
  function de(M = new Uint8Array(), ...j) {
    const J = Le(...j);
    return Q(a(m(J, ct("context", M), !!i)));
  }
  function fe(M, j, J = {}) {
    (M = ct("message", M)), i && (M = i(M));
    const { prefix: ee, scalar: ge, pointBytes: ae } = re(j),
      le = de(J.context, ee, M),
      te = ie.multiply(le).toRawBytes(),
      x = de(J.context, te, ae, M),
      se = G(le + x * ge);
    ar("signature.s", se, bt, n);
    const ue = Le(te, gi(se, r.BYTES));
    return ct("result", ue, r.BYTES * 2);
  }
  const R = td;
  function P(M, j, J, ee = R) {
    const { context: ge, zip215: ae } = ee,
      le = r.BYTES;
    (M = ct("signature", M, 2 * le)),
      (j = ct("message", j)),
      (J = ct("publicKey", J, le)),
      ae !== void 0 && un("zip215", ae),
      i && (j = i(j));
    const te = fn(M.slice(le, 2 * le));
    let x, se, ue;
    try {
      (x = q.fromHex(J, ae)),
        (se = q.fromHex(M.slice(0, le), ae)),
        (ue = ie.multiplyUnsafe(te));
    } catch {
      return !1;
    }
    if (!ae && x.isSmallOrder()) return !1;
    const he = de(ge, se.toRawBytes(), x.toRawBytes(), j);
    return se
      .add(x.multiplyUnsafe(he))
      .subtract(ue)
      .clearCofactor()
      .equals(q.ZERO);
  }
  return (
    ie._setWindowSize(8),
    {
      ...
      ExtendedPoint: q,
      utils: {
        getExtendedPublicKey: re,
        randomPrivateKey: () => l(r.BYTES),
        precompute(M = 8, j = q.BASE) {
          return j._setWindowSize(M), j.multiply(BigInt(3)), j;
        },
      },
    }
  );
}
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ const Xs =
    BigInt(
...
function od(e) {
  const t = BigInt(10),
    ...
    $ = (It(m, i, a) * S) % a,
    V = (It($, t, a) * B) % a;
  return { pow_p_5_8: (It(V, ka, a) * e) % a, b2: o };
}
function cd(e) {
...
const fd = An(Xs, void 0, !0),
  ld = {
    ...
    hash: Q0,
    randomBytes: xc,
    adjustScalarBytes: cd,
    uvRatio: ud,
  },
  Fr = nd(ld);
var Ca = function (e, t, r, n, i) {
...
class dd {
  constructor(t = {}) {
    rt.set(this, void 0),
      rn.set(this, void 0),
      (this[Hc] = this.entries.bind(this)),
      (this[Dc] = "ExpirableMap");
    const { source: r = [], expirationTime: n = 10 * 60 * 1e3 } = t,
      i = Date.now();
    Ca(
      this,
      rt,
      new Map([...r].map(([a, l]) => [a, { value: l, timestamp: i }])),
      "f",
    ),
      Ca(this, rn, n, "f");
  }
  prune() {
    ...
    for (const [r, n] of st(this, rt, "f").entries())
      t - n.timestamp > st(this, rn, "f") && st(this, rt, "f").delete(r);
    return this;
  }
  set(t, r) {
    this.prune();
  ...
  get(t) {
    ...
    if (r !== void 0) {
      if (Date.now() - r.timestamp > st(this, rn, "f")) {
...
const _i = Uint8Array.from([48, 5, 6, 3, 43, 101, 112]);
Uint8Array.from([
  48, 16, 6, 7, 42, 134, 72, 206, 61, 2, 1, 6, 5, 43, 129, 4, 0, 10,
]);
function Kc(e, t) {
  const r = 2 + Ma(e.byteLength + 1),
    n = t.byteLength + r + e.byteLength;
  let i = 0;
  const a = new Uint8Array(1 + Ma(n) + n);
  return (
    (a[i++] = 48),
    (i += Va(a, i, n)),
    a.set(t, i),
...
const zc = (e, t) => {
  let r = 0;
  const n = (o, g) => {
      if (i[r++] !== o) throw new Error("Expected: " + g);
    },
    i = new Uint8Array(e);
  if (
    (n(48, "sequence"), (r += Us(i, r)), !Ni(i.slice(r, r + t.byteLength), t))
  )
    throw new Error("Not the expected OID.");
  (r += t.byteLength), n(3, "bit string");
  const a = hd(i, r) - 1;
  (r += Us(i, r)), n(0, "0 padding");
  const l = i.slice(r);
  if (a !== l.length)
    throw new Error(
      `DER payload mismatch: Expected length ${a} actual length ${l.length}`,
    );
  return l;
};
...
let Wc = class nn {
  constructor(t) {
    if (
      (zn.set(this, void 0),
      Wn.set(this, void 0),
      t.byteLength !== nn.RAW_KEY_LENGTH)
    )
      throw new Error("An Ed25519 public key must be exactly 32bytes long");
    $a(this, zn, t, "f"), $a(this, Wn, nn.derEncode(t), "f");
  }
  static from(t) {
  ...
  static fromDer(t) {
    return new nn(this.derDecode(t));
  }
  static derEncode(t) {
    return Kc(t, _i).buffer;
  }
  static derDecode(t) {
    const r = zc(t, _i);
...
(zn = new WeakMap()), (Wn = new WeakMap());
Wc.RAW_KEY_LENGTH = 32;
class pd {
  constructor() {
    this.observers = [];
  }
...
class Mi {
  constructor(t = Mi.default) {
    Rt.set(this, void 0),
      ...
      Pr.set(this, 0);
    const {
      initialInterval: r = Xc,
      randomizationFactor: n = Yc,
      multiplier: i = Zc,
      maxInterval: a = Jc,
      maxElapsedTime: l = Qc,
      maxIterations: o = eu,
  ...
  get ellapsedTimeInMsec() {
    return tt(this, ti, "f").now() - tt(this, Jn, "f");
  }
  get currentInterval() {
    return tt(this, Rt, "f");
  }
  ...
  get randomValueFromInterval() {
    const t = tt(this, Yn, "f") * tt(this, Rt, "f"),
      r = tt(this, Rt, "f") - t,
      n = tt(this, Rt, "f") + t;
  ...
  incrementCurrentInterval() {
    ...
    return (
      Ot(
        this,
        Rt,
        Math.min(tt(this, Rt, "f") * tt(this, Zn, "f"), tt(this, Xn, "f")),
        "f",
      ),
      Ot(this, Pr, ((t = tt(this, Pr, "f")), t++, t), "f"),
      tt(this, Rt, "f")
    );
  }
  next() {
    return this.ellapsedTimeInMsec >= tt(this, Qn, "f") ||
      tt(this, Pr, "f") >= tt(this, ei, "f")
      ? null
...
function Bd(e) {
  ...
  if (e !== void 0)
    ...
    a &&
      typeof a == "string" &&
      (n.some((o) => a.endsWith(o))
        ? (l = a)
        : (l = r.find((o) => a.endsWith(o)))),
      i && l
        ? (t = new URL(`${i.protocol}//${l}${i.port ? ":" + i.port : ""}`))
...
class jr {
  constructor(t = {}) {
    ...
    Mt.add(this),
      ...
      kr.set(this, []),
      Cr.set(this, []),
      wr.set(this, new dd({ expirationTime: 5 * 60 * 1e3 })),
      br.set(this, !0),
      ii.set(this, (a, l) => {
        if (ye(this, br, "f") === !1) return a;
        if (!l)
          throw new Pt(
            "Invalid signature from replica signed query: no matching node key found.",
          );
        const { status: o, signatures: g = [], requestId: _ } = a,
          B = new TextEncoder().encode("\vic-response");
        for (const N of g) {
          const { timestamp: I, identity: S } = N,
            m = Te.fromUint8Array(S).toText();
          let $;
          if (o === "replied") {
            const { reply: ie } = a;
            $ = pi({
            ...
            const { reject_code: ie, reject_message: C, error_code: Z } = a;
            $ = pi({
              status: o,
              reject_code: ie,
              reject_message: C,
          ...
          const V = Bt(B, new Uint8Array($)),
            W = l?.nodeKeys.get(m);
          if (!W)
            throw new Pt(
              "Invalid signature from replica signed query: no matching node key found.",
            );
          const K = Wc.fromDer(W).rawKey;
          if (Fr.verify(N.signature, new Uint8Array(V), new Uint8Array(K)))
            return a;
          throw new Pt(`Invalid signature from replica ${m} signed query.`);
        }
        return a;
      }),
      (this.config = t),
      at(this, nr, t.fetch || Td() || fetch.bind(global), "f"),
      at(this, Gr, t.fetchOptions, "f"),
      at(this, sn, t.callOptions, "f"),
      (this.rootKey = t.rootKey ? t.rootKey : Ht(gd));
    const n = Bd(t.host);
    (this.host = new URL(n)),
      t.verifyQuerySignatures !== void 0 &&
        at(this, br, t.verifyQuerySignatures, "f"),
      at(this, Et, (r = t.retryTimes) !== null && r !== void 0 ? r : 3, "f");
    const i = () => new Mi({ maxIterations: ye(this, Et, "f") });
    if (
      (at(this, yr, t.backoffStrategy || i, "f"),
      this.host.hostname.endsWith(bd)
        ? (this.host.hostname = md)
        : this.host.hostname.endsWith(xd)
          ? (this.host.hostname = _d)
          : this.host.hostname.endsWith(vd) && (this.host.hostname = Ed),
      t.credentials)
    ) {
      const { name: a, password: l } = t.credentials;
      at(this, xt, `${a}${l ? ":" + l : ""}`, "f");
    }
    if (
      (at(this, Ut, Promise.resolve(t.identity || new yi()), "f"),
    ...
    at(this, gr, t.ingressExpiryInMinutes || 5, "f"),
      this.addTransform("update", ya(As)),
      t.useQueryNonces && this.addTransform("query", ya(As)),
      t.logToConsole &&
  ...
  addTransform(t, r, n = r.priority || 0) {
    if (t === "update") {
      const i = ye(this, Cr, "f").findIndex((a) => (a.priority || 0) < n);
      ye(this, Cr, "f").splice(
        i >= 0 ? i : ye(this, Cr, "f").length,
        0,
        Object.assign(r, { priority: n }),
      );
    } else if (t === "query") {
      const i = ye(this, kr, "f").findIndex((a) => (a.priority || 0) < n);
      ye(this, kr, "f").splice(
        i >= 0 ? i : ye(this, kr, "f").length,
        0,
        Object.assign(r, { priority: n }),
      );
    }
  ...
  async getPrincipal() {
    ...
    return (await ye(this, Ut, "f")).getPrincipal();
  }
  async call(t, r, n) {
    var i;
    const a = (i = r.callSync) !== null && i !== void 0 ? i : !0,
      l = await (n !== void 0 ? await n : await ye(this, Ut, "f"));
    if (!l)
      throw new Vn(
        "This identity has expired due this application's security policy. Please refresh your authentication.",
      );
    const o = Te.from(t),
      g = r.effectiveCanisterId ? Te.from(r.effectiveCanisterId) : o,
      _ = l.getPrincipal() || Te.anonymous();
    let B = new Ur(ye(this, gr, "f") * Mn);
    Math.abs(ye(this, an, "f")) > 1e3 * 30 &&
      (B = new Ur(ye(this, gr, "f") * Mn + ye(this, an, "f")));
    const N = {
      request_type: Bs.Call,
      canister_id: o,
    ...
    let I = await this._transform({
      request: {
        ...
        headers: Object.assign(
          ...
          ye(this, xt, "f")
            ? { Authorization: "Basic " + btoa(ye(this, xt, "f")) }
            : {},
        ),
      },
      endpoint: "call",
    ...
    const S = I.body.nonce ? m(I.body.nonce) : void 0;
    N.nonce = S;
    function m(W) {
      return new Uint8Array(W);
    }
    I = await l.transformRequest(I);
    const $ = Yi(I.body),
      V = ye(this, yr, "f").call(this);
    try {
      const W = () => (
          this.log.print(
          ...
          ye(this, nr, "f").call(
            ...
            Object.assign(
              Object.assign(Object.assign({}, ye(this, sn, "f")), I.request),
              { body: $ },
            ),
          )
        ),
        ...
        ie = pn(N),
        C = await q,
        Z = await C.arrayBuffer(),
        G = C.status === 200 && Z.byteLength > 0 ? jt(Z) : null;
      if (G && "certificate" in G) {
      ...
      return {
        ...
        response: {
          ...
          body: G,
          headers: en(C.headers),
        },
        requestDetails: N,
      };
    } catch (W) {
      if (W.message.includes("v3 api not supported."))
        return (
          this.log.warn("v3 api not supported. Fall back to v2"),
          this.call(t, Object.assign(Object.assign({}, r), { callSync: !1 }), n)
        );
      throw (this.log.error("Error while making call:", W), W);
    }
  }
  async query(t, r, n) {
    const i = ye(this, yr, "f").call(this),
    ...
    const l = async () => {
        const S = await (n !== void 0 ? n : ye(this, Ut, "f"));
        if (!S)
          throw new Vn(
            "This identity has expired due this application's security policy. Please refresh your authentication.",
          );
        const m = Te.from(t),
          $ = S?.getPrincipal() || Te.anonymous(),
          V = {
            request_type: "query",
            canister_id: m,
            method_name: r.methodName,
            arg: r.arg,
            sender: $,
            ingress_expiry: new Ur(ye(this, gr, "f") * Mn),
          },
          W = pn(V);
        let K = await this._transform({
          request: {
            method: "POST",
            headers: Object.assign(
              { "Content-Type": "application/cbor" },
        ...
        K = await S?.transformRequest(K);
        const q = Yi(K.body),
          ie = {
            canister: m.toText(),
            ecid: a,
            transformedRequest: K,
            body: q,
            requestId: W,
            backoff: i,
            tries: 0,
        ...
        return {
          requestDetails: V,
          query: await ye(this, Mt, "m", ru).call(this, ie),
        };
      },
      o = async () => {
        if (!ye(this, br, "f")) return;
        const S = ye(this, wr, "f").get(a.toString());
        return (
          S ||
          (await this.fetchSubnetKeys(a.toString()),
          ye(this, wr, "f").get(a.toString()))
        );
      },
      [g, _] = await Promise.all([l(), o()]),
      { requestDetails: B, query: N } = g,
      I = Object.assign(Object.assign({}, N), { requestDetails: B });
    if ((this.log.print("Query response:", I), !ye(this, br, "f"))) return I;
    try {
      return ye(this, ii, "f").call(this, I, _);
    } catch {
      this.log.warn(
        "Query response verification failed. Retrying with fresh subnet keys.",
      ),
        ye(this, wr, "f").delete(t.toString()),
        await this.fetchSubnetKeys(a.toString());
      const m = ye(this, wr, "f").get(t.toString());
      if (!m)
        throw new Pt(
          "Invalid signature from replica signed query: no matching node key found.",
        );
      return ye(this, ii, "f").call(this, I, m);
    }
  }
  async createReadStateRequest(t, r) {
    const n = await (r !== void 0 ? await r : await ye(this, Ut, "f"));
    if (!n)
      throw new Vn(
        "This identity has expired due this application's security policy. Please refresh your authentication.",
      );
  ...
  async readState(t, r, n, i) {
    const a = typeof t == "string" ? Te.fromText(t) : t,
      ...
      o = Object.assign(Object.assign({}, l.body), {
        ingress_expiry: new Ur(tu),
      }),
      g = Yi(o);
    this.log.print(
    ...
    const _ = ye(this, yr, "f").call(this);
    try {
      const B = await ye(this, Mt, "m", ni).call(this, {
        request: () =>
          ye(this, nr, "f").call(
            this,
            "" +
            ...
            Object.assign(
              Object.assign(Object.assign({}, ye(this, Gr, "f")), l.request),
              { body: g },
            ),
          ),
        backoff: _,
  ...
  Body: ${await B.text()}
`);
      const N = jt(await B.arrayBuffer());
  ...
  async syncTime(t) {
    ...
    try {
      ...
      a && at(this, an, Number(a) - Number(n), "f");
    } catch (i) {
      this.log.error("Caught exception while attempting to sync time", i);
    }
  }
  async status() {
    const t = ye(this, xt, "f")
      ? { Authorization: "Basic " + btoa(ye(this, xt, "f")) }
      : {};
    this.log.print('fetching "/api/v2/status"');
    const r = ye(this, yr, "f").call(this),
      n = await ye(this, Mt, "m", ni).call(this, {
        backoff: r,
        request: () =>
          ye(this, nr, "f").call(
            this,
            "" + new URL("/api/v2/status", this.host),
            Object.assign({ headers: t }, ye(this, Gr, "f")),
          ),
        tries: 0,
      });
  ...
  async fetchRootKey() {
    if (!ye(this, ri, "f")) {
      ...
      (this.rootKey = t.root_key), at(this, ri, !0, "f");
    }
    return this.rootKey;
  }
  invalidateIdentity() {
  ...
  replaceIdentity(t) {
    at(this, Ut, Promise.resolve(t), "f");
  }
  async fetchSubnetKeys(t) {
    const r = Te.from(t),
      i = (await qc({ canisterId: r, paths: ["subnet"], agent: this })).get(
        "subnet",
      );
    if (i && typeof i == "object" && "nodeKeys" in i)
      return ye(this, wr, "f").set(r.toText(), i), i;
  }
  _transform(t) {
    let r = Promise.resolve(t);
    if (t.endpoint === "call")
      for (const n of ye(this, Cr, "f"))
        r = r.then((i) => n(i).then((a) => a || i));
    else
      for (const n of ye(this, kr, "f"))
        r = r.then((i) => n(i).then((a) => a || i));
    return r;
  }
}
  ...
  (ru = async function e(t) {
    ...
    if (
      (this.log.print(
        ...
        { tries: _, backoff: g, delay: B },
      ),
      B === null)
    )
      throw new De(
        `Timestamp failed to pass the watermark after retrying the configured ${ye(this, Et, "f")} times. We cannot guarantee the integrity of the response since it could be a replay attack.`,
      );
    ...
    try {
      ...
      const m = await ye(this, nr, "f").call(
        this,
        "" + new URL(`/api/v2/canister/${i.toString()}/query`, this.host),
        Object.assign(
          Object.assign(Object.assign({}, ye(this, Gr, "f")), a.request),
          { body: l },
        ),
      );
      if (m.status === 200) {
        const $ = jt(await m.arrayBuffer());
        N = Object.assign(Object.assign({}, $), {
          httpDetails: {
            ok: m.ok,
            status: m.status,
            statusText: m.statusText,
            headers: en(m.headers),
          },
          requestId: o,
        });
      } else
...
`,
  ...
  ${m}
  Retrying query.`),
          await ye(this, Mt, "m", e).call(
            this,
            Object.assign(Object.assign({}, t), { tries: _ + 1 }),
          )
        );
      throw m;
    }
    ...
    if (
      ...
      const m = new De("Timestamp is below the watermark. Retrying query.");
      if (
        ...
        return await ye(this, Mt, "m", e).call(
          this,
          Object.assign(Object.assign({}, t), { tries: _ + 1 }),
        );
      throw new De(
  ...
  (ni = async function e(t) {
    ...
    a > 0 && (await new Promise((_) => setTimeout(_, a)));
    let l;
    try {
      l = await r();
    } catch (_) {
  ...
  ${_}
  Retrying request.`),
          await ye(this, Mt, "m", e).call(this, {
            request: r,
            backoff: n,
            tries: i + 1,
          })
    ...
    if (l.ok) return l;
    const o = await l.clone().text(),
      g = `Server returned an error:
  Code: ${l.status} (${l.statusText})
  Body: ${o}
`;
    if (l.status === 404 && l.url.includes("api/v3"))
      throw new Zi("v3 api not supported. Fall back to v2", {
        ok: l.ok,
        status: l.status,
        statusText: l.statusText,
        headers: en(l.headers),
      });
    if (i < ye(this, Et, "f"))
      return await ye(this, Mt, "m", e).call(this, {
        request: r,
        backoff: n,
        tries: i + 1,
      });
...
const Ad = 5 * 60 * 1e3;
function nu() {
  return Rd(Sd(Nd(), 1e3), Od(1e3, 1.2), Id(Ad));
}
function Nd() {
  let e = !0;
...
function Ud(e) {
  return (
    ...
    Or(e.body, "content") &&
    e.body.content !== null &&
    typeof e.body.content == "object" &&
    Or(e.body.content, "request_type") &&
    e.body.content.request_type === "read_state" &&
    Or(e.body.content, "ingress_expiry") &&
    typeof e.body.content.ingress_expiry == "object" &&
    e.body.content.ingress_expiry !== null &&
    Or(e.body.content.ingress_expiry, "toCBOR") &&
    typeof e.body.content.ingress_expiry.toCBOR == "function" &&
    Or(e.body.content.ingress_expiry, "toHash") &&
    typeof e.body.content.ingress_expiry.toHash == "function"
  );
}
async function iu(e, t, r, n = nu(), i, a) {
  var l;
  const o = [new TextEncoder().encode("request_status"), r],
    g =
      i ??
      (await ((l = e.createReadStateRequest) === null || l === void 0
        ? void 0
        : l.call(e, { paths: [o] })));
  i && Ud(g) && (g.body.content.ingress_expiry = new Ur(tu));
  const _ = await e.readState(t, { paths: [o] }, void 0, g);
  if (e.rootKey == null)
  ...
  const B = await _r.create({
    ...
    N = gt(B.lookup([...o, new TextEncoder().encode("status")]));
  let I;
  switch (
    (typeof N > "u" ? (I = $t.Unknown) : (I = new TextDecoder().decode(N)), I)
  ) {
    case $t.Replied:
      return { reply: gt(B.lookup([...o, "reply"])), certificate: B };
    case $t.Received:
    case $t.Unknown:
    case $t.Processing:
      return await n(t, r, I), iu(e, t, r, n, g, a);
    case $t.Rejected: {
      const S = new Uint8Array(gt(B.lookup([...o, "reject_code"])))[0],
        m = new TextDecoder().decode(gt(B.lookup([...o, "reject_message"])));
...
const Fd = ({ IDL: e }) => {
  const t = e.Variant({ mainnet: e.Null, testnet: e.Null }),
    ...
    a = i,
    l = e.Nat32,
    o = e.Record({ start_height: l, end_height: e.Opt(l), network: t }),
    g = e.Vec(e.Nat8),
    _ = e.Record({ tip_height: l, block_headers: e.Vec(g) }),
    B = e.Record({ network: t }),
    N = e.Nat64,
    I = e.Vec(N),
    S = e.Record({
      network: t,
    ...
    m = e.Vec(e.Nat8),
    $ = e.Record({ txid: e.Vec(e.Nat8), vout: e.Nat32 }),
    V = e.Record({ height: e.Nat32, value: i, outpoint: $ }),
    W = e.Record({
    ...
    K = e.Record({ transaction: e.Vec(e.Nat8), network: t }),
    q = e.Principal,
    ie = e.Record({ canister_id: q, num_requested_changes: e.Opt(e.Nat64) }),
    C = e.Variant({
    ...
    re = e.Record({
      ...
      recent_changes: e.Vec(Q),
      total_num_changes: e.Nat64,
    }),
    X = e.Record({ canister_id: q }),
    de = e.Variant({ controllers: e.Null, public: e.Null }),
    fe = e.Record({
    ...
    j = e.Record({ canister_id: q }),
    J = e.Record({ canister_id: q }),
    ee = e.Record({ canister_id: q, snapshot_id: Z }),
    ge = e.Record({ canister_id: q }),
    ae = e.Variant({ secp256k1: e.Null }),
    le = e.Record({
      key_id: e.Record({ name: e.Text, curve: ae }),
      canister_id: e.Opt(q),
      derivation_path: e.Vec(e.Vec(e.Nat8)),
    }),
    te = e.Record({ public_key: e.Vec(e.Nat8), chain_code: e.Vec(e.Nat8) }),
    x = e.Record({ canister_id: q }),
    se = e.Record({
      idx: e.Nat64,
      timestamp_nanos: e.Nat64,
    ...
    ue = e.Record({ canister_log_records: e.Vec(se) }),
    he = e.Record({ value: e.Text, name: e.Text }),
    ne = e.Record({ status: e.Nat, body: e.Vec(e.Nat8), headers: e.Vec(he) }),
    ce = e.Record({
      url: e.Text,
      ...
      transform: e.Opt(
        e.Record({
          function: e.Func(
            [e.Record({ context: e.Vec(e.Nat8), response: ne })],
            [ne],
            ["query"],
          ),
    ...
    s = e.Record({ hash: e.Vec(e.Nat8) }),
    h = e.Record({
      arg: e.Vec(e.Nat8),
      wasm_module_hash: e.Vec(e.Nat8),
      mode: b,
      chunk_hashes_list: e.Vec(s),
      target_canister: q,
      store_canister: e.Opt(q),
      sender_canister_version: e.Opt(e.Nat64),
    }),
    E = e.Vec(e.Nat8),
    T = e.Record({
    ...
    U = e.Record({ canister_id: q }),
    p = e.Record({ id: Z, total_size: e.Nat64, taken_at_timestamp: e.Nat64 }),
    c = e.Vec(p),
    u = e.Record({
      canister_id: q,
      sender_canister_version: e.Opt(e.Nat64),
    ...
    w = e.Record({ start_at_timestamp_nanos: e.Nat64, subnet_id: e.Principal }),
    v = e.Record({
      num_block_failures_total: e.Nat64,
      node_id: e.Principal,
      num_blocks_proposed_total: e.Nat64,
    }),
    O = e.Vec(e.Record({ timestamp_nanos: e.Nat64, node_metrics: e.Vec(v) })),
    L = e.Record({
      settings: e.Opt(z),
      specified_id: e.Opt(q),
      amount: e.Opt(e.Nat),
      sender_canister_version: e.Opt(e.Nat64),
    }),
    Y = e.Record({ canister_id: q }),
    oe = e.Record({ canister_id: q, amount: e.Nat }),
    pe = e.Vec(e.Nat8),
    me = e.Variant({ ed25519: e.Null, bip340secp256k1: e.Null }),
    y = e.Record({
      key_id: e.Record({ algorithm: me, name: e.Text }),
      canister_id: e.Opt(q),
      derivation_path: e.Vec(e.Vec(e.Nat8)),
    }),
    f = e.Record({ public_key: e.Vec(e.Nat8), chain_code: e.Vec(e.Nat8) }),
    d = e.Record({
      key_id: e.Record({ name: e.Text, curve: ae }),
      derivation_path: e.Vec(e.Vec(e.Nat8)),
      message_hash: e.Vec(e.Nat8),
    }),
    A = e.Record({ signature: e.Vec(e.Nat8) }),
    k = e.Record({
      key_id: e.Record({ algorithm: me, name: e.Text }),
      derivation_path: e.Vec(e.Vec(e.Nat8)),
      message: e.Vec(e.Nat8),
    }),
    D = e.Record({ signature: e.Vec(e.Nat8) }),
    H = e.Record({ canister_id: q }),
    _e = e.Record({ canister_id: q }),
    ve = e.Record({ canister_id: q }),
    Ee = e.Vec(s),
    xe = e.Record({ replace_snapshot: e.Opt(Z), canister_id: q }),
    Oe = p,
    ke = e.Record({ canister_id: q, sender_canister_version: e.Opt(e.Nat64) }),
    qi = e.Record({
      canister_id: e.Principal,
      settings: z,
      sender_canister_version: e.Opt(e.Nat64),
    }),
    Gi = e.Record({ chunk: e.Vec(e.Nat8), canister_id: e.Principal }),
    ji = s;
  return e.Service({
    bitcoin_get_balance: e.Func([n], [a], []),
    bitcoin_get_block_headers: e.Func([o], [_], []),
    bitcoin_get_current_fee_percentiles: e.Func([B], [I], []),
    bitcoin_get_utxos: e.Func([S], [W], []),
    bitcoin_send_transaction: e.Func([K], [], []),
    canister_info: e.Func([ie], [re], []),
    canister_status: e.Func([X], [R], []),
    clear_chunk_store: e.Func([P], [], []),
    create_canister: e.Func([M], [j], []),
    delete_canister: e.Func([J], [], []),
    delete_canister_snapshot: e.Func([ee], [], []),
    deposit_cycles: e.Func([ge], [], []),
    ecdsa_public_key: e.Func([le], [te], []),
    fetch_canister_logs: e.Func([x], [ue], ["query"]),
    http_request: e.Func([ce], [ne], []),
    install_chunked_code: e.Func([h], [], []),
    install_code: e.Func([T], [], []),
    list_canister_snapshots: e.Func([U], [c], []),
    load_canister_snapshot: e.Func([u], [], []),
    node_metrics_history: e.Func([w], [O], []),
    provisional_create_canister_with_cycles: e.Func([L], [Y], []),
    provisional_top_up_canister: e.Func([oe], [], []),
    raw_rand: e.Func([], [pe], []),
    schnorr_public_key: e.Func([y], [f], []),
    sign_with_ecdsa: e.Func([d], [A], []),
    sign_with_schnorr: e.Func([k], [D], []),
    start_canister: e.Func([H], [], []),
    stop_canister: e.Func([_e], [], []),
    stored_chunks: e.Func([ve], [Ee], []),
    take_canister_snapshot: e.Func([xe], [Oe], []),
    uninstall_code: e.Func([ke], [], []),
    update_settings: e.Func([qi], [], []),
    upload_chunk: e.Func([Gi], [ji], []),
  });
};
class su extends De {
  constructor(t, r, n, i) {
  ...
  constructor(t, r, n, i, a, l, o) {
    super(
      ...
      Object.assign(
        { "Request ID": et(n) },
        i.body
          ? Object.assign(Object.assign({}, o ? { "Error code": o } : {}), {
      ...
      constructor(l) {
        ...
        const o =
          typeof l.canisterId == "string"
            ? Te.fromText(l.canisterId)
            : l.canisterId;
        super({
          config: Object.assign(Object.assign(Object.assign({}, au), l), {
            canisterId: o,
          }),
          service: n,
        });
        for (const [g, _] of n._fields)
          r?.httpDetails && _.annotations.push(Fs),
            r?.certificate && _.annotations.push(ou),
            (this[g] = kd(this, g, _, l.blsVerify));
      }
    }
    return i;
  }
...
const au = { pollingStrategyFactory: nu },
  Fs = "http-details",
  ou = "certificate";
function kd(e, t, r, n) {
  let i;
  r.annotations.includes("query") || r.annotations.includes("composite_query")
    ? (i = async (l, ...o) => {
        ...
        l = Object.assign(
          Object.assign({}, l),
          (_ = (g = e[yt].config).queryTransform) === null || _ === void 0
            ? void 0
            : _.call(
                g,
                t,
                o,
                Object.assign(Object.assign({}, e[yt].config), l),
              ),
        );
        const B = l.agent || e[yt].config.agent || ja(),
          N = Te.from(l.canisterId || e[yt].config.canisterId),
          I = ws(r.argTypes, o),
          S = await B.query(N, {
            methodName: t,
            arg: I,
          ...
          m = Object.assign(Object.assign({}, S.httpDetails), {
        ...
        switch (S.status) {
          case "rejected":
            throw new Pd(N, t, S);
          case "replied":
            return r.annotations.includes(Fs)
              ? { httpDetails: m, result: Rr(r.retTypes, S.reply.arg) }
              : Rr(r.retTypes, S.reply.arg);
        }
      })
    : (i = async (l, ...o) => {
        var g, _;
        l = Object.assign(
          Object.assign({}, l),
          (_ = (g = e[yt].config).callTransform) === null || _ === void 0
            ? void 0
            : _.call(
                g,
                t,
        ...
        const B = l.agent || e[yt].config.agent || ja(),
          {
            ...
            Object.assign(Object.assign({}, au), e[yt].config),
            l,
          ),
          m = Te.from(N),
          $ = I !== void 0 ? Te.from(I) : m,
          V = ws(r.argTypes, o);
        if (B.rootKey == null)
        ...
        const {
          ...
          response: K,
          requestDetails: q,
        } = await B.call(m, { methodName: t, arg: V, effectiveCanisterId: $ });
        let ie, C;
        if (K.body && K.body.certificate) {
          ...
          switch (new TextDecoder().decode(gt(C.lookup([...X, "status"])))) {
            case "replied":
              ie = gt(C.lookup([...X, "reply"]));
              break;
            case "rejected": {
              const fe = new Uint8Array(gt(C.lookup([...X, "reject_code"])))[0],
                R = new TextDecoder().decode(
                  gt(C.lookup([...X, "reject_message"])),
                ),
                P = gt(C.lookup([...X, "error_code"])),
                z = P ? new TextDecoder().decode(P) : void 0;
              throw new La(m, t, W, K, fe, R, z);
            }
          }
        } else if (K.body && "reject_message" in K.body) {
          const { reject_code: re, reject_message: X, error_code: de } = K.body;
          throw new La(m, t, W, K, re, X, de);
        }
        if (K.status === 202) {
          const re = S(),
            X = await iu(B, $, W, re, n);
          (C = X.certificate), (ie = X.reply);
        }
        const Z = r.annotations.includes(Fs),
          G = r.annotations.includes(ou),
          Q = Object.assign(Object.assign({}, K), { requestDetails: q });
        if (ie !== void 0)
          return Z && G
            ? { httpDetails: Q, certificate: C, result: Rr(r.retTypes, ie) }
            : G
              ? { certificate: C, result: Rr(r.retTypes, ie) }
              : Z
                ? { httpDetails: Q, result: Rr(r.retTypes, ie) }
                : Rr(r.retTypes, ie);
        if (r.retTypes.length === 0)
          return Z ? { httpDetails: K, result: void 0 } : void 0;
        throw new Error(
...
class Lt {
  constructor(t) {
    if (
      (si.set(this, void 0),
      ai.set(this, void 0),
      t.byteLength !== Lt.RAW_KEY_LENGTH)
    )
      throw new Error("An Ed25519 public key must be exactly 32bytes long");
    xi(this, si, t, "f"), xi(this, ai, Lt.derEncode(t), "f");
  }
  static from(t) {
    if (typeof t == "string") {
      const r = Ht(t);
      ...
      const r = t;
      if (Da(r) && Object.hasOwnProperty.call(r, "__derEncodedPublicKey__"))
        return this.fromDer(r);
      if (ArrayBuffer.isView(r)) {
        const n = r;
        return this.fromRaw(Ms(n.buffer));
      } else {
  ...
  static fromDer(t) {
    return new Lt(this.derDecode(t));
  }
  static derEncode(t) {
    const r = Kc(t, _i).buffer;
...
(si = new WeakMap()), (ai = new WeakMap());
Lt.RAW_KEY_LENGTH = 32;
class ur extends Hs {
  constructor(t, r) {
    super(),
      Mr.set(this, void 0),
      Vr.set(this, void 0),
      xi(this, Mr, Lt.from(t), "f"),
      xi(this, Vr, new Uint8Array(r), "f");
  }
  static generate(t) {
    if (t && t.length !== 32)
      throw new Error("Ed25519 Seed needs to be 32 bytes long.");
    t || (t = Fr.utils.randomPrivateKey()),
      Ni(t, new Uint8Array(new Array(32).fill(0))) &&
        console.warn(
    ...
    const n = Fr.getPublicKey(r);
    return ur.fromKeyPair(n, r);
  }
  static fromParsedJson(t) {
    const [r, n] = t;
    return new ur(Lt.fromDer(Ht(r)), Ht(n));
  }
  static fromJSON(t) {
  ...
  static fromKeyPair(t, r) {
    return new ur(Lt.fromRaw(t), r);
  }
  static fromSecretKey(t) {
    const r = Fr.getPublicKey(new Uint8Array(t));
    return ur.fromKeyPair(r, t);
  }
  toJSON() {
    return [et(ir(this, Mr, "f").toDer()), et(ir(this, Vr, "f"))];
  }
  getKeyPair() {
    return { secretKey: ir(this, Vr, "f"), publicKey: ir(this, Mr, "f") };
  }
  getPublicKey() {
    return ir(this, Mr, "f");
  }
  async sign(t) {
    const r = new Uint8Array(t),
      n = cn(Fr.sign(r, ir(this, Vr, "f").slice(0, 32)));
    return (
  ...
  static verify(t, r, n) {
    const [i, a, l] = [t, r, n].map(
      (o) => (
        typeof o == "string" && (o = Ht(o)),
        o instanceof Uint8Array && (o = o.buffer),
        new Uint8Array(o)
      ),
    );
    return Fr.verify(a, i, l);
  }
}
(Mr = new WeakMap()), (Vr = new WeakMap());
...
class Ei extends Hs {
  ...
  static async generate(t) {
    const {
      ...
      a = Ka(i),
      l = await a.generateKey({ name: "ECDSA", namedCurve: "P-256" }, r, n),
      o = await a.exportKey("spki", l.publicKey);
    return new this(l, o, a);
  }
...
class Md {
  constructor(t) {
    er.set(this, void 0), Cd(this, er, t, "f");
  }
  get rawKey() {
    return Jr(this, er, "f").rawKey;
  }
  get derKey() {
    return Jr(this, er, "f").derKey;
  }
  toDer() {
    return Jr(this, er, "f").toDer();
  }
  getPublicKey() {
    return Jr(this, er, "f");
  }
  getPrincipal() {
    return Te.from(Jr(this, er, "f").rawKey);
  }
  transformRequest() {
...
var Vd = function (e, t, r, n, i) {
  ...
  oi;
const Gd = new TextEncoder().encode("ic-request-auth-delegation"),
  jd = new TextEncoder().encode(`
ic-request`);
function os(e) {
...
async function Ld(e, t, r, n) {
  const i = new Qs(t.toDer(), BigInt(+r) * BigInt(1e6), n),
    a = new Uint8Array([...Gd, ...new Uint8Array(pn(Object.assign({}, i)))]),
    l = await e.sign(a);
...
class vi {
  ...
  static async create(t, r, n = new Date(Date.now() + 15 * 60 * 1e3), i = {}) {
    var a, l;
    const o = await Ld(t, r, n, i.targets);
    return new vi(
      [
  ...
  static fromJSON(t) {
    ...
    const i = n.map((a) => {
      const { delegation: l, signature: o } = a,
        { pubkey: g, expiration: _, targets: B } = l;
    ...
    return Object.assign(Object.assign({}, n), {
      body: {
        ...
        sender_sig: await this.sign(
          new Uint8Array([...jd, ...new Uint8Array(i)]),
        ),
...
class Ti extends Md {
  constructor(t, r) {
    super(t), oi.set(this, void 0), Vd(this, oi, r, "f");
  }
  get delegation() {
    return $d(this, oi, "f");
  }
...
const Ya = ["mousedown", "mousemove", "keydown", "touchstart", "wheel"];
class Za {
  constructor(t = {}) {
    var r;
    (this.callbacks = []),
    ...
    window.addEventListener("load", a, !0),
      Ya.forEach(function (o) {
        document.addEventListener(o, a, !0);
      });
    const l = (o, g) => {
      let _;
      return (...B) => {
        const N = this,
          I = function () {
            (_ = void 0), o.apply(N, B);
          };
        clearTimeout(_), (_ = window.setTimeout(I, g));
      };
    };
    if (t?.captureScroll) {
      const o = l(
...
const Dd = (e, t) => t.some((r) => e instanceof r);
let Xa, Ja;
function Kd() {
  return (
    Xa ||
...
function Wd(e) {
  const t = new Promise((r, n) => {
    const i = () => {
        e.removeEventListener("success", a), e.removeEventListener("error", l);
      },
      a = () => {
        r(lr(e.result)), i();
      },
    ...
    e.addEventListener("success", a), e.addEventListener("error", l);
  });
  return (
    t
      .then((r) => {
        r instanceof IDBCursor && cu.set(r, e);
      })
      .catch(() => {}),
    ea.set(t, e),
    t
...
function Xd(e) {
  return e === IDBDatabase.prototype.transaction &&
    ...
    ? function (t, ...r) {
        const n = e.call(us(this), t, ...r);
        return uu.set(n, t.sort ? t.sort() : [t]), lr(n);
      }
    : zd().includes(e)
      ? function (...t) {
          return e.apply(us(this), t), lr(cu.get(this));
        }
      : function (...t) {
          return lr(e.apply(us(this), t));
        };
}
function Jd(e) {
  return typeof e == "function"
    ? Xd(e)
    : (e instanceof IDBTransaction && Yd(e),
      Dd(e, Kd()) ? new Proxy(e, ks) : e);
}
function lr(e) {
  if (e instanceof IDBRequest) return Wd(e);
  if (cs.has(e)) return cs.get(e);
  const t = Jd(e);
  return t !== e && (cs.set(e, t), ea.set(t, e)), t;
}
const us = (e) => ea.get(e);
function Qd(e, t, { blocked: r, upgrade: n, blocking: i, terminated: a } = {}) {
  const l = indexedDB.open(e, t),
    o = lr(l);
  return (
    n &&
      l.addEventListener("upgradeneeded", (g) => {
        n(lr(l.result), g.oldVersion, g.newVersion, lr(l.transaction), g);
      }),
    r && l.addEventListener("blocked", (g) => r(g.oldVersion, g.newVersion, g)),
    o
      .then((g) => {
        a && g.addEventListener("close", () => a()),
          i &&
            g.addEventListener("versionchange", (_) =>
              i(_.oldVersion, _.newVersion, _),
            );
      })
      .catch(() => {}),
    o
...
const eh = ["get", "getKey", "getAll", "getAllKeys", "count"],
  th = ["put", "add", "delete", "clear"],
  fs = new Map();
function Qa(e, t) {
  if (!(e instanceof IDBDatabase && !(t in e) && typeof t == "string")) return;
  if (fs.get(t)) return fs.get(t);
  ...
  const a = async function (l, ...o) {
    const g = this.transaction(l, i ? "readwrite" : "readonly");
    let _ = g.store;
    return (
      n && (_ = _.index(o.shift())),
      (await Promise.all([_[r](...o), i && g.done]))[0]
    );
  };
  return fs.set(t, a), a;
}
Zd((e) => ({
  ...e,
  get: (t, r, n) => Qa(t, r) || e.get(t, r, n),
  has: (t, r) => !!Qa(t, r) || e.has(t, r),
}));
const fu = "auth-client-db",
  lu = "ic-keyval",
  rh = async (e = fu, t = lu, r) => (
    du &&
      localStorage != null &&
      localStorage.getItem(cr) &&
      (localStorage.removeItem(cr), localStorage.removeItem(sr)),
    await Qd(e, r, {
      upgrade: (n) => {
...
class ta {
  ...
  static async create(t) {
    const { dbName: r = fu, storeName: n = lu, version: i = uh } = t ?? {},
      a = await rh(r, n, i);
    return new ta(a, n);
  }
  async set(t, r) {
    return await ih(this._db, this._storeName, t, r);
  }
  async get(t) {
    var r;
    return (r = await nh(this._db, this._storeName, t)) !== null && r !== void 0
      ? r
      : null;
  }
  async remove(t) {
    return await sh(this._db, this._storeName, t);
  }
}
...
class lh {
  constructor(t) {
    ci.set(this, void 0), ah(this, ci, t ?? {}, "f");
  }
  get _db() {
...
ci = new WeakMap();
const dh = "https://identity.ic0.app",
  hh = "#authorize",
  ls = "ECDSA",
  ds = "Ed25519",
  ph = 500,
...
class fp {
  ...
  static async create(t = {}) {
    var r, n, i;
    const a = (r = t.storage) !== null && r !== void 0 ? r : new lh(),
      l = (n = t.keyType) !== null && n !== void 0 ? n : ls;
    let o = null;
    if (t.identity) o = t.identity;
    else {
      let N = await a.get(sr);
      if (!N && du)
        try {
          const I = new fh(),
            S = await I.get(cr),
      ...
      if (N)
        try {
          typeof N == "object"
            ? l === ds && typeof N == "string"
              ? (o = await ur.fromJSON(N))
              : (o = await Ei.fromKeyPair(N))
            : typeof N == "string" && (o = ur.fromJSON(N));
        } catch {}
    }
    let g = new yi(),
      _ = null;
      ...
      try {
        ...
        t.identity
          ...
          : N &&
            ...
            Hd(_)
              ? "toDer" in o
                ? (g = Ti.fromDelegation(o, _))
                : (g = za.fromDelegation(o, _))
              : (await hs(a), (o = null)));
      } catch (N) {
        console.error(N), await hs(a), (o = null);
      }
    let B;
    return (
      !((i = t.idleOptions) === null || i === void 0) && i.disableIdle
        ? (B = void 0)
        : (_ || t.identity) && (B = Za.create(t.idleOptions)),
      o ||
        (l === ds
          ? ((o = await ur.generate()),
            await a.set(sr, JSON.stringify(o.toJSON())))
          : (t.storage &&
              l === ls &&
              console.warn(
                `You are using a custom storage provider that may not support CryptoKey storage. If you are using a custom storage provider that does not support CryptoKey storage, you should use '${ds}' as the key type, as it can serialize to a string`,
              ),
            (o = await Ei.generate()),
            await a.set(sr, o.getKeyPair()))),
      new this(g, o, _, a, B, t)
    );
  }
  ...
  async _handleSuccess(t, r) {
    var n, i;
    const a = t.delegations.map((_) => ({
        delegation: new Qs(
          _.delegation.pubkey,
          _.delegation.expiration,
          _.delegation.targets,
        ),
        signature: _.signature.buffer,
      })),
      l = vi.fromDelegations(a, t.userPublicKey.buffer),
      o = this._key;
    if (!o) return;
    (this._chain = l),
      "toDer" in o
        ? (this._identity = Ti.fromDelegation(o, this._chain))
        : (this._identity = za.fromDelegation(o, this._chain)),
    ...
    !this.idleManager &&
      !g?.disableIdle &&
      ((this.idleManager = Za.create(g)), this._registerDefaultIdleCallback()),
      this._removeEventListener(),
      delete this._idpWindow,
      this._chain &&
        (await this._storage.set(cr, JSON.stringify(this._chain.toJSON()))),
      r?.(t);
  }
  getIdentity() {
    ...
    (o.hash = hh),
      ...
      (this._eventHandler = this._getEventHandler(
        ...
        Object.assign(
          {
            maxTimeToLive:
              (i = t?.maxTimeToLive) !== null && i !== void 0 ? i : l,
          },
          t,
        ),
      )),
    ...
    const g = () => {
      this._idpWindow &&
        (this._idpWindow.closed
          ? this._handleFailure(yh, t?.onError)
          : setTimeout(g, ph));
    };
    g();
  }
      ...
      switch (o.kind) {
        ...
        case "authorize-client-success":
          try {
            ...
            this._handleFailure(g.message, r?.onError);
          }
          break;
  ...
  async logout(t = {}) {
    if (
      (await hs(this._storage),
      (this._identity = new yi()),
      (this._chain = null),
      t.returnTo)
    )
      try {
...
async function hs(e) {
  await e.remove(sr), await e.remove(cr), await e.remove(ch);
}
var gh = ((e) => (
...
var wh = class {
  ...
  hu = (e) => e == null,
  Cs = (e) => !hu(e),
  mh = () => jr.createSync({ host: "https://icp-api.io", identity: new yi() }),
  lp = async ({
    identity: e,
    host: t,
    fetchRootKey: r = !1,
  ...
  bh = ({
    ...
    return { service: _, certifiedService: B, agent: g, canisterId: e };
  },
  eo = "abcdefghijklmnopqrstuvwxyz234567",
  bn = Object.create(null);
for (let e = 0; e < eo.length; e++) bn[eo[e]] = e;
bn[0] = bn.o;
bn[1] = bn.i;
var Xe = (e) => (Cs(e) ? [e] : []),
  _h = {};
...
class Bh {
  constructor(t, r = t?.byteLength || 0) {
    (this._buffer = Bi(t || new ArrayBuffer(0))),
      (this._view = new Uint8Array(this._buffer, 0, r));
  }
  get buffer() {
    return Bi(this._view.slice());
  }
  get byteLength() {
    return this._view.byteLength;
  }
...
ut.bufFromBufLike = Bi;
var Vi = {};
Object.defineProperty(Vi, "__esModule", { value: !0 });
Vi.idlLabelToId = void 0;
function Ah(e) {
  const r = new TextEncoder().encode(e);
  let n = 0;
  for (const i of r) n = (n * 223 + i) % 2 ** 32;
...
function yu(e, t) {
  return e.byteLength < t && pu(), e.read(t);
}
Me.safeRead = yu;
function Ai(e) {
  const t = e.readUint8();
  return t === void 0 && pu(), t;
}
Me.safeReadUint8 = Ai;
function Sh(e) {
  if ((typeof e == "number" && (e = BigInt(e)), e < BigInt(0)))
    throw new Error("Cannot leb encode negative values.");
  const t = (e === BigInt(0) ? 0 : Math.ceil(Math.log2(Number(e)))) + 1,
    r = new ra.PipeArrayBuffer(new ArrayBuffer(t), 0);
  for (;;) {
    const n = Number(e & BigInt(127));
    if (((e /= BigInt(128)), e === BigInt(0))) {
      r.write(new Uint8Array([n]));
...
function gu(e) {
  let t = BigInt(1),
    r = BigInt(0),
    n;
  do (n = Ai(e)), (r += BigInt(n & 127).valueOf() * t), (t *= BigInt(128));
  while (n >= 128);
  return r;
}
Me.lebDecode = gu;
function Ih(e) {
  ...
  t && (e = -e - BigInt(1));
  const r = (e === BigInt(0) ? 0 : Math.ceil(Math.log2(Number(e)))) + 1,
    n = new ra.PipeArrayBuffer(new ArrayBuffer(r), 0);
  for (;;) {
    const a = i(e);
    if (
      ((e /= BigInt(128)),
...
function Oh(e) {
  ...
  for (; r < t.byteLength; r++)
    if (t[r] < 128) {
      if (!(t[r] & 64)) return gu(e);
      break;
    }
  const n = new Uint8Array(yu(e, r + 1));
  let i = BigInt(0);
  for (let a = n.byteLength - 1; a >= 0; a--)
    i = i * BigInt(128) + BigInt(128 - (n[a] & 127) - 1);
  return -i - BigInt(1);
...
function wu(e, t) {
  e = BigInt(e);
  const r = new ra.PipeArrayBuffer(new ArrayBuffer(Math.min(1, t)), 0);
  let n = 0,
    i = BigInt(256),
    a = BigInt(0),
    l = Number(e % i);
...
(function (e) {
  ...
  class m extends I {
    ...
    covariant(s) {
      throw new Error(`Invalid ${this.display()} argument: ${ee(s)}`);
    }
    encodeValue() {
      throw new Error("Empty cannot appear as a function argument");
    }
  ...
  class re extends S {
    constructor(s) {
      super(),
        (this._type = s),
        (this._blobOptimization = !1),
        s instanceof Q && s._bits === 8 && (this._blobOptimization = !0);
    }
    accept(s, h) {
...
index ${T} -> ${U.message}`);
    ...
    decodeValue(s, h) {
      ...
      if (!(E instanceof re)) throw new Error("Not a vector type");
...
-> ${h.message}`);
    ...
    decodeValue(s, h) {
      const E = this.checkType(h);
      if (!(E instanceof X)) throw new Error("Not an option type");
...
field ${h} -> ${T.message}`);
    ...
    encodeValue(s) {
      const h = this._fields.map(([T]) => s[T]),
        E = g(this._fields, h, ([, T], U) => T.encodeValue(U));
      return (0, r.concat)(...E);
    }
    _buildTypeTableImpl(s) {
    ...
    decodeValue(s, h) {
      const E = this.checkType(h);
      if (!(E instanceof de)) throw new Error("Not a record type");
      const T = {};
      let U = 0,
        p = 0;
      for (; p < E._fields.length; ) {
        const [c, u] = E._fields[p];
        if (U >= this._fields.length) {
          u.decodeValue(s, u), p++;
          continue;
        }
        const [w, v] = this._fields[U],
          O = (0, n.idlLabelToId)(this._fields[U][0]),
          L = (0, n.idlLabelToId)(c);
        if (O === L) (T[w] = v.decodeValue(s, u)), U++, p++;
        else if (L > O)
          if (v instanceof X || v instanceof K) (T[w] = []), U++;
          else throw new Error("Cannot find required field " + w);
        else u.decodeValue(s, u), p++;
      }
      for (const [c, u] of this._fields.slice(U))
        if (u instanceof X || u instanceof K) T[c] = [];
    ...
    valueToString(s) {
      const h = this._fields.map(([T]) => s[T]);
      return `record {${g(this._fields, h, ([T, U], p) => T + "=" + U.valueToString(p)).join("; ")}}`;
    }
  }
  e.RecordClass = de;
  class fe extends de {
...
index ${E} -> ${T.message}`);
    ...
    encodeValue(s) {
      const h = g(this._components, s, (E, T) => E.encodeValue(T));
      return (0, r.concat)(...h);
    }
    decodeValue(s, h) {
      const E = this.checkType(h);
      if (!(E instanceof fe)) throw new Error("not a tuple type");
    ...
    valueToString(s) {
      return `record {${g(this._components, s, (E, T) => E.valueToString(T)).join("; ")}}`;
    }
  }
  e.TupleClass = fe;
  class R extends S {
...
variant ${h} -> ${T.message}`);
  ...
  function z(b) {
    if ((0, i.safeReadUint8)(b) !== 1)
      throw new Error("Cannot decode principal");
    const h = Number((0, i.lebDecode)(b));
    return t.Principal.fromUint8Array(new Uint8Array((0, i.safeRead)(b, h)));
  }
  class M extends I {
    accept(s, h) {
  ...
  class j extends S {
    ...
    _buildTypeTableImpl(s) {
      this.argTypes.forEach((w) => w.buildTypeTable(s)),
        this.retTypes.forEach((w) => w.buildTypeTable(s));
      const h = (0, i.slebEncode)(-22),
        E = (0, i.lebEncode)(this.argTypes.length),
        T = (0, r.concat)(...this.argTypes.map((w) => w.encodeType(s))),
        U = (0, i.lebEncode)(this.retTypes.length),
        p = (0, r.concat)(...this.retTypes.map((w) => w.encodeType(s))),
        c = (0, i.lebEncode)(this.annotations.length),
        u = (0, r.concat)(
          ...this.annotations.map((w) => this.encodeAnnotation(w)),
        );
      s.add(this, (0, r.concat)(h, E, T, U, p, c, u));
    }
    decodeValue(s) {
    ...
    _buildTypeTableImpl(s) {
      ...
      const h = (0, i.slebEncode)(-23),
        ...
        T = this._fields.map(([U, p]) => {
          ...
          return (0, r.concat)(u, c, p.encodeType(s));
        });
      s.add(this, (0, r.concat)(h, E, ...T));
    }
    decodeValue(s) {
  ...
  e.ServiceClass = J;
  function ee(b) {
    const s = JSON.stringify(b, (h, E) =>
      typeof E == "bigint" ? `BigInt(${E})` : E,
    );
    return s && s.length > o ? s.substring(0, o - 3) + "..." : s;
  }
  function ge(b, s) {
    if (s.length < b.length) throw Error("Wrong number of message arguments");
    const h = new _();
    b.forEach((u) => u.buildTypeTable(h));
    const E = new TextEncoder().encode(l),
      T = h.encode(),
      U = (0, i.lebEncode)(s.length),
      p = (0, r.concat)(...b.map((u) => u.encodeType(h))),
      c = (0, r.concat)(
        ...g(b, s, (u, w) => {
          try {
            u.covariant(w);
...
`,
          ...
          return u.encodeValue(w);
        }),
      );
    return (0, r.concat)(E, T, U, p, c);
  }
  e.encode = ge;
  function ae(b, s) {
    const h = new r.PipeArrayBuffer(s);
    if (s.byteLength < l.length)
      throw new Error("Message length smaller than magic number");
    const E = (0, i.safeRead)(h, l.length),
      T = new TextDecoder().decode(E);
    if (T !== l) throw new Error("Wrong magic number: " + JSON.stringify(T));
    function U(Y) {
      const oe = [],
        pe = Number((0, i.lebDecode)(Y));
      for (let f = 0; f < pe; f++) {
        const d = Number((0, i.slebDecode)(Y));
        switch (d) {
          case -18:
          case -19: {
            const A = Number((0, i.slebDecode)(Y));
            oe.push([d, A]);
            break;
          }
          case -20:
          case -21: {
            const A = [];
            let k = Number((0, i.lebDecode)(Y)),
              D;
            for (; k--; ) {
              const H = Number((0, i.lebDecode)(Y));
              if (H >= Math.pow(2, 32))
                throw new Error("field id out of 32-bit range");
              if (typeof D == "number" && D >= H)
                throw new Error("field id collision or not sorted");
              D = H;
              const _e = Number((0, i.slebDecode)(Y));
              A.push([H, _e]);
            }
            oe.push([d, A]);
            break;
          ...
          case -22: {
            const A = [];
            let k = Number((0, i.lebDecode)(Y));
            for (; k--; ) A.push(Number((0, i.slebDecode)(Y)));
            const D = [];
            let H = Number((0, i.lebDecode)(Y));
            for (; H--; ) D.push(Number((0, i.slebDecode)(Y)));
            const _e = [];
            let ve = Number((0, i.lebDecode)(Y));
            for (; ve--; )
              switch (Number((0, i.lebDecode)(Y))) {
                case 1: {
                  _e.push("query");
                  break;
                }
          ...
          case -23: {
            let A = Number((0, i.lebDecode)(Y));
            const k = [];
            for (; A--; ) {
              const D = Number((0, i.lebDecode)(Y)),
                H = new TextDecoder().decode((0, i.safeRead)(Y, D)),
                _e = (0, i.slebDecode)(Y);
              k.push([H, _e]);
            }
            oe.push([d, k]);
      ...
      const me = [],
        y = Number((0, i.lebDecode)(Y));
      for (let f = 0; f < y; f++) me.push(Number((0, i.slebDecode)(Y)));
      return [oe, me];
    }
    const [p, c] = U(h);
    if (c.length < b.length) throw new Error("Wrong number of return values");
    const u = p.map((Y) => he());
    function w(Y) {
      if (Y < -24) throw new Error("future value not supported");
      if (Y < 0)
        switch (Y) {
          case -1:
            return e.Null;
      ...
      if (Y >= p.length) throw new Error("type index out of range");
      return u[Y];
    }
    function v(Y) {
      switch (Y[0]) {
        ...
        case -20: {
          const oe = {};
          for (const [y, f] of Y[1]) {
            const d = `_${y}_`;
            oe[d] = w(f);
          }
          const pe = se(oe),
            me = pe.tryAsTuple();
          return Array.isArray(me) ? le(...me) : pe;
        }
        case -21: {
          const oe = {};
          for (const [pe, me] of Y[1]) {
            const y = `_${pe}_`;
            oe[y] = w(me);
          }
          return ue(oe);
        ...
        case -23: {
          const oe = {},
            pe = Y[1];
          for (const [me, y] of pe) {
            let f = w(y);
            if ((f instanceof P && (f = f.getType()), !(f instanceof j)))
              throw new Error(
                "Illegal service definition: services can only contain functions",
              );
            oe[me] = f;
    ...
    const O = c.map((Y) => w(Y)),
      L = b.map((Y, oe) => Y.decodeValue(h, O[oe]));
    for (let Y = b.length; Y < O.length; Y++) O[Y].decodeValue(h, O[Y]);
...
var kh = ({ IDL: e }) => {
    let t = e.Rec(),
      ...
      l = e.Vec(e.Nat8),
      o = e.Record({ owner: e.Principal, subaccount: e.Opt(l) }),
      g = e.Variant({ SetTo: o, Unset: e.Null }),
      _ = e.Record({ icrc2: e.Bool }),
      B = e.Record({
    ...
    let I = e.Nat,
      ...
      m = e.Record({ start: I, length: e.Nat }),
      $ = e.Vec(e.Tuple(e.Text, n));
    n.fill(
      e.Variant({
        Int: e.Int,
        Map: $,
    ...
    let V = n,
      ...
      q = e.Record({
        ...
        archived_blocks: e.Vec(
          e.Record({ callback: K, start: I, length: e.Nat }),
        ),
      }),
      ie = e.Record({
        certificate: e.Opt(e.Vec(e.Nat8)),
      ...
      C = e.Nat,
      Z = e.Record({ start: C, length: e.Nat }),
      G = e.Nat64,
      Q = e.Record({
        from: o,
        memo: e.Opt(e.Vec(e.Nat8)),
        created_at_time: e.Opt(G),
        amount: e.Nat,
        spender: e.Opt(o),
      }),
      re = e.Record({
      ...
      R = e.Record({ transactions: e.Vec(fe) }),
      P = e.Func([Z], [R], []),
      z = e.Record({
        first_index: C,
        log_length: e.Nat,
        transactions: e.Vec(fe),
        archived_transactions: e.Vec(
          e.Record({ callback: P, start: C, length: e.Nat }),
        ),
      }),
      M = e.Nat,
      j = e.Record({ url: e.Text, name: e.Text }),
      J = e.Record({
        to: o,
        fee: e.Opt(M),
        memo: e.Opt(e.Vec(e.Nat8)),
      ...
      ee = e.Variant({
        ...
        CreatedInFuture: e.Record({ ledger_time: G }),
        TooOld: e.Null,
        InsufficientFunds: e.Record({ balance: M }),
      }),
      ge = e.Variant({ Ok: I, Err: ee }),
      ...
      se = e.Record({ metadata: ae, consent_message: x }),
      ue = e.Record({ description: e.Text }),
      he = e.Variant({
        GenericError: e.Record({ description: e.Text, error_code: e.Nat }),
        InsufficientPayment: ue,
        UnsupportedCanisterCall: ue,
        ConsentMessageUnavailable: ue,
      }),
      ne = e.Variant({ Ok: se, Err: he }),
      ce = e.Record({ account: o, spender: o }),
      b = e.Record({ allowance: e.Nat, expires_at: e.Opt(G) }),
      s = e.Record({
        fee: e.Opt(e.Nat),
        memo: e.Opt(e.Vec(e.Nat8)),
      ...
      h = e.Variant({
        ...
        CreatedInFuture: e.Record({ ledger_time: G }),
        TooOld: e.Null,
        Expired: e.Record({ ledger_time: G }),
      ...
      c = e.Record({ from: e.Opt(e.Principal) }),
      u = e.Vec(
    ...
    r.fill(
      ...
      t.fill(
        e.Record({
          ...
          archived_blocks: e.Vec(
            e.Record({ args: e.Vec(m), callback: e.Func([e.Vec(m)], [t], []) }),
          ),
        }),
      );
    let w = e.Record({ certificate: e.Vec(e.Nat8), hash_tree: e.Vec(e.Nat8) });
    return e.Service({
      archives: e.Func([], [e.Vec(S)], []),
      get_blocks: e.Func([m], [q], []),
      get_data_certificate: e.Func([], [ie], []),
      get_transactions: e.Func([Z], [z], []),
      icrc10_supported_standards: e.Func(
        [],
        [e.Vec(e.Record({ url: e.Text, name: e.Text }))],
        [],
      ),
      icrc1_balance_of: e.Func([o], [M], []),
      icrc1_decimals: e.Func([], [e.Nat8], []),
      icrc1_fee: e.Func([], [M], []),
      icrc1_metadata: e.Func([], [e.Vec(e.Tuple(e.Text, a))], []),
      icrc1_minting_account: e.Func([], [e.Opt(o)], []),
      icrc1_name: e.Func([], [e.Text], []),
      icrc1_supported_standards: e.Func([], [e.Vec(j)], []),
      icrc1_symbol: e.Func([], [e.Text], []),
      icrc1_total_supply: e.Func([], [M], []),
      icrc1_transfer: e.Func([J], [ge], []),
      icrc21_canister_call_consent_message: e.Func([te], [ne], []),
      icrc2_allowance: e.Func([ce], [b], []),
      icrc2_approve: e.Func([s], [E], []),
      icrc2_transfer_from: e.Func([T], [p], []),
      icrc3_get_archives: e.Func([c], [u], []),
      icrc3_get_blocks: e.Func([e.Vec(m)], [t], []),
      icrc3_get_tip_certificate: e.Func([], [e.Opt(w)], []),
      icrc3_supported_block_types: e.Func(
        [],
        [e.Vec(e.Record({ url: e.Text, block_type: e.Text }))],
        [],
      ),
      is_ledger_ready: e.Func([], [e.Bool], []),
    });
  },
  Ch = ({ IDL: e }) => {
    let t = e.Rec(),
      ...
      t.fill(
        e.Record({
          ...
          archived_blocks: e.Vec(
            e.Record({
              args: e.Vec(m),
              callback: e.Func([e.Vec(m)], [t], ["query"]),
            }),
          ),
        }),
      );
    ...
    return e.Service({
      ...
      get_blocks: e.Func([m], [q], ["query"]),
      get_data_certificate: e.Func([], [ie], ["query"]),
      get_transactions: e.Func([Z], [z], ["query"]),
      icrc10_supported_standards: e.Func(
        [],
        [e.Vec(e.Record({ url: e.Text, name: e.Text }))],
        ["query"],
      ),
      icrc1_balance_of: e.Func([o], [M], ["query"]),
      ...
      icrc1_supported_standards: e.Func([], [e.Vec(j)], ["query"]),
      icrc1_symbol: e.Func([], [e.Text], ["query"]),
      icrc1_total_supply: e.Func([], [M], ["query"]),
      icrc1_transfer: e.Func([J], [ge], []),
      icrc21_canister_call_consent_message: e.Func([te], [ne], []),
      icrc2_allowance: e.Func([ce], [b], ["query"]),
      icrc2_approve: e.Func([s], [E], []),
      icrc2_transfer_from: e.Func([T], [p], []),
      icrc3_get_archives: e.Func([c], [u], ["query"]),
      icrc3_get_blocks: e.Func([e.Vec(m)], [t], ["query"]),
      icrc3_get_tip_certificate: e.Func([], [e.Opt(w)], ["query"]),
      icrc3_supported_block_types: e.Func(
        [],
        [e.Vec(e.Record({ url: e.Text, block_type: e.Text }))],
        ["query"],
  ...
  Mh = ({ from_subaccount: e, fee: t, created_at_time: r, memo: n, ...i }) => ({
    ...i,
    fee: Xe(t),
    memo: Xe(n),
  ...
  Dh = (e) =>
    "GenericError" in e
      ? new Gh(e.GenericError.description, e.GenericError.error_code)
      : "InsufficientPayment" in e
        ? new jh(e.InsufficientPayment.description)
        : "UnsupportedCanisterCall" in e
          ? new Lh(e.UnsupportedCanisterCall.description)
          : "ConsentMessageUnavailable" in e
            ? new Hh(e.ConsentMessageUnavailable.description)
            : new $i(`Unknown error type ${JSON.stringify(e)}`),
  dp = class bu extends wh {
    constructor() {
      super(...arguments),
        ...
        (this.transfer = async (t) => {
          let r = await this.caller({ certified: !0 }).icrc1_transfer(Mh(t));
          if ("Err" in r)
            throw new ps({ errorType: r.Err, msg: "Failed to transfer" });
          return r.Ok;
        }),
        ...
        (this.transferFrom = async (t) => {
          ...
          if ("Err" in r)
            throw new ps({ errorType: r.Err, msg: "Failed to transfer from" });
          return r.Ok;
        }),
        (this.approve = async (t) => {
          let r = await this.caller({ certified: !0 }).icrc2_approve($h(t));
          if ("Err" in r)
            throw new ps({
              errorType: r.Err,
    ...
    static create(t) {
      let {
        ...
        certifiedService: n,
        canisterId: i,
      } = bh({ options: t, idlFactory: Ch, certifiedIdlFactory: kh });
      return new bu(i, r, n);
    }
  },
  Kh = ((e) => (
