...
for (var pe = 0, Is = ar.length; pe < Is; ++pe)
  (qt[pe] = ar[pe]), ($t[ar.charCodeAt(pe)] = pe);
$t[45] = 62;
$t[95] = 63;
function jn(e) {
  var t = e.length;
...
function Ss(e) {
  ...
  for (b = 0; b < c; b += 4)
    (t =
      ($t[e.charCodeAt(b)] << 18) |
      ($t[e.charCodeAt(b + 1)] << 12) |
      ($t[e.charCodeAt(b + 2)] << 6) |
      $t[e.charCodeAt(b + 3)]),
      (d[w++] = (t >> 16) & 255),
      (d[w++] = (t >> 8) & 255),
      (d[w++] = t & 255);
  return (
    u === 2 &&
      ((t = ($t[e.charCodeAt(b)] << 2) | ($t[e.charCodeAt(b + 1)] >> 4)),
      (d[w++] = t & 255)),
    u === 1 &&
      ((t =
        ($t[e.charCodeAt(b)] << 10) |
        ($t[e.charCodeAt(b + 1)] << 4) |
        ($t[e.charCodeAt(b + 2)] >> 2)),
      (d[w++] = (t >> 8) & 255),
      (d[w++] = t & 255)),
    d
  );
...
function Ns(e) {
  for (
    var t, r = e.length, i = r % 3, u = [], d = 16383, w = 0, c = r - i;
    w < c;
    w += d
  )
    u.push(Us(e, w, w + d > c ? c : w + d));
  return (
    i === 1
...
var Le = {};
/*! ieee754. BSD-3-Clause License. Feross Aboukhadijeh <https://feross.org/opensource> */ Le.read =
  function (e, t, r, i, u) {
    var d,
      w,
      c = u * 8 - i - 1,
      ...
      O = e[t + R];
    for (
      R += D, d = O & ((1 << -U) - 1), O >>= -U, U += c;
      U > 0;
      d = d * 256 + e[t + R], R += D, U -= 8
    );
    for (
      w = d & ((1 << -U) - 1), d >>= -U, U += i;
      U > 0;
      w = w * 256 + e[t + R], R += D, U -= 8
    );
    if (d === 0) d = 1 - A;
    else {
      if (d === b) return w ? NaN : (O ? -1 : 1) * (1 / 0);
      (w = w + Math.pow(2, i)), (d = d - A);
    }
    return (O ? -1 : 1) * w * Math.pow(2, d - i);
  };
Le.write = function (e, t, r, i, u, d) {
  var w,
    c,
    b,
    A = d * 8 - u - 1,
  ...
  for (
    t = Math.abs(t),
      isNaN(t) || t === 1 / 0
        ? ((c = isNaN(t) ? 1 : 0), (w = U))
        : ((w = Math.floor(Math.log(t) / Math.LN2)),
          t * (b = Math.pow(2, -w)) < 1 && (w--, (b *= 2)),
          w + R >= 1 ? (t += D / b) : (t += D * Math.pow(2, 1 - R)),
          t * b >= 2 && (w++, (b /= 2)),
          w + R >= U
            ? ((c = 0), (w = U))
            : w + R >= 1
              ? ((c = (t * b - 1) * Math.pow(2, u)), (w = w + R))
              : ((c = t * Math.pow(2, R - 1) * Math.pow(2, u)), (w = 0)));
    u >= 8;
    e[r + O] = c & 255, O += q, c /= 256, u -= 8
  );
  for (
    w = (w << u) | c, A += u;
    A > 0;
    e[r + O] = w & 255, O += q, w /= 256, A -= 8
  );
  e[r + O - q] |= V * 128;
};
/*!
 ...
 */ (function (e) {
  ...
  c.poolSize = 8192;
  function b(h, o, a) {
    if (typeof h == "string") return D(h, o);
  ...
  function q(h) {
    if (F(h, Uint8Array)) {
      const o = new Uint8Array(h);
      return V(o.buffer, o.byteOffset, o.byteLength);
    }
    return O(h);
  }
  function V(h, o, a) {
  ...
  function lt(h) {
    ...
    if (h.length !== void 0)
      return typeof h.length != "number" || M(h.length) ? w(0) : O(h);
    if (h.type === "Buffer" && Array.isArray(h.data)) return O(h.data);
  }
  function Et(h) {
    if (h >= u)
      throw new RangeError(
  ...
  (c.isBuffer = function (o) {
    ...
    (c.compare = function (o, a) {
      ...
      let m = o.length,
        B = a.length;
      for (let L = 0, v = Math.min(m, B); L < v; ++L)
        if (o[L] !== a[L]) {
          (m = o[L]), (B = a[L]);
          break;
        }
    ...
    (c.concat = function (o, a) {
      ...
      for (m = 0; m < o.length; ++m) {
        ...
        if (F(v, Uint8Array))
          L + v.length > B.length
            ? (c.isBuffer(v) || (v = c.from(v)), v.copy(B, L))
            : Uint8Array.prototype.set.call(B, v, L);
        else if (c.isBuffer(v)) v.copy(B, L);
  ...
  (c.prototype.swap16 = function () {
    ...
    (c.prototype.compare = function (o, a, m, B, L) {
      if (
        (F(o, Uint8Array) && (o = c.from(o, o.offset, o.byteLength)),
        !c.isBuffer(o))
      )
      ...
      if (
        ...
        a < 0 || m > o.length || B < 0 || L > this.length)
      )
        throw new RangeError("out of range index");
      if (B >= L && a >= m) return 0;
      if (B >= L) return -1;
      if (a >= m) return 1;
      if (((a >>>= 0), (m >>>= 0), (B >>>= 0), (L >>>= 0), this === o))
        return 0;
      let v = L - B,
        et = m - a;
  ...
  function J(h, o, a, m, B) {
    ...
    if ((typeof o == "string" && (o = c.from(o, m)), c.isBuffer(o)))
      return o.length === 0 ? -1 : X(h, o, a, m, B);
    if (typeof o == "number")
      return (
        (o = o & 255),
  ...
  function X(h, o, a, m, B) {
    ...
    function ht(tt, bt) {
      return L === 1 ? tt[bt] : tt.readUInt16BE(bt * L);
    }
    let st;
    if (B) {
      let tt = -1;
      for (st = a; st < v; st++)
        if (ht(h, st) === ht(o, tt === -1 ? 0 : st - tt)) {
          if ((tt === -1 && (tt = st), st - tt + 1 === et)) return tt * L;
  ...
  (c.prototype.write = function (o, a, m, B) {
  ...
  function P(h, o, a) {
    let m = "";
    a = Math.min(h.length, a);
    for (let B = o; B < a; ++B) m += String.fromCharCode(h[B] & 127);
    return m;
  }
  function k(h, o, a) {
    let m = "";
    a = Math.min(h.length, a);
    for (let B = o; B < a; ++B) m += String.fromCharCode(h[B]);
    return m;
  }
  function j(h, o, a) {
    const m = h.length;
  ...
  function Q(h, o, a) {
    ...
    for (let L = 0; L < m.length - 1; L += 2)
      B += String.fromCharCode(m[L] + m[L + 1] * 256);
    return B;
  }
  ...
  (c.prototype.readUintLE = c.prototype.readUIntLE =
    function (o, a, m) {
      (o = o >>> 0), (a = a >>> 0), m || $(o, a, this.length);
      let B = this[o],
        L = 1,
        v = 0;
      for (; ++v < a && (L *= 256); ) B += this[o + v] * L;
      return B;
    }),
    ...
    (c.prototype.readUint16LE = c.prototype.readUInt16LE =
      function (o, a) {
        return (
          (o = o >>> 0), a || $(o, 2, this.length), this[o] | (this[o + 1] << 8)
        );
      }),
    (c.prototype.readUint16BE = c.prototype.readUInt16BE =
      function (o, a) {
        return (
          (o = o >>> 0), a || $(o, 2, this.length), (this[o] << 8) | this[o + 1]
        );
      }),
    ...
    (c.prototype.readBigUInt64LE = W(function (o) {
      (o = o >>> 0), T(o, "offset");
      const a = this[o],
        m = this[o + 7];
      (a === void 0 || m === void 0) && S(o, this.length - 8);
      const B =
          a + this[++o] * 2 ** 8 + this[++o] * 2 ** 16 + this[++o] * 2 ** 24,
        L = this[++o] + this[++o] * 2 ** 8 + this[++o] * 2 ** 16 + m * 2 ** 24;
      return BigInt(B) + (BigInt(L) << BigInt(32));
    })),
    (c.prototype.readBigUInt64BE = W(function (o) {
      (o = o >>> 0), T(o, "offset");
      const a = this[o],
        m = this[o + 7];
      (a === void 0 || m === void 0) && S(o, this.length - 8);
      const B =
        ...
        L = this[++o] * 2 ** 24 + this[++o] * 2 ** 16 + this[++o] * 2 ** 8 + m;
    ...
    (c.prototype.readIntLE = function (o, a, m) {
      ...
      let B = this[o],
        ...
        v = 0;
      for (; ++v < a && (L *= 256); ) B += this[o + v] * L;
      return (L *= 128), B >= L && (B -= Math.pow(2, 8 * a)), B;
    }),
    (c.prototype.readIntBE = function (o, a, m) {
      ...
      let B = a,
        L = 1,
        v = this[o + --B];
      for (; B > 0 && (L *= 256); ) v += this[o + --B] * L;
      return (L *= 128), v >= L && (v -= Math.pow(2, 8 * a)), v;
    }),
    ...
    (c.prototype.readBigInt64LE = W(function (o) {
      (o = o >>> 0), T(o, "offset");
      const a = this[o],
        m = this[o + 7];
      (a === void 0 || m === void 0) && S(o, this.length - 8);
    ...
    (c.prototype.readBigInt64BE = W(function (o) {
      (o = o >>> 0), T(o, "offset");
      const a = this[o],
        m = this[o + 7];
      (a === void 0 || m === void 0) && S(o, this.length - 8);
    ...
    (c.prototype.readFloatLE = function (o, a) {
      return (
        (o = o >>> 0), a || $(o, 4, this.length), r.read(this, o, !0, 23, 4)
      );
    }),
    (c.prototype.readFloatBE = function (o, a) {
      return (
        (o = o >>> 0), a || $(o, 4, this.length), r.read(this, o, !1, 23, 4)
      );
    }),
    (c.prototype.readDoubleLE = function (o, a) {
      return (
        (o = o >>> 0), a || $(o, 8, this.length), r.read(this, o, !0, 52, 8)
      );
    }),
    (c.prototype.readDoubleBE = function (o, a) {
      return (
        (o = o >>> 0), a || $(o, 8, this.length), r.read(this, o, !1, 52, 8)
      );
    });
  function G(h, o, a, m, B, L) {
    if (!c.isBuffer(h))
  ...
  (c.prototype.writeUintLE = c.prototype.writeUIntLE =
    function (o, a, m, B) {
      if (((o = +o), (a = a >>> 0), (m = m >>> 0), !B)) {
        const et = Math.pow(2, 8 * m) - 1;
        G(this, o, a, m, et, 0);
      }
      let L = 1,
        v = 0;
      for (this[a] = o & 255; ++v < m && (L *= 256); )
        this[a + v] = (o / L) & 255;
      return a + m;
    }),
  ...
  function yt(h, o, a, m, B) {
    _(o, m, B, h, a, 7);
    let L = Number(o & BigInt(4294967295));
    (h[a++] = L),
      (L = L >> 8),
      (h[a++] = L),
      (L = L >> 8),
  ...
  (c.prototype.writeBigUInt64LE = W(function (o, a = 0) {
    return yt(this, o, a, BigInt(0), BigInt("0xffffffffffffffff"));
  })),
    (c.prototype.writeBigUInt64BE = W(function (o, a = 0) {
      return g(this, o, a, BigInt(0), BigInt("0xffffffffffffffff"));
    })),
    (c.prototype.writeIntLE = function (o, a, m, B) {
      if (((o = +o), (a = a >>> 0), !B)) {
        const ht = Math.pow(2, 8 * m - 1);
        G(this, o, a, m, ht - 1, -ht);
      }
      let L = 0,
        v = 1,
        et = 0;
      for (this[a] = o & 255; ++L < m && (v *= 256); )
        o < 0 && et === 0 && this[a + L - 1] !== 0 && (et = 1),
          (this[a + L] = (((o / v) >> 0) - et) & 255);
      return a + m;
    }),
    (c.prototype.writeIntBE = function (o, a, m, B) {
      if (((o = +o), (a = a >>> 0), !B)) {
        const ht = Math.pow(2, 8 * m - 1);
        G(this, o, a, m, ht - 1, -ht);
      }
    ...
    (c.prototype.writeInt32LE = function (o, a, m) {
      return (
        (o = +o),
        (a = a >>> 0),
        m || G(this, o, a, 4, 2147483647, -2147483648),
        (this[a] = o & 255),
        (this[a + 1] = o >>> 8),
        (this[a + 2] = o >>> 16),
        (this[a + 3] = o >>> 24),
    ...
    (c.prototype.writeBigInt64LE = W(function (o, a = 0) {
      return yt(
        this,
        o,
        a,
    ...
    (c.prototype.writeBigInt64BE = W(function (o, a = 0) {
      return g(
        this,
        o,
        a,
  ...
  (c.prototype.writeDoubleLE = function (o, a, m) {
    ...
    (c.prototype.copy = function (o, a, m, B) {
      ...
      B > this.length && (B = this.length),
        o.length - a < B - m && (B = o.length - a + m);
      const L = B - m;
      return (
        this === o && typeof Uint8Array.prototype.copyWithin == "function"
          ? this.copyWithin(a, m, B)
          : Uint8Array.prototype.set.call(o, this.subarray(m, B), a),
        L
      );
    }),
    (c.prototype.fill = function (o, a, m, B) {
      if (typeof o == "string") {
        if (
          (typeof a == "string"
      ...
      let L;
      if (typeof o == "number") for (L = a; L < m; ++L) this[L] = o;
      else {
        const v = c.isBuffer(o) ? o : c.from(o, B),
          et = v.length;
        if (et === 0)
          throw new TypeError(
            'The value "' + o + '" is invalid for argument "value"',
          );
        for (L = 0; L < m - a; ++L) this[L + a] = v[L % et];
      }
      return this;
    });
  const H = {};
  ...
  function x(h, o, a) {
    T(o, "offset"),
      (h[o] === void 0 || h[o + a] === void 0) && S(o, h.length - (a + 1));
  }
  function _(h, o, a, m, B, L) {
    if (h > a || h < o) {
      const v = typeof o == "bigint" ? "n" : "";
      let et;
      throw (
        (o === 0 || o === BigInt(0)
          ? (et = `>= 0${v} and < 2${v} ** ${(L + 1) * 8}${v}`)
          : (et = `>= -(2${v} ** ${(L + 1) * 8 - 1}${v}) and < 2 ** ${(L + 1) * 8 - 1}${v}`),
  ...
  function n(h, o) {
    ...
    for (let v = 0; v < m; ++v) {
      if (((a = h.charCodeAt(v)), a > 55295 && a < 57344)) {
        ...
        if (a < 56320) {
          (o -= 3) > -1 && L.push(239, 191, 189), (B = a);
          continue;
        }
        a = (((B - 55296) << 10) | (a - 56320)) + 65536;
      } else B && (o -= 3) > -1 && L.push(239, 191, 189);
      if (((B = null), a < 128)) {
        if ((o -= 1) < 0) break;
        L.push(a);
      } else if (a < 2048) {
  ...
  function l(h, o) {
    ...
    for (let v = 0; v < h.length && !((o -= 2) < 0); ++v)
      (a = h.charCodeAt(v)), (m = a >> 8), (B = a % 256), L.push(B), L.push(m);
    return L;
  }
  function p(h) {
  ...
  function E(h, o, a, m) {
    let B;
    for (B = 0; B < m && !(B + a >= o.length || B >= h.length); ++B)
      o[B + a] = h[B];
    return B;
  }
  function F(h, o) {
  ...
  const z = (function () {
    ...
    for (let a = 0; a < 16; ++a) {
      const m = a * 16;
      for (let B = 0; B < 16; ++B) o[m + B] = h[a] + h[B];
    }
    return o;
  })();
  function W(h) {
...
function vs(e) {
  ...
  let u = 0;
  function d(w) {
    let c = _e[w.toLowerCase()];
    if (c === void 0)
      throw new Error(`Invalid character: ${JSON.stringify(w)}`);
    (c <<= 3),
      (r |= c >>> t),
      (t += 5),
      t >= 8 &&
        ((i[u++] = r), (t -= 8), t > 0 ? (r = (c << (5 - t)) & 255) : (r = 0));
  }
  for (const w of e) d(w);
  return i.slice(0, u);
}
const Ls = new Uint32Array([
...
function Zn(e, ...t) {
  if (!Os(e)) throw new Error("Uint8Array expected");
...
function Qn(e) {
  return typeof e == "string" && (e = Ms(e)), Zn(e), e;
}
let Ps = class {
  clone() {
...
function ti(e) {
  const t = (i) => e().update(Qn(i)).digest(),
    r = e();
  return (
...
function Cs(e, t, r, i) {
  ...
  const u = BigInt(32),
    ...
    b = i ? 4 : 0,
    A = i ? 0 : 4;
  e.setUint32(t + b, w, i), e.setUint32(t + A, c, i);
}
const ks = (e, t, r) => (e & t) ^ (~e & r),
  $s = (e, t, r) => (e & t) ^ (e & r) ^ (t & r);
let Hs = class extends Ps {
  constructor(t, r, i, u) {
    super(),
      (this.blockLen = t),
      (this.outputLen = r),
  ...
  update(t) {
    ...
    const d = t.length;
    for (let w = 0; w < d; ) {
      const c = Math.min(u - this.pos, d - w);
      if (c === u) {
        const b = ur(t);
        for (; u <= d - w; w += u) this.process(b, w);
        continue;
      }
      i.set(t.subarray(w, w + c), this.pos),
        (this.pos += c),
        (w += c),
  ...
  digestInto(t) {
    fn(this), Ds(t, this), (this.finished = !0);
    const { buffer: r, view: i, blockLen: u, isLE: d } = this;
    let { pos: w } = this;
    (r[w++] = 128),
      this.buffer.subarray(w).fill(0),
      this.padOffset > u - w && (this.process(i, 0), (w = 0));
    for (let R = w; R < u; R++) r[R] = 0;
    Cs(i, u - 8, BigInt(this.length * 8), d), this.process(i, 0);
    const c = ur(t),
      b = this.outputLen;
    ...
    for (let R = 0; R < A; R++) c.setUint32(4 * R, U[R], d);
  }
  digest() {
...
class ei extends Hs {
  ...
  get() {
    const { A: t, B: r, C: i, D: u, E: d, F: w, G: c, H: b } = this;
    return [t, r, i, u, d, w, c, b];
  }
  set(t, r, i, u, d, w, c, b) {
    (this.A = t | 0),
      (this.B = r | 0),
  ...
  process(t, r) {
    for (let R = 0; R < 16; R++, r += 4) ee[R] = t.getUint32(r, !1);
    for (let R = 16; R < 64; R++) {
      const D = ee[R - 15],
        O = ee[R - 2],
        q = Yt(D, 7) ^ Yt(D, 18) ^ (D >>> 3),
        V = Yt(O, 17) ^ Yt(O, 19) ^ (O >>> 10);
      ee[R] = (V + ee[R - 7] + q + ee[R - 16]) | 0;
    }
    let { A: i, B: u, C: d, D: w, E: c, F: b, G: A, H: U } = this;
    for (let R = 0; R < 64; R++) {
      const D = Yt(c, 6) ^ Yt(c, 11) ^ Yt(c, 25),
        O = (U + D + ks(c, b, A) + Gs[R] + ee[R]) | 0,
        V = ((Yt(i, 2) ^ Yt(i, 13) ^ Yt(i, 22)) + $s(i, u, d)) | 0;
      (U = A),
        (A = b),
        (b = c),
        (c = (w + O) | 0),
...
const Ks = ti(() => new ei()),
  Ys = ti(() => new zs());
function Vs(e) {
  return Ys.create().update(new Uint8Array(e)).digest();
}
const Pe = "__principal__",
  ...
  Xs = (e) => e.reduce((t, r) => t + r.toString(16).padStart(2, "0"), "");
class ue {
  constructor(t) {
  ...
  static managementCanister() {
    return this.fromHex(qs);
  }
  static selfAuthenticating(t) {
    const r = Vs(t);
    return new this(new Uint8Array([...r, Ws]));
  }
  static from(t) {
  ...
  static fromText(t) {
    ...
    const i = r.toLowerCase().replace(/-/g, "");
    let u = vs(i);
  ...
  toHex() {
    return Xs(this._arr).toUpperCase();
  }
  toText() {
    const t = new ArrayBuffer(4);
    new DataView(t).setUint32(0, Rs(this._arr));
    const i = new Uint8Array(t),
      u = Uint8Array.from(this._arr),
      d = new Uint8Array([...i, ...u]),
      c = Fs(d).match(/.{1,5}/g);
...
function Ne(...e) {
  const t = new Uint8Array(e.reduce((i, u) => i + u.byteLength, 0));
  let r = 0;
  for (const i of e) t.set(new Uint8Array(i), r), (r += i.byteLength);
  return t.buffer;
}
function be(e) {
...
const js = new RegExp(/^[0-9a-fA-F]+$/);
function ce(e) {
  if (!js.test(e)) throw new Error("Invalid hexadecimal string.");
  const t = [...e]
    .reduce((r, i, u) => ((r[(u / 2) | 0] = (r[(u / 2) | 0] || "") + i), r), [])
...
function ri(e, t) {
  ...
  const r = new Uint8Array(e),
    i = new Uint8Array(t);
  for (let u = 0; u < r.length; u++) if (r[u] !== i[u]) return r[u] - i[u];
  return 0;
}
function ni(e, t) {
  return ri(e, t) === 0;
...
class Hr {
  constructor(t, r = t?.byteLength || 0) {
    (this._buffer = Tr(t || new ArrayBuffer(0))),
      (this._view = new Uint8Array(this._buffer, 0, r));
  }
  get buffer() {
    return Tr(this._view.slice());
  }
  get byteLength() {
  ...
  alloc(t) {
    const r = new ArrayBuffer(((this._buffer.byteLength + t) * 1.2) | 0),
      i = new Uint8Array(r, 0, this._view.byteLength + t);
    i.set(this._view), (this._buffer = r), (this._view = i);
  }
}
function cr(e) {
  return new DataView(e.buffer, e.byteOffset, e.byteLength).buffer;
...
function Zs(e, t) {
  return e.byteLength < t && si(), e.read(t);
}
function ln(e) {
  const t = e.readUint8();
...
function dn(e) {
  ...
  for (;;) {
    ...
    if (((e /= BigInt(128)), e === BigInt(0))) {
      r.write(new Uint8Array([i]));
      break;
    } else r.write(new Uint8Array([i | 128]));
  }
  return r.buffer;
}
function Gr(e) {
  ...
  for (;;) {
    ...
    if (
      ...
      i.write(new Uint8Array([d]));
      break;
    } else i.write(new Uint8Array([d | 128]));
  }
  function u(d) {
    const w = d % BigInt(128);
    return Number(t ? BigInt(128) - w - BigInt(1) : w);
  }
  return i.buffer;
}
function Qs(e, t) {
...
function oi(e, t) {
  ...
  let i = 0,
    ...
    d = BigInt(0),
    w = Number(e % u);
  for (r.write(new Uint8Array([w])); ++i < t; )
    e < 0 && d === BigInt(0) && w !== 0 && (d = BigInt(1)),
      (w = Number((e / u - d) % BigInt(256))),
      r.write(new Uint8Array([w])),
      (u *= BigInt(256));
  return r.buffer;
}
function ai(e, t) {
...
function to(e, t) {
  let r = ai(e, t);
  const i = BigInt(2) ** (BigInt(8) * BigInt(t - 1) + BigInt(7));
  return r >= i && (r -= i * BigInt(2)), r;
}
function Ur(e) {
  const t = BigInt(e);
...
class ci extends zr {
  ...
  encodeValue(t) {
    const r = new ArrayBuffer(this._bits / 8),
      i = new DataView(r);
    return (
      this._bits === 32 ? i.setFloat32(0, t, !0) : i.setFloat64(0, t, !0), r
    );
  }
  encodeType() {
...
class er extends zr {
  ...
  covariant(t) {
    const r = Ur(this._bits - 1) * BigInt(-1),
      i = Ur(this._bits - 1) - BigInt(1);
    let u = !1;
    if (typeof t == "bigint") u = t >= r && t <= i;
 ...
 */ (function (e) {
  ...
  function b(f, n, s) {
    ...
    if (l != null && l !== f) return c.from(l, n, s);
    var p = lt(f);
    if (p) return p;
    if (
      typeof Symbol < "u" &&
      ...
      return c.from(f[Symbol.toPrimitive]("string"), n, s);
    throw new TypeError(
      "The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type " +
        typeof f,
    );
  }
  (c.from = function (f, n, s) {
    return b(f, n, s);
  }),
    Object.setPrototypeOf(c.prototype, Uint8Array.prototype),
    Object.setPrototypeOf(c, Uint8Array);
  ...
  c.alloc = function (f, n, s) {
    return U(f, n, s);
  };
  function R(f) {
    return A(f), w(f < 0 ? 0 : Et(f) | 0);
  }
  ...
  function O(f) {
    for (
      var n = f.length < 0 ? 0 : Et(f.length) | 0, s = w(n), l = 0;
      l < n;
      l += 1
    )
      s[l] = f[l] & 255;
  ...
  function lt(f) {
    if (c.isBuffer(f)) {
      var n = Et(f.length) | 0,
        s = w(n);
      return s.length === 0 || f.copy(s, 0, 0, n), s;
    }
    if (f.length !== void 0)
      return typeof f.length != "number" || S(f.length) ? w(0) : O(f);
    if (f.type === "Buffer" && Array.isArray(f.data)) return O(f.data);
  }
  function Et(f) {
    if (f >= u)
      throw new RangeError(
  ...
  (c.isBuffer = function (n) {
    ...
    (c.compare = function (n, s) {
      ...
      if (n === s) return 0;
      for (
        var l = n.length, p = s.length, E = 0, F = Math.min(l, p);
        E < F;
        ++E
      )
        if (n[E] !== s[E]) {
    ...
    (c.concat = function (n, s) {
      if (!Array.isArray(n))
        throw new TypeError('"list" argument must be an Array of Buffers');
      if (n.length === 0) return c.alloc(0);
      var l;
      if (s === void 0) for (s = 0, l = 0; l < n.length; ++l) s += n[l].length;
  ...
  (c.prototype.swap16 = function () {
    ...
    if (n % 2 !== 0)
      throw new RangeError("Buffer size must be a multiple of 16-bits");
    for (var s = 0; s < n; s += 2) ut(this, s, s + 1);
    return this;
  }),
    (c.prototype.swap32 = function () {
      var n = this.length;
      if (n % 4 !== 0)
        throw new RangeError("Buffer size must be a multiple of 32-bits");
      for (var s = 0; s < n; s += 4) ut(this, s, s + 3), ut(this, s + 1, s + 2);
      return this;
    }),
    (c.prototype.swap64 = function () {
      var n = this.length;
    ...
    i && (c.prototype[i] = c.prototype.inspect),
    (c.prototype.compare = function (n, s, l, p, E) {
      if (
        (T(n, Uint8Array) && (n = c.from(n, n.offset, n.byteLength)),
        !c.isBuffer(n))
      )
      ...
      if (
        ...
        s < 0 || l > n.length || p < 0 || E > this.length)
      )
        throw new RangeError("out of range index");
      if (p >= E && s >= l) return 0;
      if (p >= E) return -1;
      if (s >= l) return 1;
      if (((s >>>= 0), (l >>>= 0), (p >>>= 0), (E >>>= 0), this === n))
        return 0;
      for (
        var F = E - p,
          M = l - s,
  ...
  function J(f, n, s, l, p) {
    ...
    if ((typeof n == "string" && (n = c.from(n, l)), c.isBuffer(n)))
      return n.length === 0 ? -1 : X(f, n, s, l, p);
    if (typeof n == "number")
      return (
        (n = n & 255),
        typeof Uint8Array.prototype.indexOf == "function"
          ? p
            ? Uint8Array.prototype.indexOf.call(f, n, s)
            : Uint8Array.prototype.lastIndexOf.call(f, n, s)
          : X(f, [n], s, l, p)
      );
    throw new TypeError("val must be string, number or Buffer");
  }
  function X(f, n, s, l, p) {
    var E = 1,
      F = f.length,
      M = n.length;
    if (
    ...
    if (p) {
      var rt = -1;
      for (W = s; W < F; W++)
        if (z(f, W) === z(n, rt === -1 ? 0 : W - rt)) {
          if ((rt === -1 && (rt = W), W - rt + 1 === M)) return rt * E;
        } else rt !== -1 && (W -= W - rt), (rt = -1);
    } else
      for (s + M > F && (s = F - M), W = s; W >= 0; W--) {
        for (var h = !0, o = 0; o < M; o++)
          if (z(f, W + o) !== z(n, o)) {
            h = !1;
            break;
          }
  ...
  (c.prototype.includes = function (n, s, l) {
    return this.indexOf(n, s, l) !== -1;
  }),
    (c.prototype.indexOf = function (n, s, l) {
      return J(this, n, s, l, !0);
    }),
    (c.prototype.lastIndexOf = function (n, s, l) {
      return J(this, n, s, l, !1);
    });
  function nt(f, n, s, l) {
    s = Number(s) || 0;
    var p = f.length - s;
    ...
    l > E / 2 && (l = E / 2);
    for (var F = 0; F < l; ++F) {
      var M = parseInt(n.substr(F * 2, 2), 16);
      if (S(M)) return F;
      f[s + F] = M;
    }
    return F;
  ...
  function ct(f, n, s, l) {
    return _(y(n, f.length - s), f, s, l);
  }
  (c.prototype.write = function (n, s, l, p) {
    ...
    if (
      ((l === void 0 || l > E) && (l = E),
      (n.length > 0 && (l < 0 || s < 0)) || s > this.length)
    )
      throw new RangeError("Attempt to write outside buffer bounds");
    p || (p = "utf8");
    for (var F = !1; ; )
      switch (p) {
        case "hex":
          return nt(this, n, s, l);
        case "utf8":
        case "utf-8":
          return it(this, n, s, l);
        case "ascii":
        case "latin1":
        case "binary":
          return C(this, n, s, l);
        case "base64":
          return xt(this, n, s, l);
        case "ucs2":
        case "ucs-2":
        case "utf16le":
        case "utf-16le":
          return ct(this, n, s, l);
        default:
  ...
  function ft(f, n, s) {
    return n === 0 && s === f.length
      ? t.fromByteArray(f)
      : t.fromByteArray(f.slice(n, s));
  }
  function St(f, n, s) {
  ...
  function Z(f) {
    ...
    for (var s = "", l = 0; l < n; )
      s += String.fromCharCode.apply(String, f.slice(l, (l += _t)));
    return s;
  }
  function P(f, n, s) {
    var l = "";
    s = Math.min(f.length, s);
    for (var p = n; p < s; ++p) l += String.fromCharCode(f[p] & 127);
    return l;
  }
  function k(f, n, s) {
    var l = "";
    s = Math.min(f.length, s);
    for (var p = n; p < s; ++p) l += String.fromCharCode(f[p]);
    return l;
  }
  function j(f, n, s) {
    var l = f.length;
    (!n || n < 0) && (n = 0), (!s || s < 0 || s > l) && (s = l);
    for (var p = "", E = n; E < s; ++E) p += N[f[E]];
    return p;
  }
  function Q(f, n, s) {
    for (var l = f.slice(n, s), p = "", E = 0; E < l.length - 1; E += 2)
      p += String.fromCharCode(l[E] + l[E + 1] * 256);
    return p;
  }
  c.prototype.slice = function (n, s) {
    var l = this.length;
    (n = ~~n),
      (s = s === void 0 ? l : ~~s),
  ...
  (c.prototype.readUintLE = c.prototype.readUIntLE =
    function (n, s, l) {
      (n = n >>> 0), (s = s >>> 0), l || $(n, s, this.length);
      for (var p = this[n], E = 1, F = 0; ++F < s && (E *= 256); )
        p += this[n + F] * E;
      return p;
    }),
    (c.prototype.readUintBE = c.prototype.readUIntBE =
      function (n, s, l) {
        (n = n >>> 0), (s = s >>> 0), l || $(n, s, this.length);
        for (var p = this[n + --s], E = 1; s > 0 && (E *= 256); )
          p += this[n + --s] * E;
        return p;
      }),
    (c.prototype.readUint8 = c.prototype.readUInt8 =
      function (n, s) {
        return (n = n >>> 0), s || $(n, 1, this.length), this[n];
      }),
    (c.prototype.readUint16LE = c.prototype.readUInt16LE =
      function (n, s) {
        return (
          (n = n >>> 0), s || $(n, 2, this.length), this[n] | (this[n + 1] << 8)
        );
      }),
    (c.prototype.readUint16BE = c.prototype.readUInt16BE =
      function (n, s) {
        return (
          (n = n >>> 0), s || $(n, 2, this.length), (this[n] << 8) | this[n + 1]
        );
      }),
    (c.prototype.readUint32LE = c.prototype.readUInt32LE =
      function (n, s) {
    ...
    (c.prototype.readIntLE = function (n, s, l) {
      (n = n >>> 0), (s = s >>> 0), l || $(n, s, this.length);
      for (var p = this[n], E = 1, F = 0; ++F < s && (E *= 256); )
        p += this[n + F] * E;
      return (E *= 128), p >= E && (p -= Math.pow(2, 8 * s)), p;
    }),
    (c.prototype.readIntBE = function (n, s, l) {
      (n = n >>> 0), (s = s >>> 0), l || $(n, s, this.length);
      for (var p = s, E = 1, F = this[n + --p]; p > 0 && (E *= 256); )
        F += this[n + --p] * E;
      return (E *= 128), F >= E && (F -= Math.pow(2, 8 * s)), F;
    }),
    (c.prototype.readInt8 = function (n, s) {
      return (
        (n = n >>> 0),
        s || $(n, 1, this.length),
    ...
    (c.prototype.readInt16LE = function (n, s) {
      (n = n >>> 0), s || $(n, 2, this.length);
      var l = this[n] | (this[n + 1] << 8);
      return l & 32768 ? l | 4294901760 : l;
    }),
    (c.prototype.readInt16BE = function (n, s) {
      (n = n >>> 0), s || $(n, 2, this.length);
      var l = this[n + 1] | (this[n] << 8);
      return l & 32768 ? l | 4294901760 : l;
    }),
    (c.prototype.readInt32LE = function (n, s) {
      return (
        (n = n >>> 0),
        s || $(n, 4, this.length),
    ...
    (c.prototype.readInt32BE = function (n, s) {
      return (
        (n = n >>> 0),
        s || $(n, 4, this.length),
    ...
    (c.prototype.readFloatLE = function (n, s) {
      return (
        (n = n >>> 0), s || $(n, 4, this.length), r.read(this, n, !0, 23, 4)
      );
    }),
    (c.prototype.readFloatBE = function (n, s) {
      return (
        (n = n >>> 0), s || $(n, 4, this.length), r.read(this, n, !1, 23, 4)
      );
    }),
    (c.prototype.readDoubleLE = function (n, s) {
      return (
        (n = n >>> 0), s || $(n, 8, this.length), r.read(this, n, !0, 52, 8)
      );
    }),
    (c.prototype.readDoubleBE = function (n, s) {
      return (
        (n = n >>> 0), s || $(n, 8, this.length), r.read(this, n, !1, 52, 8)
      );
    });
  function G(f, n, s, l, p, E) {
    if (!c.isBuffer(f))
      throw new TypeError('"buffer" argument must be a Buffer instance');
    if (n > p || n < E)
      throw new RangeError('"value" argument is out of bounds');
  ...
  (c.prototype.writeUintLE = c.prototype.writeUIntLE =
    function (n, s, l, p) {
      if (((n = +n), (s = s >>> 0), (l = l >>> 0), !p)) {
        var E = Math.pow(2, 8 * l) - 1;
        G(this, n, s, l, E, 0);
      }
      var F = 1,
        M = 0;
      for (this[s] = n & 255; ++M < l && (F *= 256); )
        this[s + M] = (n / F) & 255;
      return s + l;
    }),
    (c.prototype.writeUintBE = c.prototype.writeUIntBE =
    ...
    (c.prototype.writeIntLE = function (n, s, l, p) {
      if (((n = +n), (s = s >>> 0), !p)) {
        var E = Math.pow(2, 8 * l - 1);
        G(this, n, s, l, E - 1, -E);
      }
      var F = 0,
        M = 1,
        z = 0;
      for (this[s] = n & 255; ++F < l && (M *= 256); )
        n < 0 && z === 0 && this[s + F - 1] !== 0 && (z = 1),
          (this[s + F] = (((n / M) >> 0) - z) & 255);
      return s + l;
    }),
    (c.prototype.writeIntBE = function (n, s, l, p) {
      if (((n = +n), (s = s >>> 0), !p)) {
        var E = Math.pow(2, 8 * l - 1);
        G(this, n, s, l, E - 1, -E);
      }
    ...
    (c.prototype.writeInt8 = function (n, s, l) {
      return (
        (n = +n),
        (s = s >>> 0),
        l || G(this, n, s, 1, 127, -128),
        n < 0 && (n = 255 + n + 1),
        (this[s] = n & 255),
        s + 1
      );
    }),
    (c.prototype.writeInt16LE = function (n, s, l) {
      return (
        (n = +n),
        (s = s >>> 0),
        l || G(this, n, s, 2, 32767, -32768),
        (this[s] = n & 255),
        (this[s + 1] = n >>> 8),
        s + 2
      );
    }),
    (c.prototype.writeInt16BE = function (n, s, l) {
      return (
        (n = +n),
        (s = s >>> 0),
        l || G(this, n, s, 2, 32767, -32768),
    ...
    (c.prototype.writeInt32LE = function (n, s, l) {
      return (
        (n = +n),
        (s = s >>> 0),
        l || G(this, n, s, 4, 2147483647, -2147483648),
        (this[s] = n & 255),
        (this[s + 1] = n >>> 8),
        (this[s + 2] = n >>> 16),
        (this[s + 3] = n >>> 24),
    ...
    (c.prototype.writeInt32BE = function (n, s, l) {
      return (
        (n = +n),
        (s = s >>> 0),
        l || G(this, n, s, 4, 2147483647, -2147483648),
  ...
  function yt(f, n, s, l, p, E) {
    if (s + l > f.length) throw new RangeError("Index out of range");
    if (s < 0) throw new RangeError("Index out of range");
  }
  function g(f, n, s, l, p) {
    return (
      (n = +n),
      (s = s >>> 0),
      p || yt(f, n, s, 4),
      r.write(f, n, s, l, 23, 4),
      s + 4
    );
  }
  (c.prototype.writeFloatLE = function (n, s, l) {
    return g(this, n, s, !0, l);
  }),
    (c.prototype.writeFloatBE = function (n, s, l) {
      return g(this, n, s, !1, l);
    });
  function dt(f, n, s, l, p) {
    return (
      (n = +n),
      (s = s >>> 0),
      p || yt(f, n, s, 8),
      r.write(f, n, s, l, 52, 8),
      s + 8
    );
  }
  (c.prototype.writeDoubleLE = function (n, s, l) {
    return dt(this, n, s, !0, l);
  }),
    (c.prototype.writeDoubleBE = function (n, s, l) {
      return dt(this, n, s, !1, l);
    }),
    (c.prototype.copy = function (n, s, l, p) {
      ...
      p > this.length && (p = this.length),
        n.length - s < p - l && (p = n.length - s + l);
      var E = p - l;
      return (
        this === n && typeof Uint8Array.prototype.copyWithin == "function"
          ? this.copyWithin(s, l, p)
          : Uint8Array.prototype.set.call(n, this.subarray(l, p), s),
        E
      );
    }),
    (c.prototype.fill = function (n, s, l, p) {
      if (typeof n == "string") {
        if (
          (typeof s == "string"
      ...
      if (s < 0 || this.length < s || this.length < l)
        throw new RangeError("Out of range index");
      if (l <= s) return this;
      (s = s >>> 0), (l = l === void 0 ? this.length : l >>> 0), n || (n = 0);
      var F;
      if (typeof n == "number") for (F = s; F < l; ++F) this[F] = n;
      else {
        var M = c.isBuffer(n) ? n : c.from(n, p),
          z = M.length;
        if (z === 0)
          throw new TypeError(
            'The value "' + n + '" is invalid for argument "value"',
          );
        for (F = 0; F < l - s; ++F) this[F + s] = M[F % z];
      }
      return this;
    });
  ...
  function Y(f) {
    for (var n = [], s = 0; s < f.length; ++s) n.push(f.charCodeAt(s) & 255);
    return n;
  }
  function y(f, n) {
    for (var s, l, p, E = [], F = 0; F < f.length && !((n -= 2) < 0); ++F)
      (s = f.charCodeAt(F)), (l = s >> 8), (p = s % 256), E.push(p), E.push(l);
    return E;
  }
  function x(f) {
  ...
  function _(f, n, s, l) {
    for (var p = 0; p < l && !(p + s >= n.length || p >= f.length); ++p)
      n[p + s] = f[p];
    return p;
  }
  function T(f, n) {
  ...
  var N = (function () {
    for (var f = "0123456789abcdef", n = new Array(256), s = 0; s < 16; ++s)
      for (var l = s * 16, p = 0; p < 16; ++p) n[l + p] = f[s] + f[p];
    return n;
  })();
})(Oe);
var hi = { exports: {} };
(function (e) {
  (function (t) {
    var r,
      ...
      d = Math.floor,
      w = "[BigNumber Error] ",
      c = w + "Number primitive has more than 15 significant digits: ",
      b = 1e14,
      A = 14,
      U = 9007199254740991,
      R = [
    ...
    function q(J) {
      var X,
        nt,
        it,
        C = (g.prototype = { constructor: g, toString: null, valueOf: null }),
        xt = new g(1),
        ct = 20,
        ft = 4,
        St = -7,
      ...
      function g(y, x) {
        var _,
          ...
          l,
          p = this;
        if (!(p instanceof g)) return new g(y, x);
        if (x == null) {
          if (y && y._isBigNumber === !0) {
            (p.s = y.s),
              !y.c || y.e > P
                ...
                : y.e < Z
                  ? (p.c = [(p.e = 0)])
                  : ((p.e = y.e), (p.c = y.c.slice()));
            return;
          }
          if ((n = typeof y == "number") && y * 0 == 0) {
            if (((p.s = 1 / y < 0 ? ((y = -y), -1) : 1), y === ~~y)) {
              for (N = 0, f = y; f >= 10; f /= 10, N++);
              N > P ? (p.c = p.e = null) : ((p.e = N), (p.c = [y]));
              return;
            }
            l = String(y);
          } else {
            if (!i.test((l = String(y)))) return it(p, l, n);
          ...
          if ((at(x, 2, G.length, "Base"), x == 10 && yt))
            return (p = new g(y)), H(p, ct + p.e + 1, ft);
          if (((l = String(y)), (n = typeof y == "number"))) {
            if (y * 0 != 0) return it(p, l, n, x);
            if (
              ((p.s = 1 / y < 0 ? ((l = l.slice(1)), -1) : 1),
              g.DEBUG && l.replace(/^0\.0*|\./, "").length > 15)
            )
              throw Error(c + y);
          } else p.s = l.charCodeAt(0) === 45 ? ((l = l.slice(1)), -1) : 1;
          for (_ = G.slice(0, x), N = f = 0, s = l.length; f < s; f++)
        ...
        if ((l = l.slice(f, ++s))) {
          if (((s -= f), n && g.DEBUG && s > 15 && (y > U || y !== d(y))))
            throw Error(c + p.s * y);
          if ((N = N - f - 1) > P) p.c = p.e = null;
          else if (N < Z) p.c = [(p.e = 0)];
          else {
            if (
              ((p.e = N),
              (p.c = []),
              ...
              for (f && p.c.push(+l.slice(0, f)), s -= A; f < s; )
      ...
      (g.clone = q),
        ...
        (g.config = g.set =
          function (y) {
            ...
            if (y != null)
              if (typeof y == "object") {
                if (
                  (y.hasOwnProperty((x = "DECIMAL_PLACES")) &&
                    ((_ = y[x]), at(_, 0, O, x), (ct = _)),
                  y.hasOwnProperty((x = "ROUNDING_MODE")) &&
                    ((_ = y[x]), at(_, 0, 8, x), (ft = _)),
                  y.hasOwnProperty((x = "EXPONENTIAL_AT")) &&
                    ((_ = y[x]),
                    _ && _.pop
                      ? (at(_[0], -O, 0, x),
                        at(_[1], 0, O, x),
                        (St = _[0]),
                        (_t = _[1]))
                      : (at(_, -O, O, x), (St = -(_t = _ < 0 ? -_ : _)))),
                  y.hasOwnProperty((x = "RANGE")))
                )
                  if (((_ = y[x]), _ && _.pop))
                    at(_[0], -O, -1, x),
                      at(_[1], 1, O, x),
                      (Z = _[0]),
                      (P = _[1]);
                  else if ((at(_, -O, O, x), _)) Z = -(P = _ < 0 ? -_ : _);
                  else throw Error(w + x + " cannot be zero: " + _);
                if (y.hasOwnProperty((x = "CRYPTO")))
                  if (((_ = y[x]), _ === !!_))
                    if (_)
                      if (
                        typeof crypto < "u" &&
                        ...
                        k = _;
                      else throw ((k = !_), Error(w + "crypto unavailable"));
                    else k = _;
                  else throw Error(w + x + " not true or false: " + _);
                if (
                  (y.hasOwnProperty((x = "MODULO_MODE")) &&
                    ((_ = y[x]), at(_, 0, 9, x), (j = _)),
                  y.hasOwnProperty((x = "POW_PRECISION")) &&
                    ((_ = y[x]), at(_, 0, O, x), (Q = _)),
                  y.hasOwnProperty((x = "FORMAT")))
                )
                  if (((_ = y[x]), typeof _ == "object")) $ = _;
                  else throw Error(w + x + " not an object: " + _);
                if (y.hasOwnProperty((x = "ALPHABET")))
                  if (
                    ((_ = y[x]),
                    typeof _ == "string" && !/^.?$|[+\-.\s]|(.).*\1/.test(_))
                  )
                    (yt = _.slice(0, 10) == "0123456789"), (G = _);
                  else throw Error(w + x + " invalid: " + _);
              } else throw Error(w + "Object expected: " + y);
            return {
              DECIMAL_PLACES: ct,
              ROUNDING_MODE: ft,
        ...
        (g.isBigNumber = function (y) {
          ...
          t: if ({}.toString.call(T) == "[object Array]") {
            ...
            return !0;
          throw Error(w + "Invalid BigNumber: " + y);
        }),
        (g.maximum = g.max =
          function () {
        ...
        (g.random = (function () {
          ...
          return function (_) {
            var T,
              ...
              l = [],
              p = new g(xt);
            if ((_ == null ? (_ = ct) : at(_, 0, O), (f = u(_ / A)), k))
                ...
                for (T = crypto.randomBytes((f *= 7)); s < f; )
                  (n =
                    ...
                    n >= 9e15
                      ...
                      : (l.push(n % 1e14), (s += 7));
                s = f / 7;
              } else throw ((k = !1), Error(w + "crypto unavailable"));
            if (!k) for (; s < f; ) (n = x()), n < 9e15 && (l[s++] = n % 1e14);
            for (
              f = l[--s],
                _ %= A,
                f && _ && ((n = R[A - _]), (l[s] = d(f / n) * n));
              l[s] === 0;
              l.pop(), s--
            );
            if (s < 0) l = [(N = 0)];
        ...
        (g.sum = function () {
          for (var y = 1, x = arguments, _ = new g(x[0]); y < x.length; )
            _ = _.plus(x[y++]);
          return _;
        }),
        (nt = (function () {
          var y = "0123456789";
          function x(_, T, S, N) {
            for (var f, n = [0], s, l = 0, p = _.length; l < p; ) {
              for (s = n.length; s--; n[s] *= T);
          ...
          return function (_, T, S, N, f) {
            ...
            for (
              W >= 0 &&
                ...
                (F = z.pow(_.length - W)),
                (Q = p),
                (z.c = x(ut(lt(F.c), F.e, "0"), 10, S, y)),
                (z.e = z.c.length)),
                M = x(_, T, S, f ? ((n = G), y) : ((n = y), G)),
                l = p = M.length;
              M[--p] == 0;
              M.pop()
            );
            ...
            if (
              ...
              if (((M.length = s), E))
                for (--S; ++M[--s] > S; )
                  (M[s] = 0), s || (++l, (M = [1].concat(M)));
              for (p = M.length; !M[--p]; );
              for (W = 0, _ = ""; W <= p; _ += n.charAt(M[W++]));
              _ = ut(_, l, n.charAt(0));
            }
            return _;
          };
          ...
          return function (T, S, N, f, n) {
            ...
            for (
              W = new g(ht),
                ...
                ht = N + l + 1,
                n ||
                  ((n = b), (l = V(T.e / A) - V(S.e / A)), (ht = (ht / A) | 0)),
                p = 0;
              tt[p] == (st[p] || 0);
              p++
            );
                ...
                if (((F = 0), (s = x(tt, h, v, o)), s < 0)) {
                  if (
                    ...
                    for (
                      ...
                      F--, _(M, v < z ? et : tt, z, n), (z = M.length), (s = 1);
                  else F == 0 && (s = F = 1), (M = tt.slice()), (z = M.length);
                  if (
                    (z < o && (M = [0].concat(M)),
                    _(h, M, o, n),
                    (o = h.length),
      ...
      function dt(y, x, _, T) {
        var S, N, f, n, s;
        if ((_ == null ? (_ = ft) : at(_, 0, 8), !y.c)) return y.toString();
        if (((S = y.c[0]), (f = y.e), x == null))
          (s = lt(y.c)),
            (s =
              T == 1 || (T == 2 && (f <= St || f >= _t))
                ? Ut(s, f)
      ...
      function mt(y, x) {
        for (var _, T, S = 1, N = new g(y[0]); S < y.length; S++)
          (T = new g(y[S])),
            (!T.s || (_ = Et(N, T)) === x || (_ === 0 && N.s === x)) && (N = T);
        return N;
      }
      function Tt(y, x, _) {
      ...
      it = (function () {
        ...
        return function (N, f, n, s) {
          ...
          if (T.test(p)) N.s = isNaN(p) ? null : p < 0 ? -1 : 1;
            ...
            if (
              !n &&
              ((p = p.replace(y, function (E, F, M) {
                return (
                  (l = (M = M.toLowerCase()) == "x" ? 16 : M == "b" ? 2 : 8),
                  !s || s == l ? F : E
                );
              })),
      ...
      function H(y, x, _, T) {
        ...
        if (E) {
          t: {
            ...
            if (((N = x - S), N < 0))
              ...
              if (T) {
                ...
                (s = p = 0), (S = 1), (N %= A), (f = N - A + 1);
              } else break t;
            else {
              for (s = n = E[l], S = 1; n >= 10; n /= 10, S++);
              (N %= A),
                (f = N - A + S),
                (p = f < 0 ? 0 : d((s / F[S - f - 1]) % 10));
            }
            if (
              ((T =
                T ||
          ...
          y.e > P ? (y.c = y.e = null) : y.e < Z && (y.c = [(y.e = 0)]);
        }
        return y;
      }
      function Y(y) {
      ...
      return (
        ...
        (C.comparedTo = function (y, x) {
          return Et(this, new g(y, x));
        }),
        (C.decimalPlaces = C.dp =
          function (y, x) {
            ...
            if (((T = ((S = _.length - 1) - V(this.e / A)) * A), (S = _[S])))
              for (; S % 10 == 0; S /= 10, T--);
            return T < 0 && (T = 0), T;
          }),
        (C.dividedBy = C.div =
          function (y, x) {
            return X(this, new g(y, x), ct, ft);
          }),
        (C.dividedToIntegerBy = C.idiv =
          function (y, x) {
            return X(this, new g(y, x), 0, 1);
          }),
        (C.exponentiatedBy = C.pow =
          function (y, x) {
            var _,
              ...
              p,
              E = this;
            if (((y = new g(y)), y.c && !y.isInteger()))
              throw Error(w + "Exponent not an integer: " + Y(y));
            if (
              (x != null && (x = new g(x)),
              (n = y.e > 14),
              !E.c ||
              ...
              return (
                (p = new g(Math.pow(+Y(E), n ? y.s * (2 - K(y)) : +Y(y)))),
                x ? p.mod(x) : p
              );
            if (((s = y.s < 0), x)) {
              if (x.c ? !x.c[0] : !x.s) return new g(NaN);
            ...
            for (
              n
                ? ((_ = new g(0.5)), s && (y.s = 1), (l = K(y)))
                : ((S = Math.abs(+Y(y))), (l = S % 2)),
                p = new g(xt);
              ;
              ...
              if (S) {
                ...
                l = S % 2;
              } else if (((y = y.times(_)), H(y, y.e + 1, 1), y.e > 14))
                l = K(y);
              else {
                if (((S = +Y(y)), S === 0)) break;
                l = S % 2;
            ...
            return T
              ? p
              : (s && (p = xt.div(p)), x ? p.mod(x) : N ? H(p, Q, ft, f) : p);
          }),
        (C.integerValue = function (y) {
          var x = new g(this);
          return y == null ? (y = ft) : at(y, 0, 8), H(x, x.e + 1, y);
        }),
        (C.isEqualTo = C.eq =
          function (y, x) {
            return Et(this, new g(y, x)) === 0;
          }),
        (C.isFinite = function () {
          return !!this.c;
        }),
        ...
        (C.isGreaterThanOrEqualTo = C.gte =
          function (y, x) {
            return (x = Et(this, new g(y, x))) === 1 || x === 0;
          }),
        (C.isInteger = function () {
          return !!this.c && V(this.e / A) > this.c.length - 2;
        }),
        (C.isLessThan = C.lt =
          function (y, x) {
            return Et(this, new g(y, x)) < 0;
        ...
        (C.minus = function (y, x) {
          var _,
            ...
            f = this,
            n = f.s;
          if (((y = new g(y, x)), (x = y.s), !n || !x)) return new g(NaN);
          if (n != x) return (y.s = -x), f.plus(y);
          var s = f.e / A,
            l = y.e / A,
            p = f.c,
            E = y.c;
          if (!s || !l) {
            if (!p || !E) return p ? ((y.s = -x), y) : new g(E ? f : NaN);
            if (!p[0] || !E[0])
              return E[0]
                ? ((y.s = -x), y)
                : new g(p[0] ? f : ft == 3 ? -0 : 0);
          }
          if (((s = V(s)), (l = V(l)), (p = p.slice()), (n = s - l))) {
            for (
              (N = n < 0) ? ((n = -n), (S = p)) : ((l = s), (S = E)),
                S.reverse(),
                x = n;
              x--;
              S.push(0)
        ...
        (C.multipliedBy = C.times =
          function (y, x) {
            ...
            if (!o || !a || !o[0] || !a[0])
              return (
                !h.s || !y.s || (o && !o[0] && !a) || (a && !a[0] && !o)
                  ? (y.c = y.e = y.s = null)
                  : ((y.s *= h.s),
                    !o || !a ? (y.c = y.e = null) : ((y.c = [0]), (y.e = 0))),
                y
              );
            for (
              T = V(h.e / A) + V(y.e / A),
                ...
                s = o.length,
                E = a.length,
                s < E && ((z = o), (o = a), (a = z), (S = s), (s = E), (E = S)),
                S = s + E,
                z = [];
              S--;
              z.push(0)
            );
            for (W = b, rt = D, S = E; --S >= 0; ) {
              for (
                _ = 0, F = a[S] % rt, M = (a[S] / rt) | 0, f = s, N = S + f;
                N > S;
            ...
            return _ ? ++T : z.splice(0, 1), Tt(y, z, T);
          }),
        (C.negated = function () {
          var y = new g(this);
        ...
        (C.plus = function (y, x) {
          var _,
            T = this,
            S = T.s;
          if (((y = new g(y, x)), (x = y.s), !S || !x)) return new g(NaN);
          if (S != x) return (y.s = -x), T.minus(y);
          var N = T.e / A,
            f = y.e / A,
            n = T.c,
            s = y.c;
          if (!N || !f) {
            if (!n || !s) return new g(S / 0);
            if (!n[0] || !s[0]) return s[0] ? y : new g(n[0] ? T : S * 0);
          }
          if (((N = V(N)), (f = V(f)), (n = n.slice()), (S = N - f))) {
            for (
              S > 0 ? ((f = N), (_ = s)) : ((S = -S), (_ = n)), _.reverse();
              S--;
              _.push(0)
            );
            _.reverse();
          ...
          for (
            ...
            (S = ((n[--x] = n[x] + s[x] + S) / b) | 0),
              (n[x] = b === n[x] ? 0 : n[x] % b);
          return S && ((n = [S].concat(n)), ++f), Tt(y, n, f);
        }),
        (C.precision = C.sd =
          function (y, x) {
            var _,
            ...
            return y && N.e + 1 > T && (T = N.e + 1), T;
          }),
        (C.shiftedBy = function (y) {
          return at(y, -U, U), this.times("1e" + y);
        }),
        (C.squareRoot = C.sqrt =
          function () {
            var y,
              ...
              p = new g("0.5");
            if (n !== 1 || !f || !f[0])
              return new g(!n || (n < 0 && (!f || f[0])) ? NaN : f ? N : 1 / 0);
            if (
              ((n = Math.sqrt(+Y(N))),
              n == 0 || n == 1 / 0
                ? ((x = lt(f)),
              ...
              for (s = _.e, n = s + l, n < 3 && (n = 0); ; )
                if (
                  ((S = _),
                  (_ = p.times(S.plus(X(N, S, l, 1)))),
                  lt(S.c).slice(0, n) === (x = lt(_.c)).slice(0, n))
                )
                  if (
                    (_.e < s && --n,
                    (x = x.slice(n - 3, n + 1)),
                    ...
                    if (!T && (H(S, S.e + ct + 2, 0), S.times(S).eq(N))) {
                      _ = S;
                      break;
                    }
                    (l += 4), (n += 4), (T = 1);
                    ...
                    (!+x || (!+x.slice(1) && x.charAt(0) == "5")) &&
                      (H(_, _.e + ct + 2, 1), (y = !_.times(_).eq(N)));
                    break;
                  }
            }
            return H(_, _.e + ct + 1, ft, y);
          }),
        (C.toExponential = function (y, x) {
          return y != null && (at(y, 0, O), y++), dt(this, y, x, 1);
        }),
        (C.toFixed = function (y, x) {
          return (
            y != null && (at(y, 0, O), (y = y + this.e + 1)), dt(this, y, x)
          );
        }),
        (C.toFormat = function (y, x, _) {
          var T,
            S = this;
          if (_ == null)
            y != null && x && typeof x == "object"
              ? ((_ = x), (x = null))
              : y && typeof y == "object"
                ? ((_ = y), (y = x = null))
                : (_ = $);
          else if (typeof _ != "object")
            throw Error(w + "Argument not an object: " + _);
          if (((T = S.toFixed(y, x)), S.c)) {
            var N,
              f = T.split("."),
              n = +_.groupSize,
              ...
              M = F ? p.slice(1) : p,
              z = M.length;
            if ((s && ((N = n), (n = s), (s = N), (z -= N)), n > 0 && z > 0)) {
              for (N = z % n || n, p = M.substr(0, N); N < z; N += n)
                p += l + M.substr(N, n);
              s > 0 && (p += l + M.slice(N)), F && (p = "-" + p);
            }
            T = E
              ? p +
                (_.decimalSeparator || "") +
        ...
        (C.toFraction = function (y) {
          ...
          if (
            y != null &&
            ((n = new g(y)), (!n.isInteger() && (n.c || n.s !== 1)) || n.lt(xt))
          )
            throw Error(
              w +
                "Argument " +
          ...
          for (
            x = new g(xt),
              ...
              T = s = new g(xt),
              F = lt(z),
              N = x.e = F.length - M.e - 1,
              x.c[0] = R[(f = N % A) < 0 ? A + f : f],
              y = !y || n.comparedTo(x) > 0 ? (N > 0 ? x : l) : n,
              f = P,
              P = 1 / 0,
              n = new g(F),
              s.c[0] = 0;
            (p = X(n, x, 0, 1)), (S = _.plus(p.times(T))), S.comparedTo(y) != 1;

          )
            (_ = T),
              (T = S),
              (l = s.plus(p.times((S = l)))),
              (s = S),
          ...
          return (
            ...
            (E =
              X(l, T, N, ft)
                .minus(M)
                .abs()
                .comparedTo(X(s, _, N, ft).minus(M).abs()) < 1
                ? [l, T]
                : [s, _]),
            (P = f),
            E
        ...
        (C.toPrecision = function (y, x) {
          return y != null && at(y, 1, O), dt(this, y, x, 2);
        }),
        (C.toString = function (y) {
          ...
          return (
            S === null
              ...
              : (y == null
                  ? (x =
                      S <= St || S >= _t ? Ut(lt(_.c), S) : ut(lt(_.c), S, "0"))
                  : y === 10 && yt
                    ? ((_ = H(new g(_), ct + S + 1, ft)),
                      (x = ut(lt(_.c), _.e, "0")))
                    : (at(y, 2, G.length, "Base"),
                      (x = nt(ut(lt(_.c), S, "0"), 10, y, T, !0))),
                T < 0 && _.c[0] && (x = "-" + x)),
            x
          );
        }),
    ...
    function lt(J) {
      for (var X, nt, it = 1, C = J.length, xt = J[0] + ""; it < C; ) {
        for (X = J[it++] + "", nt = A - X.length; nt--; X = "0" + X);
        xt += X;
      }
  ...
  ro = function (t, r, i) {
    ...
    function Tt(I) {
      for (
        I = I | 0, g = 0, dt = I;
        (g | 0) < (dt | 0) &&
        ((mt = xs[u[g] & 255](u[g] | 0) | 0), !((mt | 0) > 0));

      );
      return mt | 0;
    }
    function H(I) {
      return (I = I | 0), (((g | 0) + (I | 0)) | 0) < (dt | 0) ? 0 : 1;
    }
    function Y(I) {
    ...
    function x(I) {
      return (I = I | 0), d(I | 0), (g = (g + 1) | 0), 0;
    }
    function _(I) {
      return (
        (I = I | 0),
        H(1) | 0 ? 1 : (d(u[(g + 1) | 0] | 0), (g = (g + 2) | 0), 0)
      );
    }
    function T(I) {
      return (
        (I = I | 0),
        H(2) | 0 ? 1 : (d(Y((g + 1) | 0) | 0), (g = (g + 3) | 0), 0)
      );
    }
    function S(I) {
      return (
        ...
        H(4) | 0
          ? 1
          : (w(Y((g + 1) | 0) | 0, Y((g + 3) | 0) | 0), (g = (g + 5) | 0), 0)
      );
    }
    function N(I) {
      return (
    ...
    function f(I) {
      return (I = I | 0), d((-1 - ((I - 32) | 0)) | 0), (g = (g + 1) | 0), 0;
    }
    function n(I) {
      return (
        (I = I | 0),
    ...
    function l(I) {
      return (
        ...
        H(4) | 0
          ? 1
          : (c(Y((g + 1) | 0) | 0, Y((g + 3) | 0) | 0), (g = (g + 5) | 0), 0)
      );
    }
    function p(I) {
      return (
    ...
    function L(I) {
      return (I = I | 0), Z(), (g = (g + 1) | 0), 0;
    }
    function v(I) {
      return (I = I | 0), J((I - 128) | 0), (g = (g + 1) | 0), 0;
    }
    function et(I) {
      return (
        (I = I | 0),
        H(1) | 0 ? 1 : (J(u[(g + 1) | 0] | 0), (g = (g + 2) | 0), 0)
      );
    }
    function ht(I) {
      return (
        (I = I | 0),
        H(2) | 0 ? 1 : (J(Y((g + 1) | 0) | 0), (g = (g + 3) | 0), 0)
      );
    }
    function st(I) {
      return (
        ...
        H(4) | 0
          ? 1
          : (X(Y((g + 1) | 0) | 0, Y((g + 3) | 0) | 0), (g = (g + 5) | 0), 0)
      );
    }
    function tt(I) {
      return (
    ...
    function Nt(I) {
      ...
      return (
        (wt = (I - 160) | 0),
        H(wt | 0) | 0 ? 1 : (C(wt | 0), (g = (g + 1) | 0), 0)
      );
    }
    function ts(I) {
      return (
        (I = I | 0),
        H(1) | 0 ? 1 : (C(u[(g + 1) | 0] | 0), (g = (g + 2) | 0), 0)
      );
    }
    function es(I) {
      return (
        (I = I | 0),
        H(2) | 0 ? 1 : (C(Y((g + 1) | 0) | 0), (g = (g + 3) | 0), 0)
      );
    }
    function rs(I) {
      return (
        ...
        H(4) | 0
          ? 1
          : (xt(Y((g + 1) | 0) | 0, Y((g + 3) | 0) | 0), (g = (g + 5) | 0), 0)
      );
    }
    function ns(I) {
      return (
    ...
    function is(I) {
      return (I = I | 0), it(), (g = (g + 1) | 0), 0;
    }
    function de(I) {
      return (I = I | 0), k((I - 192) | 0 | 0), (g = (g + 1) | 0), 0;
    }
    function iu(I) {
      return (I = I | 0), k(I | 0), (g = (g + 1) | 0), 0;
    }
    function su(I) {
      return (I = I | 0), k(I | 0), (g = (g + 1) | 0), 0;
    }
    ...
    function ss(I) {
      return (
        (I = I | 0),
        H(1) | 0 ? 1 : (k(u[(g + 1) | 0] | 0), (g = (g + 2) | 0), 0)
      );
    }
    function os(I) {
      return (
        (I = I | 0),
        H(2) | 0 ? 1 : (k(Y((g + 1) | 0) | 0), (g = (g + 3) | 0), 0)
      );
    }
    function as(I) {
      return (
        ...
        H(4) | 0
          ? 1
          : (j(Y((g + 1) | 0) | 0, Y((g + 3) | 0) | 0), (g = (g + 5) | 0), 0)
      );
    }
    function us(I) {
      return (
    ...
    function vt(I) {
      return (I = I | 0), P(((I | 0) - 224) | 0), (g = (g + 1) | 0), 0;
    }
    function cs(I) {
      return (I = I | 0), q(), (g = (g + 1) | 0), 0;
    }
    function fs(I) {
      return (I = I | 0), O(), (g = (g + 1) | 0), 0;
    }
    function hs(I) {
      return (I = I | 0), lt(), (g = (g + 1) | 0), 0;
    }
    function ls(I) {
      return (I = I | 0), V(), (g = (g + 1) | 0), 0;
    }
    function ds(I) {
      return (
        (I = I | 0),
        H(1) | 0 ? 1 : (P(u[(g + 1) | 0] | 0), (g = (g + 2) | 0), 0)
      );
    }
    function ps(I) {
      I = I | 0;
...
Mt.SIMPLE = { FALSE: 20, TRUE: 21, NULL: 22, UNDEFINED: 23 };
Mt.SYMS = {
  NULL: Symbol("null"),
...
Mt.SHIFT32 = Math.pow(2, 32);
Mt.SHIFT16 = Math.pow(2, 16);
Mt.MAX_SAFE_HIGH = 2097151;
Mt.NEG_ONE = new Kr(-1);
Mt.TEN = new Kr(10);
Mt.TWO = new Kr(2);
Mt.PARENT = {
  ...
  e.parseHalf = function (A) {
    ...
    return (
      ...
      U
        ? U === 31
          ? D * (R ? NaN : 1 / 0)
          : D * Math.pow(2, U - 25) * (1024 + R)
        : D * 5960464477539063e-23 * R
    );
  };
  function c(b) {
  ...
  (e.arrayBufferToBignumber = function (b) {
    ...
    (e.buildMap = (b) => {
      const A = new Map(),
        U = Object.keys(b),
        R = U.length;
      for (let D = 0; D < R; D++) A.set(U[D], b[U[D]]);
      return A;
    }),
    (e.buildInt32 = (b, A) => b * d + A),
    (e.buildInt64 = (b, A, U, R) => {
      const D = e.buildInt32(b, A),
        O = e.buildInt32(U, R);
      return D > w ? new r(D).times(u).plus(O) : D * u + O;
    }),
    (e.writeHalf = function (A, U) {
      const R = t.allocUnsafe(4);
      R.writeFloatBE(U, 0);
      const D = R.readUInt32BE(0);
      if (D & 8191) return !1;
      var O = (D >> 16) & 32768;
      const q = (D >> 23) & 255,
        V = D & 8388607;
      if (q >= 113 && q <= 142) O += ((q - 112) << 10) + (V >> 13);
      else if (q >= 103 && q < 113) {
        if (V & ((1 << (126 - q)) - 1)) return !1;
        O += (V + 8388608) >> (126 - q);
      } else return !1;
      return A.writeUInt16BE(O, 0), !0;
    }),
    (e.keySorter = function (b, A) {
      var U = b[0].byteLength,
        R = A[0].byteLength;
      return U > R ? 1 : R > U ? -1 : b[0].compare(A[0]);
    }),
...
let io = class Nr {
  ...
  encodeCBOR(t) {
    return t._pushInt(this.value, no.SIMPLE_FLOAT);
  }
  static isSimple(t) {
...
let so = class Fr {
  ...
  convert(t) {
    ...
    if (
      ((i = t?.[this.tag]),
      typeof i != "function" &&
        ((i = Fr["_tag" + this.tag]), typeof i != "function"))
    )
      return this;
    try {
      return i.call(Fr, this.value);
    } catch (u) {
...
var di = so;
const pi = self.location
    ? self.location.protocol + "//" + self.location.host
    : "",
  vr = self.URL;
let oo = class {
  constructor(t = "", r = pi) {
    (this.super = new vr(t, r)),
...
function ao(e) {
  if (typeof e == "string") return new vr(e).toString();
  if (!(e instanceof vr)) {
    const t = e.username && e.password ? `${e.username}:${e.password}@` : "",
      ...
      A = e.pathname || "",
      U = e.path || A + c;
    return `${u}${t || r}${d || w + i}${U}${b}`;
  }
}
var wi = {
  URLWithLegacySupport: oo,
  URLSearchParams: self.URLSearchParams,
  defaultBase: pi,
  format: ao,
};
const { URLWithLegacySupport: wn, format: uo } = wi;
var co = (e, t = {}, r = {}, i) => {
  ...
  return new wn(e, uo(w)).toString();
};
const {
    URLWithLegacySupport: fo,
    format: ho,
    URLSearchParams: lo,
    defaultBase: po,
  } = wi,
...
let Lr = class Rr {
  constructor(t) {
    (t = t || {}),
      !t.size || t.size < 65536
        ? (t.size = 65536)
        : (t.size = Pt.nextPowerOf2(t.size)),
      (this._heap = new ArrayBuffer(t.size)),
      (this._heap8 = new Uint8Array(this._heap)),
      (this._buffer = we.from(this._heap)),
      this._reset(),
      (this._knownTags = Object.assign(
        {
          0: (r) => new Date(r),
          1: (r) => new Date(r * 1e3),
          2: (r) => Pt.arrayBufferToBignumber(r),
          3: (r) => It.NEG_ONE.minus(Pt.arrayBufferToBignumber(r)),
  ...
  _push(t, r) {
    ...
    switch ((i.values++, i.type)) {
      ...
      case It.PARENT.UTF8_STRING:
        i.length > -1
          ? (this._ref[this._ref.length - i.length] = t)
          : this._ref.push(t),
          this._dec();
        break;
      case It.PARENT.OBJECT:
        i.tmpKey != null
          ? ((this._ref[i.tmpKey] = t), (i.tmpKey = null), this._dec())
          : ((i.tmpKey = t),
            typeof i.tmpKey != "string" &&
              ((i.type = It.PARENT.MAP), (i.ref = Pt.buildMap(i.ref))));
        break;
      case It.PARENT.MAP:
        i.tmpKey != null
          ? (this._ref.set(i.tmpKey, t), (i.tmpKey = null), this._dec())
          : (i.tmpKey = t);
        break;
      case It.PARENT.TAG:
  ...
  createTag(t, r) {
    const i = this._knownTags[t];
    return i ? i(r) : new mo(t, r);
  }
  createMap(t, r) {
    return t;
  }
  ...
  createByteStringFromHeap(t, r) {
    return t === r ? we.alloc(0) : we.from(this._heap.slice(t, r));
  }
  createInt(t) {
    return t;
  }
  createInt32(t, r) {
    return Pt.buildInt32(t, r);
  }
  createInt64(t, r, i, u) {
    return Pt.buildInt64(t, r, i, u);
  }
  createFloat(t) {
    return t;
  }
  createFloatSingle(t, r, i, u) {
    return yn.read([t, r, i, u], 0, !1, 23, 4);
  }
  createFloatDouble(t, r, i, u, d, w, c, b) {
    return yn.read([t, r, i, u, d, w, c, b], 0, !1, 52, 8);
  }
  createInt32Neg(t, r) {
    return -1 - Pt.buildInt32(t, r);
  }
  createInt64Neg(t, r, i, u) {
    const d = Pt.buildInt32(t, r),
      w = Pt.buildInt32(i, u);
    return d > It.MAX_SAFE_HIGH
      ? It.NEG_ONE.minus(new yo(d).times(It.SHIFT32).plus(w))
      : -1 - (d * It.SHIFT32 + w);
  }
  createTrue() {
    return !0;
  ...
  pushInt64(t, r, i, u) {
    this._push(this.createInt64(t, r, i, u));
  }
  pushFloat(t) {
    this._push(this.createFloat(t));
  }
  pushFloatSingle(t, r, i, u) {
    this._push(this.createFloatSingle(t, r, i, u));
  }
  pushFloatDouble(t, r, i, u, d, w, c, b) {
    this._push(this.createFloatDouble(t, r, i, u, d, w, c, b));
  }
  pushInt32Neg(t, r) {
    this._push(this.createInt32Neg(t, r));
  }
  pushInt64Neg(t, r, i, u) {
    this._push(this.createInt64Neg(t, r, i, u));
  }
  pushTrue() {
  ...
  pushArrayStartFixed32(t, r) {
    const i = Pt.buildInt32(t, r);
    this._createArrayStartFixed(i);
  }
  pushArrayStartFixed64(t, r, i, u) {
    const d = Pt.buildInt64(t, r, i, u);
  ...
  pushObjectStartFixed64(t, r, i, u) {
    const d = Pt.buildInt64(t, r, i, u);
  ...
  pushTagStart4(t, r) {
    this.pushTagStart(Pt.buildInt32(t, r));
  }
  pushTagStart8(t, r, i, u) {
    this.pushTagStart(Pt.buildInt64(t, r, i, u));
  }
  pushTagUnassigned(t) {
  ...
  static decode(t, r) {
    return (
      typeof t == "string" && (t = we.from(t, r || "hex")),
...
class Vr extends Eo {
  ...
  createInt64(t, r, i, u) {
    return super.createInt64(t, r, i, u).toString();
  }
  createInt32Neg(t, r) {
    return super.createInt32Neg(t, r).toString();
  }
  createInt64Neg(t, r, i, u) {
    return super.createInt64Neg(t, r, i, u).toString();
  }
  createTrue() {
    return "true";
  }
  ...
  createFloat(t) {
    ...
    return _o.isNegativeZero(t) ? "-0_1" : `${r}_1`;
  }
  createFloatSingle(t, r, i, u) {
    return `${super.createFloatSingle(t, r, i, u)}_2`;
  }
  createFloatDouble(t, r, i, u, d, w, c, b) {
    return `${super.createFloatDouble(t, r, i, u, d, w, c, b)}_3`;
  }
  createByteString(t, r) {
    const i = t.join(", ");
    return r === -1 ? `(_ ${i})` : `h'${i}`;
  ...
  createArray(t, r) {
    const i = super.createArray(t, r);
    return r === -1 ? `[_ ${i.join(", ")}]` : `[${i.join(", ")}]`;
  }
  createMap(t, r) {
    const i = super.createMap(t),
      u = Array.from(i.keys()).reduce(gn(i), "");
    return r === -1 ? `{_ ${u}}` : `{${u}}`;
  }
  createObject(t, r) {
    const i = super.createObject(t),
      u = Object.keys(i).reduce(gn(i), "");
    return r === -1 ? `{_ ${u}}` : `{${u}}`;
  }
  createUtf8String(t, r) {
    const i = t.join(", ");
...
const { Buffer: Wt } = Oe,
  ...
  mn = Rt.SYMS,
  ye = Rt.TAG,
  Ao = (Rt.MT.SIMPLE_FLOAT << 5) | Rt.NUMBYTES.TWO,
  So = (Rt.MT.SIMPLE_FLOAT << 5) | Rt.NUMBYTES.FOUR,
  To = (Rt.MT.SIMPLE_FLOAT << 5) | Rt.NUMBYTES.EIGHT,
  Uo = (Rt.MT.SIMPLE_FLOAT << 5) | Rt.SIMPLE.TRUE,
  No = (Rt.MT.SIMPLE_FLOAT << 5) | Rt.SIMPLE.FALSE,
  Fo = (Rt.MT.SIMPLE_FLOAT << 5) | Rt.SIMPLE.UNDEFINED,
  bn = (Rt.MT.SIMPLE_FLOAT << 5) | Rt.SIMPLE.NULL,
  vo = new Or("0x20000000000000"),
  Lo = Wt.from("f97e00", "hex"),
  Ro = Wt.from("f9fc00", "hex"),
  Oo = Wt.from("f97c00", "hex");
function Do(e) {
...
class je {
  constructor(t) {
    (t = t || {}),
      ...
      (this.semanticTypes = [
        [Bo, this._pushUrl],
        [Or, this._pushBigNumber],
      ]);
    const r = t.genTypes || [],
      i = r.length;
    for (let u = 0; u < i; u++) this.addSemanticType(r[u][0], r[u][1]);
    this._reset();
  }
  addSemanticType(t, r) {
    ...
    for (let u = 0; u < i; u++)
      if (this.semanticTypes[u][0] === t) {
        const w = this.semanticTypes[u][1];
        return (this.semanticTypes[u][1] = r), w;
      }
  ...
  _pushFloat(t) {
    const r = Wt.allocUnsafe(2);
    if (lr.writeHalf(r, t) && lr.parseHalf(r) === t)
      return this._pushUInt8(Ao) && this.push(r);
    const i = Wt.allocUnsafe(4);
    return (
      i.writeFloatBE(t, 0),
      i.readFloatBE(0) === t
        ? this._pushUInt8(So) && this.push(i)
        : this._pushUInt8(To) && this._pushDoubleBE(t)
    );
  }
  _pushInt(t, r, i) {
    const u = r << 5;
          ...
          : t <= 4294967295
            ...
            : t <= Number.MAX_SAFE_INTEGER
              ? this._pushUInt8(u | ke.EIGHT) &&
                this._pushUInt32BE(Math.floor(t / xn)) &&
                this._pushUInt32BE(t % xn)
              : r === Ht.NEG_INT
                ? this._pushFloat(i)
                : this._pushFloat(t);
  }
  ...
  _pushString(t) {
    const r = Wt.byteLength(t, "utf8");
    return this._pushInt(r, Ht.UTF8_STRING) && this.pushWrite(t, 5, r);
  }
  _pushBoolean(t) {
    return this._pushUInt8(t ? Uo : No);
  }
  _pushUndefined(t) {
    return this._pushUInt8(Fo);
  }
  _pushArray(t, r) {
    const i = r.length;
    if (!t._pushInt(i, Ht.ARRAY)) return !1;
    for (let u = 0; u < i; u++) if (!t.pushAny(r[u])) return !1;
    return !0;
  }
  _pushTag(t) {
  ...
  _pushDate(t, r) {
    return t._pushTag(ye.DATE_EPOCH) && t.pushAny(Math.round(r / 1e3));
  }
  _pushBuffer(t, r) {
  ...
  _pushRegexp(t, r) {
    return t._pushTag(ye.REGEXP) && t.pushAny(r.source);
  }
  _pushSet(t, r) {
    if (!t._pushInt(r.size, Ht.ARRAY)) return !1;
    for (const i of r) if (!t.pushAny(i)) return !1;
    return !0;
  }
  _pushUrl(t, r) {
    return t._pushTag(ye.URI) && t.pushAny(r.format());
  }
  _pushBigint(t) {
    let r = ye.POS_BIGINT;
    t.isNegative() && ((t = t.negated().minus(1)), (r = ye.NEG_BIGINT));
    let i = t.toString(16);
    i.length % 2 && (i = "0" + i);
    const u = Wt.from(i, "hex");
  ...
  _pushBigNumber(t, r) {
    ...
    if (!(t._pushTag(ye.DECIMAL_FRAC) && t._pushInt(2, Ht.ARRAY))) return !1;
    const i = r.decimalPlaces(),
      u = r.multipliedBy(new Or(10).pow(i));
    return t._pushIntNum(-i)
      ? u.abs().isLessThan(vo)
  ...
  _pushObject(t) {
    if (!t) return this._pushUInt8(bn);
    for (var r = this.semanticTypes.length, i = 0; i < r; i++)
      if (t instanceof this.semanticTypes[i][0])
        return this.semanticTypes[i][1].call(t, this, t);
    var u = t.encodeCBOR;
    if (typeof u == "function") return u.call(t, this);
    var d = Object.keys(t),
      w = d.length;
    return this._pushInt(w, Ht.MAP)
      ? this._pushRawMap(
          w,
          d.map((c) => [c, t[c]]),
        )
  ...
  _pushRawMap(t, r) {
    r = r
      ...
      .sort(lr.keySorter);
    for (var i = 0; i < t; i++)
      if (!this.push(r[i][0]) || !this.pushAny(r[i][1])) return !1;
    return !0;
  }
  write(t) {
  ...
  pushAny(t) {
    ...
    switch (r) {
      ...
      case "Uint8Array":
        return this._pushBuffer(this, Wt.isBuffer(t) ? t : Wt.from(t));
      case "Null":
        return this._pushUInt8(bn);
      case "Undefined":
    ...
    for (w = 0; w < u; w++) {
      switch (((A = r[w]), i[w])) {
        case 0:
          ...
          break;
        case 1:
          c.writeUInt8(t[w], b, !0);
          break;
        case 2:
          c.writeUInt16BE(t[w], b, !0);
          break;
        case 3:
          c.writeUInt32BE(t[w], b, !0);
          break;
        case 4:
          c.writeDoubleBE(t[w], b, !0);
          break;
        case 5:
          c.write(t[w], b, A, "utf8");
          break;
        default:
...
var xi = bs(fi);
function he(e) {
  return Ue(Ks.create().update(new Uint8Array(e)).digest());
}
function ze(e) {
  if (e instanceof xi.Tagged) return ze(e.value);
  ...
  if (Array.isArray(e)) {
    ...
    if (typeof e == "object" && e !== null && typeof e.toHash == "function")
      return ze(e.toHash());
    if (typeof e == "object") return bi(e);
...
const Co = new TextEncoder().encode(`
ic-request`);
class qr {
  getPrincipal() {
    return (
  ...
  async transformRequest(t) {
    ...
    return Object.assign(Object.assign({}, i), {
      body: {
        ...
        sender_sig: await this.sign(Ne(Co, u)),
      },
    });
  }
}
...
function Qt(e, ...t) {
  ...
  let i = e.byteLength;
  for (const u of t) r.set(new Uint8Array(u), i), (i += u.byteLength);
  return r.buffer;
}
function Kt(e, t, r) {
  r = r.replace(/[^0-9a-fA-F]/g, "");
  const i = 2 ** (t - 24);
  r = r.slice(-i * 2).padStart(i * 2, "0");
...
function Ei(e) {
  ...
  for (let r = 0; r < e.length; r++) {
    ...
    i < 128
      ? t.push(i)
      : i < 2048
        ? t.push(192 | (i >> 6), 128 | (i & 63))
        : i < 55296 || i >= 57344
          ? t.push(224 | (i >> 12), 128 | ((i >> 6) & 63), 128 | (i & 63))
          : (r++,
            (i = ((i & 1023) << 10) | (e.charCodeAt(r) & 1023)),
            t.push(
              240 | (i >> 18),
              128 | ((i >> 12) & 63),
              128 | ((i >> 6) & 63),
  ...
  if (e < 24) return Qt(new Uint8Array([192 + e]), t);
  {
    const r = e <= 255 ? 24 : e <= 65535 ? 25 : e <= 4294967295 ? 26 : 27,
      ...
      u = e
        ...
        .slice(-i * 2)
        .padStart(i * 2, "0"),
      d = [192 + r].concat(u.match(/../g).map((w) => parseInt(w, 16)));
...
function Xr(e, t) {
  ...
  if (((e = parseInt("" + e, t)), isNaN(e)))
    throw new RangeError("Invalid number.");
  return (e = Math.min(Math.max(0, e), ko)), (e = e.toString(16)), Kt(0, 27, e);
}
At.u64 = Xr;
function Ai(e) {
  if (isNaN(e)) throw new RangeError("Invalid number.");
...
function Ni(e, t) {
  if (typeof e == "string" && t == 16) {
    if (
      ...
      throw new RangeError("Invalid number.");
    let r = !1,
      i = e.split("").reduceRight((u, d) => {
        if (r) return d + u;
        let w = parseInt(d, 16) - 1;
        return w >= 0 ? ((r = !0), w.toString(16) + u) : "f" + u;
      }, "");
    return r ? Kt(1, 27, i) : Xr(0);
  }
  if (((e = parseInt("" + e, t)), isNaN(e)))
    throw new RangeError("Invalid number.");
  return (
...
function Yo(e, t = !1) {
  ...
  return (
    t && (r = r.sort(([i], [u]) => i.localeCompare(u))),
    Qt(or(5, e.size), ...r.map(([i, u]) => Qt(Ei(i), u)))
  );
}
At.map = Yo;
function Vo(e) {
...
class Oi {
  ...
  static withDefaultEncoders(t = !1) {
    const r = new this();
    return r.addEncoder(new Li(r, t)), r.addEncoder(new Ri()), r;
  }
  removeEncoder(t) {
  ...
  getEncoderFor(t) {
    ...
    for (const i of this._encoders)
      (!r || i.priority > r.priority) && i.match(t) && (r = i);
...
Ie.SelfDescribeCborSerializer = Qo;
(function (e) {
  function t(u) {
  ...
  var r =
    ...
    function (u) {
      ...
      var d = {};
      if (u != null)
        for (var w in u) Object.hasOwnProperty.call(u, w) && (d[w] = u[w]);
...
jr.addEncoder(new ta());
jr.addEncoder(new ea());
jr.addEncoder(new ra());
var _n;
(function (e) {
  (e[(e.Uint64LittleEndian = 71)] = "Uint64LittleEndian"),
    (e[(e.Semantic = 55799)] = "Semantic");
})(_n || (_n = {}));
class yu extends xi.Decoder {
  createByteString(t) {
    return Ne(...t);
  }
  createByteStringFromHeap(t, r) {
...
const ge =
  typeof globalThis == "object" && "crypto" in globalThis
    ? globalThis.crypto
    : void 0;
/*! noble-hashes - MIT License (c) 2022 Paul Miller (paulmillr.com) */ const dr =
  (e) => new DataView(e.buffer, e.byteOffset, e.byteLength);
function sa(e) {
  if (typeof e != "string")
    throw new Error("utf8ToBytes expected string, got " + typeof e);
...
function Mi(e) {
  return typeof e == "string" && (e = sa(e)), Di(e), e;
}
class oa {
  clone() {
    return this._cloneInto();
...
function aa(e) {
  const t = (i) => e().update(Mi(i)).digest(),
    r = e();
  return (
    (t.outputLen = r.outputLen),
    (t.blockLen = r.blockLen),
...
function ua(e = 32) {
  if (ge && typeof ge.getRandomValues == "function")
    return ge.getRandomValues(new Uint8Array(e));
...
class fa extends oa {
  ...
  digestInto(t) {
    Bn(this), ia(t, this), (this.finished = !0);
    const { buffer: r, view: i, blockLen: u, isLE: d } = this;
    let { pos: w } = this;
    (r[w++] = 128),
      this.buffer.subarray(w).fill(0),
      this.padOffset > u - w && (this.process(i, 0), (w = 0));
    for (let R = w; R < u; R++) r[R] = 0;
    ca(i, u - 8, BigInt(this.length * 8), d), this.process(i, 0);
    const c = dr(t),
      b = this.outputLen;
    if (b % 4) throw new Error("_sha2: outputLen should be aligned to 32bit");
    const A = b / 4,
...
const la = Array.from({ length: 256 }, (e, t) =>
  t.toString(16).padStart(2, "0"),
);
function en(e) {
  tn(e);
  let t = "";
  for (let r = 0; r < e.length; r++) t += la[e[r]];
  return t;
}
function Ci(e) {
  if (typeof e != "string")
...
function ki(e) {
  ...
  for (let u = 0, d = 0; u < r; u++, d += 2) {
    const w = An(e.charCodeAt(d)),
      c = An(e.charCodeAt(d + 1));
...
function Ke(e) {
  return tn(e), Ci(en(Uint8Array.from(e).reverse()));
}
function $i(e, t) {
  return ki(e.toString(16).padStart(t * 2, "0"));
}
function Dr(e, t) {
  return $i(e, t).reverse();
}
function Xt(e, t, r) {
  let i;
  if (typeof t == "string")
  ...
  else if (Qr(t)) i = Uint8Array.from(t);
...
function Sn(...e) {
  ...
  const r = new Uint8Array(t);
  for (let i = 0, u = 0; i < e.length; i++) {
    const d = e[i];
    r.set(d, u), (u += d.length);
  }
  return r;
}
const wr = (e) => typeof e == "bigint" && Zr <= e;
function pa(e, t, r) {
...
function wa(e) {
  let t;
  for (t = 0; e > Zr; e >>= Pi, t += 1);
  return t;
}
const ya = (e) => (ha << BigInt(e - 1)) - Pi,
  ga = {
...
function rn(e, t, r = {}) {
  ...
  for (const [u, d] of Object.entries(t)) i(u, d, !1);
  for (const [u, d] of Object.entries(r)) i(u, d, !0);
  return e;
}
function Tn(e) {
  const t = new WeakMap();
...
function ma(e, t, r) {
  ...
  if (r === Ft) return Dt;
  let i = Ft;
  for (; t > Dt; ) t & Ft && (i = (i * e) % r), (e = (e * e) % r), (t >>= Ft);
  return i;
}
function Vt(e, t, r) {
  let i = e;
...
function Fn(e, t) {
  ...
  if (i !== Ft) throw new Error("invert: does not exist");
  return Lt(u, t);
}
function ba(e) {
  const t = (e - Ft) / le;
  let r, i, u;
  for (r = e - Ft, i = 0; r % le === Dt; r /= le, i++);
  for (u = le; u < e && ma(u, t, e) !== e - Ft; u++)
  ...
  return function (c, b) {
    ...
    for (; !c.eql(D, c.ONE); ) {
      ...
      let O = 1;
      for (let V = c.sqr(D); O < A && !c.eql(V, c.ONE); O++) V = c.sqr(V);
      const q = c.pow(U, Ft << BigInt(A - O - 1));
      (U = c.sqr(q)), (R = c.mul(R, q)), (D = c.mul(D, U)), (A = O);
    }
    return R;
  };
}
function Ea(e) {
  if (e % Mr === xa) {
    ...
    return function (i, u) {
      const d = i.pow(u, t);
      if (!i.eql(i.sqr(d), u)) throw new Error("Cannot find square root");
      return d;
    };
  }
  if (e % Nn === Un) {
    ...
    return function (i, u) {
      const d = i.mul(u, le),
        w = i.pow(d, t),
        c = i.mul(u, w),
        b = i.mul(i.mul(c, le), w),
        A = i.mul(c, i.sub(b, i.ONE));
      if (!i.eql(i.sqr(A), u)) throw new Error("Cannot find square root");
      return A;
    };
  }
  return ba(e);
}
const _a = (e, t) => (Lt(e, t) & Ft) === Ft,
  Ia = [
    "create",
    "isValid",
    "is0",
...
function Ba(e) {
  const t = {
    ...
    r = Ia.reduce((i, u) => ((i[u] = "function"), i), t);
  return rn(e, r);
}
function Aa(e, t, r) {
  ...
  let i = e.ONE,
    u = t;
  for (; r > Dt; ) r & Ft && (i = e.mul(i, u)), (u = e.sqr(u)), (r >>= Ft);
  return i;
}
function Sa(e, t) {
  const r = new Array(t.length),
    i = t.reduce(
      (d, w, c) => (e.is0(w) ? d : ((r[c] = d), e.mul(d, w))),
      e.ONE,
    ),
    u = e.inv(i);
  return (
    t.reduceRight(
      (d, w, c) => (e.is0(w) ? d : ((r[c] = e.mul(d, r[c])), e.mul(d, w))),
      u,
    ),
    r
  );
...
function Gi(e, t, r = !1, i = {}) {
  if (e <= Dt) throw new Error("invalid field: expected ORDER > 0, got " + e);
  const { nBitLength: u, nByteLength: d } = Hi(e, t);
  if (d > 2048)
  ...
  const c = Object.freeze({
    ...
    mul: (b, A) => Lt(b * A, e),
    pow: (b, A) => Aa(c, b, A),
    div: (b, A) => Lt(b * Fn(A, e), e),
    sqrN: (b) => b * b,
    addN: (b, A) => b + A,
    subN: (b, A) => b - A,
    mulN: (b, A) => b * A,
    inv: (b) => Fn(b, e),
    sqrt: i.sqrt || ((b) => (w || (w = Ea(e)), w(c, b))),
    invertBatch: (b) => Sa(c, b),
    cmov: (b, A, U) => (U ? A : b),
    toBytes: (b) => (r ? Dr(b, d) : $i(b, d)),
    fromBytes: (b) => {
      if (b.length !== d)
        throw new Error(
...
function Ta(e, t) {
  ...
  e.forEach((r, i) => {
    if (!(r instanceof t)) throw new Error("invalid point at index " + i);
  });
}
function Ua(e, t) {
  if (!Array.isArray(e)) throw new Error("array of scalars expected");
  e.forEach((r, i) => {
    if (!t.isValid(r)) throw new Error("invalid scalar at index " + i);
  });
}
...
function Na(e, t) {
  return {
    ...
    unsafeLadder(r, i, u = e.ZERO) {
      let d = r;
      for (; i > vn; ) i & $e && (u = u.add(d)), (d = d.double()), (i >>= $e);
      return u;
    },
    precomputeWindow(r, i) {
      const { windows: u, windowSize: d } = gr(i, t),
        w = [];
      let c = r,
        b = c;
      for (let A = 0; A < u; A++) {
        (b = c), w.push(b);
        for (let U = 1; U < d; U++) (b = b.add(c)), w.push(b);
        c = b.double();
      }
      return w;
    },
    wNAF(r, i, u) {
      const { windows: d, windowSize: w } = gr(r, t);
      let c = e.ZERO,
        b = e.BASE;
      const A = BigInt(2 ** r - 1),
        U = 2 ** r,
        R = BigInt(r);
      for (let D = 0; D < d; D++) {
        const O = D * w;
        ...
        const V = O,
          ...
          Et = D % 2 !== 0,
          at = q < 0;
        q === 0 ? (b = b.add(yr(Et, i[V]))) : (c = c.add(yr(at, i[lt])));
      }
      return { p: c, f: b };
    },
    wNAFUnsafe(r, i, u, d = e.ZERO) {
      const { windows: w, windowSize: c } = gr(r, t),
        b = BigInt(2 ** r - 1),
        A = 2 ** r,
        U = BigInt(r);
      for (let R = 0; R < w; R++) {
        ...
        if (u === vn) break;
        let O = Number(u & b);
        if (((u >>= U), O > c && ((O -= A), (u += $e)), O === 0)) continue;
        let q = i[D + Math.abs(O) - 1];
        O < 0 && (q = q.negate()), (d = d.add(q));
      }
      return d;
    },
    getPrecomputes(r, i, u) {
      let d = xr.get(i);
      return (
        d || ((d = this.precomputeWindow(i, r)), r !== 1 && xr.set(i, u(d))), d
      );
    },
    wNAFCached(r, i, u) {
      const d = mr(r);
    ...
    wNAFCachedUnsafe(r, i, u, d) {
      const w = mr(r);
      return w === 1
        ? this.unsafeLadder(r, i, d)
        : this.wNAFUnsafe(w, this.getPrecomputes(w, r, u), i, d);
    },
    setWindowSize(r, i) {
      zi(i, t), Ki.set(r, i), xr.delete(r);
    },
  };
}
function Fa(e, t, r, i) {
  if ((Ta(r, e), Ua(i, t), r.length !== i.length))
    throw new Error("arrays of points and scalars must have equal length");
  const u = e.ZERO,
    d = wa(BigInt(r.length)),
    w = d > 12 ? d - 3 : d > 4 ? d - 2 : d ? 2 : 1,
    c = (1 << w) - 1,
    b = new Array(c + 1).fill(u),
    A = Math.floor((t.BITS - 1) / w) * w;
  let U = u;
  for (let R = A; R >= 0; R -= w) {
    b.fill(u);
    for (let O = 0; O < i.length; O++) {
      const q = i[O],
        V = Number((q >> BigInt(R)) & BigInt(c));
      b[V] = b[V].add(r[O]);
    }
    let D = u;
    for (let O = b.length - 1, q = u; O > 0; O--)
      (q = q.add(b[O])), (D = D.add(q));
    if (((U = U.add(D)), R !== 0)) for (let O = 0; O < w; O++) U = U.double();
  }
  return U;
}
function va(e) {
  return (
    ...
    Object.freeze({ ...Hi(e.n, e.nBitLength), ...e, p: e.Fp.ORDER })
  );
}
var Ln;
(function (e) {
...
function La(e, t = !1) {
  ...
  for (let u = 0; u < e.length; u++) {
    const { h: d, l: w } = Yi(e[u], t);
    [r[u], i[u]] = [d, w];
  }
  return [r, i];
}
const Ra = (e, t) => (BigInt(e >>> 0) << Pr) | BigInt(t >>> 0),
  Oa = (e, t, r) => e >>> r,
  Da = (e, t, r) => (e << (32 - r)) | (t >>> r),
  Ma = (e, t, r) => (e >>> r) | (t << (32 - r)),
  Pa = (e, t, r) => (e << (32 - r)) | (t >>> r),
  Ca = (e, t, r) => (e << (64 - r)) | (t >>> (r - 32)),
  ka = (e, t, r) => (e >>> (r - 32)) | (t << (64 - r)),
  $a = (e, t) => t,
  Ha = (e, t) => e,
  Ga = (e, t, r) => (e << r) | (t >>> (32 - r)),
  za = (e, t, r) => (t << r) | (e >>> (32 - r)),
  Ka = (e, t, r) => (t << (r - 32)) | (e >>> (64 - r)),
  Ya = (e, t, r) => (e << (r - 32)) | (t >>> (64 - r));
function Va(e, t, r, i) {
  const u = (t >>> 0) + (i >>> 0);
  return { h: (e + r + ((u / 2 ** 32) | 0)) | 0, l: u | 0 };
}
const Wa = (e, t, r) => (e >>> 0) + (t >>> 0) + (r >>> 0),
  qa = (e, t, r, i) => (t + r + i + ((e / 2 ** 32) | 0)) | 0,
  Ja = (e, t, r, i) => (e >>> 0) + (t >>> 0) + (r >>> 0) + (i >>> 0),
  Xa = (e, t, r, i, u) => (t + r + i + u + ((e / 2 ** 32) | 0)) | 0,
  ja = (e, t, r, i, u) =>
    (e >>> 0) + (t >>> 0) + (r >>> 0) + (i >>> 0) + (u >>> 0),
  Za = (e, t, r, i, u, d) => (t + r + i + u + d + ((e / 2 ** 32) | 0)) | 0,
  ot = {
    fromBig: Yi,
    split: La,
    toBig: Ra,
...
class e0 extends fa {
  ...
  get() {
    ...
    return [t, r, i, u, d, w, c, b, A, U, R, D, O, q, V, lt];
  }
  set(t, r, i, u, d, w, c, b, A, U, R, D, O, q, V, lt) {
    (this.Ah = t | 0),
      (this.Al = r | 0),
      (this.Bh = i | 0),
      (this.Bl = u | 0),
  ...
  process(t, r) {
    ...
    for (let K = 0; K < 80; K++) {
      const Ut =
          ot.rotrSH(R, D, 14) ^ ot.rotrSH(R, D, 18) ^ ot.rotrBH(R, D, 41),
        ut = ot.rotrSL(R, D, 14) ^ ot.rotrSL(R, D, 18) ^ ot.rotrBL(R, D, 41),
        J = (R & O) ^ (~R & V),
        X = (D & q) ^ (~D & lt),
        nt = ot.add5L(at, ut, X, t0[K], ne[K]),
        it = ot.add5H(nt, Et, Ut, J, Qa[K], re[K]),
        C = nt | 0,
        xt = ot.rotrSH(i, u, 28) ^ ot.rotrBH(i, u, 34) ^ ot.rotrBH(i, u, 39),
        ct = ot.rotrSL(i, u, 28) ^ ot.rotrBL(i, u, 34) ^ ot.rotrBL(i, u, 39),
        ft = (i & d) ^ (i & c) ^ (d & c),
        St = (u & w) ^ (u & b) ^ (w & b);
      (Et = V | 0),
        (at = lt | 0),
        ...
        (O = R | 0),
        (q = D | 0),
        ({ h: R, l: D } = ot.add(A | 0, U | 0, it | 0, C | 0)),
        (A = c | 0),
        (U = b | 0),
        (c = d | 0),
        (b = w | 0),
      ...
      (i = ot.add3H(_t, it, xt, ft)), (u = _t | 0);
    }
    ({ h: i, l: u } = ot.add(this.Ah | 0, this.Al | 0, i | 0, u | 0)),
      ({ h: d, l: w } = ot.add(this.Bh | 0, this.Bl | 0, d | 0, w | 0)),
      ({ h: c, l: b } = ot.add(this.Ch | 0, this.Cl | 0, c | 0, b | 0)),
      ({ h: A, l: U } = ot.add(this.Dh | 0, this.Dl | 0, A | 0, U | 0)),
      ({ h: R, l: D } = ot.add(this.Eh | 0, this.El | 0, R | 0, D | 0)),
      ({ h: O, l: q } = ot.add(this.Fh | 0, this.Fl | 0, O | 0, q | 0)),
      ({ h: V, l: lt } = ot.add(this.Gh | 0, this.Gl | 0, V | 0, lt | 0)),
      ({ h: Et, l: at } = ot.add(this.Hh | 0, this.Hl | 0, Et | 0, at | 0)),
      this.set(i, u, d, w, c, b, A, U, R, D, O, q, V, lt, Et, at);
  }
  roundClean() {
    re.fill(0), ne.fill(0);
  }
...
function o0(e) {
  const t = s0(e),
    ...
    O = t.adjustScalarBytes || ((Z) => Z),
    q =
      t.domain ||
      ((Z, P, k) => {
        if ((pr("phflag", k), P.length || k))
          throw new Error("Contexts/pre-hash are not supported");
        return Z;
      });
  function V(Z, P) {
    Ae("coordinate " + Z, P, Gt, A);
  }
  function lt(Z) {
  ...
  const Et = Tn((Z, P) => {
      ...
      const G = U(k * P),
        ...
        g = U(Q * P);
      if ($) return { x: Gt, y: Ct };
      if (g !== Ct) throw new Error("invZ was invalid");
      return { x: G, y: yt };
    }),
    at = Tn((Z) => {
      const { a: P, d: k } = t;
      if (Z.is0()) throw new Error("bad point: ZERO");
      const { ex: j, ey: Q, ez: $, et: G } = Z,
        yt = U(j * j),
        g = U(Q * Q),
        dt = U($ * $),
        mt = U(dt * dt),
      ...
      const y = U(j * Q),
        x = U($ * G);
      if (y !== x) throw new Error("bad point: equation left != right (2)");
      return !0;
    });
  class K {
    constructor(P, k, j, Q) {
    ...
    static fromAffine(P) {
      ...
      const { x: k, y: j } = P || {};
      return V("x", k), V("y", j), new K(k, j, Ct, U(k * j));
    }
    static normalizeZ(P) {
    ...
    negate() {
      return new K(U(-this.ex), this.ey, this.ez, U(-this.et));
    }
    double() {
      const { a: P } = t,
        { ex: k, ey: j, ez: Q } = this,
        ...
        _ = U(mt * Y),
        T = U(H * Tt);
      return new K(y, x, T, _);
    }
    add(P) {
      lt(P);
      const { a: k, d: j } = t,
        { ex: Q, ey: $, ez: G, et: yt } = this,
        { ex: g, ey: dt, ez: mt, et: Tt } = P;
      if (k === BigInt(-1)) {
        const p = U(($ - Q) * (dt + g)),
          E = U(($ + Q) * (dt - g)),
          F = U(E - p);
        if (F === Gt) return this.double();
        const M = U(G * Ge * Tt),
          z = U(yt * Ge * mt),
          W = z + M,
          rt = E + p,
    ...
    isTorsionFree() {
      return J.unsafeLadder(this, i).is0();
    }
    toAffine(P) {
      return Et(this, P);
    }
    ...
    static fromHex(P, k = !1) {
      const { d: j, a: Q } = t,
        $ = r.BYTES;
      (P = Xt("pointHex", P, $)), pr("zip215", k);
      const G = P.slice(),
        yt = P[$ - 1];
      G[$ - 1] = yt & -129;
      const g = Ke(G),
        dt = k ? A : r.ORDER;
      Ae("pointHex.y", g, Gt, dt);
      const mt = U(g * g),
        Tt = U(mt - Ct),
        H = U(j * mt - Q);
      let { isValid: Y, value: y } = D(Tt, H);
      if (!Y) throw new Error("Point.fromHex: invalid y coordinate");
      const x = (y & Ct) === Ct,
        _ = (yt & 128) !== 0;
      if (!k && y === Gt && _) throw new Error("Point.fromHex: x=0 and x_0=1");
      return _ !== x && (y = U(-y)), K.fromAffine({ x: y, y: g });
    }
  ...
  (K.BASE = new K(t.Gx, t.Gy, Ct, U(t.Gx * t.Gy))),
    (K.ZERO = new K(Gt, Ct, Ct, Gt));
  ...
  function it(Z) {
    const P = r.BYTES;
    Z = Xt("private key", Z, P);
    const k = Xt("hashed private key", d(Z), 2 * P),
      j = O(k.slice(0, P)),
      Q = k.slice(P, 2 * P),
      $ = nt(j),
      G = Ut.multiply($),
      yt = G.toRawBytes();
    return { head: j, prefix: Q, scalar: $, point: G, pointBytes: yt };
  }
  function C(Z) {
    return it(Z).pointBytes;
  }
  function xt(Z = new Uint8Array(), ...P) {
    const k = Sn(...P);
    return nt(d(q(k, Xt("context", Z), !!u)));
  }
  function ct(Z, P, k = {}) {
    (Z = Xt("message", Z)), u && (Z = u(Z));
    const { prefix: j, scalar: Q, pointBytes: $ } = it(P),
      G = xt(k.context, j, Z),
      yt = Ut.multiply(G).toRawBytes(),
      g = xt(k.context, yt, $, Z),
      dt = X(G + g * Q);
    Ae("signature.s", dt, Gt, i);
    const mt = Sn(yt, Dr(dt, r.BYTES));
    return Xt("result", mt, r.BYTES * 2);
  }
  const ft = i0;
  function St(Z, P, k, j = ft) {
    const { context: Q, zip215: $ } = j,
      G = r.BYTES;
    (Z = Xt("signature", Z, 2 * G)),
      (P = Xt("message", P)),
      (k = Xt("publicKey", k, G)),
      $ !== void 0 && pr("zip215", $),
      u && (P = u(P));
    const yt = Ke(Z.slice(G, 2 * G));
    let g, dt, mt;
    try {
      (g = K.fromHex(k, $)),
    ...
    if (!$ && g.isSmallOrder()) return !1;
    const Tt = xt(Q, dt.toRawBytes(), g.toRawBytes(), P);
    return dt
      .add(g.multiplyUnsafe(Tt))
      .subtract(mt)
      .clearCofactor()
      .equals(K.ZERO);
  }
...
function f0(e) {
  const t = BigInt(10),
    ...
    V = (Vt(q, u, d) * O) % d,
    lt = (Vt(V, t, d) * U) % d;
  return { pow_p_5_8: (Vt(lt, Mn, d) * e) % d, b2: c };
}
function h0(e) {
...
const kn = Uint8Array.from([48, 5, 6, 3, 43, 101, 112]);
Uint8Array.from([
  48, 16, 6, 7, 42, 134, 72, 206, 61, 2, 1, 6, 5, 43, 129, 4, 0, 10,
]);
function y0(e, t) {
  const r = 2 + Pn(e.byteLength + 1),
    i = t.byteLength + r + e.byteLength;
  let u = 0;
  const d = new Uint8Array(1 + Pn(i) + i);
  return (
    (d[u++] = 48),
    (u += Cn(d, u, i)),
    d.set(t, u),
...
const g0 = (e, t) => {
  ...
  const i = (c, b) => {
    ...
    u = new Uint8Array(e);
  if (
    (i(48, "sequence"), (r += Cr(u, r)), !ni(u.slice(r, r + t.byteLength), t))
  )
    throw new Error("Not the expected OID.");
  (r += t.byteLength), i(3, "bit string");
  const d = w0(u, r) - 1;
  (r += Cr(u, r)), i(0, "0 padding");
  const w = u.slice(r);
  if (d !== w.length)
    throw new Error(
      `DER payload mismatch: Expected length ${d} actual length ${w.length}`,
    );
  return w;
};
var $n;
...
var Ze = function (e, t, r, i, u) {
    ...
    return i === "a" ? u.call(e, r) : u ? (u.value = r) : t.set(e, r), r;
  },
  se = function (e, t, r, i) {
    if (r === "a" && !i)
...
class Zt {
  constructor(t) {
    ...
    Ze(this, Ye, t, "f"), Ze(this, Ve, Zt.derEncode(t), "f");
  }
  static from(t) {
    if (typeof t == "string") {
      const r = ce(t);
      ...
      if (ArrayBuffer.isView(r)) {
        const i = r;
        return this.fromRaw(ii(i.buffer));
      } else {
...
class ae extends qr {
  ...
  static generate(t) {
    ...
    const i = Se.getPublicKey(r);
    return ae.fromKeyPair(i, r);
  }
  static fromParsedJson(t) {
    const [r, i] = t;
    return new ae(Zt.fromDer(ce(r)), ce(i));
  }
  static fromJSON(t) {
  ...
  async sign(t) {
    const r = new Uint8Array(t),
      i = Ue(Se.sign(r, se(this, me, "f").slice(0, 32)));
    return (
...
class Qe extends qr {
  constructor(t, r, i) {
    super(), (this._keyPair = t), (this._derKey = r), (this._subtleCrypto = i);
  }
  static async generate(t) {
    const {
      ...
      d = zn(u),
      w = await d.generateKey({ name: "ECDSA", namedCurve: "P-256" }, r, i),
      c = await d.exportKey("spki", w.publicKey);
    return new this(w, c, d);
  }
  static async fromKeyPair(t, r) {
    const i = zn(r),
      u = await i.exportKey("spki", t.publicKey);
    return new Qe(t, u, i);
  }
  getKeyPair() {
...
class m0 {
  constructor(t) {
    ie.set(this, void 0), x0(this, ie, t, "f");
  }
  get rawKey() {
...
var b0 = function (e, t, r, i, u) {
  ...
  We;
const I0 = new TextEncoder().encode("ic-request-auth-delegation"),
  B0 = new TextEncoder().encode(`
ic-request`);
function br(e) {
...
async function A0(e, t, r, i) {
  const u = new on(t.toDer(), BigInt(+r) * BigInt(1e6), i),
    d = new Uint8Array([...I0, ...new Uint8Array(Wr(Object.assign({}, u)))]),
    w = await e.sign(d);
  return { delegation: u, signature: w };
}
class Fe {
  constructor(t, r) {
    (this.delegations = t), (this.publicKey = r);
  }
  static async create(t, r, i = new Date(Date.now() + 15 * 60 * 1e3), u = {}) {
    var d, w;
    const c = await A0(t, r, i, u.targets);
    return new Fe(
      [
    ...
    const u = i.map((d) => {
      ...
      return {
        delegation: new on(
          ...
          U &&
            U.map((R) => {
              if (typeof R != "string") throw new Error("Invalid target.");
              return ue.fromHex(R);
            }),
        ),
        signature: br(c),
  ...
  toJSON() {
    return {
      delegations: this.delegations.map((t) => {
        const { delegation: r, signature: i } = t,
          { targets: u } = r;
        return {
    ...
    return Object.assign(Object.assign({}, i), {
      body: {
        ...
        sender_sig: await this.sign(
          new Uint8Array([...B0, ...new Uint8Array(u)]),
        ),
...
class tr extends m0 {
  constructor(t, r) {
    super(t), We.set(this, void 0), b0(this, We, r, "f");
  }
  get delegation() {
    return E0(this, We, "f");
  }
...
We = new WeakMap();
function Vi(e, t) {
  for (const { delegation: i } of e.delegations)
...
const Vn = ["mousedown", "mousemove", "keydown", "touchstart", "wheel"];
class Wn {
  constructor(t = {}) {
    var r;
    (this.callbacks = []),
    ...
    const { onIdle: i, idleTimeout: u = 10 * 60 * 1e3 } = t || {};
    (this.callbacks = i ? [i] : []), (this.idleTimeout = u);
    ...
    const w = (c, b) => {
      ...
      return (...U) => {
        const R = this,
          D = function () {
            (A = void 0), c.apply(R, U);
          };
        clearTimeout(A), (A = window.setTimeout(D, b));
      };
    };
    if (t?.captureScroll) {
      const c = w(
...
const S0 = (e, t) => t.some((r) => e instanceof r);
let qn, Jn;
function T0() {
  return (
    qn ||
...
function N0(e) {
  const t = new Promise((r, i) => {
    const u = () => {
        e.removeEventListener("success", d), e.removeEventListener("error", w);
      },
      d = () => {
        r(fe(e.result)), u();
      },
    ...
    e.addEventListener("success", d), e.addEventListener("error", w);
  });
  return (
    t
      .then((r) => {
        r instanceof IDBCursor && Wi.set(r, e);
      })
      .catch(() => {}),
    an.set(t, e),
    t
  ...
  const t = new Promise((r, i) => {
    const u = () => {
        e.removeEventListener("complete", d),
          ...
          e.removeEventListener("abort", w);
      },
      d = () => {
        r(), u();
      },
      w = () => {
        i(e.error || new DOMException("AbortError", "AbortError")), u();
      };
    e.addEventListener("complete", d),
      e.addEventListener("error", w),
      e.addEventListener("abort", w);
  });
  kr.set(e, t);
}
let $r = {
...
function L0(e) {
  return e === IDBDatabase.prototype.transaction &&
    ...
    ? function (t, ...r) {
        const i = e.call(_r(this), t, ...r);
        return qi.set(i, t.sort ? t.sort() : [t]), fe(i);
      }
    : U0().includes(e)
      ? function (...t) {
          return e.apply(_r(this), t), fe(Wi.get(this));
        }
      : function (...t) {
          return fe(e.apply(_r(this), t));
        };
}
function R0(e) {
  return typeof e == "function"
    ? L0(e)
    : (e instanceof IDBTransaction && F0(e),
      S0(e, T0()) ? new Proxy(e, $r) : e);
}
function fe(e) {
  if (e instanceof IDBRequest) return N0(e);
  if (Er.has(e)) return Er.get(e);
  const t = R0(e);
  return t !== e && (Er.set(e, t), an.set(t, e)), t;
}
const _r = (e) => an.get(e);
function O0(e, t, { blocked: r, upgrade: i, blocking: u, terminated: d } = {}) {
  const w = indexedDB.open(e, t),
    c = fe(w);
  return (
    i &&
      w.addEventListener("upgradeneeded", (b) => {
        i(fe(w.result), b.oldVersion, b.newVersion, fe(w.transaction), b);
      }),
    r && w.addEventListener("blocked", (b) => r(b.oldVersion, b.newVersion, b)),
    c
      .then((b) => {
...
const D0 = ["get", "getKey", "getAll", "getAllKeys", "count"],
...
function Xn(e, t) {
  ...
  if (
    ...
    return;
  const d = async function (w, ...c) {
    const b = this.transaction(w, u ? "readwrite" : "readonly");
    let A = b.store;
    return (
      i && (A = A.index(c.shift())),
...
v0((e) => ({
  ...e,
  get: (t, r, i) => Xn(t, r) || e.get(t, r, i),
  has: (t, r) => !!Xn(t, r) || e.has(t, r),
}));
const Ji = "auth-client-db",
  Xi = "ic-keyval",
  P0 = async (e = Ji, t = Xi, r) => (
    ji &&
      localStorage != null &&
    ...
    await O0(e, r, {
      upgrade: (i) => {
        i.objectStoreNames.contains(t) && i.clear(t), i.createObjectStore(t);
      },
    })
  );
async function C0(e, t, r) {
  return await e.get(t, r);
}
async function k0(e, t, r, i) {
  return await e.put(t, i, r);
}
async function $0(e, t, r) {
...
class un {
  ...
  static async create(t) {
    const { dbName: r = Ji, storeName: i = Xi, version: u = K0 } = t ?? {},
      d = await P0(r, i, u);
    return new un(d, i);
  }
  async set(t, r) {
    return await k0(this._db, this._storeName, t, r);
  }
  async get(t) {
    var r;
    return (r = await C0(this._db, this._storeName, t)) !== null && r !== void 0
      ? r
      : null;
  }
  async remove(t) {
    return await $0(this._db, this._storeName, t);
  }
}
var H0 = function (e, t, r, i, u) {
    if (i === "m") throw new TypeError("Private method is not writable");
    if (i === "a" && !u)
      throw new TypeError("Private accessor was defined without a setter");
    if (typeof t == "function" ? e !== t || !u : !t.has(e))
...
class Zi {
  constructor(t) {
    qe.set(this, void 0), H0(this, qe, t ?? {}, "f");
  }
  get _db() {
...
qe = new WeakMap();
const V0 = "https://identity.ic0.app",
  W0 = "#authorize",
  Br = "ECDSA",
  Ar = "Ed25519",
  q0 = 500,
  J0 = "UserInterrupt";
class X0 {
  constructor(t, r, i, u, d, w, c, b) {
    (this._identity = t),
      (this._key = r),
      (this._chain = i),
      (this._storage = u),
      (this.idleManager = d),
      (this._createOptions = w),
      (this._idpWindow = c),
  ...
  static async create(t = {}) {
    ...
    const d = (r = t.storage) !== null && r !== void 0 ? r : new Zi(),
      w = (i = t.keyType) !== null && i !== void 0 ? i : Br;
    let c = null;
    if (t.identity) c = t.identity;
    else {
      let R = await d.get(oe);
      if (!R && ji)
        try {
          const D = new Y0(),
            O = await D.get(jt),
      ...
      if (R)
        try {
          typeof R == "object"
            ? w === Ar && typeof R == "string"
              ? (c = await ae.fromJSON(R))
              : (c = await Qe.fromKeyPair(R))
            : typeof R == "string" && (c = ae.fromJSON(R));
        } catch {}
    }
    let b = new En(),
      A = null;
      ...
      try {
        ...
        t.identity
          ...
          : R &&
            ...
            Vi(A)
              ? "toDer" in c
                ? (b = tr.fromDelegation(c, A))
                : (b = Kn.fromDelegation(c, A))
              : (await Sr(d), (c = null)));
      } catch (R) {
        console.error(R), await Sr(d), (c = null);
      }
    let U;
    return (
      !((u = t.idleOptions) === null || u === void 0) && u.disableIdle
        ? (U = void 0)
        : (A || t.identity) && (U = Wn.create(t.idleOptions)),
      c ||
        (w === Ar
          ? ((c = await ae.generate()),
  ...
  async _handleSuccess(t, r) {
    ...
    const d = t.delegations.map((A) => ({
      ...
      w = Fe.fromDelegations(d, t.userPublicKey.buffer),
      c = this._key;
    if (!c) return;
    (this._chain = w),
      "toDer" in c
        ? (this._identity = tr.fromDelegation(c, this._chain))
        : (this._identity = Kn.fromDelegation(c, this._chain)),
    ...
    !this.idleManager &&
      !b?.disableIdle &&
      ((this.idleManager = Wn.create(b)), this._registerDefaultIdleCallback()),
    ...
    (c.hash = W0),
      ...
      (this._eventHandler = this._getEventHandler(
        ...
        Object.assign(
          {
            maxTimeToLive:
              (u = t?.maxTimeToLive) !== null && u !== void 0 ? u : w,
          },
          t,
        ),
      )),
    ...
    const b = () => {
      this._idpWindow &&
        (this._idpWindow.closed
          ? this._handleFailure(J0, t?.onError)
          : setTimeout(b, q0));
    };
    b();
  }
    ...
    return async (i) => {
      ...
      switch (c.kind) {
        case "authorize-ready": {
          ...
          (w = this._idpWindow) === null ||
            w === void 0 ||
            w.postMessage(b, t.origin);
          break;
        }
  ...
  async logout(t = {}) {
    if (
      (await Sr(this._storage),
      (this._identity = new En()),
      (this._chain = null),
      t.returnTo)
    )
      try {
...
async function Sr(e) {
  await e.remove(oe), await e.remove(jt), await e.remove(z0);
}
const j0 = () =>
  X0.create({
...
let Je;
const Z0 = () => (Je = setInterval(async () => await Q0(), ms)),
  Qi = () => {
    Je && (clearInterval(Je), (Je = void 0));
  },
  Q0 = async () => {
    const [e, t] = await Promise.all([tu(), eu()]);
  ...
  tu = async () => (await j0()).isAuthenticated(),
  eu = async () => {
    const t = await new Zi().get(jt),
      r = t !== null ? Fe.fromJSON(t) : null;
    return { valid: r !== null && Vi(r), delegation: r };
  },
  ru = () => {
    Qi(), postMessage({ msg: "signOutIdleTimer" });
  },
  nu = (e) => {
