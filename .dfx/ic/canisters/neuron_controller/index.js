...
import { idlFactory } from './neuron_controller.did.js';
export { idlFactory } from './neuron_controller.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_NEURON_CONTROLLER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./neuron_controller.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the neuron_controller canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./neuron_controller.did.js")._SERVICE>}
 */
export const neuron_controller = createActor(canisterId);
