...
import { idlFactory } from "./OpenWSL_frontend.did.js";
export { idlFactory } from "./OpenWSL_frontend.did.js";
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_OPENWSL_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./OpenWSL_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the OpenWSL_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./OpenWSL_frontend.did.js")._SERVICE>}
 */
export const OpenWSL_frontend = createActor(canisterId);
