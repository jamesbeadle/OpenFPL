...
export type Result_1 = { 'ok' : Array<SeasonDTO> } |
  { 'err' : Error };
export type Result_2 = { 'ok' : Array<PlayerDTO> } |
  { 'err' : Error };
export type Result_3 = { 'ok' : Array<FixtureDTO> } |
  { 'err' : Error };
export type Result_4 = { 'ok' : Array<[number, PlayerScoreDTO]> } |
  { 'err' : Error };
export type Result_5 = { 'ok' : Array<PlayerPointsDTO> } |
  { 'err' : Error };
export type Result_6 = { 'ok' : PlayerDetailDTO } |
  { 'err' : Error };
export type Result_7 = { 'ok' : Array<FootballLeague> } |
  { 'err' : Error };
export type Result_8 = { 'ok' : Array<Club> } |
  { 'err' : Error };
