...
export type Result_18 = { ok: Array<CanisterId> } | { err: Error };
...
export type Result_7 = { ok: PickTeamDTO } | { err: Error };
...
export interface _SERVICE {
  ...
  getSantiTeam: ActorMethod<[], Result_7>;
  ...
  getTeejayTeam: ActorMethod<[], Result_7>;
