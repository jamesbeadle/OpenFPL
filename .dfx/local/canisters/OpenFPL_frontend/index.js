...
import { idlFactory } from './OpenFPL_frontend.did.js';
export { idlFactory } from './OpenFPL_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_OPENFPL_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./OpenFPL_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the OpenFPL_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./OpenFPL_frontend.did.js")._SERVICE>}
 */
export const OpenFPL_frontend = createActor(canisterId);
