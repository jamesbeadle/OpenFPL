...
import { idlFactory } from "./OpenFPL_backend.did.js";
export { idlFactory } from "./OpenFPL_backend.did.js";
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_OPENFPL_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./OpenFPL_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the OpenFPL_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./OpenFPL_backend.did.js")._SERVICE>}
 */
