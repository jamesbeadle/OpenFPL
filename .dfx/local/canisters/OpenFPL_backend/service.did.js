export const idlFactory = ({ IDL }) => {
  ...
  const Result_12 = IDL.Variant({ ok: RewardRatesDTO, err: Error });
  ...
  const Result_11 = IDL.Variant({ ok: IDL.Vec(CanisterDTO), err: Error });
  ...
  const Result_10 = IDL.Variant({ ok: TeamSelectionDTO, err: Error });
