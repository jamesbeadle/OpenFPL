...
import { idlFactory } from './OpenWSL_backend.did.js';
export { idlFactory } from './OpenWSL_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_OPENWSL_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./OpenWSL_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the OpenWSL_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./OpenWSL_backend.did.js")._SERVICE>}
 */
export const OpenWSL_backend = createActor(canisterId);
