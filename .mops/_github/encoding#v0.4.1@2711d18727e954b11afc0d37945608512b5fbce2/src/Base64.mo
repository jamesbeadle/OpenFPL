...
module Base64 {
  ...
  public func decode(data : [Nat8], decodeMap : [Nat8]) : Result.Result<[Nat8], Text> {
    ...
    while ((data.size() - si : Nat) >= 8 and (dst.size() - n : Nat) >= 8) switch (
      assemble64(
    ...
    while ((data.size() - si : Nat) >= 4 and (dst.size() - n : Nat) >= 4) switch (
      assemble32(
        decodeMap[Nat8.toNat(data[si])],
        decodeMap[Nat8.toNat(data[si + 1])],
        decodeMap[Nat8.toNat(data[si + 2])],
  ...
  private func assemble32(b0 : Nat8, b1 : Nat8, b2 : Nat8, b3 : Nat8) : ?Nat32 {
    ...
    return ?(
      Nat32.fromNat(Nat8.toNat(b0)) << 26 | Nat32.fromNat(Nat8.toNat(b1)) << 20 | Nat32.fromNat(Nat8.toNat(b2)) << 14 | Nat32.fromNat(Nat8.toNat(b3)) << 8,
    );
  };
  ...
  private func assemble64(b0 : Nat8, b1 : Nat8, b2 : Nat8, b3 : Nat8, b4 : Nat8, b5 : Nat8, b6 : Nat8, b7 : Nat8) : ?Nat64 {
    ...
    return ?(
      Nat64.fromNat(Nat8.toNat(b0)) << 58 | Nat64.fromNat(Nat8.toNat(b1)) << 52 | Nat64.fromNat(Nat8.toNat(b2)) << 46 | Nat64.fromNat(Nat8.toNat(b3)) << 40 | Nat64.fromNat(Nat8.toNat(b4)) << 34 | Nat64.fromNat(Nat8.toNat(b5)) << 28 | Nat64.fromNat(Nat8.toNat(b6)) << 22 | Nat64.fromNat(Nat8.toNat(b7)) << 16,
    );
  };
  ...
  private func decodeQuantum(decodeMap : [Nat8], dst : [var Nat8], n : Nat, src : [Nat8], i : Nat) : Result.Result<(Nat, Nat), Text> {
    ...
    // 4x6bit to 3 bytes
    let v = Nat32.fromNat(Nat8.toNat(dstBuffer[0])) << 18 | Nat32.fromNat(Nat8.toNat(dstBuffer[1])) << 12 | Nat32.fromNat(Nat8.toNat(dstBuffer[2])) << 6 | Nat32.fromNat(Nat8.toNat(dstBuffer[3]));
