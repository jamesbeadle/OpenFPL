...
assert (
  StdEncoding.encode([102, 111, 111, 32, 98, 97, 114]) == [90, 109, 57, 118, 73, 71, 74, 104, 99, 103],
); // "foo bar"

assert (
  URLEncoding.decode([90, 109, 57, 118, 73, 71, 74, 104, 99, 103]) == #ok([102, 111, 111, 32, 98, 97, 114]),
); // "foo bar"
