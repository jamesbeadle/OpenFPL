...
actor Test {
  public query func testPerf() : async [Text] {
    ...
    let setCost = IC.countInstructions(
      func() {
        var i = 0 : Nat32;
    ...
    let getCost = IC.countInstructions(
      func() {
        var i = 0 : Nat32;
    ...
    let updateCost = IC.countInstructions(
      func() {
        var i = 0 : Nat32;
    ...
    let deleteCost = IC.countInstructions(
      func() {
        var i = 0 : Nat32;
    ...
    let deleteDescCost = IC.countInstructions(
      func() {
        var i = 100000 : Nat32;
