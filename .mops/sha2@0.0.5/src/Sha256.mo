...
*/
      ...
      h +%= h_0;
      s0h := nat32To16(a >> 16);
      s0l := nat32To16(a & 0xffff);
      s1h := nat32To16(b >> 16);
      s1l := nat32To16(b & 0xffff);
      s2h := nat32To16(c >> 16);
      s2l := nat32To16(c & 0xffff);
      s3h := nat32To16(d >> 16);
      s3l := nat32To16(d & 0xffff);
      s4h := nat32To16(e >> 16);
      s4l := nat32To16(e & 0xffff);
      s5h := nat32To16(f >> 16);
      s5l := nat32To16(f & 0xffff);
      s6h := nat32To16(g >> 16);
      s6l := nat32To16(g & 0xffff);
      s7h := nat32To16(h >> 16);
      s7l := nat32To16(h & 0xffff);
    };
