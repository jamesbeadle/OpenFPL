...
declare module '$env/static/private' {
	...
	export const CANISTER_ID_nns_sns_wasm: string;
	export const NNS_ROOT_CANISTER_ID: string;
	export const CANISTER_ID_NNS_ROOT: string;
	export const CANISTER_ID_nns_root: string;
	export const NNS_REGISTRY_CANISTER_ID: string;
	export const CANISTER_ID_NNS_REGISTRY: string;
	export const CANISTER_ID_nns_registry: string;
	...
	export const CANISTER_ID_nns_governance: string;
	export const NNS_GENESIS_TOKEN_CANISTER_ID: string;
	export const CANISTER_ID_NNS_GENESIS_TOKEN: string;
	export const CANISTER_ID_nns_genesis_token: string;
	export const NNS_CYCLES_MINTING_CANISTER_ID: string;
	export const CANISTER_ID_NNS_CYCLES_MINTING: string;
	export const CANISTER_ID_nns_cycles_minting: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		CANISTER_ID_nns_sns_wasm: string;
		NNS_ROOT_CANISTER_ID: string;
		CANISTER_ID_NNS_ROOT: string;
		CANISTER_ID_nns_root: string;
		NNS_REGISTRY_CANISTER_ID: string;
		CANISTER_ID_NNS_REGISTRY: string;
		CANISTER_ID_nns_registry: string;
		...
		CANISTER_ID_nns_governance: string;
		NNS_GENESIS_TOKEN_CANISTER_ID: string;
		CANISTER_ID_NNS_GENESIS_TOKEN: string;
		CANISTER_ID_nns_genesis_token: string;
		NNS_CYCLES_MINTING_CANISTER_ID: string;
		CANISTER_ID_NNS_CYCLES_MINTING: string;
		CANISTER_ID_nns_cycles_minting: string;
