    ...
    {}
      ...
      ${`<ul class="hidden md:flex"><li class="mx-2 flex items-center h-16"><button class="flex items-center justify-center px-4 py-2 bg-blue-500 text-white rounded-md shadow hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-300 focus:ring-opacity-50 nav-button svelte-197nckd">Connect
        ...
        <div class="${
          escape(
            null_to_empty(
              `absolute top-12 right-2.5 bg-black rounded-lg shadow-md z-10 p-2 ${"hidden"} md:hidden`
            ),
            true
          ) + " svelte-197nckd"
...
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<footer class="bg-gray-900 text-white py-3"><div class="container mx-auto flex flex-col sm:flex-row items-start sm:items-center justify-between text-xs"><div class="flex-1"><div class="flex justify-start"><div class="flex flex-row pl-4"><a href="https://oc.app/community/uf3iv-naaaa-aaaar-ar3ta-cai/?ref=zv6hh-xaaaa-aaaar-ac35q-cai" target="_blank" rel="noopener noreferrer"><img src="openchat.png" class="h-4 w-auto mb-2 mr-2" alt="OpenChat"></a>
    ...
    <div class="flex-0"><a href="/"><b class="px-4 mt-2 sm:mt-0 sm:px-10 flex items-center">${validate_component(
      OpenFPLIcon,
      "OpenFplIcon"
    ).$$render(
      $$result,
...
const Toast = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_toastStore = subscribe(
    toastStore,
    (value) => ($toastStore = value)
  );
  ...
  return `${
    $toastStore.visible
      ? `<div class="${
          escape(
            null_to_empty(
              `fixed inset-x-0 bottom-0 text-white text-center py-2 toast-panel-${$toastStore.type}`
            ),
            true
          ) + " svelte-1pzngus"
        }">${escape($toastStore.message)}</div>`
      : ``
  }`;
});
...
const LoadingIcon = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let $loadingText, $$unsubscribe_loadingText;
    $$unsubscribe_loadingText = subscribe(
      loadingText,
    ...
    return `<div class="flex justify-center items-center h-screen"><div class="${
      escape(
        null_to_empty(
          `${className} flex flex-col justify-center items-center h-screen pulse-text-color`
        ),
        true
      ) + " svelte-1ormd53"
    }"><div class="relative"><svg xmlns="http://www.w3.org/2000/svg" class="${
      escape(null_to_empty(`pulse-color w-20 h-20 mb-2 ${className}`), true) +
      " svelte-1ormd53"
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_isLoading = subscribe(
    isLoading,
    (value) => ($isLoading = value)
  );
  $$result.css.add(css);
  $$unsubscribe_isLoading();
  return `<div class="flex flex-col h-screen justify-between">${validate_component(
    Header,
    "Header"
  ).$$render($$result, {}, {}, {})}
  ${
    $isLoading
      ? `<div class="loading-overlay svelte-1ynyyny">${validate_component(
          LoadingIcon,
          "LoadingIcon"
        ).$$render($$result, {}, {}, {})}</div>`
      : `<main class="svelte-1ynyyny">${
