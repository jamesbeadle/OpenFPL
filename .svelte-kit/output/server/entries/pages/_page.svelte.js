...
import { S as SystemService, r as replacer, F as FixtureService, T as TeamService } from "../../chunks/TeamService.js";
import "@dfinity/agent";
import { A as ActorFactory, i as idlFactory, a as authStore } from "../../chunks/ActorFactory.js";
...
class LeaderboardService {
  ...
  async getWeeklyLeaderboardPage(gameweek, currentPage) {
...
class ManagerService {
  ...
  async getFantasyTeamForGameweek(managerId, gameweek) {
    try {
      let systemService = new SystemService();
      await systemService.updateSystemStateData();
      let systemState = await systemService.getSystemState();
  ...
  async saveFantasyTeam(userFantasyTeam, activeGameweek) {
    try {
  ...
  getBonusPlayed(userFantasyTeam, activeGameweek) {
    let bonusPlayed = 0;
  ...
  getBonusPlayerId(userFantasyTeam, activeGameweek) {
    let bonusPlayerId = 0;
    if (userFantasyTeam.goalGetterGameweek == activeGameweek) {
  ...
  getBonusTeamId(userFantasyTeam, activeGameweek) {
    let bonusTeamId = 0;
    if (userFantasyTeam.teamBoostGameweek == activeGameweek) {
