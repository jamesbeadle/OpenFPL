...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  <div class="mx-4"><div class="bg-panel rounded-md mx-4"><ul class="flex bg-light-gray px-4 pt-2"><li class="${escape(null_to_empty(`mr-4 text-xs md:text-lg ${"active-tab"}`), true) + " svelte-18fkfyi"}"><button class="${escape(
        null_to_empty(`p-2 ${"text-white"}`),
        true
      ) + " svelte-18fkfyi"}">Fixtures
          </button></li>
        ${``}
        <li class="${escape(null_to_empty(`mr-4 text-xs md:text-lg ${""}`), true) + " svelte-18fkfyi"}"><button class="${escape(
