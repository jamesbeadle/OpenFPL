import { c as create_ssr_component, b as each, d as add_attribute, e as escape, v as validate_component, n as null_to_empty } from "../../chunks/index3.js";
import "../../chunks/app.constants.js";
import "@dfinity/auth-client";
import "@dfinity/utils";
import "../../chunks/manager-store.js";
import { L as Layout } from "../../chunks/Layout.js";
import { t as teamStore, s as systemStore, f as formatUnixTimeToTime, A as ActorFactory, i as idlFactory, r as replacer } from "../../chunks/team-store.js";
    ...
    default: () => {
      ...
      <div class="flex flex-col md:flex-row justify-start md:items-center text-white space-x-0 md:space-x-4 flex-grow m-4 bg-panel p-4 rounded-md"><div class="flex-grow mb-4 md:mb-0"><p class="text-gray-300 text-xs">Next Game:</p>
        ...
        <div class="flex-grow"><p class="text-gray-300 text-xs mt-4 md:mt-0">GW ${escape(focusGameweek)} High Score
          ...
          <p class="text-2xl sm:text-3xl md:text-4xl mt-2 mb-2 font-bold"><a${add_attribute("href", `/manager?id=${weeklyLeader.principalId}&gw=${activeGameweek}`, 0)}>${escape(weeklyLeader.username)}</a></p>
          <p class="text-gray-300 text-xs">${escape(weeklyLeader.points)} points</p></div></div></div></div>
