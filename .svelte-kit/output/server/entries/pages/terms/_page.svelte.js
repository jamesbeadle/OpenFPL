...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(Layout, "Layout").$$render($$result, {}, {}, {
    default: () => {
      ...
      <div class="bg-panel rounded-lg m-4"><div><p class="my-2 text-xs">Last Updated: 13th October 2023</p>

          <p class="my-4">By accessing the OpenFPL website (&quot;Site&quot;) and participating in the
          ...
          <p class="my-4">OpenFPL operates as a decentralised autonomous organisation (DAO).
          ...
          <p class="my-4">The Service is open to users of all ages.</p>
          ...
          <p class="my-4">These Terms and Conditions are subject to change. Amendments will be
