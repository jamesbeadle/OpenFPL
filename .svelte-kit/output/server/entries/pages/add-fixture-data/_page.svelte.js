import { c as create_ssr_component, a as subscribe, e as escape, b as each, d as add_attribute, g as get_store_value, o as onDestroy, v as validate_component, f as noop } from "../../../chunks/index3.js";
...
const Player_events_modal = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${show ? `<div class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full"><div class="relative top-20 mx-auto p-5 border w-3/4 shadow-lg rounded-md bg-white">${player ? `<div class="flex justify-between items-center"><h4 class="text-lg font-bold">${escape(player.firstName !== "" ? player.firstName.charAt(0) + "." : "")}
...
const Select_players_modal = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${show ? `<div class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full"><div class="relative top-20 mx-auto p-5 border w-3/4 shadow-lg rounded-md bg-white"><div class="flex justify-between items-center"><h4 class="text-lg font-bold">Select ${escape(selectedTeam.friendlyName)} Players
        </h4>
        <button class="text-black">✕</button></div>
...
const Confirm_fixture_data_modal = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${show ? `<div class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full"><div class="relative top-20 mx-auto p-5 border w-3/4 shadow-lg rounded-md bg-white"><div class="flex justify-between items-center"><h4 class="text-lg font-bold">Confirm Fixture Data</h4>
        <button class="text-black">✕</button></div>
...
const Clear_draft_modal = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.onConfirm === void 0 && $$bindings.onConfirm && onConfirm !== void 0)
    $$bindings.onConfirm(onConfirm);
  return `${show ? `<div class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full"><div class="relative top-20 mx-auto p-5 border w-3/4 shadow-lg rounded-md bg-white"><div class="flex justify-between items-center"><h4 class="text-lg font-bold">Confirm Clear Draft</h4>
        <button class="text-black">✕</button></div>
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let $$unsubscribe_selectedPlayers;
  let $$unsubscribe_playerEventData = noop, $$subscribe_playerEventData = () => ($$unsubscribe_playerEventData(), $$unsubscribe_playerEventData = subscribe(playerEventData, ($$value) => $$value), playerEventData);
  $$unsubscribe_page = subscribe(page, (value) => $page = value);
  let showPlayerEventModal = false;
  let teamPlayers = writable([]);
  let selectedPlayers = writable([]);
  $$unsubscribe_selectedPlayers = subscribe(selectedPlayers, (value) => value);
  let selectedTeam;
  let selectedPlayer;
  ...
  return `${validate_component(Layout, "Layout").$$render($$result, {}, {}, {
    default: () => {
      return `${`<div class="flex items-center justify-center h-screen"><p class="text-center mt-1">Loading Fixture Data...</p></div>`}`;
    }
  })}
