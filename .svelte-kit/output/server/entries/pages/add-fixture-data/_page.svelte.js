...
import { A as ActorFactory, i as idlFactory, a as authStore, t as teamStore } from "../../../chunks/team-store.js";
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  async function confirmFixtureData() {
    try {
      await new GovernanceService().submitFixtureData(fixtureId, get_store_value(playerEventData));
