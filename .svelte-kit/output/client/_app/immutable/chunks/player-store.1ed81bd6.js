import { f as O } from "./fixture-store.724d0928.js";
import { w as L } from "./index.8caf67b2.js";
import { s as F } from "./system-store.28344883.js";
import { A as j, k as q, r as x } from "./team-store.90511bc6.js";
import "./toast-store.58fa49f6.js";
function w() {
  const { subscribe: C, set: v } = L([]);
  let b;
  F.subscribe((a) => {
    b = a;
  });
  let g;
  O.subscribe((a) => (g = a));
  let N = j.createActor(q, "pec6o-uqaaa-aaaal-qb7eq-cai");
  async function T() {
    let a = "players",
    ...
    if (e?.hash != r) {
      ...
      localStorage.setItem("players_data", JSON.stringify(n, x)),
  ...
  return { subscribe: C, sync: T, getPlayerDetails: y, getGameweekPlayers: f };
}
const H = w();
export { H as p };
