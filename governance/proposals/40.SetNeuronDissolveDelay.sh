...
ARGS="(record { neuron_id = 2511989001097450386:nat64; command = variant { Configure = record { operation = opt variant { IncreaseDissolveDelay = record { additional_dissolve_delay_seconds = 252460800:nat32 } } } } })"
FUNCTION_ID=20000
