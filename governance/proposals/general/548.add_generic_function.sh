...
PROPOSAL="(
    record {
        title = \"Create Revalue Player Up Callback Function\";          
        url = \"https://github.com/jamesbeadle/football_god/blob/master/src/data_canister/main.mo\";        
        summary = \"Proposal to create the endpoint for adding the callback function to revalue a player up on the data canister.\";
        action = opt variant {
            AddGenericNervousSystemFunction = record {
                id = 50000 : nat64;
                name = \"Increase Player Value\";
                description = opt \"Increase a players value by £0.25m.\";
                function_type = opt variant { 
                    GenericNervousSystemFunction = record { 
                        ...
                        target_method_name = opt \"revaluePlayerUp\";
                    } 
                };
            }
        };
